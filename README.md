...
- 노트 녹음 기능
    ...
    - 소리 입력상태 출력
- 이미지 업로드 기능
  - 클립보드의 이미지를 붙여넣어 업로드 가능
- keyboard shortcut으로 snippet이나 내용 넣을 수 있도록 하는 기능
- 폴더목록 새로고침 애니메이션 추가.
...
- Web Ink API
- markdown 입력 쪽에 text 입력 밑에 약간의 padding을 넣어 추가로 스크롤 가능하게 하기 (50dvh)
  - vscode에서 스크롤하면 하단에 여백이 약간 더 남는 것처럼.
...
- 프린트 페이지에서 font를 직접 설정할 수 있도록 하기
  - bold 문구 폰트 설정
  - heading 문구 폰트 설정
  - 본문 폰트 설정
  - code block 폰트 설정