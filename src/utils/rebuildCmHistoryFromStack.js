 ...
 * @returns {boolean}
 */
export function rebuildCmHistoryFromStack(view, stack, resetHistory) {
 ...
 * @returns {(() => void) | null}
 */
export function getResetHistoryFn(editorApi) {
 ...
 */
export function getEditorViewFromApi(editorApi) {
  if (!editorApi) return null;
