...
export const wikiImageCacheDb = new Dexie('s3haim-wiki-image-cache') as any;
 ...
 */
export async function getCachedWikiImageObjectUrl(path: any) {
 ...
 */
export async function setCachedWikiImageBlob({
  path,
  blob
}: any) {
  const table = wikiImageCacheDb.table('blobs');
 ...
 */
export async function getCachedWikiImageUrl(path: any) {
 ...
 */
export async function setCachedWikiImageUrl(item: any) {
  const table = wikiImageCacheDb.table('urls');
