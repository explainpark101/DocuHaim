...
function withClipboardFileName(file) {
 ...
 */
export async function readClipboardImagesAsAttachments(event, currentCount = 0) {
 ...
 */
export async function readImageFileAsAttachment(file) {
