 ...
 */
export function parseWikiImageOptions(rawOption: any) {
...
export function parseWikiImageSizeOption(rawOption: any) {
...
export function normalizeSizeValue(rawValue: any) {
...
export function buildWikiImageStyle({
  width,
  height,
  background
}: any = {}) {
...
export function wikiImageMarkupFromAttrs({
  path,
  width,
  height,
  background
...
export function getWikiImageAttrsFromElement(img: any) {
...
export function getWikiImageOccurrenceInContainer(container: any, img: any, path: any) {
...
export function updateWikiImagePathInMarkdown(markdown: any, {
  path,
  occurrence = 0,
  nextPath,
  width,
...
export function updateWikiImageSizeInMarkdown(markdown: any, {
  path,
  occurrence = 0,
  width = null,
  height = null
...
export function parseMarkdownImageAttrsBlock(rawBlock: any) {
...
export function markdownImageAttrsBlockFromSize({
  width,
  height,
  background
}: any = {}) {
...
export function getResizableImageAttrsFromElement(img: any) {
  if (!img || typeof img.getAttribute !== 'function') {
...
export function getMarkdownImageOccurrenceInContainer(container: any, img: any, src: any) {
...
export function replaceMarkdownImageWithWikiPath(markdown: any, {
  src,
  occurrence = 0,
  nextPath,
  width,
...
export function updateMarkdownImageSizeInMarkdown(markdown: any, {
  src,
  occurrence = 0,
  width = null,
  height = null
...
export function updateMarkdownImageSrcInMarkdown(markdown: any, {
  src,
  occurrence = 0,
  nextSrc,
  width,
