...
export const pendingUploadsDb = new Dexie('s3haim-pending-uploads') as any;
 ...
 * @param {number} id
 */
export async function deletePendingUpload(id: any) {
 ...
 * @param {string} key
 */
export async function deletePendingUploadByKey(key: any) {
