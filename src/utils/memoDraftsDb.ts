...
export const memoDraftsDb = new Dexie('s3haim-memo-drafts') as any;
 ...
 * @returns {string}
 */
export function getDraftKey(storageType: any, path: any) {
 ...
 */
export async function getMemoDraft(key: any) {
 ...
 * @param {string} key
 */
export async function deleteMemoDraft(key: any) {
