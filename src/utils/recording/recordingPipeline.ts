 ...
 * mimeType으로 확장자 결정
 */
function getExtensionFromMimeType(mimeType: any) {
 ...
 */
export function getNoteBase(noteKey: any) {
 ...
 */
export function getAudioKey(noteKey: any, mimeType: any, timestamp: any) {
 ...
 */
export function getSyncKeyForRecording(audioKey: any) {
 ...
 */
export function getSyncKey(noteKey: any, timestamp: any) {
  if (!noteKey || typeof noteKey !== 'string') return null;
  const base = getNoteBase(noteKey);
  if (timestamp != null) {
