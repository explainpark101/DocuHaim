...
function writeBoolPref(key: any, value: any) {
...
export function writeComposerToolbarPref(visible: any) {
...
export function writeComposerLineNumbersPref(visible: any) {
...
export function writeComposerHelperTextPref(visible: any) {
...
export function writeOpenLinksInNewWindowPref(enabled: any) {
...
export function writePerfReduceLayoutAnimPref(enabled: any) {
...
export function writePerfReduceBubblePressFxPref(enabled: any) {
...
export function writeComposerLightweightPref(enabled: any) {
 ...
 */
export function getChatRailOpen(railId: any, { isMobileLayout = false } = {}) {
