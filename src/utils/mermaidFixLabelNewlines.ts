 ...
 * Pre-render math and turn label backslash-n into <br/> so the normal HTML
 * label path measures multi-line boxes correctly.
 */
import katex from 'katex';

const KATEX_BLOCK_RE = /\$\$([\s\S]*?)\$\$/g;

/** Prepare mermaid source so label newlines + math layout correctly. */
