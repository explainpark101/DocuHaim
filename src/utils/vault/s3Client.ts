 ...
 * @param {string[]} keys
 */
export async function putS3FolderMarkers(client: any, bucket: any, keys: any) {
 ...
 */
export async function getObjectBody(client: any, bucket: any, key: any) {
 ...
 *   객체가 없으면 null
 */
export async function headObject(client: any, bucket: any, key: any) {
  try {
 ...
 */
export async function putObject(client: any, params: any) {
 ...
 */
export async function getSignedPutUrl(client: any, params: any, expiresIn = 300) {
 ...
 */
export async function deleteObject(client: any, bucket: any, key: any) {
 ...
 */
export async function deleteObjects(client: any, bucket: any, objects: any) {
 ...
 */
export async function copyObject(client: any, bucket: any, copySourceKey: any, key: any) {
 ...
 */
export async function streamS3ObjectToWritable(client: any, bucket: any, key: any, writable: any, onProgress: any) {
  const command = new GetObjectCommand({
    Bucket: bucket,
    Key: key,
    ResponseCacheControl: 'no-cache, no-store, must-revalidate',
 ...
 * @returns {Promise<string>}
 */
export async function getSignedGetUrl(client: any, bucket: any, key: any, expiresIn = 60) {
  const command = new GetObjectCommand({
    Bucket: bucket,
    Key: key,
    ResponseCacheControl: 'no-cache, no-store, must-revalidate',
