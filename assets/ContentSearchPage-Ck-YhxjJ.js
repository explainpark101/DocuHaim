import { r, j as t, u as z, e as A } from "./vendor-react-BFxggocB.js";
import { I as D, J as k, S as H, K as Q, N as B, O as G, Q as U, U as X, Z as F } from "./index-BFytel-U.js";
import { M as J, b as K, c as V, X as W, L as Z } from "./vendor-lucide-BpsjM9FN.js";
...
function Y({ lines: s, query: c, terms: l }) {
...
function pe({ storageMode: s, s3Tree: c, localTree: l, webdavTree: a, sessionWorkspaces: g, onOpenFile: f, isActive: h = true }) {
  const u = z(), [o, d] = A(), x = o.get("q") || "", [p, S] = r.useState(x), [i, w] = r.useState(x), [b, C] = r.useState([]), [v, j] = r.useState(false), [L, E] = r.useState([]), [M, q] = r.useState(() => k.getStatus()), N = r.useRef(0), R = r.useRef(null), [, I] = r.useTransition();
  ...
  r.useEffect(() => {
    ...
    j(true), (async () => {
      const y = await U(e, []), O = y.length > 0 ? y.map((m) => m.toLowerCase()) : e.toLowerCase().split(/\s+/).map((m) => m.trim()).filter((m) => m.length >= 2);
      if (n !== N.current) return;
      const P = await k.searchContentPage(e, T(), 60);
      n === N.current && I(() => {
        C(P), E(O), j(false);
      });
    })();
  ...
  const _ = r.useMemo(() => i ? v ? "\uAC80\uC0C9 \uC911\u2026" : "\uC77C\uCE58\uD558\uB294 \uBCF8\uBB38\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." : "\uAC80\uC0C9\uC5B4\uB97C \uC785\uB825\uD558\uBA74 \uBCFC\uD2B8 \uBCF8\uBB38\uC5D0\uC11C \uC77C\uCE58 \uAD6C\uAC04\uC744 \uCC3E\uC2B5\uB2C8\uB2E4.", [i, v]), $ = r.useCallback((e) => {
