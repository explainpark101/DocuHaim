...
import { T as Oa } from "./TableStyleTemplateEditor-DrWpov5l.js";
...
import { G as za, O as $a, __tla as __tla_3 } from "./OpenAiCompatibleModelSelect-1lcQjJZ9.js";
                          ...
                          onClick: async () => {
                            try {
                              const { createWebdavBackend: s } = await gr(async () => {
                                const { createWebdavBackend: Q } = await import("./index-DYocwnql.js").then(async (m2) => {
                                  await m2.__tla;
                                  return m2;
                                }).then((Re) => Re.gs);
                                return {
