...
import { j as o, r as a, u as vo, a as ko, c as Cs } from "./vendor-react-kfkzeLNk.js";
import { B as Es, D as Zn, S as Co, l as Lt, F as Eo, G as cr, W as Ss, H as So, J as It, M as it, O as No, j as er, V as jo, P as Mo, m as Ie, Q as Ns, R as js, T as Ms, U as Rs, X as Ts, Y as wn, Z as ur, $ as Ls, a0 as Ps, c as As, a1 as Ds, a2 as Ro, v as Is, a3 as $s, a4 as Fs, K as _s, a5 as Hs, a6 as Os, a7 as Bs, a8 as Ks, a9 as zs, aa as Vs, ab as Ws, ac as qs, ad as Us, ae as Xs, af as Ys, ag as Gs, ah as Qs, ai as Js, aj as Zs, ak as ei, al as ti, am as ni, an as ri, ao as oi } from "./vendor-md-editor-BDWDGvn8.js";
import { o as si, eN as To, eO as ln, eP as $e, eQ as Lo, aa as ht, eR as dr, eS as ii, ah as Po, ai as Ao, eT as fr, eU as ai, U as $t, ad as li, eV as mr, F as pr, eW as ci, eX as ui, eY as di, eZ as hr, e_ as Do, e$ as fi, f0 as mi, f1 as pi, f2 as hi, f3 as gi, f4 as Io, f5 as xi, a4 as nn, dD as $o, aH as bi, au as wi, f6 as yi, q as vi, f7 as gr, f8 as ki, f9 as Ci, x as Ei, O as yn, fa as Si, N as vn, fb as Ni, y as kn, w as ji, dK as Fo, ed as zn, aJ as Mi, ay as rn, fc as xr, aI as Ri, fd as Ti, fe as Li, ff as Pi, ee as Ai, fg as Di, fh as Vn, a5 as Ii, e5 as tr, a0 as nr, fi as $i, fj as Fi, fk as _i, eh as Hi, dn as Oi, eI as Bi, ea as _o, fl as Tt, fm as Ki, fn as zi, fo as Vi, ef as Wi, ev as qi, fp as Ho, fq as Ui, fr as Xi, fs as br, ft as Yi, fu as Gi, E as Qi, es as Ji, fv as Ut, eo as Zi, fw as ea, fx as jt, fy as ta, fz as na, fA as ra, cB as wr, al as Cn, eA as En, am as oa, eB as yr, eC as sa, an as ia, ao as aa, a2 as la, ap as ca, aj as ua, ak as da, T as fa, M as ma, eK as pa, fB as ha, fC as ga, fD as Sn, fE as Nn, fF as vr, fG as kr, fH as jn, fI as Cr, fJ as xa, fK as Er, fL as Sr, eL as ba, ar as wa, eM as ya, fM as va, fN as ka, fO as Ca, fP as Ea, fQ as Nr, fR as We, fS as Sa, fT as Mn, fU as Rn, ct as Na } from "./index-CxSNwP6k.js";
import { S as ja, aC as Ma, aD as jr, aE as Tn, ap as Ln, aF as Ra, O as Ta, aG as rr, aH as La, J as Oo, aI as Pa, R as Aa, X as cn, v as Da, aJ as Ia, aK as $a, i as un, aL as Fa, aM as _a, aN as Bo, aO as Ha, x as Oa, aP as on, as as Ba, at as Ka, aB as Mr, aQ as Pn, aR as Rr, aS as za, am as Va, j as Wa, aT as Tr, aU as qa, aV as Ua, aW as Xa, aX as Ya, G as gt, z as Ga, L as Qa } from "./vendor-lucide-DL-f4Fg7.js";
import { d as Ko, r as An, s as Dn, G as Ja, H as Za, I as el, J as tl, K as nl, M as rl, N as ol, Q as sl, U as il, V as al, S as or, b as sr, e as Wn, T as qn, f as Un, g as Xn, A as Yn, l as ll, F as qe, L as ot, m as Xt, X as cl, Y as ul, Z as dl, W as fl, a0 as Lr, a1 as ml, a2 as pl, a3 as hl, a4 as gl, a5 as Pr } from "./vendor-radix-DRr4EGX0.js";
import { M as xl } from "./MdEditorToolbarTooltips-bsIxqDmD.js";
import { a as bl, h as wl, P as yl, H as vl } from "./previewFootnoteScroll-CfDDyN8M.js";
import { N as kl, u as Cl, W as El } from "./useTocTitleWrap-BE6VMNiv.js";
import { H as In, T as Sl } from "./TableStyleTemplateEditor-C_QTntxI.js";
import { a as dn } from "./vendor-motion-jUlp7ZOS.js";
import { c as Nl } from "./clipboardImageFiles-DJIQSxn-.js";
import { u as jl } from "./useWikiImageHydration-CGF0G0z2.js";
...
function $l(e, t, n) {
  ...
  for (const u of r) {
    ...
    const b = p[u.c] ?? "";
    b && (m[u.c] = b, p[u.c] = "");
    const T = $e(n, u.c), N = $e(l, u.c), R = s[T];
    R && (s[N] = { ...R }, delete s[T]);
  }
...
function Fl(e, t, n) {
  ...
  for (const l of r) {
    ...
    const p = u[l.c] ?? "";
    p && (u[l.c + 1] = p, u[l.c] = "");
    const m = $e(l.r, n), b = $e(l.r, n + 1), T = s[m];
    T && (s[b] = { ...T }, delete s[m]);
  }
  return { grid: { rows: i, aligns: [...e.aligns] }, meta: { ...t, cells: s } };
}
...
function Ol(e, t, n) {
  ...
  const i = $l(e, t, n), s = [...i.grid.rows.slice(0, n), ...i.grid.rows.slice(n + 1)];
...
function Bl(e, t, n) {
  ...
  if (r <= 1) return { grid: e, meta: t };
  if (n < 0 || n >= r) return { grid: e, meta: t };
  const i = Fl(e, t, n), s = i.grid.rows.map((p) => {
    const m = [...p];
...
function tc({ markdown: e = "", onMarkdownChange: t }) {
  const [n, r] = a.useState(""), [i, s] = a.useState("all"), [l, u] = a.useState({}), [p, m] = a.useState("dashboard"), b = a.useMemo(() => Zl(e), [e]);
  a.useEffect(() => {
    const S = {};
  ...
  return o.jsxs("div", { className: "space-y-3 text-xs text-slate-100", children: [o.jsxs("div", { className: "grid grid-cols-2 gap-2 sm:grid-cols-4", children: [o.jsxs("div", { className: "col-span-2 sm:col-span-1 relative overflow-hidden rounded-xl border border-indigo-500/30 bg-gradient-to-br from-indigo-900/40 via-slate-900 to-slate-900 p-3", children: [o.jsx("div", { className: "pointer-events-none absolute -right-2 -top-2 opacity-10", children: o.jsx(Ma, { className: "h-16 w-16 text-indigo-400" }) }), o.jsx("span", { className: "text-[10px] font-semibold uppercase tracking-wider text-indigo-300", children: "\uC804\uCCB4 \uC9C4\uD589\uB960" }), o.jsx("div", { className: "my-1.5 flex items-baseline gap-1", children: o.jsxs("span", { className: "text-3xl font-extrabold text-white", children: [b.percentage, "%"] }) }), o.jsx("div", { className: "h-1.5 w-full overflow-hidden rounded-full bg-slate-800", children: o.jsx("div", { className: "h-full bg-gradient-to-r from-indigo-500 to-emerald-400 transition-all duration-700 ease-out", style: { width: `${b.percentage}%` } }) })] }), o.jsxs("div", { className: "flex flex-col justify-between rounded-xl border border-slate-800 bg-slate-950 p-3", children: [o.jsxs("div", { className: "flex items-center justify-between text-slate-400", children: [o.jsx("span", { className: "text-[10px] font-medium", children: "\uCD1D \uD0DC\uC2A4\uD06C" }), o.jsx(jr, { className: "h-3.5 w-3.5 text-slate-500" })] }), o.jsxs("div", { className: "mt-1 text-xl font-bold text-slate-100", children: [b.totalTasks, " ", o.jsx("span", { className: "text-[10px] font-normal text-slate-500", children: "\uAC1C" })] })] }), o.jsxs("div", { className: "flex flex-col justify-between rounded-xl border border-slate-800 bg-slate-950 p-3", children: [o.jsxs("div", { className: "flex items-center justify-between text-emerald-400", children: [o.jsx("span", { className: "text-[10px] font-medium", children: "\uC644\uB8CC\uB428" }), o.jsx(Tn, { className: "h-3.5 w-3.5" })] }), o.jsxs("div", { className: "mt-1 text-xl font-bold text-emerald-400", children: [b.completedTasks, " ", o.jsx("span", { className: "text-[10px] font-normal text-slate-500", children: "\uAC1C" })] })] }), o.jsxs("div", { className: "flex flex-col justify-between rounded-xl border border-slate-800 bg-slate-950 p-3", children: [o.jsxs("div", { className: "flex items-center justify-between text-amber-400", children: [o.jsx("span", { className: "text-[10px] font-medium", children: "\uC9C4\uD589 \uC608\uC815" }), o.jsx(Ln, { className: "h-3.5 w-3.5" })] }), o.jsxs("div", { className: "mt-1 text-xl font-bold text-amber-400", children: [b.pendingTasks, " ", o.jsx("span", { className: "text-[10px] font-normal text-slate-500", children: "\uAC1C" })] })] })] }), o.jsxs("div", { className: "space-y-3 rounded-xl border border-slate-800 bg-slate-950 p-3", children: [o.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2 border-b border-slate-800/80 pb-2", children: [o.jsxs("div", { className: "flex rounded-lg border border-slate-800 bg-slate-900 p-0.5", children: [o.jsxs("button", { type: "button", onClick: () => m("dashboard"), className: `inline-flex items-center gap-1 rounded-md px-2 py-1 text-[11px] font-medium transition ${p === "dashboard" ? "bg-indigo-600 text-white shadow-md" : "text-slate-400 hover:text-slate-200"}`, children: [o.jsx(Ra, { className: "h-3 w-3" }), o.jsx("span", { children: "\uCE74\uD14C\uACE0\uB9AC" })] }), o.jsxs("button", { type: "button", onClick: () => m("checklist"), className: `inline-flex items-center gap-1 rounded-md px-2 py-1 text-[11px] font-medium transition ${p === "checklist" ? "bg-indigo-600 text-white shadow-md" : "text-slate-400 hover:text-slate-200"}`, children: [o.jsx(jr, { className: "h-3 w-3" }), o.jsx("span", { children: "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8" })] })] }), o.jsxs("div", { className: "flex min-w-0 flex-1 flex-wrap items-center justify-end gap-1.5", children: [o.jsxs("div", { className: "relative min-w-[120px] flex-1", children: [o.jsx(Ta, { className: "absolute left-2 top-1/2 h-3 w-3 -translate-y-1/2 text-slate-500" }), o.jsx("input", { type: "text", value: n, onChange: (S) => r(S.target.value), placeholder: "\uAC80\uC0C9...", className: "w-full rounded-md border border-slate-800 bg-slate-900 py-1 pl-7 pr-2 text-[11px] text-slate-200 focus:border-indigo-500 focus:outline-none" })] }), o.jsxs("select", { value: i, onChange: (S) => s(S.target.value), className: "rounded-md border border-slate-800 bg-slate-900 px-2 py-1 text-[11px] text-slate-300 focus:border-indigo-500 focus:outline-none", children: [o.jsx("option", { value: "all", children: "\uC804\uCCB4" }), o.jsx("option", { value: "completed", children: "\uC644\uB8CC\uB9CC" }), o.jsx("option", { value: "pending", children: "\uBBF8\uC644\uB8CC\uB9CC" })] })] })] }), p === "dashboard" && o.jsx("div", { className: "max-h-[min(42vh,360px)] space-y-2 overflow-y-auto pr-0.5", children: b.categories.length === 0 ? o.jsxs("div", { className: "py-8 text-center text-slate-500", children: [o.jsx(rr, { className: "mx-auto mb-2 h-8 w-8 opacity-40" }), o.jsx("p", { children: "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8 \uD56D\uBAA9\uC744 \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4." }), o.jsx("code", { className: "mt-1 inline-block rounded bg-slate-900 px-1.5 py-0.5 text-[10px] text-indigo-400", children: "- [ ] \uD560 \uC77C" })] }) : b.categories.map((S, L) => {
    const K = S.tasks.length, $ = S.tasks.filter((P) => P.completed).length, J = K > 0 ? Math.round($ / K * 100) : 0, Z = !!l[S.name], v = S.tasks.filter(R);
    return n && v.length === 0 ? null : o.jsxs("div", { className: "overflow-hidden rounded-lg border border-slate-800/80 bg-slate-900/70", children: [o.jsxs("button", { type: "button", onClick: () => N(S.name), className: "flex w-full cursor-pointer items-center justify-between bg-slate-900/40 p-2.5 text-left hover:bg-slate-800/40", children: [o.jsxs("div", { className: "flex min-w-0 items-center gap-2", children: [o.jsx("span", { className: "shrink-0 text-slate-500", children: Z ? o.jsx(La, { className: "h-3.5 w-3.5" }) : o.jsx(Oo, { className: "h-3.5 w-3.5" }) }), o.jsx("span", { className: "truncate text-[12px] font-semibold text-slate-200", children: S.name })] }), o.jsxs("div", { className: "flex shrink-0 items-center gap-2", children: [o.jsxs("span", { className: "text-[10px] font-medium text-slate-400", children: [o.jsx("strong", { className: "text-slate-200", children: $ }), " / ", K] }), o.jsxs("span", { className: `rounded-full px-1.5 py-0.5 text-[10px] font-bold ${J === 100 ? "border border-emerald-500/20 bg-emerald-500/10 text-emerald-400" : "border border-indigo-500/20 bg-indigo-500/10 text-indigo-400"}`, children: [J, "%"] })] })] }), Z && o.jsx("div", { className: "space-y-1 border-t border-slate-800/60 bg-slate-950/40 p-2", children: v.length === 0 ? o.jsx("p", { className: "py-1 pl-5 text-[11px] text-slate-500", children: "\uC870\uAC74\uC5D0 \uC77C\uCE58\uD558\uB294 \uD0DC\uC2A4\uD06C\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." }) : v.map((P) => o.jsxs("button", { type: "button", onClick: () => T(P.lineIndex), style: { paddingLeft: `${P.indent * 12 + 8}px` }, className: "flex w-full items-start gap-2 rounded-md px-1.5 py-1 text-left text-[11px] hover:bg-slate-800/50", children: [o.jsx("span", { className: "mt-0.5 shrink-0 text-slate-400", children: P.completed ? o.jsx(Tn, { className: "h-3.5 w-3.5 text-emerald-400" }) : o.jsx(Ln, { className: "h-3.5 w-3.5 text-slate-600" }) }), o.jsx("span", { className: `leading-relaxed ${P.completed ? "text-slate-500 line-through" : "text-slate-300"}`, children: P.text })] }, P.id)) })] }, `${S.name}-${L}`);
    ...
    return K.length === 0 ? null : o.jsxs("div", { className: "space-y-1", children: [o.jsxs("div", { className: "sticky top-0 border-b border-slate-800/80 bg-slate-950 py-1 text-[10px] font-bold uppercase tracking-wider text-indigo-400", children: [S.name, " (", K.length, ")"] }), K.map(($) => o.jsxs("button", { type: "button", onClick: () => T($.lineIndex), style: { paddingLeft: `${$.indent * 10 + 6}px` }, className: "flex w-full items-start gap-2 rounded-md border border-slate-800/40 bg-slate-900/40 p-1.5 text-left text-[11px] hover:bg-slate-800/60", children: [o.jsx("span", { className: "mt-0.5 shrink-0", children: $.completed ? o.jsx(Tn, { className: "h-3.5 w-3.5 text-emerald-400" }) : o.jsx(Ln, { className: "h-3.5 w-3.5 text-slate-600" }) }), o.jsx("span", { className: `leading-relaxed ${$.completed ? "text-slate-500 line-through" : "text-slate-200"}`, children: $.text })] }, $.id))] }, `${S.name}-list-${L}`);
  }) })] })] });
}
...
function sc({ editorRef: e, onChange: t, open: n, onOpenChange: r }) {
  const [i, s] = a.useState(() => nc()), [l, u] = a.useState(""), [p, m] = a.useState({ from: 0, to: 0 }), b = a.useRef({ active: false, startX: 0, startY: 0, startLeftVw: 0, startTopVh: 0 }), T = a.useCallback(() => {
    const { text: L, from: K, to: $ } = dr(e);
    return u(L), m({ from: K, to: $ }), L;
  }, [e]);
  a.useEffect(() => {
    if (n) {
      if (Ir()) {
    ...
    if (!n) return;
    const L = window.matchMedia(Wo), K = ($) => {
      $.matches && (r == null ? void 0 : r(false));
    };
  ...
  const N = a.useCallback((L) => {
    ...
    L.preventDefault();
    const K = L.clientX, $ = L.clientY;
    b.current = { active: true, startX: K, startY: $, startLeftVw: i.leftVw, startTopVh: i.topVh };
    const J = (v) => {
      if (!b.current.active) return;
      Math.hypot(v.clientX - K, v.clientY - $) <= oc;
      ...
      b.current.active && (b.current.active = false, document.removeEventListener("pointermove", J), document.removeEventListener("pointerup", Z), s((v) => (rc(v), v)));
    };
    document.addEventListener("pointermove", J), document.addEventListener("pointerup", Z);
  }, [i.leftVw, i.topVh]), R = a.useCallback((L) => {
    u(L);
    const { view: K } = dr(e), { from: $, to: J } = p;
    ii(K, $, J, L, t) && m({ from: $, to: $ + L.length });
  }, [e, p, t]), S = () => {
    r == null ? void 0 : r(false);
  };
...
function dc({ onOpen: e }) {
  return o.jsx("button", { type: "button", className: "md-editor-toolbar-item", title: "\uCD5C\uB300 heading \uBCC0\uACBD", "aria-label": "\uCD5C\uB300 heading \uBCC0\uACBD", onClick: () => e(), children: o.jsx($a, { className: "md-editor-icon", size: 16 }) });
}
...
function xc({ isOpen: e, markdown: t, selectedMarkdown: n = "", onClose: r, onApply: i }) {
  ...
  const $ = a.useMemo(() => ai(K, p, { maxLevel: hr, renumberOutline: b, outlineStyle: N, outlineStart: S }), [K, p, b, N, S]), J = (v) => {
...
function bc({ checked: e = false, onChange: t, theme: n = "light" }) {
  return o.jsx(fn, { checked: e, onChange: t, theme: n, icon: Fa, title: e ? "\uBAA9\uCC28 \uC81C\uBAA9 \uC904\uBC14\uAFC8 \uCF1C\uC9D0" : "\uBAA9\uCC28 \uC81C\uBAA9 \uB9D0\uC904\uC784(...)", ariaLabel: "\uBAA9\uCC28 \uC81C\uBAA9 \uC904\uBC14\uAFC8" });
}
...
function Sc({ isOpen: e, file: t, onClose: n, onConfirm: r }) {
  ...
  }, [e, t]), o.jsx($t, { isOpen: e && !!t, onClose: n, contentClassName: "max-w-2xl w-[min(96vw,42rem)] max-h-[90vh] h-[min(90vh,720px)]", resizeHeight: true, children: i ? o.jsx(kl, { imageSrc: i, ...(t == null ? void 0 : t.name) ? { fileName: t.name } : {}, onCancel: n, onConfirm: r }) : null });
}
...
const es = Co.define({ create() {
  ...
  t.docChanged && n.length && (n = n.map(({ from: i, to: s }) => ({ from: t.changes.mapPos(i, 1), to: t.changes.mapPos(s, -1) })).filter(({ from: i, to: s }) => i < s));
  let r = n !== e;
  for (const i of t.effects) if (i.is(It)) Zo(n, i.value.from, i.value.to) || (n = [...n, i.value], r = true);
  else if (i.is(it)) {
...
function Hr(e) {
  ...
  for (const r of Hc(e.state)) Zo(t, r.from, r.to) || _c(e.state, r.from, r.to) || n.push(it.of(r));
...
function Yc({ enabled: e, historyKey: t, meta: n, grid: r, applySnapshot: i }) {
  ...
  }, []), K = a.useCallback(() => Br({ meta: n, grid: r }), [r, n]), $ = a.useCallback(() => {
    L();
    const z = b.current;
    if (z == null) return;
    b.current = null;
  ...
  const J = a.useCallback(() => {
    !e || !p.current || u.current || (b.current = K(), $());
  }, [K, e, $]), Z = a.useCallback(() => {
...
function Rt(e, t, n, r, i, s, l) {
  ...
  for (let L = 0; L < b.length; L += 1) {
    if (N && Jr("row", L, N)) continue;
    const K = b[L], $ = Math.abs(r - K);
    $ <= Fn && n >= u.left - m && n <= u.right + m && (!R || $ < R.dist) && (R = { index: L, dist: $, y: K });
  }
  let S = null;
  for (let L = 0; L < T.length; L += 1) {
    if (N && Jr("col", L, N)) continue;
    const K = T[L], $ = Math.abs(n - K);
    $ <= Fn && r >= u.top - m && r <= u.bottom + m && (!S || $ < S.dist) && (S = { index: L, dist: $, x: K });
  }
...
function vu({ isOpen: e, initialMeta: t, initialGrid: n, onClose: r, onSave: i }) {
  ...
  const [s, l] = a.useState(nn()), [u, p] = a.useState(n), [m, b] = a.useState(null), [T, N] = a.useState(false), [R, S] = a.useState("thead"), [L, K] = a.useState([]), [$, J] = a.useState(false), [Z, v] = a.useState(null), [P, Q] = a.useState(null), [z, H] = a.useState(false), [E, V] = a.useState(0), [Y, ne] = a.useState(null), [se, ee] = a.useState(null), ye = a.useRef(null), [G, re] = a.useState(null), oe = G !== null, q = $o(), [ae, Ue] = a.useState(Wr), [Le, Xe] = a.useState(Wr), [je, ve] = a.useState(false), [Ne, _e] = a.useState(false), [O, F] = a.useState(() => typeof window < "u" ? window.innerWidth : 1280), [U, W] = a.useState(() => typeof window < "u" ? window.matchMedia("(orientation: landscape)").matches : true), me = a.useRef(null), pe = a.useRef(null), he = a.useRef(null), He = a.useRef(null), Fe = a.useRef(false), Me = a.useRef(null), fe = a.useRef(null), Oe = a.useRef(false), Pe = a.useRef(false), Ye = a.useRef({ x: 0, y: 0 });
  He.current = P, Fe.current = T, fe.current = m, Oe.current = je, Pe.current = oe, ye.current = se;
  ...
  }, []), { undo: kt, redo: Ae, canUndo: Je, canRedo: Ct, recordNow: _t } = Yc({ enabled: e, historyKey: E, meta: s, grid: u, applySnapshot: Qe }), ct = a.useRef(false);
  a.useEffect(() => {
    ...
    const d = window.matchMedia("(orientation: landscape)"), c = () => {
      F(window.innerWidth), W(d.matches);
    };
  ...
  }, [Le, U, ae, O]), ft = a.useMemo(() => le ? s.cells[$e(le.r, le.c)] ?? {} : {}, [s.cells, le]), Re = a.useCallback((d) => {
    Ce.length && l((c) => {
      const g = { ...c.cells };
  ...
  return o.jsxs(o.Fragment, { children: [o.jsxs($t, { isOpen: e, onClose: () => {
    ...
    return o.jsx("tr", { style: g ? { height: g } : void 0, children: Array.from({ length: de }, (k, C) => {
      ...
      const A = ji(s.merges, c, C), I = ce(c, C), be = kn(s.colWidths, C), Se = o.jsx("td", { "data-edit-r": c, "data-edit-c": C, colSpan: A == null ? void 0 : A.colspan, rowSpan: A == null ? void 0 : A.rowspan, className: `min-h-11 cursor-pointer border-2 border-gray-300 p-0 transition-[box-shadow,outline-color] dark:border-odp-borderStrong ${be ? "" : "min-w-28"} ${I ? "relative z-[1] outline outline-2 outline-offset-[-2px] outline-blue-500 ring-0" : "hover:relative hover:z-[1] hover:outline hover:outline-2 hover:outline-offset-[-2px] hover:outline-blue-400/70"}`, onContextMenu: () => {
        ...
        Fe.current || Oe.current && !fe.current || nt(c, C);
  ...
  }) })] }), se ? o.jsx(bu, { kind: se.kind, indices: se.indices, table: he.current, wrap: pe.current, colCount: de }) : null, q && G ? o.jsxs(Fo, { open: oe, onOpenChange: (d) => {
    d || (re(null), ze());
    ...
    const { kind: d, index: c } = P;
    d === "row" ? Ze(c) : Bt(c);
  }, style: { left: P.x, top: P.y } }, `btn-${P.kind}-${P.index}`)] }) : null] }) })] })] })] }), o.jsx(Sl, { isOpen: $, template: Z, onClose: () => {
    J(false), v(null);
  }, onSave: (d) => {
    const g = [...Ri().templates.filter((k) => k.id !== (Z == null ? void 0 : Z.id) && k.id !== d.id), d];
    Mi({ templates: g }).then((k) => {
      K(k.templates), J(false), v(null);
    });
...
function Cu({ containerRef: e, getMarkdown: t, setMarkdown: n, onEditTable: r, onEditFailed: i }) {
  const s = $o(), [l, u] = a.useState(false), [p, m] = a.useState(null), [b, T] = a.useState(null), N = a.useRef(null);
  N.current = p;
  ...
  const S = () => {
    ...
    u(false), m(null);
  }, Z = o.jsxs(o.Fragment, { children: [o.jsxs("button", { type: "button", className: s ? Ai : Zr, onClick: () => {
    S(), J();
  ...
  return o.jsxs(o.Fragment, { children: [s ? o.jsx(Fo, { open: l, onOpenChange: (v) => {
    u(v), v || m(null);
  }, title: "\uBBF8\uB9AC\uBCF4\uAE30 \uD45C", subtitle: "\uB9C8\uD06C\uB2E4\uC6B4 \uD14C\uC774\uBE14", children: Z }) : o.jsxs(ml, { open: l, onOpenChange: (v) => {
    u(v), v || m(null);
  }, modal: true, children: [o.jsx(pl, { asChild: true, children: o.jsx("button", { type: "button", "aria-hidden": true, tabIndex: -1, className: "pointer-events-none fixed h-px w-px opacity-0", style: { left: $.x, top: $.y } }) }), o.jsx(hl, { children: o.jsxs(gl, { className: ku, side: "bottom", align: "start", sideOffset: 2, collisionPadding: 12, onCloseAutoFocus: (v) => v.preventDefault(), children: [o.jsxs(Pr, { className: Zr, onSelect: S, children: [o.jsx(on, { className: Gt, "aria-hidden": true }), "\uD45C \uD3B8\uC9D1\uAE30"] }), o.jsxs(Pr, { className: eo, onSelect: L, children: [o.jsx(gt, { className: Gt, "aria-hidden": true }), "\uD45C \uC0AD\uC81C"] })] }) })] }), o.jsx(rn, { isOpen: b !== null, variant: "danger", title: "\uD45C \uC0AD\uC81C", message: "\uC774 \uD45C\uB97C \uB9C8\uD06C\uB2E4\uC6B4\uC5D0\uC11C \uC0AD\uC81C\uD560\uAE4C\uC694?", confirmLabel: "\uC0AD\uC81C", cancelLabel: "\uCDE8\uC18C", onConfirm: K, onCancel: () => T(null) })] });
}
function Eu(e) {
...
const At = Ns.define({ combine: (e) => e[e.length - 1] ?? null }), as = new Zn();
function Lu(e) {
...
function Ou({ cover: e, getPresignedUrl: t }) {
  const n = Fi(e.pageSizeId) ? e.pageSizeId : _i, r = a.useMemo(() => ({ ...Hi(), pageSizeId: n }), [n]), i = a.useMemo(() => Oi(n), [n]), s = a.useMemo(() => Bi(r), [r]);
...
function ed(e, t = {}) {
  ...
  return ms(e).forEach((s, l) => {
    ...
    const b = !n.has(p), T = Ju(b);
    s.insertBefore(T, s.firstChild);
    const N = (S) => {
      s.classList.toggle(Qt, S), Kn(u, S), Zu(T, !S);
    };
...
function ld(e) {
  ...
  function m(R) {
    n && r === R || (n == null ? void 0 : n.disconnect(), r = R, n = new MutationObserver((S) => {
      S.some((K) => {
        const $ = [...K.addedNodes, ...K.removedNodes];
        return $.length === 0 ? K.type === "characterData" || K.type === "attributes" : $.some((J) => {
          var _a2, _b;
          return J instanceof Element ? !(J.hasAttribute("data-preview-caret-mirror") || J.hasAttribute("data-preview-sel-mirror") || ((_a2 = J.classList) == null ? void 0 : _a2.contains("s3haim-preview-caret-mirror")) || ((_b = J.classList) == null ? void 0 : _b.contains("s3haim-preview-sel-mirror"))) : true;
        });
      }) && p();
...
function hd(e) {
  ...
  function Q(O) {
    ...
    const F = e.getView(), U = e.getPreviewRoot();
    if (F && (O === F.scrollDOM || F.dom.contains(O))) return "editor";
    if (U) {
  ...
  function z(O, F) {
    if (O !== "preview" || !(F instanceof HTMLElement)) return;
    const U = e.getPreviewRoot();
    if (!U) return;
    const W = ht(U);
    W && (F === W || F.contains(W)) && (T = F);
  }
  function H(O, F) {
    if (!(F instanceof HTMLElement)) return false;
    if (O === "editor") {
      const me = e.getView();
      return !!(me && (F === me.scrollDOM || F.contains(me.scrollDOM)));
    }
    const U = e.getPreviewRoot(), W = U ? ht(U) : null;
    return !!(W && (F === W || F.contains(W)));
  }
  function E() {
    if (S) return false;
    const O = e.getPreviewRoot(), F = e.getView();
    if (!O || !F || R === "preview" || R !== "none" && R !== "follow") return false;
    R = "follow";
    const U = zi(F, O);
    return Z("follow"), U;
  }
  ...
  function Y() {
    ...
    const U = v(F), W = P(O);
    if (!W) return;
    const me = U.scrollTop, pe = F.lineBlockAtHeight(me), he = F.state.doc.lineAt(pe.from).number - 1, He = fd(O, he);
    if (!He) return;
    const Fe = pe.height > 0 ? Math.max(0, Math.min(1, (me - pe.top) / pe.height)) : 0, fe = Jn(He, W) + He.offsetHeight * Fe - co;
    fo(W, fe);
  }
  function ne() {
    const O = e.getPreviewRoot(), F = e.getView();
    ...
    if (!pe) return;
    const { el: he, line0: He } = pe, Fe = Math.min(Math.max(1, He + 1), F.state.doc.lines), Me = F.state.doc.line(Fe), fe = F.lineBlockAt(Me.from), Oe = Jn(he, W), Pe = he.offsetHeight > 0 ? Math.max(0, Math.min(1, (me - Oe) / he.offsetHeight)) : 0;
  ...
  function re(O) {
    const F = Q(O.target);
    !F || !H(F, O.target) || (z(F, O.target), F === "editor" ? ye() : G());
  }
  function oe(O) {
    const F = Q(O.target);
    F && requestAnimationFrame(() => {
      const U = e.getView(), W = e.getPreviewRoot();
      F === "editor" && U ? ye() : F === "preview" && W && (z("preview", ht(W)), G());
    });
  }
  function q(O) {
    const F = O.target;
    if (F instanceof HTMLImageElement && (N == null ? void 0 : N.contains(F))) {
      V(), L();
  ...
  function ae(O) {
    const F = O.scrollDOM;
    return F instanceof HTMLElement ? (p === F || (p && p.removeEventListener("scroll", re), p = F, F.addEventListener("scroll", re, { passive: true })), true) : false;
  }
  function Ue(O) {
    const F = ht(O);
    return F ? (m === F || (m && m.removeEventListener("scroll", re), m = F, T = F, F.addEventListener("scroll", re, { passive: true })), true) : false;
  }
  function Le(O, F) {
    const U = pd(O, F);
...
function Ed({ currentFile: e, value: t, onChange: n, editorRef: r, enabled: i = true }) {
  ...
  const $ = a.useCallback(async (H, E, V) => {
    ...
    var _a2, _b;
    const V = N.current ?? "", Y = ((_a2 = E == null ? void 0 : E.stack) == null ? void 0 : _a2.length) ? E.stack : [V], ne = ((_b = E == null ? void 0 : E.stack) == null ? void 0 : _b.length) ? E.index ?? E.stack.length - 1 : 0, se = Jt(Y, ne, V);
  ...
  return a.useEffect(() => {
    ...
    if (Z(), T.current && (clearTimeout(T.current), T.current = null), H && H !== E) {
      const se = v();
      $(H, se.stack, se.index);
    }
  ...
  }, [i, s, r, Z, v, $, Q]), a.useEffect(() => {
    if (!i || !s || S.current !== s || R.current || m.current || t === K.current) return;
    const H = t ?? "";
    K.current = H;
    const E = Jt(l.current, u.current, H);
    l.current = E.stack, u.current = E.index, P(E.stack.slice(0, E.index + 1)), J(s, E.stack, E.index);
  }, [i, s, t, P, J]), a.useEffect(() => {
    if (i) return () => {
      Z(), T.current && (clearTimeout(T.current), T.current = null);
      const H = p.current;
      if (!H) return;
      const E = Jt(l.current, u.current, N.current ?? "");
      po({ key: H, stack: E.stack, index: E.index }).catch(() => {
      });
    };
  }, [i, Z]), { onChange: a.useCallback((H) => {
    m.current || (K.current = H, R.current = true, n == null ? void 0 : n(H), !(!i || !p.current) && (Z(), b.current = setTimeout(() => {
      if (b.current = null, m.current) return;
      const E = p.current;
      if (!E) return;
      const V = vd(l.current, u.current, H);
      V.changed && (l.current = V.stack, u.current = V.index, J(E, V.stack, V.index));
    }, gd)));
  }, [i, n, Z, J]) };
}
...
Is({ editorConfig: { languageUserDefined: { "ko-KR": _s }, renderDelay: Ho() ? 500 : 0 }, codeMirrorExtensions(e, { keyBindings: t }) {
  ...
  }), i = [{ key: "ArrowLeft", run: (s) => Nr(s, -1) }, { key: "ArrowRight", run: (s) => Nr(s, 1) }, { key: "Ctrl-ArrowLeft", mac: "Alt-ArrowLeft", run: (s) => We(s, -1, Xs), shift: (s) => We(s, -1, Us) }, { key: "Ctrl-ArrowRight", mac: "Alt-ArrowRight", run: (s) => We(s, 1, Gs), shift: (s) => We(s, 1, Ys) }, { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: (s) => We(s, -1, Js), shift: (s) => We(s, -1, Qs) }, { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: (s) => We(s, 1, ei), shift: (s) => We(s, 1, Zs) }, ...ef, { key: "Alt--", preventDefault: true, run: _d }, { key: "Ctrl-Tab", run: Hd }, { key: "Ctrl-d", mac: "Cmd-d", preventDefault: true, run: (s) => (Bs(s), true) }, { key: "Ctrl-b", mac: "Cmd-b", preventDefault: true, run: Rd }, { key: "Ctrl-i", mac: "Cmd-i", preventDefault: true, run: Td }, { key: "Ctrl-u", mac: "Cmd-u", preventDefault: true, run: Pd, shift: Od }, { key: "Ctrl-o", mac: "Cmd-o", preventDefault: true, run: Bd }, { key: "Shift-Ctrl-s", mac: "Shift-Cmd-s", preventDefault: true, run: Ld }, { key: "Ctrl-ArrowUp", mac: "Cmd-ArrowUp", preventDefault: true, run: Ad }, { key: "Ctrl-ArrowDown", mac: "Cmd-ArrowDown", preventDefault: true, run: Dd }, ...[1, 2, 3, 4, 5, 6, 7, 8, 9].map((s) => ({ key: `Ctrl-${s}`, mac: `Cmd-${s}`, preventDefault: true, run: (l) => xo(l, s) })), { key: "Ctrl-0", mac: "Cmd-0", preventDefault: true, run: (s) => xo(s, 10) }, { any: (s, l) => (l.ctrlKey || l.metaKey) && l.altKey && l.code === "KeyC" ? vs(s) : ks(s, l) }, { key: "Mod-Alt-ArrowUp", run: Hs }, { key: "Mod-Alt-ArrowDown", run: Os }, ...r];
  ...
  }) }, { type: "multiCursorPreview", extension: Vs({ minSelectionLength: 2, maxMatches: 200 }) }, { type: "keymap", extension: Ro.of(i) }, { type: "base64ImageFold", extension: $c(Gn()) }, { type: "mermaidBase64Fold", extension: Kc(Gn()) }, { type: "autocompleteGate", extension: Lt.updateListener.of((s) => {
    id(s), !Do() && Ws(s.state) === "active" && qs(s.view);
  }) }), n;
}, markdownItPlugins(e) {
  return Ea(e);
} });
function vf({ value: e, onChange: t, onSave: n, theme: r = "light", currentFile: i = null, previewOnly: s = false, isMobileLayout: l = false, onUploadImage: u, isUploadingEditorImage: p = false, uploadImagePercent: m = 0, onCancelUploadImage: b, onResolveWikiImageUrl: T, snippetConfig: N = { snippets: [] }, llmProviderProfiles: R = [], getImgbbApiKey: S, onOpenViewPath: L, onRequestConvertAllImagesToWiki: K, onRegisterConvertAllImagesToWiki: $, isActiveFile: J = true }) {
  var _a2, _b;
  const Z = Vi(), v = vo(), { showAlert: P } = Wi(), Q = a.useId(), z = a.useMemo(() => Wl(Q), [Q]), H = a.useMemo(() => ql(z), [z]), E = a.useRef(null), V = a.useRef(null), Y = a.useRef(null), ne = a.useRef(null), se = a.useRef(N), ee = a.useRef(e), ye = a.useRef(i), G = a.useRef(r), re = a.useRef("");
  a.useEffect(() => {
...
${h}` }));
  ...
  }), [F, U] = a.useState(false), [W, me] = a.useState(null), [pe, he] = a.useState(0), [He, Fe] = a.useState(false), [Me, fe] = a.useState(false), Oe = a.useRef({ from: 0, to: 0 }), Pe = a.useRef(q);
  a.useEffect(() => {
    Pe.current = q;
  }, [q]);
  const [Ye, Ge] = a.useState(null), [ge, Qe] = a.useState(null), [kt, Ae] = a.useState(false), [Je, Ct] = a.useState(null), [_t, ct] = a.useState(false), [ke, xe] = a.useState(null), [de, Ce] = a.useState(null), le = a.useRef(null), [ut, Et] = Cl(), [Ke, dt] = jc(), [Ht, Ot] = Mc(), [mn, ft] = Rc(), Re = a.useMemo(() => Ho(), []), ue = Re ? false : mn, Ee = a.useRef(null);
  a.useEffect(() => {
    if (s) return;
    const f = () => {
      var _a3, _b2, _c2;
...
`;
  ...
  const Be = Z == null ? void 0 : Z.registerEditorBridge;
  a.useEffect(() => {
    if (s || !J || !Be) return;
    const f = () => {
      const h = E.current;
  ...
  const { width: Ze, isResizing: Bt, handleProps: Kt } = Qi({ storageKey: qd, defaultWidth: Ud, minWidth: 160, collapseBelowWidth: 80, maxWidth: 640, edge: "right", onCollapseBelowMin: () => {
    var _a3, _b2, _c2;
  ...
  a.useEffect(() => {
    ...
    const f = () => {
      var _a3, _b2, _c2;
      const y = (_c2 = (_b2 = ((_a3 = E.current) == null ? void 0 : _a3.value) ?? E.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2);
      return y ? (Fc(y, Ke), zc(y, Ke), true) : false;
    };
    if (f()) return;
  ...
  }, [ke, H]), jl(V, e, T, (i == null ? void 0 : i.id) ?? null), Zi(V, { layoutKey: `${r}|${e}` }), a.useEffect(() => {
    const f = V.current;
    if (!f || !e) return;
    let h = 0;
    const x = () => {
...
`), te = ((_c2 = (_b2 = ((_a4 = E.current) == null ? void 0 : _a4.value) ?? E.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2)) ?? D;
        ...
        var _a4;
        if (!w) return;
        if (!w.composing && Zd(x) && vs(w) || !w.composing && ks(w, x)) return x.preventDefault(), x.stopPropagation(), true;
        const y = yo(x);
        if (!y) return;
        if (y === "mod+shift+enter") return x.preventDefault(), x.stopPropagation(), Jd(w), false;
        if (y === "mod+s") return;
        const j = ((_a4 = se.current) == null ? void 0 : _a4.snippets) || [], D = Zt(y), B = j.find((X) => Zt(X.prefix) === D && (X.body || "").trim());
    ...
    const f = (h) => {
      ...
      const B = ((_e2 = se.current) == null ? void 0 : _e2.snippets) || [], X = Zt(x), ce = B.find((te) => Zt(te.prefix) === X && (te.body || "").trim());
  ...
  a.useEffect(() => {
    if (typeof $ == "function") return $(async () => {
...
`), Ge(null);
  ...
  const qt = a.useMemo(() => [o.jsx(cc, { value: e, theme: r, currentFile: i, language: "ko-KR" }, "export-pdf"), o.jsx(uc, { editorRef: E }, "insert-pgbr"), o.jsx(dc, { onOpen: rt }, "heading-remap"), o.jsx(Jl, { active: !!(Z == null ? void 0 : Z.open), onToggle: () => {
    var _a3;
    (_a3 = Z == null ? void 0 : Z.toggleAssist) == null ? void 0 : _a3.call(Z);
  } }, "llm-assist"), o.jsx(lc, { onOpen: () => {
    U(true);
  } }, "checklist-progress"), o.jsx(bc, { checked: ut, onChange: Et, theme: r }, "toc-title-wrap"), o.jsx(wc, { checked: Ke, onChange: dt, theme: r }, "base64-image-fold"), o.jsx(yc, { checked: Ht, onChange: Ot, theme: r }, "editor-autocomplete"), Re ? null : o.jsx(vc, { checked: ue, onChange: ft, theme: r }, "mirror-edit"), o.jsx(kc, { disabled: typeof u != "function", onRequestLink: () => Fe(true), onRequestUpload: (f) => {
    tt(f);
  }, onRequestClip: (f) => Ge(f) }, "image-toolbar")], [e, r, i, ut, Et, Ke, dt, Ht, Ot, Re, ue, ft, u, tt, rt, Z == null ? void 0 : Z.open, Z == null ? void 0 : Z.toggleAssist]), St = a.useMemo(() => ["bold", "underline", "italic", "-", "strikeThrough", "sub", "sup", "quote", "unorderedList", "orderedList", "task", "-", "codeRow", "code", "link", 9, "table", "mermaid", "katex", 1, 2, 3, 4, "-", "revoke", "next", 0, "=", 6, 7, ...Re ? [] : [8], "pageFullscreen", "fullscreen", "previewOnly", "preview", "htmlPreview", ...ke ? [5] : [], "catalog"], [ke, Re]), bn = a.useMemo(() => {
...
`);
    ...
    ve(false), _e(null);
  } }), o.jsx(sc, { editorRef: E, onChange: q, open: F, onOpenChange: U })] });
}
export {
  vf as default
};
