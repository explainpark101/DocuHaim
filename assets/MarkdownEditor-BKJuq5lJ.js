...
import { B as Es, D as Jn, S as Co, l as Lt, F as Eo, G as cr, W as Ss, H as So, J as It, M as it, O as No, j as er, V as jo, P as Mo, m as Ie, Q as Ns, R as js, T as Ms, U as Rs, X as Ts, Y as wn, Z as ur, $ as Ls, a0 as Ps, c as As, a1 as Ds, a2 as Ro, v as Is, a3 as $s, a4 as Fs, K as _s, a5 as Hs, a6 as Os, a7 as Bs, a8 as Ks, a9 as zs, aa as Vs, ab as Ws, ac as qs, ad as Us, ae as Xs, af as Ys, ag as Gs, ah as Qs, ai as Zs, aj as Js, ak as ei, al as ti, am as ni, an as ri, ao as oi } from "./vendor-md-editor-BebLMpT_.js";
import { o as si, ew as To, ex as ln, ey as $e, ez as Lo, aa as ht, eA as dr, eB as ii, ah as Po, ai as Ao, eC as fr, eD as ai, U as $t, ad as li, eE as mr, F as pr, eF as ci, eG as ui, eH as di, eI as hr, eJ as Do, eK as fi, eL as mi, eM as pi, eN as hi, eO as gi, eP as Io, eQ as xi, a4 as nn, dl as $o, aA as bi, au as wi, eR as yi, q as vi, eS as gr, eT as ki, eU as Ci, x as Ei, O as yn, eV as Si, N as vn, eW as Ni, y as kn, w as ji, dt as Fo, dY as zn, aC as Mi, ay as rn, eX as xr, aB as Ri, eY as Ti, eZ as Li, e_ as Pi, dZ as Ai, e$ as Di, f0 as Vn, a5 as Ii, dQ as tr, a0 as nr, f1 as $i, f2 as Fi, f3 as _i, e0 as Hi, d6 as Oi, er as Bi, dV as _o, f4 as Tt, f5 as Ki, f6 as zi, f7 as Vi, d_ as Wi, ee as qi, f8 as Ho, f9 as Ui, fa as Xi, fb as br, fc as Yi, fd as Gi, E as Qi, eb as Zi, eq as Ut, e7 as Ji, fe as ea, ff as jt, fg as ta, fh as na, fi as ra, cm as wr, al as Cn, ej as En, am as oa, ek as yr, el as sa, an as ia, ao as aa, a2 as la, ap as ca, aj as ua, ak as da, T as fa, M as ma, et as pa, fj as ha, fk as ga, fl as Sn, fm as Nn, fn as vr, fo as kr, fp as jn, fq as Cr, fr as xa, fs as Er, ft as Sr, eu as ba, ar as wa, ev as ya, fu as va, fv as ka, fw as Ca, fx as Ea, fy as Nr, fz as We, fA as Sa, fB as Mn, fC as Rn, cf as Na } from "./index-RydzSnnb.js";
import { S as ja, aC as Ma, aD as jr, aE as Tn, ap as Ln, aF as Ra, O as Ta, aG as rr, aH as La, J as Oo, aI as Pa, R as Aa, X as cn, v as Da, aJ as Ia, aK as $a, i as un, aL as Fa, aM as _a, aN as Bo, aO as Ha, x as Oa, aP as on, as as Ba, at as Ka, aB as Mr, aQ as Pn, aR as Rr, aS as za, am as Va, j as Wa, aT as Tr, aU as qa, aV as Ua, aW as Xa, aX as Ya, G as gt, z as Ga, L as Qa } from "./vendor-lucide-DsWVGDs1.js";
import { d as Ko, r as An, s as Dn, G as Za, H as Ja, I as el, J as tl, K as nl, M as rl, N as ol, Q as sl, U as il, V as al, S as or, b as sr, e as Wn, T as qn, f as Un, g as Xn, A as Yn, l as ll, F as qe, L as ot, m as Xt, X as cl, Y as ul, Z as dl, W as fl, a0 as Lr, a1 as ml, a2 as pl, a3 as hl, a4 as gl, a5 as Pr } from "./vendor-radix-BWhlk-Y9.js";
import { M as xl } from "./MdEditorToolbarTooltips-o981ejY5.js";
import { a as bl, h as wl, P as yl, H as vl } from "./previewFootnoteScroll-De8C5JUp.js";
import { N as kl, u as Cl, W as El } from "./useTocTitleWrap-4a3XmQ7p.js";
import { H as In, T as Sl } from "./TableStyleTemplateEditor-DvYR2A_i.js";
import { a as dn } from "./vendor-motion-9P87yVtW.js";
import { c as Nl } from "./clipboardImageFiles-xh-LRD_u.js";
import { u as jl } from "./useWikiImageHydration-C94v8Uag.js";
...
function sc({ editorRef: e, onChange: t, open: n, onOpenChange: r }) {
  ...
  const N = a.useCallback((L) => {
    ...
    u(L);
    const { view: K } = dr(e), { from: $, to: Z } = p;
    ii(K, $, Z, L, t) && m({ from: $, to: $ + L.length });
  }, [e, p, t]), S = () => {
    r == null ? void 0 : r(false);
  };
...
function xc({ isOpen: e, markdown: t, selectedMarkdown: n = "", onClose: r, onApply: i }) {
  ...
  const $ = a.useMemo(() => ai(K, p, { maxLevel: hr, renumberOutline: b, outlineStyle: N, outlineStart: S }), [K, p, b, N, S]), Z = (v) => {
  ...
  return o.jsx($t, { isOpen: e, onClose: r, onConfirm: J, contentClassName: "max-w-3xl", children: o.jsx(Ko, { delayDuration: 250, skipDelayDuration: 0, children: o.jsxs("div", { className: "flex min-h-0 flex-1 flex-col p-6", children: [o.jsx("h2", { className: "text-lg font-bold text-gray-800 dark:text-odp-fgStrong", children: "\uCD5C\uB300 heading \uBCC0\uACBD" }), o.jsxs("p", { className: "mt-1 text-sm text-gray-500 dark:text-odp-muted", children: ["\uAC10\uC9C0\uB41C \uCD5C\uB300 heading\uC744 \uC120\uD0DD\uD55C \uB2E8\uACC4\uB85C \uBC14\uAFB8\uACE0, \uD558\uC704 heading\uB3C4 \uAC19\uC740 \uAC04\uACA9\uC73C\uB85C \uC774\uB3D9\uD569\uB2C8\uB2E4.", " ", "\uC22B\uC790 \uD0A4 1\u20139\uB85C \uCD5C\uB300 heading\uC744 \uBC14\uAFC0 \uC218 \uC788\uC2B5\uB2C8\uB2E4."] }), o.jsxs("div", { className: "mt-4", children: [o.jsx("div", { className: "mb-2 text-xs font-medium text-gray-500 dark:text-odp-muted", children: "\uC801\uC6A9 \uBC94\uC704" }), o.jsx(An, { className: "flex items-center gap-2", value: l, onValueChange: Z, "aria-label": "\uCD5C\uB300 heading \uC801\uC6A9 \uBC94\uC704", children: fc.map((v) => {
...
const Tc = 48, Fr = /data:image\/([a-z0-9.+-]+);base64,([a-z0-9+/=]+)/gi, Uo = Eo.define(), Xo = Eo.define(), Yo = new Jn();
function Lc(e) {
  const t = [];
  Fr.lastIndex = 0;
  let n;
...
function Yc({ enabled: e, historyKey: t, meta: n, grid: r, applySnapshot: i }) {
  ...
  return { undo: J, redo: v, canUndo: P, canRedo: Q, recordNow: Z, flushPendingRecord: $ };
}
...
function vu({ isOpen: e, initialMeta: t, initialGrid: n, onClose: r, onSave: i }) {
  ...
  return o.jsxs(o.Fragment, { children: [o.jsxs($t, { isOpen: e, onClose: () => {
    ...
    const { kind: d, index: c } = P;
    d === "row" ? Je(c) : Bt(c);
  }, style: { left: P.x, top: P.y } }, `btn-${P.kind}-${P.index}`)] }) : null] }) })] })] })] }), o.jsx(Sl, { isOpen: $, template: J, onClose: () => {
    Z(false), v(null);
  }, onSave: (d) => {
  ...
  function m(R) {
    n && r === R || (n == null ? void 0 : n.disconnect(), r = R, n = new MutationObserver((S) => {
      S.some((K) => {
        ...
        return $.length === 0 ? K.type === "characterData" || K.type === "attributes" : $.some((Z) => {
          var _a2, _b;
...
function hd(e) {
  ...
  function Y() {
    ...
    if (!He) return;
    const Fe = pe.height > 0 ? Math.max(0, Math.min(1, (me - pe.top) / pe.height)) : 0, fe = Zn(He, W) + He.offsetHeight * Fe - co;
    fo(W, fe);
  }
  function ne() {
    const O = e.getPreviewRoot(), F = e.getView();
    ...
    if (!pe) return;
    const { el: he, line0: He } = pe, Fe = Math.min(Math.max(1, He + 1), F.state.doc.lines), Me = F.state.doc.line(Fe), fe = F.lineBlockAt(Me.from), Oe = Zn(he, W), Pe = he.offsetHeight > 0 ? Math.max(0, Math.min(1, (me - Oe) / he.offsetHeight)) : 0;
...
function vf({ value: e, onChange: t, onSave: n, theme: r = "light", currentFile: i = null, previewOnly: s = false, isMobileLayout: l = false, onUploadImage: u, isUploadingEditorImage: p = false, uploadImagePercent: m = 0, onCancelUploadImage: b, onResolveWikiImageUrl: T, snippetConfig: N = { snippets: [] }, llmProviderProfiles: R = [], getImgbbApiKey: S, onOpenViewPath: L, onRequestConvertAllImagesToWiki: K, onRegisterConvertAllImagesToWiki: $, isActiveFile: Z = true }) {
  var _a2, _b;
...
`;
  ...
  }, [ke, H]), jl(V, e, T, (i == null ? void 0 : i.id) ?? null), Ji(V, { layoutKey: `${r}|${e}` }), a.useEffect(() => {
    const f = V.current;
    if (!f || !e) return;
    let h = 0;
    const x = () => {
