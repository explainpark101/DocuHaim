...
import { A as ho, B as Bt, S as er, l as Ke, D as tr, F as rn, W as go, G as nr, H as Ye, J as Se, M as rr, j as Ot, V as Vt, O as or, m as ce, P as xo, Q as bo, R as wo, T as yo, U as vo, X as kt, Y as on, Z as ko, $ as Eo, c as So, a0 as Co, a1 as sr, v as No, a2 as jo, a3 as Mo, K as Lo, a4 as To, a5 as Ro, a6 as Ao, a7 as Po, a8 as Do, a9 as Io, aa as Fo, ab as $o, ac as Ho, ad as _o, ae as Bo, af as Oo, ag as Vo, ah as Ko, ai as zo, aj as qo, ak as Wo, al as Yo, am as Uo, an as Go, ao as Xo } from "./vendor-md-editor-B-aq3e3o.js";
import { b0 as Le, c$ as sn, d0 as Qo, al as ir, am as ar, d1 as an, d2 as Zo, a7 as mt, ah as Jo, d3 as cn, D as ln, d4 as es, d5 as ts, d6 as ns, d7 as dn, d8 as cr, d9 as rs, da as os, db as ss, dc as is, dd as as, de as lr, df as cs, dg as Kt, ab as zt, dh as ls, di as ds, dj as us, dk as fs, dl as ms, dm as ps, dn as dr, dp as Ve, dq as hs, dr as gs, ds as xs, dt as bs, du as ws, dv as ur, dw as ys, dx as vs, dy as un, dz as ks, dA as Es, A as Ss, dB as Cs, dC as st, dD as Ns, dE as js, dF as Oe, dG as Ms, dH as Ls, dI as Ts, cw as fn, ap as Et, dJ as St, aq as Rs, dK as mn, dL as As, ar as Ps, as as Ds, ad as Is, at as Fs, an as $s, ao as Hs, T as _s, M as Bs, dM as Os, dN as Vs, aP as pn, dO as Ks, dP as Ct, dQ as Nt, dR as hn, dS as gn, dT as jt, dU as xn, dV as zs, dW as bn, dX as wn, aY as qs, dY as Ws, av as Ys, dZ as Us, d_ as Gs, d$ as Xs, e0 as Qs, e1 as Zs, e2 as yn, e3 as be, e4 as Js, e5 as Mt, e6 as Lt, co as ei } from "./index-BLrAQ2ns.js";
import { S as ti, ac as ni, ad as vn, ae as Tt, af as Rt, ag as ri, c as oi, ah as qt, ai as si, a9 as fr, aj as ii, a4 as ai, X as Wt, y as ci, ak as li, al as di, k as Yt, am as ui, an as fi, a0 as mi, ao as pi, D as hi, L as gi } from "./vendor-lucide-DkNZUuPp.js";
import { b as xi, M as At, N as Pt, U as bi, V as wi, W as yi, X as vi, Y as ki, Z as Ei, _ as Si, $ as Ci, a0 as Ni, a1 as ji, S as mr, g as pr, d as kn, T as En, e as Sn, f as Cn, A as Nn } from "./vendor-radix-DvzC9O2a.js";
import { M as Mi } from "./MdEditorToolbarTooltips-BsNZQp6f.js";
import { C as Li, u as Ti, b as Ri, P as Ai, T as Pi, a as Di, H as Ii } from "./previewFootnoteScroll-B1azP_Hu.js";
import { N as Fi, u as $i, W as Hi } from "./useTocTitleWrap-CPK8eo6Q.js";
import { a as pt } from "./vendor-motion-b8oTnHK_.js";
import { c as _i } from "./clipboardImageFiles-DcXJbWfD.js";
import { u as Bi } from "./useWikiImageHydration-R9Z0k_Yb.js";
import "./vendor-aws-DP_cBT5a.js";
import "./vendor-zip-Bez6qchM.js";
import "./vendor-google-genai-DGp6lEvQ.js";
import "./TableStyleTemplateEditor-BtHtIqPI.js";
import "./index-moa0c9-p.js";
import "./vendor-image-crop-2jwX4VUM.js";
import "./cropPadImage-B23YvrI_.js";
...
function Ki(e) {
  const t = `${e}-h`;
  return (n, r, i) => {
    const s = Number.isInteger(i) ? i : 0, u = typeof n == "object" && n !== null ? Number(n.index) : NaN, m = Number.isInteger(u) ? u : s;
    return `${t}-${m}`;
  };
}
const jn = ".md-editor-catalog-link", zi = "md-preview-heading-folded", Mn = "md-preview-heading-section-hidden", qi = 2;
function Wi(e, t) {
  ...
  for (let t = 0; t < 8; t += 1) {
    ...
    for (; s && !i; ) {
      if (s instanceof HTMLElement && (s.classList.contains(Mn) || s.hasAttribute("hidden"))) {
        let m = s.previousElementSibling;
        for (; m; ) {
          if (m instanceof HTMLElement && m.classList.contains(zi)) {
            const x = m.querySelector(":scope > .md-preview-heading-fold-chevron");
...
function Ui(e, t) {
  const n = (r) => {
    ...
    const m = Array.from(e.querySelectorAll(jn)).indexOf(s);
    if (m < 0) return;
    const x = t.mdHeadingId({ index: m + 1 }), k = t.getEditorRoot(), w = ((_a2 = k == null ? void 0 : k.querySelector) == null ? void 0 : _a2.call(k, `#${CSS.escape(x)}`)) ?? null;
    if (!w || k && !k.contains(w)) return;
    r.preventDefault(), r.stopPropagation(), typeof r.stopImmediatePropagation == "function" && r.stopImmediatePropagation(), Yi(w);
    const A = Le(w);
    if (!A) {
      w.scrollIntoView({ block: "start", behavior: "smooth" });
      return;
    }
    const N = w.previousElementSibling ? 0 : Number.parseFloat(getComputedStyle(w).marginBlockStart || "0") || 0, L = Wi(w, A) - qi - N;
...
function Gi({ onToggle: e, active: t = false }) {
  return o.jsx("button", { type: "button", className: ["md-editor-toolbar-item", t ? "md-editor-toolbar-active bg-violet-200! hover:bg-violet-300! dark:bg-violet-800/85! dark:hover:bg-violet-700/90!" : ""].filter(Boolean).join(" "), onClick: () => e == null ? void 0 : e(), title: t ? "AI \uB3C4\uC6B0\uBBF8 \uB2EB\uAE30" : "AI \uB3C4\uC6B0\uBBF8", "aria-label": t ? "AI \uB3C4\uC6B0\uBBF8 \uB2EB\uAE30" : "AI \uB3C4\uC6B0\uBBF8", "aria-pressed": t, children: o.jsx(ti, { className: "md-editor-icon", size: 16 }) });
}
function Xi(e) {
...
`), n = [];
  ...
  t.forEach((m, x) => {
    const k = m.match(/^(#{1,6})\s+(.*)/);
    if (k) {
      (r.tasks.length > 0 || r.name !== "\uC77C\uBC18 / \uBBF8\uBD84\uB958") && n.push(r), r = { name: k[2].trim(), tasks: [] };
      return;
    }
    const w = m.match(/^(\s*)([-*]|\d+\.)\s+\[([ xX])\]\s+(.*)/);
    if (w) {
      const A = Math.floor(w[1].length / 2), N = w[3].toLowerCase() === "x", L = w[4].trim();
      i += 1, N && (s += 1), r.tasks.push({ id: `line-${x}`, lineIndex: x, indent: A, completed: N, text: L, rawLine: m });
    }
...
function Zi({ markdown: e = "", onMarkdownChange: t }) {
  const [n, r] = l.useState(""), [i, s] = l.useState("all"), [u, m] = l.useState({}), [x, k] = l.useState("dashboard"), w = l.useMemo(() => Xi(e), [e]);
  l.useEffect(() => {
    const E = {};
...
function ea({ leftVw: e, topVh: t }) {
  try {
    localStorage.setItem(hr, JSON.stringify({ leftVw: Math.min(95, Math.max(0, e)), topVh: Math.min(95, Math.max(0, t)) }));
  } catch {
  }
}
const gr = "(max-width: 768px)", ta = 5;
function Ln() {
  return typeof window < "u" && window.matchMedia(gr).matches;
}
function na({ editorRef: e, onChange: t, open: n, onOpenChange: r }) {
  const [i, s] = l.useState(() => Ji()), [u, m] = l.useState(""), [x, k] = l.useState({ from: 0, to: 0 }), w = l.useRef({ active: false, startX: 0, startY: 0, startLeftVw: 0, startTopVh: 0 }), A = l.useCallback(() => {
    const { text: T, from: F, to: H } = sn(e);
    return m(T), k({ from: F, to: H }), T;
  }, [e]);
  l.useEffect(() => {
    if (n) {
      if (Ln()) {
  ...
  const N = l.useCallback((T) => {
    ...
    const q = (y) => {
      ...
      Math.hypot(y.clientX - F, y.clientY - H) <= ta;
      ...
      w.current.active && (w.current.active = false, document.removeEventListener("pointermove", q), document.removeEventListener("pointerup", z), s((y) => (ea(y), y)));
    };
    ...
    Qo(F, H, q, T, t) && k({ from: H, to: H + T.length });
  }, [e, x, t]), E = () => {
    r == null ? void 0 : r(false);
  };
  return !n || Ln() ? null : o.jsxs("div", { className: "fixed z-[10050] w-[min(92vw,440px)] rounded-lg border border-indigo-400/40 bg-slate-950/95 shadow-2xl backdrop-blur-md", style: { left: `${i.leftVw}vw`, top: `${i.topVh}vh` }, role: "dialog", "aria-modal": "false", "aria-label": "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8 \uC9C4\uD589\uB960", children: [o.jsxs("div", { className: "flex cursor-grab items-center justify-between gap-2 border-b border-indigo-500/30 bg-indigo-950/50 px-3 py-2 active:cursor-grabbing", onPointerDown: N, children: [o.jsxs("div", { className: "flex min-w-0 items-center gap-2 text-sm font-semibold text-indigo-100", children: [o.jsx(ii, { size: 16, className: "shrink-0 opacity-60", "aria-hidden": true }), o.jsx(qt, { size: 16, className: "shrink-0", "aria-hidden": true }), o.jsx("span", { className: "truncate", children: "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8 \uC9C4\uD589\uB960" })] }), o.jsxs("div", { className: "flex shrink-0 items-center gap-1", children: [o.jsxs("button", { type: "button", onPointerDown: (T) => T.stopPropagation(), onClick: A, className: "inline-flex items-center gap-1 rounded px-1.5 py-1 text-[11px] text-indigo-200 hover:bg-indigo-900/50", title: "\uC120\uD0DD \uC601\uC5ED \uC0C8\uB85C\uACE0\uCE68", "aria-label": "\uC120\uD0DD \uC601\uC5ED \uC0C8\uB85C\uACE0\uCE68", children: [o.jsx(ai, { size: 14 }), o.jsx("span", { className: "hidden sm:inline", children: "\uC0C8\uB85C\uACE0\uCE68" })] }), o.jsx("button", { type: "button", onPointerDown: (T) => T.stopPropagation(), onClick: E, className: "rounded p-1 text-indigo-200 hover:bg-indigo-900/50", title: "\uB2EB\uAE30", "aria-label": "\uB2EB\uAE30", children: o.jsx(Wt, { size: 15 }) })] })] }), o.jsx("div", { className: "max-h-[min(72vh,640px)] overflow-y-auto p-3", children: u.trim() ? o.jsx(Zi, { markdown: u, onMarkdownChange: L }) : o.jsxs("p", { className: "rounded-lg border border-dashed border-slate-700 bg-slate-900/60 px-3 py-6 text-center text-xs text-slate-400", children: ["\uC5D0\uB514\uD130\uC5D0\uC11C \uCCB4\uD06C\uB9AC\uC2A4\uD2B8\uAC00 \uD3EC\uD568\uB41C \uD14D\uC2A4\uD2B8\uB97C \uC120\uD0DD\uD55C \uB4A4", o.jsx("br", {}), "\uD234\uBC14 \uBC84\uD2BC\uC744 \uB204\uB974\uAC70\uB098 \uC0C8\uB85C\uACE0\uCE68\uD558\uC138\uC694."] }) })] });
}
const ra = "(max-width: 768px)";
function oa() {
  return typeof window < "u" && window.matchMedia(ra).matches;
}
...
function ia({ value: e = "", theme: t = "light", currentFile: n = null, disabled: r, trigger: i }) {
  const s = Jn(), u = l.useCallback(() => {
    r || (ir({ currentFile: n, editorContent: e }), s(ar(n == null ? void 0 : n.id), { state: { value: e, theme: t, currentFile: n } }));
  }, [s, e, t, r, n]);
  return o.jsx("button", { type: "button", className: "md-editor-toolbar-item", onClick: u, disabled: r, title: "PDF\uB85C \uB0B4\uBCF4\uB0B4\uAE30", "aria-label": "PDF\uB85C \uB0B4\uBCF4\uB0B4\uAE30", children: i ?? o.jsx(ci, { className: "md-editor-icon", size: 16 }) });
}
function aa({ editorRef: e }) {
...
`;
  ...
  return o.jsx("button", { type: "button", className: "md-editor-toolbar-item", onClick: t, title: "Insert print page break (<pgbr/>)", "aria-label": "Insert print page break", children: o.jsx(li, { className: "md-editor-icon", size: 16 }) });
}
function ca({ onOpen: e }) {
...
const la = [{ value: "selection", title: "\uC120\uD0DD \uC601\uC5ED", description: "\uD604\uC7AC \uC120\uD0DD\uB41C \uD14D\uC2A4\uD2B8\uB9CC \uBCC0\uACBD" }, { value: "document", title: "\uC804\uCCB4 \uBB38\uC11C", description: "\uBB38\uC11C \uC804\uCCB4 heading\uC744 \uBCC0\uACBD" }], da = [{ value: "flat", title: "1. \uD615\uC2DD", description: "\uCD5C\uB300 heading\uC744 \uD55C \uC790\uB9AC \uBC88\uD638\uB85C \uC2DC\uC791" }, { value: "nested", title: "2.1. \uD615\uC2DD", description: "heading \uC218\uC900\uB9CC\uD07C \uBC88\uD638\uB97C \uBD99\uC784" }], ua = [{ value: 1, title: "1\uBD80\uD130", description: "\uCD5C\uB300 heading\uC774 1. / 1.1. \u2026" }, { value: 2, title: "2\uBD80\uD130", description: "\uCD5C\uB300 heading\uC774 2. / 2.1. \u2026" }], fa = (e) => ["relative inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border outline-none transition-all duration-200 focus-visible:ring-2 focus-visible:ring-blue-400", e ? "border-blue-500 bg-blue-500 shadow-sm dark:border-blue-500 dark:bg-blue-500" : "border-transparent bg-gray-300 dark:border-odp-borderStrong dark:bg-odp-borderStrong"].join(" "), ma = "block h-4 w-4 translate-x-0.5 rounded-full bg-white shadow transition-transform will-change-transform data-[state=checked]:translate-x-[1.125rem]", Tn = "z-100010 max-w-[min(92vw,320px)] rounded-md border border-gray-200 bg-white px-2.5 py-1.5 text-xs text-gray-800 shadow-md dark:border-odp-borderStrong dark:bg-odp-surface dark:text-odp-fgStrong";
function pa({ isOpen: e, markdown: t, selectedMarkdown: n = "", onClose: r, onApply: i }) {
  const s = n.length > 0, [u, m] = l.useState("document"), [x, k] = l.useState(1), [w, A] = l.useState(false), [N, L] = l.useState("nested"), [E, T] = l.useState(1), F = u === "selection" ? n : t;
  l.useEffect(() => {
    if (!e) return;
    const y = s ? "selection" : "document";
    m(y), k(an(y === "selection" ? n : t)), A(false), L("nested"), T(1);
  }, [e, t, n, s]), l.useEffect(() => {
    if (!e) return;
    const y = (K) => {
      const $ = K;
  ...
  const H = l.useMemo(() => Zo(F, x, { maxLevel: dn, renumberOutline: w, outlineStyle: N, outlineStart: E }), [F, x, w, N, E]), q = (y) => {
    if (y !== "selection" && y !== "document" || y === "selection" && !s) return;
    m(y), k(an(y === "selection" ? n : t));
  }, z = () => {
    if (!H.sourceMax) return;
    const y = ns(F, x, { maxLevel: dn, renumberOutline: w, outlineStyle: N, outlineStart: E });
    y !== F && i(y, u), r();
  };
  return o.jsx(mt, { isOpen: e, onClose: r, onConfirm: z, contentClassName: "max-w-3xl", children: o.jsx(xi, { delayDuration: 250, skipDelayDuration: 0, children: o.jsxs("div", { className: "flex min-h-0 flex-1 flex-col p-6", children: [o.jsx("h2", { className: "text-lg font-bold text-gray-800 dark:text-odp-fgStrong", children: "\uCD5C\uB300 heading \uBCC0\uACBD" }), o.jsxs("p", { className: "mt-1 text-sm text-gray-500 dark:text-odp-muted", children: ["\uAC10\uC9C0\uB41C \uCD5C\uB300 heading\uC744 \uC120\uD0DD\uD55C \uB2E8\uACC4\uB85C \uBC14\uAFB8\uACE0, \uD558\uC704 heading\uB3C4 \uAC19\uC740 \uAC04\uACA9\uC73C\uB85C \uC774\uB3D9\uD569\uB2C8\uB2E4.", " ", "\uC22B\uC790 \uD0A4 1\u20139\uB85C \uCD5C\uB300 heading\uC744 \uBC14\uAFC0 \uC218 \uC788\uC2B5\uB2C8\uB2E4."] }), o.jsxs("div", { className: "mt-4", children: [o.jsx("div", { className: "mb-2 text-xs font-medium text-gray-500 dark:text-odp-muted", children: "\uC801\uC6A9 \uBC94\uC704" }), o.jsx(At, { className: "flex items-center gap-2", value: u, onValueChange: q, "aria-label": "\uCD5C\uB300 heading \uC801\uC6A9 \uBC94\uC704", children: la.map((y) => {
  ...
  }) })] }), o.jsxs("div", { className: "mt-4", children: [o.jsx("label", { htmlFor: "editor-heading-max", className: "mb-2 block text-xs font-medium text-gray-500 dark:text-odp-muted", children: "\uCD5C\uB300 heading" }), o.jsxs(bi, { value: String(x), onValueChange: (y) => {
    const D = Number(y);
    cn(D) && k(D);
  }, children: [o.jsxs(wi, { id: "editor-heading-max", "aria-label": "\uCD5C\uB300 heading", className: "inline-flex w-full items-center justify-between gap-2 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-800 outline-none focus-visible:ring-2 focus-visible:ring-blue-400 dark:border-odp-borderStrong dark:bg-odp-surface dark:text-odp-fgStrong", children: [o.jsx(yi, {}), o.jsx(vi, { className: "text-gray-500", children: o.jsx(fr, { size: 14 }) })] }), o.jsx(ki, { children: o.jsx(Ei, { className: "z-100010 max-h-60 min-w-(--radix-select-trigger-width) overflow-hidden rounded-md border border-gray-200 bg-white shadow-lg dark:border-odp-borderStrong dark:bg-odp-bgSoft", position: "popper", sideOffset: 4, children: o.jsx(Si, { className: "p-1", children: Jo.map((y) => o.jsxs(Ci, { value: String(y), className: "relative flex cursor-pointer select-none items-center rounded-sm py-1.5 pl-7 pr-3 text-sm text-gray-800 outline-none data-highlighted:bg-gray-100 dark:text-odp-fg dark:data-highlighted:bg-odp-focusBg", children: [o.jsx(Ni, { className: "absolute left-1.5 inline-flex items-center", children: o.jsx(Yt, { size: 12 }) }), o.jsx(ji, { children: `h${y}` })] }, y)) }) }) })] })] }), o.jsxs("div", { className: "mt-4 rounded-lg border border-gray-200 p-3 dark:border-odp-borderSoft", children: [o.jsxs("div", { className: "flex items-center justify-between gap-3", children: [o.jsxs("div", { className: "min-w-0", children: [o.jsx("div", { className: "text-sm font-medium text-gray-800 dark:text-odp-fgStrong", children: "outline \uBC88\uD638 \uB9DE\uCD94\uAE30" }), o.jsx("p", { className: "mt-0.5 text-[11px] leading-snug text-gray-500 dark:text-odp-muted", children: "\uC81C\uBAA9 \uC55E\uC758 1. / 2.1. \uAC19\uC740 \uBC88\uD638\uB97C \uD604\uC7AC heading \uC218\uC900\uC5D0 \uB9DE\uAC8C \uB2E4\uC2DC \uBD99\uC785\uB2C8\uB2E4." })] }), o.jsx(mr, { className: fa(w), checked: w, onCheckedChange: A, "aria-label": "outline \uBC88\uD638 \uB9DE\uCD94\uAE30", children: o.jsx(pr, { className: ma }) })] }), w ? o.jsxs("div", { className: "mt-3 space-y-3 border-t border-gray-100 pt-3 dark:border-odp-borderSoft/60", children: [o.jsxs("div", { children: [o.jsx("div", { className: "mb-2 text-xs font-medium text-gray-500 dark:text-odp-muted", children: "\uCD5C\uB300 heading \uBC88\uD638 \uD615\uC2DD" }), o.jsx(At, { className: "flex items-center gap-2", value: N, onValueChange: (y) => {
    (y === "flat" || y === "nested") && L(y);
  }, "aria-label": "\uCD5C\uB300 heading \uBC88\uD638 \uD615\uC2DD", children: da.map((y) => {
    const D = N === y.value;
...
function ht({ checked: e = false, onChange: t, theme: n = "light", title: r, ariaLabel: i, icon: s }) {
  ...
  return o.jsx("span", { className: "md-editor-toolbar-item inline-flex items-center !w-auto !min-w-0 px-1", title: r, children: o.jsxs("label", { className: "inline-flex shrink-0 cursor-pointer select-none items-center gap-1", onMouseDown: (x) => {
    x.preventDefault();
  }, children: [o.jsx(s, { className: `md-editor-icon shrink-0 ${u ? "text-odp-muted" : "text-gray-500"}`, size: 16, "aria-hidden": true }), o.jsx(mr, { checked: e, onCheckedChange: (x) => t == null ? void 0 : t(!!x), "aria-label": m, className: ["relative h-4 w-7 rounded-full border-0 outline-none transition-colors", "focus-visible:ring-2 focus-visible:ring-blue-400", e ? "bg-blue-600 dark:bg-blue-500" : u ? "bg-odp-borderStrong" : "bg-gray-300"].join(" "), children: o.jsx(pr, { className: ["block h-3 w-3 translate-x-0.5 rounded-full bg-white shadow transition-transform", "data-[state=checked]:translate-x-3.5"].join(" ") }) })] }) });
}
function ha({ checked: e = false, onChange: t, theme: n = "light" }) {
  return o.jsx(ht, { checked: e, onChange: t, theme: n, icon: ui, title: e ? "\uBAA9\uCC28 \uC81C\uBAA9 \uC904\uBC14\uAFC8 \uCF1C\uC9D0" : "\uBAA9\uCC28 \uC81C\uBAA9 \uB9D0\uC904\uC784(...)", ariaLabel: "\uBAA9\uCC28 \uC81C\uBAA9 \uC904\uBC14\uAFC8" });
}
function ga({ checked: e = false, onChange: t, theme: n = "light" }) {
  return o.jsx(ht, { checked: e, onChange: t, theme: n, icon: fi, title: e ? "base64 \uC774\uBBF8\uC9C0 \uC811\uD798" : "base64 \uC774\uBBF8\uC9C0 \uD3BC\uCE68", ariaLabel: "base64 \uC774\uBBF8\uC9C0 \uC811\uAE30" });
}
function xa({ checked: e = true, onChange: t, theme: n = "light" }) {
  return o.jsx(ht, { checked: e, onChange: t, theme: n, icon: mi, title: e ? "\uC790\uB3D9\uC644\uC131 \uCD94\uCC9C \uCF1C\uC9D0" : "\uC790\uB3D9\uC644\uC131 \uCD94\uCC9C \uAEBC\uC9D0", ariaLabel: "\uC790\uB3D9\uC644\uC131 \uCD94\uCC9C" });
}
function ba({ checked: e = false, onChange: t, theme: n = "light" }) {
  return o.jsx(ht, { checked: e, onChange: t, theme: n, icon: pi, title: e ? "Mirror Edit on \u2014 dual caret + instant preview sync" : "Mirror Edit off", ariaLabel: "Mirror Edit" });
}
function wa({ onRequestLink: e, onRequestUpload: t, onRequestClip: n, disabled: r = false }) {
  const [i, s] = l.useState(false), u = l.useRef(null), m = l.useRef(null), x = l.useCallback(() => s(false), []);
  return o.jsxs(o.Fragment, { children: [o.jsx(ho, { title: "\uC774\uBBF8\uC9C0", visible: i, onChange: s, disabled: r, overlay: o.jsxs("ul", { className: "md-editor-menu", role: "menu", onClick: x, children: [o.jsx("li", { className: "md-editor-menu-item md-editor-menu-item-image", role: "menuitem", tabIndex: 0, onClick: () => e(), onKeyDown: (k) => {
    ...
    var _a2;
    (k.key === "Enter" || k.key === " ") && (k.preventDefault(), (_a2 = m.current) == null ? void 0 : _a2.click());
  }, children: "\uC798\uB77C\uC11C \uC5C5\uB85C\uB4DC" })] }), children: o.jsx(hi, { className: "md-editor-icon", size: 16, "aria-hidden": true }) }), o.jsx("input", { ref: u, type: "file", accept: "image/*", multiple: true, className: "hidden", tabIndex: -1, "aria-hidden": true, onChange: (k) => {
    const w = Array.from(k.target.files || []);
    k.target.value = "", w.length && t(w);
  } }), o.jsx("input", { ref: m, type: "file", accept: "image/*", className: "hidden", tabIndex: -1, "aria-hidden": true, onChange: (k) => {
    var _a2;
...
function ya({ isOpen: e, onClose: t, onConfirm: n }) {
  const [r, i] = l.useState(""), [s, u] = l.useState(""), [m, x] = l.useState("");
  l.useEffect(() => {
    e && (i(""), u(""), x(""));
  }, [e]);
  const k = () => {
...
function ka({ isOpen: e, file: t, onClose: n, onConfirm: r }) {
  ...
  }, [e, t]), o.jsx(mt, { isOpen: e && !!t, onClose: n, contentClassName: "max-w-2xl w-[min(96vw,42rem)] max-h-[90vh] h-[min(90vh,720px)]", resizeHeight: true, children: i ? o.jsx(Fi, { imageSrc: i, ...(t == null ? void 0 : t.name) ? { fileName: t.name } : {}, onCancel: n, onConfirm: r }) : null });
}
...
const ja = 48, Rn = /data:image\/([a-z0-9.+-]+);base64,([a-z0-9+/=]+)/gi, br = tr.define(), wr = tr.define(), yr = new Bt();
function Ma(e) {
  const t = [];
  Rn.lastIndex = 0;
  let n;
  for (; (n = Rn.exec(e)) !== null; ) {
    ...
    if (i.length < ja) continue;
    const s = n[0], u = s.length - i.length, m = n.index + u;
    t.push({ from: m, to: n.index + s.length, mime: r });
  }
  return t;
}
function La(e, t) {
...
function An(e, t) {
  ...
  for (let i = 1; i <= e.doc.lines; i += 1) {
    ...
    for (const u of Ma(s.text)) {
      const m = s.from + u.from, x = s.from + u.to;
      if (Ra(t, m, x)) {
        r.push({ from: m, to: x });
        continue;
      }
      n.push(rn.replace({ widget: new Ta(La(u.mime, x - m), m, x) }).range(m, x));
    }
  }
...
}, provide: (e) => Ke.decorations.from(e, (t) => t.deco) }), Aa = Ke.domEventHandlers({ mousedown(e, t) {
...
function Pn(e) {
  ...
  for (const r of Fa(e.state)) Sr(t, r.from, r.to) || Ia(e.state, r.from, r.to) || n.push(Se.of(r));
  n.length > 0 && e.dispatch({ effects: n });
}
const $a = Vt.fromClass(class {
  constructor(e) {
    Pn(e);
  }
  update(e) {
...
`;
function Va(e) {
  if (!cs() || !(e == null ? void 0 : e.state)) return false;
  const t = e.state.selection.main, n = Oa;
...
function za(e) {
  return !(e == null ? void 0 : e.id) || e.type !== "s3" && e.type !== "local" && e.type !== "webdav" ? null : Ka(e.type, e.id);
}
async function qa(e) {
  if (!e) return null;
...
function Tr(e, t) {
  ...
  if (!n || !r) return null;
  const i = e.contentDOM.getBoundingClientRect(), s = Math.min(n.top, r.top), u = Math.max(n.bottom, r.bottom), m = Math.max(0, u - s);
  if (m < 2) return null;
  const x = document.createElement("div");
  return x.className = "cm-note-cover-fold-motion", x.style.cssText = ["position:fixed", `top:${s}px`, `left:${i.left}px`, `width:${Math.max(0, i.width)}px`, `height:${m}px`, "overflow:hidden", "pointer-events:none", "z-index:6", "background:var(--md-bk-color, var(--cm-background, #fff))"].join(";"), document.body.appendChild(x), x;
}
...
function tc() {
  return Vt.fromClass(class {
    ...
    syncKeyAndMaybeRestore() {
      ...
      qa(e).then((r) => {
        n === this.loadGen && r != null && ec(this.view, r);
      });
    }
  });
}
...
function rc() {
  return [Ga(null), nr({ preparePlaceholder(e, t) {
    const n = Ce(e);
    return n && Ya(n, t) ? "cover" : "heading";
  ...
  }, lineMarkerChange: (e) => e.docChanged || e.viewportChanged || nc(e), initialSpacer: () => new Dn(true, "heading"), domEventHandlers: { mousedown(e, t, n) {
  ...
  } } }), tc(), Ke.theme({ ".cm-note-cover-fold-gutter": { width: "1.1rem" }, ".cm-note-cover-fold-gutter .cm-gutterElement": { display: "flex", alignItems: "center", justifyContent: "center", padding: "0" }, ".cm-note-cover-fold-chevron": { display: "inline-flex", alignItems: "center", justifyContent: "center", width: "1rem", height: "1rem", padding: "0", margin: "0", border: "none", background: "transparent", color: "inherit", opacity: "0.65", cursor: "pointer", lineHeight: "1" }, ".cm-note-cover-fold-chevron:hover": { opacity: "1" }, ".cm-note-cover-fold-chevron svg": { display: "block" } })];
}
function oc({ cover: e, getPresignedUrl: t }) {
  const n = ds(e.pageSizeId) ? e.pageSizeId : us, r = l.useMemo(() => ({ ...fs(), pageSizeId: n }), [n]), i = l.useMemo(() => ms(n), [n]), s = l.useMemo(() => ps(r), [r]);
  return o.jsx("div", { className: "md-note-cover-preview-light w-full bg-white text-gray-900", "data-note-cover-preview": "1", "data-color-mode": "light", "data-cover-page-size": n, style: s, children: o.jsx(Li, { cover: e, getPresignedUrl: t, className: "md-note-cover-preview-slide mx-auto max-w-full shadow-[0_4px_16px_rgba(15,23,42,0.1)]", style: { width: "100%", height: "auto", aspectRatio: `${i.widthMm} / ${i.heightMm}` } }) });
}
const ut = /* @__PURE__ */ new WeakMap(), sc = "\uD45C\uC9C0 \uBD88\uB7EC\uC624\uB294 \uC911\u2026", ic = "\uD45C\uC9C0";
function Ar(e) {
  const t = ut.get(e);
...
function Hn(e, t) {
  e && (e.classList.toggle("md-note-cover-placeholder--pending", t === "pending"), e.classList.toggle("md-note-cover-placeholder--ready", t === "ready"), e.classList.toggle("md-note-cover-placeholder--empty", t === "empty"), t === "pending" ? $n(e, sc) : t === "empty" && $n(e, ic));
}
function ac(e, t, n) {
  let r = ut.get(e);
  r || (r = mo.createRoot(e), ut.set(e, r)), r.render(l.createElement(oc, { cover: t, getPresignedUrl: n ?? void 0 }));
}
function cc(e, t, n, r) {
  ...
  if (!(i == null ? void 0 : i.enabled)) {
    for (const u of s) {
      Ar(u);
      const m = u.closest("[data-note-cover-placeholder]");
      Hn(m, "empty");
    }
    return 0;
  }
...
const dc = "h1, h2, h3, h4, h5, h6", Pr = "md-preview-heading-fold-chevron", _n = "md-preview-heading-foldable", it = "md-preview-heading-folded", uc = "md-preview-heading-section-hidden", dt = "data-md-preview-heading-fold";
function fc(e) {
  if (!e) return false;
  const t = e.tagName;
...
function Dr(e) {
  ...
  for (; r && !(fc(r) && Bn(r) <= t || r.hasAttribute("data-note-cover-placeholder")); ) r instanceof HTMLElement && n.push(r), r = r.nextElementSibling;
  return n;
}
function pc(e) {
...
function Ir(e) {
  return Array.from(e.querySelectorAll(dc)).filter((t) => !(!(t instanceof HTMLElement) || pc(t)));
}
function hc(e) {
...
function Ft(e, t) {
  for (const n of e) n.classList.toggle(uc, t), t ? n.setAttribute("hidden", "") : n.removeAttribute("hidden");
}
function bc(e, t = {}) {
  if (!e || typeof e.querySelectorAll != "function") return () => {
  };
  ...
  return Ir(e).forEach((s, u) => {
    ...
    const w = !n.has(x), A = gc(w);
    s.insertBefore(A, s.firstChild);
    const N = (E) => {
      s.classList.toggle(it, E), Ft(m, E), xc(A, !E);
    };
    w || (s.classList.add(it), Ft(m, true));
    const L = (E) => {
      var _a3;
    ...
    A.addEventListener("click", L), r.push(() => {
      A.removeEventListener("click", L), A.remove(), s.classList.remove(_n, it), s.removeAttribute(dt), Ft(m, false);
    });
  }), () => {
    for (const s of r) s();
  };
...
function yc(e) {
  return !(e == null ? void 0 : e.id) || e.type !== "s3" && e.type !== "local" && e.type !== "webdav" ? null : wc(e.type, e.id);
}
async function vc(e) {
  if (!e) return null;
...
function Mc(e) {
  ...
  function m() {
    ...
    return !L || !E || Ve(L) ? false : hs(E, L, { allowCollapsed: true });
  }
  function x() {
  ...
  function w(L) {
    ...
    if (E && k(E), m(), !!(L == null ? void 0 : L.withRetries)) {
      u();
      for (const T of jc) t.push(setTimeout(() => {
        if (s) return;
...
const On = [0, 16, 48, 120, 280], Lc = 50, Tc = 40, Vn = 32, Rc = 32;
function Kn(e) {
...
function Pc(e, t, n) {
  ...
  for (const u of Hr(e)) {
    const m = Number(u.getAttribute("data-line"));
...
function Ic(e) {
  let t = false, n = [], r = null, i = 0, s = null, u = 0, m = 0, x = null, k = null, w = null, A = null, N = null, L = "none", E = false;
  function T() {
  ...
  function q() {
    u && cancelAnimationFrame(u), m && cancelAnimationFrame(m), u = 0, m = 0;
  }
  function z(M) {
  ...
  function Z() {
    ...
    const O = y(C), I = D(M);
    if (!I) return;
    const se = O.scrollTop, ue = C.lineBlockAtHeight(se), we = C.state.doc.lineAt(ue.from).number - 1, ye = Ac(M, we);
    if (!ye) return;
  ...
  function U() {
    ...
    const O = y(C), I = D(M);
    if (!I) return;
    const se = I.scrollTop + Vn, ue = Pc(M, I, se);
    if (!ue) return;
  ...
  function pe() {
    E || L === "editor" || L === "follow" || m || (m = requestAnimationFrame(() => {
      m = 0, J();
    }));
  }
  function ne(M) {
...
const qn = 100, _r = 10080 * 60 * 1e3, Fc = 500;
function $c(e, t) {
  return Kt(e, t);
}
function Hc(e) {
  return !(e == null ? void 0 : e.id) || e.type !== "s3" && e.type !== "local" ? null : $c(e.type, e.id);
}
async function _c(e) {
  if (!e) return null;
...
function Oc(e, t, n) {
  ...
  u.push(r);
  const m = Ut(u);
  return { stack: m, index: m.length - 1, changed: true };
}
function Vc(e, t, n) {
...
function zc({ currentFile: e, value: t, onChange: n, editorRef: r, enabled: i = true }) {
  const s = i ? Hc(e) : null, u = l.useRef([""]), m = l.useRef(0), x = l.useRef(null), k = l.useRef(false), w = l.useRef(null), A = l.useRef(null), N = l.useRef(t), L = l.useRef(false), E = l.useRef(null), T = l.useRef(0), F = l.useRef(t);
  N.current = t;
  const H = l.useCallback(async ($, h, P) => {
    ...
    const $ = N.current ?? "", h = at(u.current, m.current, $);
    return u.current = h.stack, m.current = h.index, h;
  }, []), D = l.useCallback(($) => {
    const h = Un(r), P = Kc(h), Z = Yn(h);
    if (!P) return false;
    const U = ++T.current;
    k.current = true;
    try {
    ...
    u.current = Q.stack, m.current = Q.index, E.current = $, L.current = false, F.current = P;
  ...
  return l.useEffect(() => {
    ...
    if ((_a2 = Yn(P)) == null ? void 0 : _a2(), !h) {
      u.current = [N.current ?? ""], m.current = 0;
      return;
    }
    const Z = ++T.current;
    let U = false;
    ...
    const $ = t ?? "";
    F.current = $;
    const h = at(u.current, m.current, $);
    u.current = h.stack, m.current = h.index, D(h.stack.slice(0, h.index + 1)), q(s, h.stack, h.index);
  }, [i, s, t, D, q]), l.useEffect(() => {
    if (i) return () => {
      z(), A.current && (clearTimeout(A.current), A.current = null);
      const $ = x.current;
      if (!$) return;
      const h = at(u.current, m.current, N.current ?? "");
    ...
    k.current || (F.current = $, L.current = true, n == null ? void 0 : n($), !(!i || !x.current) && (z(), w.current = setTimeout(() => {
      ...
      const h = x.current;
      if (!h) return;
      const P = Oc(u.current, m.current, $);
      P.changed && (u.current = P.stack, m.current = P.index, q(h, P.stack, P.index));
    }, Fc)));
  }, [i, n, z, q]) };
}
const Gt = /^(\s*)([-+*])(\s+)(.*)$/, Xt = /^(\s*)(\d+)([.)])(\s+)(.*)$/, Br = /^(\s*(?:[-+*]|\d+[.)])\s+)\[([ xX])\](.*)$/, qc = /^(#{1,10})\s+(.*)$/;
function Wc(e) {
  if (!e) return false;
  const t = e[0];
...
function Or(e, t, n, r, i) {
  ...
  if (r === i && Wc(r)) {
    const m = r[0] ?? "";
    if (s > 0 && e.sliceString(s - 1, s) === m || u < e.length && e.sliceString(u, u + 1) === m) return false;
  }
  return true;
}
function Yc(e, t, n, r) {
  ...
  const m = e.sliceString(i, s);
  if (m.length >= n.length + r.length && m.startsWith(n) && m.endsWith(r)) {
    const k = m.slice(n.length, m.length - r.length);
    return { change: { from: i, to: s, insert: k }, next: ce.range(i, i + k.length) };
  }
  if (Or(e, i, s, n, r)) {
    const k = i - n.length, w = s + r.length;
    return { change: { from: k, to: w, insert: m }, next: ce.range(k, k + m.length) };
  }
  const x = `${n}${m}${r}`;
  return { change: { from: i, to: s, insert: x }, next: ce.range(i + n.length, i + n.length + m.length) };
}
function Uc(e, t) {
...
`) && n.startsWith(r) && n.endsWith(r) && n.length > r.length * 2) {
  ...
  if (Or(e, t.from, t.to, r, r)) {
    const u = t.from - r.length, m = t.to + r.length;
    return { change: { from: u, to: m, insert: n }, next: ce.range(u, u + n.length) };
  }
  const s = `${r}${n}${r}`;
...
function Re(e, t, n = t) {
  ...
  const r = e.state.selection.ranges.map((i) => Yc(e.state.doc, i, t, n));
  return Vr(e, r);
}
function Gc(e) {
  return Re(e, "**");
...
function Kr(e) {
  ...
  const t = e.state.selection.ranges.map((n) => Uc(e.state.doc, n) ?? { next: n });
  return Vr(e, t);
}
function tl(e) {
...
const fl = "s3haim_md_editor_toc_width", ml = 360;
function Zn(e) {
...
const pl = Mo({ nonTightLists: false });
function hl(e) {
  var _a2, _b;
...
function gl(e) {
  return pl(e) ? (hl(e), true) : Va(e) ? true : jo(e);
}
const xl = Co.highest(sr.of([{ key: "Enter", run: gl }]));
function bl(e) {
  var _a2, _b;
  if (!(e == null ? void 0 : e.state)) return;
...
const yl = [{ key: "Alt-h", preventDefault: true, run: (e) => lt(e, Yo) }, { key: "Alt-j", preventDefault: true, run: (e) => lt(e, Uo) }, { key: "Alt-k", preventDefault: true, run: (e) => lt(e, Go) }, { key: "Alt-l", preventDefault: true, run: (e) => lt(e, Xo) }];
No({ editorConfig: { languageUserDefined: { "ko-KR": Lo }, renderDelay: ur() ? 500 : 0 }, codeMirrorExtensions(e, { keyBindings: t }) {
  const n = [...e].filter((s) => s.type !== "keymap" && s.type !== "linkShortener" && s.type !== "lineNumbers"), r = (t || []).filter((s) => {
    const u = String((s == null ? void 0 : s.key) || "").toLowerCase(), m = String((s == null ? void 0 : s.mac) || "").toLowerCase();
    return u !== "mod-f" && u !== "ctrl-d" && u !== "mod-d" && m !== "cmd-d" && u !== "ctrl-b" && u !== "mod-b" && m !== "cmd-b" && u !== "ctrl-u" && u !== "mod-u" && m !== "cmd-u" && u !== "ctrl-o" && u !== "mod-o" && m !== "cmd-o" && u !== "ctrl-arrowup" && u !== "mod-arrowup" && m !== "cmd-arrowup" && u !== "ctrl-arrowdown" && u !== "mod-arrowdown" && m !== "cmd-arrowdown" && !/^ctrl-[0-9]$/.test(u) && !/^mod-[0-9]$/.test(u) && !/^cmd-[0-9]$/.test(m);
  }), i = [{ key: "ArrowLeft", run: (s) => yn(s, -1) }, { key: "ArrowRight", run: (s) => yn(s, 1) }, { key: "Ctrl-ArrowLeft", mac: "Alt-ArrowLeft", run: (s) => be(s, -1, Bo), shift: (s) => be(s, -1, _o) }, { key: "Ctrl-ArrowRight", mac: "Alt-ArrowRight", run: (s) => be(s, 1, Vo), shift: (s) => be(s, 1, Oo) }, { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: (s) => be(s, -1, zo), shift: (s) => be(s, -1, Ko) }, { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: (s) => be(s, 1, Wo), shift: (s) => be(s, 1, qo) }, ...yl, { key: "Alt--", preventDefault: true, run: ol }, { key: "Ctrl-Tab", run: sl }, { key: "Ctrl-f", mac: "Cmd-f", preventDefault: true, run: To }, { key: "Ctrl-d", mac: "Cmd-d", preventDefault: true, run: (s) => (Po(s), true) }, { key: "Ctrl-b", mac: "Cmd-b", preventDefault: true, run: Gc }, { key: "Ctrl-i", mac: "Cmd-i", preventDefault: true, run: Xc }, { key: "Ctrl-u", mac: "Cmd-u", preventDefault: true, run: Zc, shift: il }, { key: "Ctrl-o", mac: "Cmd-o", preventDefault: true, run: al }, { key: "Shift-Ctrl-s", mac: "Shift-Cmd-s", preventDefault: true, run: Qc }, { key: "Ctrl-ArrowUp", mac: "Cmd-ArrowUp", preventDefault: true, run: Jc }, { key: "Ctrl-ArrowDown", mac: "Cmd-ArrowDown", preventDefault: true, run: el }, ...[1, 2, 3, 4, 5, 6, 7, 8, 9].map((s) => ({ key: `Ctrl-${s}`, mac: `Cmd-${s}`, preventDefault: true, run: (u) => Gn(u, s) })), { key: "Ctrl-0", mac: "Cmd-0", preventDefault: true, run: (s) => Gn(s, 10) }, { any: (s, u) => (u.ctrlKey || u.metaKey) && u.altKey && u.code === "KeyC" ? Kr(s) : zr(s, u) }, { key: "Mod-Alt-ArrowUp", run: Ro }, { key: "Mod-Alt-ArrowDown", run: Ao }, ...r];
  return n.some((s) => s.type === "drawSelection") || n.push({ type: "drawSelection", extension: Do() }), n.push({ type: "cmGlyphRepaintFix", extension: Cc() }), n.push({ type: "markdownSingleNewlineEnter", extension: xl }, { type: "lineNumbers", extension: rc() }, { type: "allowMultipleSelections", extension: Io.allowMultipleSelections.of(true) }, { type: "clickAddsSelectionRange", extension: Ke.clickAddsSelectionRange.of((s) => {
    const u = /Mac|iPod|iPhone|iPad/.test(navigator.platform);
    return s.altKey || (u ? s.metaKey : s.ctrlKey);
  }) }, { type: "multiCursorPreview", extension: Fo({ minSelectionLength: 2, maxMatches: 200 }) }, { type: "keymap", extension: sr.of(i) }, { type: "base64ImageFold", extension: Pa($t()) }, { type: "mermaidBase64Fold", extension: _a($t()) }, { type: "autocompleteGate", extension: Ke.updateListener.of((s) => {
    Sc(s), !cr() && $o(s.state) === "active" && Ho(s.view);
  }) }), n;
}, markdownItPlugins(e) {
  return Zs(e);
} });
function Bl({ value: e, onChange: t, onSave: n, theme: r = "light", currentFile: i = null, previewOnly: s = false, isMobileLayout: u = false, onUploadImage: m, isUploadingEditorImage: x = false, uploadImagePercent: k = 0, onCancelUploadImage: w, onResolveWikiImageUrl: A, snippetConfig: N = { snippets: [] }, llmProviderProfiles: L = [], getImgbbApiKey: E, onOpenViewPath: T, onRequestConvertAllImagesToWiki: F, onRegisterConvertAllImagesToWiki: H, isActiveFile: q = true }) {
  var _a2, _b;
  const z = xs(), y = Jn(), { showAlert: D } = bs(), ee = l.useId(), K = l.useMemo(() => Vi(ee), [ee]), $ = l.useMemo(() => Ki(K), [K]), h = l.useRef(null), P = l.useRef(null), Z = l.useRef(null), U = l.useRef(null), Q = l.useRef(N), J = l.useRef(e), me = l.useRef(i), pe = l.useRef(r), ne = l.useRef("");
  l.useEffect(() => {
...
${c}` }));
  ...
  }, [y]), { onChange: B } = zc({ currentFile: i, value: e, onChange: t, editorRef: h, enabled: !s }), te = Ti({ getMarkdown: () => J.current ?? "", setMarkdown: (a) => {
  ...
  const [Qt, Ze] = l.useState(null), [re, $e] = l.useState(null), [qr, ke] = l.useState(false), [He, gt] = l.useState(null), [Wr, xt] = l.useState(false), [fe, Yr] = l.useState(null), [Je, bt] = l.useState(null), ge = l.useRef(null), [wt, Zt] = $i(), [_e, Jt] = Sa(), [en, tn] = Ca(), [Ur, et] = Na(), ae = l.useMemo(() => ur(), []), oe = ae ? false : Ur, yt = l.useRef(null);
  l.useEffect(() => {
    if (s) return;
    const a = () => {
      var _a3, _b2, _c2;
      ...
      !(f.metaKey || f.ctrlKey) || f.altKey || f.shiftKey || f.key.toLowerCase() === "k" && a();
    };
...
`;
    ...
    for (const g of vs) g.directive && (b[g.id] = () => d(g.directive));
  ...
  l.useEffect(() => {
    ...
    const a = () => {
      ...
      const f = a(), p = yt.current;
      !f || !p || f.dispatch({ selection: p, scrollIntoView: true });
    }, d = (f, p) => {
      var _a3, _b2;
      const b = a();
      b && (b.dispatch({ changes: { from: 0, to: b.state.doc.length, insert: f }, selection: { anchor: p }, scrollIntoView: true }), (_a3 = b.focus) == null ? void 0 : _a3.call(b)), (_b2 = Fe.current) == null ? void 0 : _b2.call(Fe, f);
    };
    return Es({ getMarkdown: () => {
      var _a3;
      return ((_a3 = a()) == null ? void 0 : _a3.state.doc.toString()) ?? J.current ?? "";
    }, insertExisting: (f) => {
      c();
      const p = a(), b = (p == null ? void 0 : p.state.doc.toString()) ?? J.current ?? "", g = p == null ? void 0 : p.state.selection.main, v = Js(b, (g == null ? void 0 : g.from) ?? 0, (g == null ? void 0 : g.to) ?? 0, f);
      d(v.next, v.caret);
    }, openCompose: () => {
      var _a3;
      c();
  ...
  const { width: tt, isResizing: Gr, handleProps: Xr } = Ss({ storageKey: fl, defaultWidth: ml, minWidth: 160, collapseBelowWidth: 80, maxWidth: 640, edge: "right", onCollapseBelowMin: () => {
    var _a3, _b2, _c2;
    ...
    if (!a) return {};
    const c = {}, d = st(a.body), f = st(a.heading), p = st(a.bold), b = st(a.code, "mono");
    return d && (c["--print-font-body"] = d), f && (c["--print-font-heading"] = f), p && (c["--print-font-bold"] = p), b && (c["--print-font-code"] = b), c;
  }, [nt]);
  l.useEffect(() => {
    ...
    const a = () => {
      var _a3, _b2, _c2;
      const p = (_c2 = (_b2 = ((_a3 = h.current) == null ? void 0 : _a3.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2);
      return p ? (Da(p, _e), Ba(p, _e), true) : false;
    };
    if (a()) return;
    ...
    if (!a) return;
    const c = () => {
      const f = a.querySelector(".md-editor-catalog-fixed, .md-editor-catalog-flat");
      Yr((p) => p === f ? p : f);
    };
    c();
    ...
    const a = () => {
      ...
      bt({ top: f.top, left: f.left, height: f.height });
    };
    a();
    ...
    if (fe) return Ui(fe, { getEditorRoot: () => P.current, mdHeadingId: (a) => $(a) });
  }, [fe, $]), Bi(P, e, A, (i == null ? void 0 : i.id) ?? null), Ns(P, { layoutKey: r }), l.useEffect(() => {
    const a = P.current;
    if (!a || !e) return;
    let c = 0;
    const d = () => {
    ...
    }, b = [0, 80, 280, 600, 1100, 2e3].map((j) => setTimeout(d, j)), g = a.querySelector(".md-editor-preview") || a, v = typeof MutationObserver < "u" ? new MutationObserver(f) : null;
    ...
    const a = za(i), c = () => {
      var _a3, _b2, _c2;
      const p = (_c2 = (_b2 = ((_a3 = h.current) == null ? void 0 : _a3.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2);
      return p ? (Xa(p, a), true) : false;
    };
    if (c()) return;
    const d = [50, 200, 500, 1e3].map((f) => setTimeout(c, f));
    return () => d.forEach((f) => clearTimeout(f));
    ...
    const d = () => {
      ...
      return !b || b === c ? !!b : (a == null ? void 0 : a(), c = b, a = Ks(b), true);
    };
    if (d()) return () => {
      a == null ? void 0 : a();
    };
    const f = [50, 200, 500, 1e3].map((p) => setTimeout(d, p));
    return () => {
      f.forEach((p) => clearTimeout(p)), a == null ? void 0 : a();
    };
  }, [s, i == null ? void 0 : i.id]), l.useEffect(() => {
    const a = P.current;
    if (!a) return;
    const c = yc(i), d = { current: [] };
    let f = false, p = null, b = null, g = [];
    const v = () => a.querySelector(".md-editor-preview"), j = () => {
      if (f) return;
      const V = v();
      if (!V || !hc(V)) return;
      const ie = bc(V, { collapsedIds: d.current, onCollapsedChange: (R) => {
        d.current = R, c && kc(c, R);
      } }), S = p;
      p = () => {
        S == null ? void 0 : S(), ie();
      };
    ...
    return (async () => {
      ...
      f || (_(v()), j(), g = [80, 250, 600].map((V) => setTimeout(() => {
        f || (_(v()), j());
      }, V)));
    })(), () => {
      f = true, g.forEach((V) => clearTimeout(V)), b == null ? void 0 : b.disconnect(), b = null, p == null ? void 0 : p(), p = null;
    };
    ...
    const p = (S) => S instanceof Element ? Ct(S) ? true : !!S.closest("a, button, input, textarea, select, .md-editor-code-action, [data-transform-handle]") : false, b = (S) => {
    ...
    }, g = (S) => S.button === 2 || S.button === 0 && S.ctrlKey, v = (S, R) => bn(R, S.clientX, S.clientY) ? true : wn(S.clientX, S.clientY) ? Qs(R) : false, j = (S) => {
      var _a3, _b2, _c2, _d;
      const R = c();
      if (!R) return;
      const G = S.target;
      ...
      if (R.contains(G)) {
        f = { x: S.clientX, y: S.clientY }, !Ct(G) && !d() && Oe(R);
        return;
      }
      if (f = null, (_d = (_c2 = (_b2 = ((_a3 = h.current) == null ? void 0 : _a3.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2)) == null ? void 0 : _d.dom.contains(G)) {
        if (g(S)) return;
        Lt(), d() || Oe(R);
      }
    }, _ = (S) => {
      ...
      if (!(!R || !(S.target instanceof Node) || !R.contains(S.target)) && !p(S.target)) {
        if (Nt(a)) {
          const G = !!(f && Math.hypot(S.clientX - f.x, S.clientY - f.y) > 6);
          if (f = null, !d() || G) return;
        ...
        f = null, requestAnimationFrame(() => b(S.target));
      }
    }, V = (S) => {
      var _a3, _b2, _c2, _d;
      const R = c();
    ...
    const f = Ic({ getPreviewRoot: c, getView: d });
    Z.current = f, (_d = U.current) == null ? void 0 : _d.stop(), U.current = null, oe ? U.current = Mc({ getPreviewRoot: c, getView: d }) : Lt();
    const p = Ec((b, g) => {
      var _a4;
      const v = d();
      !v || b !== v || (f.schedule({ withRetries: g.docChanged }), oe && ((_a4 = U.current) == null ? void 0 : _a4.schedule({ withRetries: g.docChanged })));
    });
    return () => {
      var _a4, _b3;
    ...
    const a = P.current;
    if (a) return Ls(a, { getPreviewRoot: () => a.querySelector(".md-editor-preview"), getView: () => {
      var _a3, _b2, _c2;
    ...
    if (Ts(), !!c && ((_b2 = Z.current) == null ? void 0 : _b2.schedule({ withRetries: true }), !ae)) {
      if (oe && !Ve(c)) {
    ...
    const a = () => {
      ...
      return (c == null ? void 0 : c.domEventHandlers) ? (c.domEventHandlers({ paste: (d, f) => {
        const p = d.clipboardData;
        if (!p || !f) return;
        const b = _i(p);
        if (b.length && typeof m == "function") {
...
`), V = ((_c2 = (_b2 = ((_a4 = h.current) == null ? void 0 : _a4.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2)) ?? v;
        ...
        if (g) return d.preventDefault(), f.dispatch(f.state.replaceSelection(g)), false;
      }, keydown: (d, f) => {
        var _a4;
        if (!f) return;
        if (!f.composing && wl(d) && Kr(f) || !f.composing && zr(f, d)) return d.preventDefault(), d.stopPropagation(), true;
        const p = Zn(d);
        if (!p) return;
        if (p === "mod+shift+enter") return d.preventDefault(), d.stopPropagation(), bl(f), false;
        if (p === "mod+s") return;
        const g = ((_a4 = Q.current) == null ? void 0 : _a4.snippets) || [], v = ct(p), j = g.find((_) => ct(_.prefix) === v && (_.body || "").trim());
        if (j) return d.preventDefault(), d.stopPropagation(), f.dispatch(f.state.replaceSelection(j.body)), false;
      } }), true) : false;
    };
    if (!a()) {
    ...
    const a = (c) => {
      ...
      const d = P.current;
      if (!d) return;
      const f = c.target, p = f instanceof Node && d.contains(f), b = d.querySelector(".md-editor-preview"), g = (_a3 = window.getSelection) == null ? void 0 : _a3.call(window), v = !!(b && (g == null ? void 0 : g.rangeCount) && b.contains(g.getRangeAt(0).commonAncestorContainer));
      if (!p && !v && !Ve(b)) return;
    ...
    const c = (d) => {
      ...
      const f = a.querySelector(".md-editor-preview"), p = (_b2 = (_a3 = d.target) == null ? void 0 : _a3.closest) == null ? void 0 : _b2.call(_a3, "table");
      if (p && f && f.contains(p) || f && (bn(f, d.clientX, d.clientY) || wn(d.clientX, d.clientY))) return;
      ...
      d.preventDefault();
      const j = v.kind === "wiki" ? Ys(a, g, v.key) : Us(a, g, v.key);
    ...
    const c = (d) => {
      ...
      const f = a.querySelector(".md-editor-preview"), p = (_d = (_c2 = d.target) == null ? void 0 : _c2.closest) == null ? void 0 : _d.call(_c2, "table");
      if (!p || !f || !f.contains(p)) return;
      d.preventDefault(), d.stopPropagation(), De.current(p, f) || D({ title: "No table", message: "No haim-table found at this position. Click inside a table cell and try again." });
    };
    ...
    const c = (p) => {
      ...
      if (g && a.contains(g)) {
        p.preventDefault(), p.stopPropagation(), y(Gs({ id: g.getAttribute("data-chat-id") || "", href: g.getAttribute("data-chat-href") || g.getAttribute("href") || "" }));
        return;
      }
      ...
      const j = v.getAttribute("href") || "", _ = Xs(j, { currentViewPath: (i == null ? void 0 : i.type) ? i.id : null });
    ...
    return a.addEventListener("click", d), a.addEventListener("keydown", f), () => {
  ...
  const Zr = l.useCallback(({ width: a, height: c }) => {
    ...
    const f = d.kind === "wiki" ? Et(e, { path: d.key, occurrence: d.occurrence ?? 0, width: a, height: c }) : St(e, { src: d.key, occurrence: d.occurrence ?? 0, width: a, height: c });
    f.updated && f.markdown !== e && B(f.markdown);
  }, [I, B, e]), Jr = l.useCallback(async ({ file: a }) => {
    var _a3;
    const c = I;
    if (!(c == null ? void 0 : c.key) || typeof m != "function") throw new Error("Upload handler not available.");
    const f = (_a3 = await m([a])) == null ? void 0 : _a3[0];
    if (!f) throw new Error("Upload succeeded but no path was returned.");
    if (typeof B != "function") return;
    const p = c.kind === "wiki" ? Rs(e, { path: c.key, occurrence: c.occurrence ?? 0, nextPath: f }) : mn(e, { src: c.key, occurrence: c.occurrence ?? 0, nextPath: f });
    p.updated && p.markdown !== e && B(p.markdown);
  }, [B, m, e, I]), eo = l.useCallback(async ({ width: a, height: c }) => {
    var _a3;
    const d = I;
    ...
    const f = await As({ markdownSrc: d.key, displaySrc: d.imageSrc, currentNotePath: (i == null ? void 0 : i.id) ?? null });
    let p = "";
    if (f.mode === "path") p = f.path;
    else {
      if (typeof m != "function") throw new Error("Upload handler not available.");
      if (p = ((_a3 = await m([f.file])) == null ? void 0 : _a3[0]) || "", !p) throw new Error("Upload succeeded but no path was returned.");
    }
    const b = mn(e, { src: d.key, occurrence: d.occurrence ?? 0, nextPath: p, width: a, height: c });
    b.updated && b.markdown !== e && B(b.markdown);
  }, [i == null ? void 0 : i.id, B, m, e, I]), to = l.useCallback(async ({ width: a, height: c }) => {
    const d = I;
    if (!(d == null ? void 0 : d.key) || !(d == null ? void 0 : d.kind)) throw new Error("Cannot convert: image target is missing.");
    if (typeof B != "function") throw new Error("Cannot apply change.");
    const f = typeof E == "function" ? String(await Promise.resolve(E()) || "").trim() : "";
    if (!f) throw new Error("ImgBB API key is missing. Please add it in settings.");
    const p = Ps({ path: d.key, imageSrc: d.imageSrc });
    if (!p) throw new Error("Cannot determine image source URL for upload.");
    const g = (await Ds({ apiKey: f, image: p, name: Is(d.key) ? "image" : void 0 })).url, v = d.occurrence ?? 0;
    let j = e;
    ...
    const X = await Fs(j, { kind: d.kind === "wiki" ? "wiki" : "markdown", key: d.key, occurrence: v }, g);
  ...
  l.useEffect(() => {
    if (typeof H == "function") return H(async () => {
      ...
      if (typeof B != "function") throw new Error("Cannot apply change.");
      if (!$s(e)) return { markdown: e, converted: 0, failed: [] };
      const a = await Hs(e, { currentNotePath: (i == null ? void 0 : i.id) ?? null, uploadFiles: async (c) => {
        if (typeof m != "function") throw new Error("Upload handler not available.");
        return m(c);
      } });
      return a.markdown !== e && B(a.markdown), a;
    }), () => H(null);
  }, [i == null ? void 0 : i.id, B, H, m, s, e]);
  const xe = l.useCallback((a) => {
  ...
  }, []), nn = l.useCallback(({ kind: a, key: c, occurrence: d, widthPx: f, heightPx: p }) => {
    if (!c || typeof B != "function") return false;
    const b = Number.isFinite(f) ? `${Math.round(f)}px` : null, g = Number.isFinite(p) ? `${Math.round(p)}px` : null, v = a === "wiki" ? Et(e, { path: c, occurrence: d, width: b, height: g }) : St(e, { src: c, occurrence: d, width: b, height: g });
    ...
    const c = xe(a);
    if (!c) return;
    const d = c.getBoundingClientRect(), f = Math.max(24, Math.round(d.width)), p = Math.max(24, Math.round(d.height)), b = { kind: a.kind, key: a.key, occurrence: a.occurrence ?? 0, widthPx: f, heightPx: p, originalWidthPx: f, originalHeightPx: p };
    c.style.width = `${f}px`, c.style.height = `${p}px`, ge.current = b, $e(b), ke(false);
  }, [xe, I]);
  l.useEffect(() => {
    if (!re) {
      gt(null);
    ...
    const d = () => {
      ...
      gt({ left: f.left, top: f.top, width: f.width, height: f.height }), c = requestAnimationFrame(d);
    };
    ...
    return document.addEventListener("pointerdown", c, true), document.addEventListener("pointerdown", f, true), document.addEventListener("keydown", d, true), () => {
      document.removeEventListener("pointerdown", c, true), document.removeEventListener("pointerdown", f, true), document.removeEventListener("keydown", d, true);
    };
  }, [re, xe]);
  const ro = l.useCallback(() => {
    ...
    const f = (_c2 = d == null ? void 0 : d.getEditorView) == null ? void 0 : _c2.call(d);
    f && (f.dispatch(f.state.replaceSelection(c)), (_d = f.focus) == null ? void 0 : _d.call(f));
  }, []), rt = l.useCallback(async (a) => {
    if (!(a == null ? void 0 : a.length) || typeof m != "function" || x) return;
    const c = await m(a);
...
`);
  ...
  const so = l.useCallback(async (a) => {
    var _a3;
    if (!a || typeof m != "function") throw new Error("Upload handler not available.");
    const d = (_a3 = await m([a])) == null ? void 0 : _a3[0];
    if (!d) throw new Error("Upload succeeded but no path was returned.");
    Be(`![[${d}]]
`), Ze(null);
  }, [Be, m]), ot = l.useCallback(() => {
    var _a3, _b2, _c2;
    const c = (_c2 = (_b2 = ((_a3 = h.current) == null ? void 0 : _a3.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2);
    let d = null;
    if (c) {
      const { from: f, to: p } = c.state.selection.main;
      f !== p && (d = { from: f, to: p, text: c.state.doc.sliceString(f, p) });
    }
    Ie(d), he(true);
  }, []);
  l.useEffect(() => {
  ...
  const io = l.useMemo(() => [o.jsx(ia, { value: e, theme: r, currentFile: i, language: "ko-KR" }, "export-pdf"), o.jsx(aa, { editorRef: h }, "insert-pgbr"), o.jsx(ca, { onOpen: ot }, "heading-remap"), o.jsx(Gi, { active: !!(z == null ? void 0 : z.open), onToggle: () => {
    var _a3;
    (_a3 = z == null ? void 0 : z.toggleAssist) == null ? void 0 : _a3.call(z);
  } }, "llm-assist"), o.jsx(sa, { onOpen: () => {
    O(true);
  } }, "checklist-progress"), o.jsx(ha, { checked: wt, onChange: Zt, theme: r }, "toc-title-wrap"), o.jsx(ga, { checked: _e, onChange: Jt, theme: r }, "base64-image-fold"), o.jsx(xa, { checked: en, onChange: tn, theme: r }, "editor-autocomplete"), ae ? null : o.jsx(ba, { checked: oe, onChange: et, theme: r }, "mirror-edit"), o.jsx(wa, { disabled: typeof m != "function", onRequestLink: () => Me(true), onRequestUpload: (a) => {
    rt(a);
  }, onRequestClip: (a) => Ze(a) }, "image-toolbar")], [e, r, i, wt, Zt, _e, Jt, en, tn, ae, oe, et, m, rt, ot, z == null ? void 0 : z.open, z == null ? void 0 : z.toggleAssist]), ao = l.useMemo(() => ["bold", "underline", "italic", "-", "strikeThrough", "sub", "sup", "quote", "unorderedList", "orderedList", "task", "-", "codeRow", "code", "link", 9, "table", "mermaid", "katex", 1, 2, 3, 4, "-", "revoke", "next", 0, "=", 6, 7, ...ae ? [] : [8], "pageFullscreen", "fullscreen", "previewOnly", "preview", "htmlPreview", ...fe ? [5] : [], "catalog"], [fe, ae]), co = l.useMemo(() => {
    if (typeof m == "function") return async (a, c) => {
      if (x) return;
      const d = await m(a);
      (d == null ? void 0 : d.length) && c(d.map((f) => `![[${f}]]`));
    };
  }, [m, x]);
  return o.jsxs("div", { ref: P, className: `h-full w-full flex flex-col relative${wt ? " toc-titles-wrap" : ""}`, style: { "--md-catalog-width": `${tt}px`, ...Qr }, children: [(nt == null ? void 0 : nt.webfontCss) ? o.jsx("style", { "data-s3haim-document-webfonts": "1", children: nt.webfontCss }) : null, Je && po.createPortal(o.jsx(_s, { handleProps: Xr, isResizing: Gr, visibleOnHover: true, label: "TOC resize handle", style: { position: "fixed", top: Je.top, left: Je.left, height: Je.height, bottom: "auto", zIndex: 10003 } }), document.body), x && o.jsxs("div", { className: "absolute top-0 left-0 right-0 bottom-0 z-10 flex items-center justify-center gap-2 py-2 text-sm bg-blue-300/40 dark:bg-blue-800/50 text-blue-700 dark:text-blue-300 border-b border-blue-500/20", "aria-live": "polite", children: [o.jsx(gi, { size: 16, className: "animate-spin shrink-0" }), o.jsxs("span", { children: ["Uploading image... ", Math.max(0, Math.min(100, Math.round(k))), "%"] }), typeof w == "function" && o.jsx("button", { type: "button", onClick: w, className: "ml-2 rounded-md border border-blue-600/50 bg-white/80 px-2 py-1 text-xs font-medium text-blue-800 hover:bg-white dark:border-blue-300/40 dark:bg-blue-950/60 dark:text-blue-100 dark:hover:bg-blue-950", children: "Cancel" })] }), o.jsx(So, { ref: h, id: K, modelValue: e, onChange: B, mdHeadingId: $, className: "h-full! max-h-dvh", theme: r, language: "ko-KR", codeTheme: Os, customIcon: Bs, previewOnly: s, noMermaid: true, autoDetectCode: true, scrollAuto: false, footers: ["markdownTotal"], toolbars: ao, defToolbars: io, onUploadImg: co }, `footnotes-${ue}`), o.jsx(Mi, { containerRef: P }), o.jsx(Ai, { containerRef: P }), o.jsx(Hi, { isOpen: !!I, onClose: () => se(null), path: (I == null ? void 0 : I.key) ?? "", kind: (I == null ? void 0 : I.kind) ?? "wiki", initialWidth: (I == null ? void 0 : I.width) ?? "", initialHeight: (I == null ? void 0 : I.height) ?? "", imageSrc: (I == null ? void 0 : I.imageSrc) ?? "", onApply: Zr, onStartFreeTransform: no, onCrop: Jr, onConvertToWiki: eo, onConvertToImgbb: to }, I ? `${I.kind}|${I.key}|${I.width ?? ""}|${I.height ?? ""}|${I.occurrence ?? 0}` : "wiki-image-size-modal"), o.jsx(ya, { isOpen: ye, onClose: () => Me(false), onConfirm: ({ desc: a, url: c }) => {
    Be(`![${a || ""}](${c})
`);
  } }), o.jsx(va, { isOpen: Xe, onClose: () => ve(false), onConfirm: ({ line1: a, line2: c }) => {
    var _a3, _b2, _c2, _d, _e2;
    const f = (_c2 = (_b2 = ((_a3 = h.current) == null ? void 0 : _a3.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2), p = (f == null ? void 0 : f.state.doc.toString()) ?? J.current ?? "", { from: b, to: g } = Qe.current, v = Vs(p, b, g, a, c);
    f && (f.dispatch({ changes: { from: 0, to: f.state.doc.length, insert: v.next }, selection: { anchor: v.caret }, scrollIntoView: true }), (_d = f.focus) == null ? void 0 : _d.call(f)), (_e2 = Fe.current) == null ? void 0 : _e2.call(Fe, v.next);
  } }), o.jsx(ka, { isOpen: !!Qt, file: Qt, onClose: () => Ze(null), onConfirm: so }), o.jsx(Pi, { isOpen: te.isOpen, initialMeta: ((_a2 = te.editState) == null ? void 0 : _a2.meta) ?? null, initialGrid: ((_b = te.editState) == null ? void 0 : _b.grid) ?? { rows: [[""]], aligns: [null] }, onClose: te.close, onSave: te.apply }), o.jsx(Di, { containerRef: P, getMarkdown: () => J.current ?? "", setMarkdown: (a) => {
    typeof B == "function" ? B(a) : typeof t == "function" && t(a);
  }, onEditTable: (a, c) => De.current(a, c), onEditFailed: () => {
    D({ title: "? ??", message: "? ?? ???? ?? ?? ?????. ??? ??? ??? ??? ???." });
  } }), o.jsx(Ii, { containerRef: P, getMarkdown: () => J.current ?? "", setMarkdown: (a) => {
  ...
  }, onCancel: () => xt(false) }), o.jsx(pn, { isOpen: qr, title: "Save transform", message: "How would you like to handle the current transform?", confirmLabel: "Apply", cancelLabel: "Keep editing", discardLabel: "Reset transform", onConfirm: ro, onCancel: () => ke(false), onDiscard: oo }), o.jsx(pa, { isOpen: Ne, markdown: e, selectedMarkdown: (je == null ? void 0 : je.text) ?? "", onClose: () => {
    he(false), Ie(null);
  }, onApply: (a, c) => {
    if (c === "selection" && je) {
      const { from: d, to: f } = je, p = J.current ?? e, b = `${p.slice(0, d)}${a}${p.slice(f)}`;
      b !== p && B(b);
    } else a !== e && B(a);
    he(false), Ie(null);
  } }), o.jsx(na, { editorRef: h, onChange: B, open: C, onOpenChange: O })] });
}
export {
  Bl as default
};
