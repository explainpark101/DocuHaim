...
import { ek as N, ga as Z, gb as Y, gc as ee, e4 as te, fd as re, gd as v, fb as ne, fc as se, __tla as __tla_1 } from "./index-C76l_n0j.js";
import { _ as oe, __tla as __tla_2 } from "./vendor-md-editor-CyUZNHY0.js";
import { v as O, aq as $ } from "./vendor-lucide-BWX_GyjE.js";
...
`) : t || "Gemini API \uB124\uD2B8\uC6CC\uD06C \uC624\uB958";
  ...
  function Ee() {
    L || !N() || (L = true, globalThis.fetch = async (e, t) => {
      var _a;
      const r = ye(e);
  ...
  async function Se(e, t) {
    ...
    if (N()) {
      const { invoke: s } = await oe(async () => {
        const { invoke: i } = await import("./index-C76l_n0j.js").then(async (m) => {
          await m.__tla;
          return m;
        }).then((c) => c.gt);
        return {
  ...
  Je = async function({ apiKey: e, model: t, instruction: r, selectedText: n, images: s }) {
    const o = (t || Z()).trim() || Y, a = (r || "").trim(), i = (n || "").trim(), c = Array.isArray(s) ? s.filter((d) => (d == null ? void 0 : d.mimeType) && (d == null ? void 0 : d.dataBase64)) : [];
...
`).trim();
  ...
  async function De(e) {
    ...
    for (; ; ) try {
      ...
      const n = r;
      if (!((n == null ? void 0 : n.status) === 429 && t < Le && n.retryAfterSec && n.retryAfterSec <= 120)) throw r;
  ...
  Qe = function({ getGeminiApiKey: e, profileId: t = "gemini", value: r, onChange: n, autoLoad: s = false, className: o = "" }) {
    var _a;
    const a = p.useRef(e);
    a.current = e;
    const i = p.useRef(r);
    ...
    const [c, l] = p.useState(() => S(v, r)), [d, h] = p.useState(false), [y, b] = p.useState(""), f = p.useCallback(async ({ force: m = false } = {}) => {
      var _a2;
      const w = a.current;
      ...
      try {
        ...
        const M = await k;
        j = M, T = x, l(S(M, i.current));
      } catch (k) {
        b((k == null ? void 0 : k.message) || "\uBAA8\uB378 \uBAA9\uB85D\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."), l(S(v, i.current));
      } finally {
