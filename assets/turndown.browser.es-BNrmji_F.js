import{eX as p,eZ as F}from"./index-BM_2Ridh.js";function fe(e){if(p("collect:incoming",{hasData:!!e,filesLength:e?.files?.length??0,itemsLength:e?.items?.length??0}),!e)return p("collect:result",{count:0,reason:"no data"}),[];const r=[],t=new Set,n=i=>{if(!i||!i.size)return;const a=String(i.size);t.has(a)||(t.add(a),r.push(i))};if(e.files?.length)for(const i of e.files)i&&(i.type?.startsWith("image/")||!i.type&&i.size>0)&&n(i);if(e.items)for(const i of e.items){if(i.kind!=="file")continue;const a=i.type||"";if(a.startsWith("image/")||a===""){const s=i.getAsFile();s&&n(s)}}return p("collect:result",{count:r.length,files:F(r)}),r}function $(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e}function v(e,r){return Array(r+1).join(e)}function b(e){return e.replace(/^\n*/,"")}function S(e){for(var r=e.length;r>0&&e[r-1]===`
`;)r--;return e.substring(0,r)}function O(e){return S(b(e))}var V=["ADDRESS","ARTICLE","ASIDE","AUDIO","BLOCKQUOTE","BODY","CANVAS","CENTER","DD","DIR","DIV","DL","DT","FIELDSET","FIGCAPTION","FIGURE","FOOTER","FORM","FRAMESET","H1","H2","H3","H4","H5","H6","HEADER","HGROUP","HR","HTML","ISINDEX","LI","MAIN","MENU","NAV","NOFRAMES","NOSCRIPT","OL","OUTPUT","P","PRE","SECTION","TABLE","TBODY","TD","TFOOT","TH","THEAD","TR","UL"];function A(e){return N(e,V)}var w=["AREA","BASE","BR","COL","COMMAND","EMBED","HR","IMG","INPUT","KEYGEN","LINK","META","PARAM","SOURCE","TRACK","WBR"];function D(e){return N(e,w)}function W(e){return L(e,w)}var B=["A","TABLE","THEAD","TBODY","TFOOT","TH","TD","IFRAME","SCRIPT","AUDIO","VIDEO"];function U(e){return N(e,B)}function _(e){return L(e,B)}function N(e,r){return r.indexOf(e.nodeName)>=0}function L(e,r){return e.getElementsByTagName&&r.some(function(t){return e.getElementsByTagName(t).length})}var j=[[/\\/g,"\\\\"],[/\*/g,"\\*"],[/^-/g,"\\-"],[/^\+ /g,"\\+ "],[/^(=+)/g,"\\$1"],[/^(#{1,6}) /g,"\\$1 "],[/`/g,"\\`"],[/^~~~/g,"\\~~~"],[/\[/g,"\\["],[/\]/g,"\\]"],[/^>/g,"\\>"],[/_/g,"\\_"],[/^(\d+)\. /g,"$1\\. "]];function P(e){return j.reduce(function(r,t){return r.replace(t[0],t[1])},e)}var o={};o.paragraph={filter:"p",replacement:function(e){return`
