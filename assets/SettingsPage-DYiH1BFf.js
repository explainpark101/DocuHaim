                          ...
                          onClick: async () => {
                            try {
                              const { createWebdavBackend: d } = await hr(async () => {
                                const { createWebdavBackend: Q } = await import("./index-fzELaopj.js").then(async (m2) => {
                                  await m2.__tla;
                                  return m2;
                                }).then(($e) => $e.gY);
                                return {
