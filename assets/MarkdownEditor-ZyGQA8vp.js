...
import { A as ho, B as Bt, S as er, l as Ke, D as tr, F as rn, W as go, G as nr, H as Ye, J as Se, M as rr, j as Ot, V as Vt, O as or, m as ce, P as xo, Q as bo, R as wo, T as yo, U as vo, X as kt, Y as on, Z as ko, $ as Eo, c as So, a0 as Co, a1 as sr, v as No, a2 as jo, a3 as Mo, K as Lo, a4 as To, a5 as Ro, a6 as Ao, a7 as Po, a8 as Do, a9 as Io, aa as Fo, ab as $o, ac as Ho, ad as _o, ae as Bo, af as Oo, ag as Vo, ah as Ko, ai as zo, aj as qo, ak as Wo, al as Yo, am as Uo, an as Go, ao as Xo } from "./vendor-md-editor-C-U1NHmY.js";
import { b0 as Le, c$ as sn, d0 as Qo, al as ir, am as ar, d1 as an, d2 as Zo, a7 as mt, ah as Jo, d3 as cn, D as ln, d4 as es, d5 as ts, d6 as ns, d7 as dn, d8 as cr, d9 as rs, da as os, db as ss, dc as is, dd as as, de as lr, df as cs, dg as Kt, ab as zt, dh as ls, di as ds, dj as us, dk as fs, dl as ms, dm as ps, dn as dr, dp as Ve, dq as hs, dr as gs, ds as xs, dt as bs, du as ws, dv as ur, dw as ys, dx as vs, dy as un, dz as ks, dA as Es, A as Ss, dB as Cs, dC as st, dD as Ns, dE as js, dF as Oe, dG as Ms, dH as Ls, dI as Ts, cw as fn, ap as Et, dJ as St, aq as Rs, dK as mn, dL as As, ar as Ps, as as Ds, ad as Is, at as Fs, an as $s, ao as Hs, T as _s, M as Bs, dM as Os, dN as Vs, aP as pn, dO as Ks, dP as Ct, dQ as Nt, dR as hn, dS as gn, dT as jt, dU as xn, dV as zs, dW as bn, dX as wn, aY as qs, dY as Ws, av as Ys, dZ as Us, d_ as Gs, d$ as Xs, e0 as Qs, e1 as Zs, e2 as yn, e3 as be, e4 as Js, e5 as Mt, e6 as Lt, co as ei } from "./index-CuHXzZuT.js";
import { S as ti, ac as ni, ad as vn, ae as Tt, af as Rt, ag as ri, c as oi, ah as qt, ai as si, a9 as fr, aj as ii, a4 as ai, X as Wt, y as ci, ak as li, al as di, k as Yt, am as ui, an as fi, a0 as mi, ao as pi, D as hi, L as gi } from "./vendor-lucide-DdPeoGTf.js";
import { b as xi, M as At, N as Pt, U as bi, V as wi, W as yi, X as vi, Y as ki, Z as Ei, _ as Si, $ as Ci, a0 as Ni, a1 as ji, S as mr, g as pr, d as kn, T as En, e as Sn, f as Cn, A as Nn } from "./vendor-radix-BByUieSb.js";
import { M as Mi } from "./MdEditorToolbarTooltips-CFY0OXHg.js";
import { C as Li, u as Ti, b as Ri, P as Ai, T as Pi, a as Di, H as Ii } from "./previewFootnoteScroll-BW-3CAsk.js";
import { N as Fi, u as $i, W as Hi } from "./useTocTitleWrap-qvt0i5x8.js";
import { a as pt } from "./vendor-motion-b8oTnHK_.js";
import { c as _i } from "./clipboardImageFiles-D1SRdJ-P.js";
import { u as Bi } from "./useWikiImageHydration-ENyyPXzY.js";
  ...
  for (let t = 0; t < 8; t += 1) {
    ...
    for (; s && !i; ) {
      if (s instanceof HTMLElement && (s.classList.contains(Mn) || s.hasAttribute("hidden"))) {
        ...
        for (; f; ) {
          if (f instanceof HTMLElement && f.classList.contains(zi)) {
...
function Zi({ markdown: e = "", onMarkdownChange: t }) {
  const [n, r] = l.useState(""), [i, s] = l.useState("all"), [u, f] = l.useState({}), [x, k] = l.useState("dashboard"), w = l.useMemo(() => Xi(e), [e]);
  l.useEffect(() => {
    const E = {};
...
function na({ editorRef: e, onChange: t, open: n, onOpenChange: r }) {
  const [i, s] = l.useState(() => Ji()), [u, f] = l.useState(""), [x, k] = l.useState({ from: 0, to: 0 }), w = l.useRef({ active: false, startX: 0, startY: 0, startLeftVw: 0, startTopVh: 0 }), A = l.useCallback(() => {
...
function An(e, t) {
  ...
  for (let i = 1; i <= e.doc.lines; i += 1) {
    ...
    for (const u of Ma(s.text)) {
      ...
      n.push(rn.replace({ widget: new Ta(La(u.mime, x - f), f, x) }).range(f, x));
    }
  }
...
function bc(e, t = {}) {
  ...
  return Ir(e).forEach((s, u) => {
    ...
    const N = (E) => {
      s.classList.toggle(it, E), Ft(f, E), xc(A, !E);
    };
...
function zc({ currentFile: e, value: t, onChange: n, editorRef: r, enabled: i = true }) {
  const s = i ? Hc(e) : null, u = l.useRef([""]), f = l.useRef(0), x = l.useRef(null), k = l.useRef(false), w = l.useRef(null), A = l.useRef(null), N = l.useRef(t), L = l.useRef(false), E = l.useRef(null), T = l.useRef(0), F = l.useRef(t);
  N.current = t;
  ...
  return l.useEffect(() => {
    ...
    k.current || (F.current = $, L.current = true, n == null ? void 0 : n($), !(!i || !x.current) && (z(), w.current = setTimeout(() => {
      ...
      const h = x.current;
      if (!h) return;
      const P = Oc(u.current, f.current, $);
...
No({ editorConfig: { languageUserDefined: { "ko-KR": Lo }, renderDelay: ur() ? 500 : 0 }, codeMirrorExtensions(e, { keyBindings: t }) {
  const n = [...e].filter((s) => s.type !== "keymap" && s.type !== "linkShortener" && s.type !== "lineNumbers"), r = (t || []).filter((s) => {
    ...
    return u !== "mod-f" && u !== "ctrl-d" && u !== "mod-d" && f !== "cmd-d" && u !== "ctrl-b" && u !== "mod-b" && f !== "cmd-b" && u !== "ctrl-u" && u !== "mod-u" && f !== "cmd-u" && u !== "ctrl-o" && u !== "mod-o" && f !== "cmd-o" && u !== "ctrl-arrowup" && u !== "mod-arrowup" && f !== "cmd-arrowup" && u !== "ctrl-arrowdown" && u !== "mod-arrowdown" && f !== "cmd-arrowdown" && !/^ctrl-[0-9]$/.test(u) && !/^mod-[0-9]$/.test(u) && !/^cmd-[0-9]$/.test(f);
...
`;
  ...
  l.useEffect(() => {
    ...
    return Es({ getMarkdown: () => {
      ...
      c();
      const p = a(), b = (p == null ? void 0 : p.state.doc.toString()) ?? J.current ?? "", g = p == null ? void 0 : p.state.selection.main, v = Js(b, (g == null ? void 0 : g.from) ?? 0, (g == null ? void 0 : g.to) ?? 0, m);
      d(v.next, v.caret);
    }, openCompose: () => {
      var _a3;
      c();
  ...
  l.useEffect(() => {
    ...
    const m = Ic({ getPreviewRoot: c, getView: d });
    Z.current = m, (_d = U.current) == null ? void 0 : _d.stop(), U.current = null, oe ? U.current = Mc({ getPreviewRoot: c, getView: d }) : Lt();
    const p = Ec((b, g) => {
      var _a4;
      const v = d();
...
`), V = ((_c2 = (_b2 = ((_a4 = h.current) == null ? void 0 : _a4.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2)) ?? v;
        ...
        var _a4;
        if (!m) return;
        if (!m.composing && wl(d) && Kr(m) || !m.composing && zr(m, d)) return d.preventDefault(), d.stopPropagation(), true;
        const p = Zn(d);
        if (!p) return;
        if (p === "mod+shift+enter") return d.preventDefault(), d.stopPropagation(), bl(m), false;
        if (p === "mod+s") return;
  ...
  const Zr = l.useCallback(({ width: a, height: c }) => {
    ...
    const p = c.kind === "wiki" ? Rs(e, { path: c.key, occurrence: c.occurrence ?? 0, nextPath: m }) : mn(e, { src: c.key, occurrence: c.occurrence ?? 0, nextPath: m });
    ...
    const m = await As({ markdownSrc: d.key, displaySrc: d.imageSrc, currentNotePath: (i == null ? void 0 : i.id) ?? null });
    let p = "";
    ...
    const g = (await Ds({ apiKey: m, image: p, name: Is(d.key) ? "image" : void 0 })).url, v = d.occurrence ?? 0;
    let j = e;
...
`);
    ...
    var _a3, _b2, _c2, _d, _e2;
    const m = (_c2 = (_b2 = ((_a3 = h.current) == null ? void 0 : _a3.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2), p = (m == null ? void 0 : m.state.doc.toString()) ?? J.current ?? "", { from: b, to: g } = Qe.current, v = Vs(p, b, g, a, c);
