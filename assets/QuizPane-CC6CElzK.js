...
import { e7 as Je, e8 as Pt, e9 as dn, ea as un, b6 as hr, A as ct, T as At, eb as gr, D as F, dM as Ko, ec as Vo, ed as Xo, ee as Zo, ef as ns, eg as ss, eh as br, a7 as rs, d5 as xn, ei as Yo, ej as ei, aP as Jn, ca as ti, ek as ni, el as Hn, em as Qn, en as si, eo as Ze, ep as ri, eq as oi, er as kr, es as wr, et as Kn, eu as ii, ev as Vn, ew as zt, ex as ai, ey as $e, ez as li, eA as it, eB as os, eC as is, eD as yr, eE as vr, eF as Sr, eG as jr, eH as Cr, eI as ci, eJ as Nr, eK as $r, eL as Ct, eM as di, eN as Tn, eO as ui, eP as fi, eQ as mi, eR as pi, eS as Gs, eT as xi, eU as Xn, eV as hi, eW as Ws, eX as gi, eY as Zn, eZ as wt, e_ as bi, e$ as yt, f0 as $t, f1 as Nt, f2 as ki, f3 as wi, f4 as Kt, f5 as yi, U as sn, f6 as rn, f7 as on, f8 as vi, V as an, bS as Si, dt as ji, ds as Ci, f9 as Ni, fa as $i, fb as vt, fc as _n, fd as Pi, fe as zi, ff as Ei, fg as Ii, fh as Ri, fi as Mi, fj as Ai, fk as Li, fl as Oi, fm as Qi, fn as Ti, fo as _i } from "./index-CuHXzZuT.js";
import { X as Be, L as hn, ap as as, k as Pr, aq as Et, aj as Di, S as Qe, ai as Js, a9 as Yn, x as Fi, ar as Hs, as as Bi, at as qi, a8 as Ui, au as Gi, a4 as Wi, av as gn, aw as zr, ax as Er, ay as Ji, az as Ir, E as Hi, aA as Ki, b as Vi, t as Rr, aB as Xi, aC as Zi, a3 as Ks, aD as Yi } from "./vendor-lucide-DdPeoGTf.js";
import { b as It, a2 as ea, a3 as ta, d as Ie, T as Re, e as Me, f as Ae, A as Le, M as na, N as sa, S as ra, g as oa, w as ia, x as aa, y as la, z as ca, B as Vs } from "./vendor-radix-BByUieSb.js";
import { ap as da, v as ua, K as fa } from "./vendor-md-editor-C-U1NHmY.js";
import { u as ma } from "./preview-zKyBjQ54.js";
import { u as pa } from "./useWikiImageHydration-ENyyPXzY.js";
...
function xa({ value: e, children: n }) {
  return t.jsx(Mr.Provider, { value: e, children: n });
}
function ha() {
  return i.useContext(Mr);
}
function Te(e, n = 4) {
...
const Or = [0.32, 0.72, 0, 1], ga = { duration: 0 };
function ba(e) {
  return e ? { type: "spring", stiffness: 380, damping: 36 } : { type: "tween", duration: 0.22, ease: Or };
}
const ka = hr() ? { type: "tween", duration: 0.2, ease: Or } : { type: "spring", stiffness: 420, damping: 34 };
function wa(e, n = {}) {
  const { isResizing: s = false, edge: r = "right" } = n, o = n.useLayoutWidthAnim ?? dn(), a = s ? ga : ba(o);
...
function Lt({ motionKey: e, open: n, width: s, isResizing: r = false, edge: o = "right", className: a, "aria-label": c, children: f }) {
  const u = Lr(), d = wa(s, { isResizing: r, edge: o, useLayoutWidthAnim: u });
...
function $a({ open: e, question: n, defaultChoiceCount: s, busy: r = false, onClose: o, onSubmit: a }) {
  const [c, f] = i.useState("choice"), [u, d] = i.useState(s), [x, m] = i.useState(""), { width: h, handleProps: w, isResizing: v } = ct({ storageKey: "quiz-derived-question-dock-width", defaultWidth: Sa, minWidth: 280, maxWidth: 560, edge: "right" }), y = i.useMemo(() => n ? Te(n, s) : s, [s, n]);
  i.useEffect(() => {
    e && (f(Na(n)), d(y), m(""));
  }, [e, n, y]);
...
function Qr({ paths: e, onRemove: n, onOpenPicker: s, onPreview: r, isPathEnabled: o, onToggleEnabled: a, label: c = "\uADFC\uAC70 \uBB38\uC11C", emptyHint: f = "\uC120\uD0DD\uB41C \uADFC\uAC70 \uBB38\uC11C \uC5C6\uC74C", layout: u = "chips" }) {
  ...
  return t.jsx(It, { delayDuration: 250, skipDelayDuration: 0, children: t.jsxs("div", { className: "space-y-1.5", children: [t.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [t.jsx("span", { className: "text-xs font-semibold text-gray-700 dark:text-odp-fgStrong", children: c }), s ? t.jsx(F, { type: "button", variant: "secondary", size: "sm", onClick: s, children: "\uC120\uD0DD" }) : null] }), e.length === 0 ? t.jsx("p", { className: "text-[11px] text-gray-500 dark:text-odp-muted", children: f }) : t.jsx("ul", { className: d ? "flex flex-col gap-1.5" : "flex flex-wrap gap-1.5", children: e.map((m) => {
    const h = o ? o(m) : true, w = d ? `${Ea}${h ? "" : " opacity-70"}` : Ia;
    return t.jsxs("li", { className: w, children: [x ? t.jsx(ea, { className: Ra, checked: h, onCheckedChange: (v) => a == null ? void 0 : a(m, v === true), "aria-label": `${m} ${h ? "\uC0AC\uC6A9 \uC911" : "\uC0AC\uC6A9 \uC548 \uD568"}`, children: t.jsx(ta, { className: "text-white", children: t.jsx(Pr, { size: 10, strokeWidth: 3 }) }) }) : null, t.jsx(Ma, { path: m, isDock: d, onPreview: r, muted: x && !h }), n ? t.jsx("button", { type: "button", "aria-label": `${m} \uC81C\uAC70`, className: d ? "ml-auto shrink-0 rounded-md p-1.5 hover:bg-violet-200/80 dark:hover:bg-violet-900" : "shrink-0 rounded p-0.5 hover:bg-violet-200/80 dark:hover:bg-violet-900", onClick: () => n(m), children: t.jsx(Be, { size: d ? 14 : 12 }) }) : null] }, m);
  }) })] }) });
}
...
function Aa({ text: e, previewId: n, className: s = "", getPresignedUrl: r, currentNotePath: o }) {
  const a = ma(), c = i.useRef(null), f = i.useMemo(() => String(e || ""), [e]), u = ha(), d = r ?? u.getPresignedUrl, x = o ?? u.currentNotePath ?? null;
...
`);
  ...
  let d = 1, x;
  const m = [];
  let h = "choice", w, v, y = false, z = false, N = false;
  for (const T of r) {
    ...
    if (J) {
      a = (J[1] || "").trim(), o = a;
      const P = Qa((J[2] || "").trim());
      h = P.kind, w = P.answerStyle, c = P.question, y = true, z = true, N = false;
      continue;
    }
    if (!y) continue;
    if (N) {
    ...
    if (z) {
      ...
      if (qa(O)) z = false;
      else if (h === "subjective" && Ua(O)) z = false;
...
function Xt(e, n) {
  return (n == null ? void 0 : n.sourcePaths) && n.sourcePaths.length > 0 ? [...n.sourcePaths] : br(e);
}
function es(e) {
  let n = 0;
  for (const s of e) {
...
function Va({ isOpen: e, onClose: n, styleTemplate: s, initial: r, nextLabel: o, onSubmit: a, onOpenSourcePicker: c, onFixWithAi: f }) {
  ...
  i.useEffect(() => {
    ...
    if (r) {
      ...
      x(r.kind), h(r.answerStyle === "essay" ? "essay" : "short"), v(A), z(r.question || ""), j(Ye(r.options || [], A)), $(r.answer || 1), S(r.modelAnswer || ""), M(r.point || ""), T(r.explanation || ""), _(r.sourcePaths || []);
    } else x(s.kind), h(s.answerStyle), v(s.choiceCount), z(""), j(Ye([], s.choiceCount)), $(1), S(""), M(""), T(""), _([]);
    Q(false), D(""), V("");
  }, [e, r, s]);
  const Y = i.useMemo(() => {
    ...
    if (!(!f || te)) {
      ...
      try {
        ...
        if (!A) return;
        const q = Ka(A, w);
        x(q.kind), h(q.answerStyle), v(q.choiceCount), z(q.question), j(q.options), $(q.answer), S(q.modelAnswer), M(q.point), T(q.explanation), Q(false);
      } catch (A) {
  ...
  return t.jsx(rs, { isOpen: e, onClose: n, contentClassName: "quiz-pane max-w-2xl max-h-[90vh]", children: t.jsxs("div", { className: "flex max-h-[min(80vh,720px)] flex-col gap-3 overflow-y-auto p-4 text-sm", children: [t.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-2", children: [t.jsx("h2", { className: "text-base font-bold text-gray-900 dark:text-odp-fgStrong", children: u ? "\uBB38\uC81C \uC218\uC815" : "\uBB38\uC81C \uCD94\uAC00" }), u && f ? t.jsxs(F, { type: "button", variant: P ? "primary" : "secondary", size: "sm", "aria-pressed": P, disabled: te, onClick: () => Q((A) => !A), children: [t.jsx(Et, { size: 14 }), "\uBB38\uC81C \uACE0\uCE58\uAE30"] }) : null] }), u && P && f ? t.jsxs("div", { className: "space-y-2 rounded-xl border border-violet-200 bg-violet-50/80 p-3 dark:border-violet-900/60 dark:bg-violet-950/25", children: [t.jsx("p", { className: "text-xs text-violet-900 dark:text-violet-100", children: "\uD604\uC7AC \uBB38\uD56D\uC744 \uBD88\uC644\uC804\uD558\uAC70\uB098 \uC624\uB958\uAC00 \uC788\uB294 \uAC83\uC73C\uB85C \uBCF4\uACE0 AI\uAC00 \uAD50\uC815\uD569\uB2C8\uB2E4. \uC694\uAD6C\uC0AC\uD56D\uC744 \uC801\uC73C\uBA74 \uBB38\uD56D \uBC29\uD5A5\xB7\uC8FC\uC81C\xB7\uB09C\uC774\uB3C4\uB97C \uC870\uC815\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4." }), t.jsxs("label", { className: "block space-y-1", children: [t.jsx("span", { className: "text-xs font-semibold text-violet-900 dark:text-violet-100", children: "\uC218\uC815 \uC694\uAD6C\uC0AC\uD56D (\uC120\uD0DD)" }), t.jsx("textarea", { className: "min-h-16 w-full rounded-lg border border-violet-200 bg-white p-2 text-xs dark:border-violet-800 dark:bg-odp-bgSoft", placeholder: "\uC608: \uACC4\uC0B0 \uACFC\uC815\uC744 \uB2E8\uC21C\uD654\uD558\uACE0, \uC624\uB2F5 \uBCF4\uAE30\uB97C \uB354 \uADF8\uB7F4\uB4EF\uD558\uAC8C \uBC14\uAFD4 \uC8FC\uC138\uC694.", value: W, onChange: (A) => D(A.target.value), disabled: te })] }), t.jsx("div", { className: "flex justify-end", children: t.jsxs(F, { type: "button", variant: "primary", size: "sm", disabled: te, onClick: () => {
    se();
  }, children: [te ? t.jsx(hn, { size: 14, className: "animate-spin", "aria-hidden": true }) : t.jsx(Et, { size: 14 }), te ? "\uACE0\uCE58\uB294 \uC911\u2026" : "AI\uB85C \uACE0\uCE58\uAE30"] }) })] }) : null, t.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [[["choice", "\uAC1D\uAD00\uC2DD"], ["subjective-short", "\uB2E8\uB2F5\uD615"], ["subjective-essay", "\uC11C\uC220\uD615"]].map(([A, q]) => {
    ...
    return t.jsx("button", { type: "button", className: `rounded-lg border px-3 py-1.5 text-xs font-semibold ${ce ? "border-blue-500 bg-blue-50 text-blue-800 dark:bg-blue-950/40 dark:text-blue-100" : "border-gray-200 bg-white text-gray-700 dark:border-odp-borderSoft dark:bg-odp-surface dark:text-odp-fg"}`, onClick: () => {
      A === "choice" ? x("choice") : (x("subjective"), h(A === "subjective-short" ? "short" : "essay"));
    }, children: q }, A);
...
function el({ isOpen: e, onClose: n, current: s, onApply: r }) {
  const [o, a] = i.useState(""), [c, f] = i.useState("append"), [u, d] = i.useState(""), [x, m] = i.useState(false), h = (v = false) => {
    const y = ot(o);
...
function tl({ isOpen: e, onClose: n, tree: s, selected: r, excludePath: o, onConfirm: a, onExpandFolder: c, onDropHostChange: f, onRegisterDropPathsMerge: u }) {
  const [d, x] = i.useState(r), [m, h] = i.useState(""), w = i.useMemo(() => Array.isArray(s) ? s : [], [s]);
  i.useEffect(() => {
    e && x(r);
  }, [e, r]);
  ...
  return t.jsx(rs, { isOpen: e, onClose: n, contentClassName: "quiz-pane max-w-lg max-h-[90vh]", children: t.jsxs("div", { className: "flex max-h-[min(75vh,640px)] flex-col gap-3 p-4 text-sm", children: [t.jsx("h2", { className: "text-base font-bold text-gray-900 dark:text-odp-fgStrong", children: "\uADFC\uAC70 \uBB38\uC11C \uC120\uD0DD" }), t.jsx("p", { className: "text-xs text-gray-600 dark:text-odp-muted", children: "vault\uC758 `.md` \uD30C\uC77C\uC744 \uB2E4\uC911 \uC120\uD0DD\uD558\uAC70\uB098, \uC0AC\uC774\uB4DC\uBC14\uC5D0\uC11C \uB04C\uC5B4\uB2E4 \uB193\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4. (\uD604\uC7AC quiz \uD30C\uC77C\uC740 \uC81C\uC678)" }), m ? t.jsx("button", { type: "button", className: "text-left text-xs text-blue-600 hover:underline", onClick: () => {
    ...
    if (N.type === "folder") return t.jsx("li", { children: t.jsxs("button", { type: "button", className: "flex w-full items-center gap-2 rounded px-2 py-1.5 text-left text-xs hover:bg-gray-100 dark:hover:bg-odp-focusBg", onClick: async () => {
      await (c == null ? void 0 : c(N)), h(N.path.endsWith("/") ? N.path : `${N.path}/`);
...
function nl(e) {
  switch (e) {
    case "running":
      return t.jsx(hn, { size: 13, className: "animate-spin text-violet-600 dark:text-violet-300" });
    case "done":
      return t.jsx(Pr, { size: 13, className: "text-emerald-600 dark:text-emerald-400" });
    case "error":
...
function il({ jobs: e, isOpen: n, size: s, onClose: r, onResize: o, onRemoveJob: a, onClearFinished: c, onUserEngage: f, onPointerEngageChange: u, onFocusEngageChange: d }) {
  const x = i.useRef(null), [m, h] = i.useState({}), w = i.useRef({ mode: null, startX: 0, startY: 0, startW: 0, startH: 0 }), v = (k) => {
    h((S) => {
      const I = { ...S };
...
function fl(e, n) {
  const s = _r(e), r = String(s.id || s.name || `var${n + 1}`).trim();
  if (!r) return null;
  const o = String(s.description || s.label || r).trim() || r, a = ul(s.originalValue ?? s.value), c = Number(s.min), f = Number(s.max), u = Number.isFinite(c) ? c : 0, d = Number.isFinite(f) ? f : u, x = Number(s.step), m = Number.isFinite(x) && x > 0 ? x : 1, h = typeof s.unit == "string" && s.unit.trim() ? s.unit.trim() : void 0;
  return { id: r, description: o, originalValue: a, min: u, max: d, step: m, ...h ? { unit: h } : {} };
}
function Dr(e) {
  const n = _r(e), s = String(n.coreCategory || n.category || n.topic || "").trim() || "general concept", r = !!(n.isCalculation ?? n.isCalc ?? n.calculation), a = (Array.isArray(n.variables) ? n.variables : []).map((c, f) => fl(c, f)).filter((c) => c != null);
...
const pl = ["\uD575\uC2EC \uAC1C\uB150\uC744 \uD30C\uC545\uD558\uC138\uC694.", "\uBB38\uD56D \uD575\uC2EC \uC811\uADFC\uBC95\uC744 \uD655\uC778\uD558\uC138\uC694."], xl = ["\uD574\uC124\uC774 \uC81C\uACF5\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4."], hl = 12, gl = 24;
function dt(e) {
  const n = String(e || "").trim();
  return !n || n.length < hl ? true : pl.some((s) => n === s);
}
function ut(e) {
  const n = String(e || "").trim();
...
function Sl({ question: e, focusOption: n, onFocusOptionChange: s, wrongExps: r, busyKey: o, onOpenAnalysisDock: a }) {
  ...
  if (c <= 0) return null;
  const f = Ze(e.id, n), u = r[f], d = u !== void 0, x = o === f, m = n === e.answer, h = m ? "\uC815\uB2F5 \uBD84\uC11D" : "\uC624\uB2F5 \uBD84\uC11D", w = m ? "mt-3 rounded-xl border border-emerald-200 bg-emerald-50 p-3 text-xs text-emerald-950 dark:border-emerald-800/70 dark:bg-emerald-950/45 dark:text-emerald-100" : "mt-3 rounded-xl border border-rose-200 bg-rose-50 p-3 text-xs text-rose-950 dark:border-rose-800/70 dark:bg-rose-950/45 dark:text-rose-100", v = m ? "font-bold text-emerald-800 dark:text-emerald-200" : "font-bold text-rose-800 dark:text-rose-200", y = m ? "text-[11px] font-semibold text-emerald-700 dark:text-emerald-200" : "text-[11px] font-semibold text-rose-700 dark:text-rose-200", z = m ? "text-[11px] text-emerald-700/90 dark:text-emerald-200/80" : "text-[11px] text-rose-700/90 dark:text-rose-200/80", N = m ? "text-[10px] font-medium text-emerald-500 dark:text-emerald-300" : "text-[10px] font-medium text-rose-500 dark:text-rose-300", j = m ? "bg-emerald-500 dark:bg-emerald-300" : "bg-rose-500 dark:bg-rose-300", b = m ? "ring-emerald-50 dark:ring-emerald-950" : "ring-rose-50 dark:ring-rose-950";
  return t.jsxs("div", { className: w, children: [t.jsxs("div", { className: "mb-2 flex flex-wrap items-center justify-between gap-2", children: [t.jsx("div", { className: v, children: h }), t.jsx(na, { className: "flex flex-wrap items-center gap-1", value: String(n), onValueChange: ($) => {
...
function Pl({ scrollRootRef: e, questions: n, running: s, getElapsedMs: r, timeLog: o, onLogChange: a }) {
  const c = i.useRef(o), f = i.useRef(a), u = i.useRef(r), d = i.useRef(n), x = i.useRef(null), m = i.useRef(null), h = i.useRef(/* @__PURE__ */ new Map());
  ...
  const w = i.useCallback((j) => {
    ...
    let j = null, b = 0;
    for (const [$, k] of h.current) k > b && (b = k, j = $);
    return b >= $l ? j : null;
  }, []), z = i.useCallback((j) => {
  ...
  i.useEffect(() => {
    ...
    h.current = new Map([...h.current.entries()].filter(([S]) => b.has(S)));
    const $ = new IntersectionObserver((S) => {
      for (const I of S) {
        const M = I.target.getAttribute(ts);
        M && h.current.set(M, I.intersectionRatio);
      }
      z(y());
...
const rr = ts;
function zl({ question: e, userAnswer: n, isSubmitted: s, isQuestionGraded: r, subjectiveGrade: o, showExplanation: a, wrongExpsForQuestion: c, wrongExpFocusOption: f, questionMemo: u, busyId: d, examInProgress: x, isFresh: m, onClearFresh: h, onAnswerCommit: w, onSelectOption: v, onEditQuestion: y, onGradeChoice: z, onGradeSubjective: N, onRetry: j, onToggleExplanation: b, onSimilar: $, onDerived: k, onGenerateSections: S, onWrongExpFocusChange: I, onOpenAnalysisDock: M, onMemoSave: B }) {
  ...
  return m ? t.jsx(We.div, { id: `q-card-${e.id}`, [rr]: e.id, initial: { opacity: 0, y: 36, scale: 0.96 }, animate: { opacity: 1, y: 0, scale: 1 }, transition: { type: "spring", stiffness: 340, damping: 26 }, onAnimationComplete: h, className: oe, children: He }) : t.jsx("div", { id: `q-card-${e.id}`, [rr]: e.id, className: oe, children: He });
}
...
function Ql({ open: e, question: n, option: s, mode: r, existingAnalysis: o = "", llmProfiles: a, profileId: c, model: f, onProfileIdChange: u, onModelChange: d, busy: x, onClose: m, onGenerate: h }) {
...
function Ul(e, n) {
  ...
  return { markdown: wr(o, r, Kn), questions: r, config: o };
}
function Gl(e) {
...
function Zl(e) {
  try {
    localStorage.setItem(Wr, String(e));
  } catch {
  }
}
function Yl({ open: e, docConfig: n, sourcePathUsage: s, busyGenSources: r, onClose: o, onPreview: a, onRemove: c, onToggleEnabled: f, onOpenPicker: u, onGenerateFromTopic: d, onDropHostChange: x }) {
  const [m, h] = i.useState(Jr), { width: w, handleProps: v, isResizing: y } = ct({ storageKey: "quiz-sources-dock-width", defaultWidth: Hl, minWidth: 240, maxWidth: 520, edge: "right" }), z = i.useCallback((N) => {
    h(N), Zl(N);
  }, []);
  return t.jsx(Lt, { motionKey: "quiz-sources-dock", open: e, width: w, isResizing: y, "aria-label": "\uD30C\uC77C \uADFC\uAC70 \uBB38\uC11C", className: "flex h-full shrink-0 flex-col overflow-hidden border-l border-slate-200 bg-white shadow-lg dark:border-odp-borderSoft dark:bg-odp-surface", children: t.jsxs("div", { className: "relative flex h-full min-h-0 flex-col", style: { width: w }, children: [t.jsx(Kl, { edge: "left", handleProps: v, isResizing: y, visibleOnHover: true, label: "\uD30C\uC77C \uADFC\uAC70 \uD328\uB110 \uB108\uBE44 \uC870\uC808" }), t.jsxs("div", { className: "border-b border-slate-200 dark:border-odp-borderSoft", children: [t.jsxs("div", { className: "flex items-center justify-between px-3 py-2.5", children: [t.jsxs("div", { className: "flex min-w-0 items-center gap-1.5 text-sm font-bold text-slate-900 dark:text-odp-fgStrong", children: [t.jsx(Ir, { size: 16, className: "shrink-0 text-violet-600 dark:text-violet-400" }), t.jsx("span", { className: "truncate", children: "\uD30C\uC77C \uADFC\uAC70" }), s.total > 0 ? t.jsxs("span", { className: "ml-0.5 inline-flex shrink-0 items-baseline gap-0.5 rounded-md bg-violet-100 px-1.5 py-0.5 text-[11px] font-bold tabular-nums dark:bg-violet-950/70", "aria-label": `\uB4F1\uB85D ${s.total}\uAC1C \uC911 ${s.active}\uAC1C \uC0AC\uC6A9 \uC911`, children: [t.jsx("span", { className: "text-violet-600 dark:text-violet-400", children: s.active }), t.jsx("span", { className: "font-medium text-slate-400", children: "/" }), t.jsx("span", { className: "text-slate-700 dark:text-slate-200", children: s.total }), t.jsx("span", { className: "ml-0.5 text-[9px] font-semibold text-violet-700 dark:text-violet-300", children: "\uC0AC\uC6A9" })] }) : null] }), t.jsx("button", { type: "button", "aria-label": "\uADFC\uAC70 \uD328\uB110 \uB2EB\uAE30", className: "rounded p-1 hover:bg-slate-100 dark:hover:bg-odp-focusBg", onClick: o, children: t.jsx(Be, { size: 16 }) })] }), t.jsxs("div", { className: "flex items-center justify-between gap-3 px-3 pb-2.5", children: [t.jsx("label", { htmlFor: "quiz-source-remove-confirm", className: "text-[11px] font-medium text-slate-600 dark:text-odp-muted", children: "\uC0AD\uC81C \uC2DC \uD655\uC778" }), t.jsx(ra, { id: "quiz-source-remove-confirm", className: Vl(m), checked: m, onCheckedChange: z, "aria-label": "\uADFC\uAC70 \uBB38\uC11C \uC0AD\uC81C \uC2DC \uD655\uC778", children: t.jsx(oa, { className: Xl }) })] })] }), t.jsxs("div", { ref: x, className: "relative min-h-0 flex-1 space-y-4 overflow-y-auto p-3", children: [t.jsx(Qr, { layout: "dock", paths: n.sourcePaths, label: "\uC120\uD0DD\uB41C \uBB38\uC11C", onPreview: a, onRemove: c, isPathEnabled: (N) => ai(n, N), onToggleEnabled: f, onOpenPicker: u }), t.jsx(Dl, { disabled: r, onGenerate: d })] })] }) });
}
...
function oc({ path: e, onClose: n, loadDocument: s, onOpenDocument: r, onOpenInNewTab: o, embedded: a = false, width: c, resizeHandleProps: f, isResizing: u, resizeEdge: d = "right" }) {
  const [x, m] = i.useState(null), [h, w] = i.useState(true), [v, y] = i.useState(""), [z, N] = i.useState(false), [j, b] = i.useState(""), $ = ct({ storageKey: a ? void 0 : "vault-document-preview-panel-width", defaultWidth: 400, minWidth: 280, maxWidth: 640, edge: d === "left" ? "left" : "right" }), k = c ?? $.width, S = f ?? $.handleProps, I = u ?? $.isResizing;
  i.useEffect(() => {
    let O = false, _;
  ...
  return t.jsxs("aside", { className: `relative flex h-full flex-col overflow-hidden bg-white dark:bg-odp-surface ${a ? "min-w-0" : "shrink-0 border-r border-slate-200 dark:border-odp-borderSoft"}`, style: a ? void 0 : { width: k }, "aria-label": "\uBB38\uC11C \uBBF8\uB9AC\uBCF4\uAE30", children: [t.jsx(rc, { edge: d, handleProps: S, isResizing: I, visibleOnHover: true, label: "\uBBF8\uB9AC\uBCF4\uAE30 \uD328\uB110 \uB108\uBE44 \uC870\uC808" }), t.jsx("div", { className: "flex items-center gap-1 border-b border-slate-200 px-2 py-2 dark:border-odp-borderSoft", children: t.jsxs(It, { delayDuration: 250, skipDelayDuration: 0, children: [t.jsxs(Ie, { children: [t.jsx(Re, { asChild: true, children: t.jsx("div", { className: "min-w-0 flex-1 truncate px-1 text-xs font-semibold text-slate-800 dark:text-odp-fgStrong", children: B }) }), t.jsx(Me, { children: t.jsxs(Ae, { side: "bottom", sideOffset: 6, className: St, children: [e, t.jsx(Le, { className: "fill-white dark:fill-odp-surface" })] }) })] }), T ? t.jsxs(Ie, { children: [t.jsx(Re, { asChild: true, children: t.jsx("button", { type: "button", className: "shrink-0 rounded p-1.5 text-slate-600 hover:bg-slate-100 dark:text-odp-muted dark:hover:bg-odp-focusBg", "aria-label": z ? "\uBBF8\uB9AC\uBCF4\uAE30 \uBAA8\uB4DC" : "\uD3B8\uC9D1 \uBAA8\uB4DC", onClick: M, children: z ? t.jsx(Hi, { size: 15 }) : t.jsx(gn, { size: 15 }) }) }), t.jsx(Me, { children: t.jsxs(Ae, { side: "bottom", sideOffset: 6, className: St, children: [z ? "\uBBF8\uB9AC\uBCF4\uAE30 \uBAA8\uB4DC" : "\uD3B8\uC9D1 \uBAA8\uB4DC", t.jsx(Le, { className: "fill-white dark:fill-odp-surface" })] }) })] }) : null, o ? t.jsxs(Ie, { children: [t.jsx(Re, { asChild: true, children: t.jsx("button", { type: "button", className: "shrink-0 rounded p-1.5 text-slate-600 hover:bg-slate-100 dark:text-odp-muted dark:hover:bg-odp-focusBg", "aria-label": "\uC0C8 \uD0ED\uC73C\uB85C \uC5F4\uAE30", onClick: () => o(e), children: t.jsx(Ki, { size: 15 }) }) }), t.jsx(Me, { children: t.jsxs(Ae, { side: "bottom", sideOffset: 6, className: St, children: ["\uC0C8 \uD0ED\uC73C\uB85C \uC5F4\uAE30", t.jsx(Le, { className: "fill-white dark:fill-odp-surface" })] }) })] }) : null, r ? t.jsxs(Ie, { children: [t.jsx(Re, { asChild: true, children: t.jsx("button", { type: "button", className: "shrink-0 rounded p-1.5 text-slate-600 hover:bg-slate-100 dark:text-odp-muted dark:hover:bg-odp-focusBg", "aria-label": "\uC774 \uBB38\uC11C \uC5F4\uAE30", onClick: () => r(e), children: t.jsx(Vi, { size: 15 }) }) }), t.jsx(Me, { children: t.jsxs(Ae, { side: "bottom", sideOffset: 6, className: St, children: ["\uC774 \uBB38\uC11C \uC5F4\uAE30", t.jsx(Le, { className: "fill-white dark:fill-odp-surface" })] }) })] }) : null, t.jsxs(Ie, { children: [t.jsx(Re, { asChild: true, children: t.jsx("button", { type: "button", className: "shrink-0 rounded p-1.5 text-slate-600 hover:bg-slate-100 dark:text-odp-muted dark:hover:bg-odp-focusBg", "aria-label": "\uBBF8\uB9AC\uBCF4\uAE30 \uB2EB\uAE30", onClick: n, children: t.jsx(Be, { size: 15 }) }) }), t.jsx(Me, { children: t.jsxs(Ae, { side: "bottom", sideOffset: 6, className: St, children: ["\uB2EB\uAE30", t.jsx(Le, { className: "fill-white dark:fill-odp-surface" })] }) })] })] }) }), t.jsx("div", { className: "min-h-0 flex-1 overflow-y-auto", children: h ? t.jsxs("div", { className: "flex h-full items-center justify-center gap-2 p-6 text-xs text-slate-500 dark:text-odp-muted", children: [t.jsx(hn, { size: 16, className: "animate-spin", "aria-hidden": true }), "\uBD88\uB7EC\uC624\uB294 \uC911\u2026"] }) : v ? t.jsx("div", { className: "p-4 text-sm text-rose-600 dark:text-rose-400", children: v }) : x ? t.jsx(sc, { payload: x, editMode: z, editContent: j, onEditContentChange: b }) : null })] });
}
const ic = 400;
...
function uc(e) {
  ...
  const h = n.length, w = h > 0 && m > 0 ? Math.round(x / h * 100) : null;
  return { correct: c, wrong: f, partial: u, answered: d, total: h, scorePercent: w };
}
const fc = 288, mc = At, pc = ["ungraded", "correct", "partial", "wrong"], xc = { ungraded: "bg-slate-100 text-slate-700 ring-1 ring-slate-200 dark:bg-slate-800/60 dark:text-slate-200 dark:ring-slate-600", correct: "bg-emerald-50 text-emerald-800 ring-1 ring-emerald-200 dark:bg-emerald-950/40 dark:text-emerald-200 dark:ring-emerald-800", partial: "bg-amber-50 text-amber-900 ring-1 ring-amber-200 dark:bg-amber-950/40 dark:text-amber-200 dark:ring-amber-800", wrong: "bg-rose-50 text-rose-800 ring-1 ring-rose-200 dark:bg-rose-950/40 dark:text-rose-200 dark:ring-rose-800" }, hc = "bg-slate-100 text-slate-400 ring-1 ring-transparent dark:bg-odp-bgSoft dark:text-odp-muted";
function gc({ open: e, questions: n, userAnswers: s, gradedQuestions: r, isSubmitted: o, subjectiveGrades: a, onClose: c, onNavigate: f }) {
  const [u, d] = i.useState({ ungraded: true, correct: true, partial: true, wrong: true }), { width: x, handleProps: m, isResizing: h } = ct({ storageKey: "quiz-toc-dock-width", defaultWidth: fc, minWidth: 220, maxWidth: 480, edge: "right" }), w = i.useCallback((y) => {
    d((z) => ({ ...z, [y]: !z[y] }));
  }, []), v = Lr();
  return t.jsx(Lt, { motionKey: "quiz-toc-dock", open: e, width: x, isResizing: h, "aria-label": "\uBB38\uC81C \uBAA9\uCC28", className: "flex h-full shrink-0 flex-col overflow-hidden border-l border-slate-200 bg-white shadow-lg dark:border-odp-borderSoft dark:bg-odp-surface", children: t.jsxs("div", { className: "relative flex h-full min-h-0 flex-col", style: { width: x }, children: [t.jsx(mc, { edge: "left", handleProps: m, isResizing: h, visibleOnHover: true, label: "\uBAA9\uCC28 \uD328\uB110 \uB108\uBE44 \uC870\uC808" }), t.jsxs("div", { className: "border-b border-slate-200 dark:border-odp-borderSoft", children: [t.jsxs("div", { className: "flex items-center justify-between px-3 py-2.5", children: [t.jsxs("div", { className: "flex items-center gap-1.5 text-sm font-bold text-slate-900 dark:text-odp-fgStrong", children: [t.jsx(Rr, { size: 16, className: "text-slate-600 dark:text-odp-muted" }), "\uBB38\uC81C \uBAA9\uCC28"] }), t.jsx("button", { type: "button", "aria-label": "\uBAA9\uCC28 \uD328\uB110 \uB2EB\uAE30", className: "rounded p-1 hover:bg-slate-100 dark:hover:bg-odp-focusBg", onClick: c, children: t.jsx(Be, { size: 16 }) })] }), t.jsx("div", { className: "flex flex-wrap items-center gap-1 px-3 pb-2.5", children: pc.map((y) => {
    const z = u[y];
    return t.jsxs("button", { type: "button", "aria-pressed": z, "aria-label": `\uBAA9\uCC28 ${cr[y]} ${z ? "\uD45C\uC2DC" : "\uC228\uAE40"}`, className: `inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-semibold transition-colors ${z ? xc[y] : hc}`, onClick: () => w(y), children: [t.jsx("span", { className: `h-2 w-2 shrink-0 rounded-full ${z ? lr[y] : "bg-slate-300 dark:bg-slate-600"}`, "aria-hidden": true }), cr[y]] }, y);
...
async function bn(e) {
  const n = $e(), s = e.topK ?? n.ragTopK, r = e.maxChars ?? n.ragMaxChars, o = Kr(e.sourcePaths);
  if (o.length === 0) return { chunks: [], usedFallback: false };
  const a = await Hr(o, e.readText);
  if (a.length === 0) return { chunks: [], usedFallback: true };
  const c = kc(e.query), f = [];
  for (const x of a) li(x.text, 12e3).forEach((h, w) => {
    h.trim() && f.push({ path: x.path, excerpt: h, chunkIndex: w, score: wc(h, c) });
  });
...
async function yc(e, n, s) {
  const r = $e(), o = Math.max(4e3, s ?? Math.min(r.ragMaxChars, 2e5)), a = Kr(e);
  return a.length ? (await Hr(a, n)).map((f) => ({ path: f.path, text: f.text.length > o ? `${f.text.slice(0, o)}
...
function $c(e) {
  const s = Vr(e).replace(/\.quiz\.md$/i, "");
  return s ? `${dr}/${s}` : dr;
}
function Pc(e) {
...
async function Se(e) {
  ...
  if (e.signal && (u.signal = e.signal), e.onChunk && (u.onChunk = e.onChunk), r.kind === Nr) {
  ...
  if (r.kind === jr) {
    const d = Cr(), x = await ui(d, e.signal ? { signal: e.signal } : {}), m = (r.baseUrl || x.baseUrl || "").trim();
    if (!m) throw new Error("llama.cpp \uC11C\uBC84 URL\uC744 \uD655\uC778\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.");
    const h = o.trim() || d.selectedModelId || x.models[0] || "";
    if (!h) throw new Error("\uC0AC\uC6A9\uD560 \uBAA8\uB378\uC744 \uC120\uD0DD\uD558\uC138\uC694.");
    return Ct(r.id, h), Tn(r.id, () => r.apiKey || d.apiKey || "no-key-required", (w) => Gs(tn({ baseUrl: m, apiKey: w, model: h, instruction: c, systemPrompt: a, selectedText: "", requestOptions: f }, u)), { allowEmpty: true, missingKeyMessage: "llama.cpp API \uD0A4\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." });
  }
  if (r.kind === yr) {
    const d = vr(), x = await Sr(d);
...
${s.point || ""}`, readText: e.readText });
  ...
  const x = n.calcComplexity === "hand" ? "[\uACC4\uC0B0 \uB09C\uC774\uB3C4: \uC190\uC73C\uB85C \uACC4\uC0B0 \uAC00\uB2A5]" : "[\uACC4\uC0B0 \uB09C\uC774\uB3C4: \uACC4\uC0B0\uAE30 \uD544\uC218]", m = Ur({ question: s.question, options: a, answer: c, point: s.point || "", explanation: s.explanation || "", ...u ? { ragBlock: u } : {} }), h = Math.min(n.temperature, 0.6);
  f({ step: "analysis", status: "running", detail: "LLM \uBB38\uD56D \uBD84\uC11D \uC911\u2026", llmInstruction: m, systemPrompt: at });
  const w = await Se(je(e.profiles, m, at, h, Fe(e.signal))), v = Dr(De(w));
  ...
  const N = bl({ question: s.question, options: a, answer: c, point: s.point || "", explanation: s.explanation || "", choiceCount: r, targetAnswer: o, complexity: x, analysisBlock: y, sampledBlock: z, ...u ? { ragBlock: u } : {} }), j = qr(n.systemPrompt || $r);
  ...
  let k = Mt($, r, o);
  if (!mn(k)) {
    const S = dt(k.point), I = ut(k.explanation), M = Gr({ question: k.question, options: k.options || [], answer: k.answer || o, analysisBlock: y, missingPoint: S, missingExplanation: I });
...
`), { chunks: M } = await bn({ sourcePaths: x, query: I, readText: e.readText });
  ...
  const m = n.calcComplexity === "hand" ? "[\uACC4\uC0B0 \uB09C\uC774\uB3C4: \uC190\uC73C\uB85C \uACC4\uC0B0 \uAC00\uB2A5]" : "[\uACC4\uC0B0 \uB09C\uC774\uB3C4: \uACC4\uC0B0\uAE30 \uD544\uC218]", h = Ur({ question: s.question, options: c, answer: s.kind === "choice" ? f : 1, point: s.point || "", explanation: s.explanation || "", ...d ? { ragBlock: d } : {} }), w = Math.min(n.temperature, 0.6);
  u({ step: "analysis", status: "running", detail: "LLM \uBB38\uD56D \uBD84\uC11D \uC911\u2026", llmInstruction: h, systemPrompt: at });
  const v = await Se(je(e.profiles, h, at, w, Fe(e.signal))), y = Dr(De(v));
  u({ step: "analysis", status: "done", detail: `${y.coreCategory}${y.isCalculation ? " \xB7 \uACC4\uC0B0\uBB38\uC81C" : ""}`, llmInstruction: h, llmResponse: le(v), systemPrompt: at });
  const z = lt(y);
  let N = "";
  if (y.isCalculation && y.variables.length > 0) {
    u({ step: "randomize", status: "running", detail: "\uC218\uCE58 \uBCC0\uC218 \uC0D8\uD50C\uB9C1\u2026" });
    const I = Fr(y.variables);
    N = Br(I);
  ...
  const j = jc({ question: s.question, options: c, answer: s.kind === "choice" ? f : 1, point: s.point || "", explanation: s.explanation || "", sourceKind: s.kind, ...s.answerStyle ? { sourceAnswerStyle: s.answerStyle } : {}, target: e.target, complexity: m, analysisBlock: z, sampledBlock: N, ...e.target.kind === "choice" ? { targetAnswer: a } : {}, ...d ? { ragBlock: d } : {} }), b = Sc(n.systemPrompt || $r);
  ...
  if (e.target.kind === "subjective" ? S = { kind: "subjective", answerStyle: e.target.answerStyle === "essay" ? "essay" : "short", question: S.question, modelAnswer: S.modelAnswer || "", point: S.point, explanation: S.explanation, isGenerated: true } : S = { kind: "choice", question: S.question, options: Ye(S.options || [], o), answer: Math.min(o, Math.max(1, S.answer || a)), point: S.point, explanation: S.explanation, isGenerated: true }, !mn(S)) {
    const I = dt(S.point), M = ut(S.explanation), B = Gr({ question: S.question, options: S.kind === "choice" ? S.options || [] : [], answer: S.kind === "choice" && S.answer ? S.answer : a, analysisBlock: z, missingPoint: I, missingExplanation: M });
...
\uC704 \uBCF8\uBB38\uC744 \uC8FC\uC81C\uBCC4 \uB9C8\uD06C\uB2E4\uC6B4 \uC694\uC57D\uC73C\uB85C\uB9CC \uC791\uC131\uD558\uC138\uC694.`;
    u({ step: "summarize", status: "running", detail: k, llmInstruction: S, systemPrompt: en, ...h ? { llmResponse: h } : {} }), (_c2 = e.onProgress) == null ? void 0 : _c2.call(e, k);
    const I = await Se(je(e.profiles, S, en, Math.min(n.temperature, 0.7), Fe(e.signal))), M = String(I || "").trim();
    M && (m.push({ path: $.path, summary: M }), h += `### ${$.path}

${le(M, 24e3)}

---

`, u({ step: "summarize", status: "running", detail: k, llmInstruction: S, systemPrompt: en, llmResponse: h }));
  }
  if (!m.length) throw u({ step: "summarize", status: "error", error: "\uADFC\uAC70 \uBB38\uC11C \uC694\uC57D\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4." }), new Error("\uADFC\uAC70 \uBB38\uC11C \uC694\uC57D\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.");
  u({ step: "summarize", status: "done", detail: `${m.length}\uAC1C \uC694\uC57D \uC644\uB8CC`, llmResponse: le(h), systemPrompt: en }), (_d2 = e.onProgress) == null ? void 0 : _d2.call(e, "\uC694\uC57D\uBCF8\uC73C\uB85C \uBB38\uD56D \uC0DD\uC131 \uC911\u2026");
...
async function ed(e) {
  const n = $e(), s = e.question, r = Te(s, e.config.choiceCount || 4), o = (h) => {
    var _a2;
    return (_a2 = e.onStep) == null ? void 0 : _a2.call(e, h);
  ...
  if (f.length > 0 && e.readText) {
    ...
    const h = [s.question, s.point || "", String(e.userInstructions || "").trim()].filter(Boolean).join(`
`), { chunks: w } = await bn({ sourcePaths: f, query: h, readText: e.readText });
...
function cd(e) {
  ...
  const c = i.useCallback((d) => {
    const x = d.trim();
    s(x), hi(x);
    const m = it(e, x), h = m ? fr(e, m.id, null) : "";
    o(h), Ws({ profileId: x || null, modelId: h || null });
  }, [e]), f = i.useCallback((d) => {
    const x = d.trim();
...
function mr(e, n, s, r = 0) {
  ...
  return i.useEffect(() => {
    ...
    x();
    const m = e.current, h = typeof ResizeObserver < "u" && m != null ? new ResizeObserver(() => {
      x();
    }) : null;
    return m != null && (h == null ? void 0 : h.observe(m)), () => {
      cancelAnimationFrame(f), u == null ? void 0 : u.disconnect(), h == null ? void 0 : h.disconnect();
    };
  }, [s, r, e, n]), o;
}
function ud({ profiles: e, profileId: n, model: s, onProfileIdChange: r, onModelChange: o, busy: a = false }) {
  return t.jsxs("section", { "aria-label": "\uD034\uC988 AI \uC81C\uACF5\uC790", className: "rounded-2xl border border-slate-200 bg-white p-4 shadow-xs dark:border-odp-borderSoft dark:bg-odp-surface", children: [t.jsxs("div", { className: "mb-3 flex items-center gap-1.5 text-xs font-bold text-slate-800 dark:text-odp-fgStrong", children: [t.jsx(Xi, { size: 14, className: "shrink-0 text-violet-600 dark:text-violet-400", "aria-hidden": true }), "AI \uC81C\uACF5\uC790"] }), t.jsx(kr, { profiles: e, profileId: n, model: s, onProfileIdChange: r, onModelChange: o, disabled: a })] });
}
const fd = i.memo(ud);
function md(e) {
  return Xr(e).map((n) => n.id === "generate" ? { ...n, label: "\uD30C\uC0DD \uBB38\uD56D \uC0DD\uC131" } : n);
}
function Xr(e) {
  const n = [];
...
const Zr = "s3haim_quiz_gen_queue_panel_size", xd = 280, hd = 180, qn = 380, Un = 320;
function Yr(e) {
  const n = Math.min(window.innerWidth * 0.92, 720), s = Math.min(window.innerHeight * 0.72, 640);
  return { width: Math.min(n, Math.max(xd, Math.round(e.width))), height: Math.min(s, Math.max(hd, Math.round(e.height))) };
}
function gd() {
  try {
    const e = typeof window < "u" ? window.localStorage.getItem(Zr) : null;
    if (!e) return { width: qn, height: Un };
    const n = JSON.parse(e);
    return Yr({ width: Number(n.width) || qn, height: Number(n.height) || Un });
  } catch {
...
function bd(e) {
  try {
    typeof window < "u" && window.localStorage.setItem(Zr, JSON.stringify(e));
  } catch {
  }
}
function kd(e, n) {
...
function wd() {
  ...
  s.current = e;
  const [r, o] = i.useState(false), [a, c] = i.useState(() => gd()), f = i.useRef(false), u = i.useRef(false), d = i.useRef(false), x = i.useRef(0), m = i.useCallback((P) => {
    const Q = Yr(P);
    c(Q), bd(Q);
  }, []), h = i.useCallback(() => {
    f.current = true;
    ...
    const Q = Gn(), W = { id: Q, kind: "similar", questionLabel: P.displayLabel, questionPreview: nn(P.preview), status: "running", steps: Xr(P.hasRag), createdAt: Date.now() };
    return n((D) => [W, ...D]), j(), Q;
  }, [j]), k = i.useCallback((P) => {
  ...
  }, [N, y, e, r]), { jobs: e, panelOpen: r, panelSize: a, setPanelSize: m, openPanel: z, closePanel: N, setPanelOpen: o, markPanelUserEngaged: h, markPanelPointerEngaged: w, markPanelFocusEngaged: v, getJob: b, createSimilarJob: $, createDerivedJob: k, createSourceJob: S, updateJobStep: I, setJobLogPath: M, setJobResultQuestionId: B, completeJob: T, failJob: O, removeJob: _, clearFinishedJobs: J, hasActiveJobs: V };
}
function Wn(e, n, s) {
...
function yd({ initialLog: e, hydrateKey: n = 0, onLogChange: s }) {
  ...
  const x = wt(r), m = r.events.length > 0, h = bi(r), w = yt(r);
  i.useEffect(() => {
  ...
  return { log: r, displayMs: v, running: x, started: m, examInProgress: h, start: y, pause: z, resume: N, stop: j };
}
function vd(e) {
...
async function Sd({ backend: e, storageType: n, path: s }) {
  ...
  if (a.includes(o) && e.getObjectUrl) {
    ...
    const h = await ((_b = e.head) == null ? void 0 : _b.call(e, s));
    return { currentFile: { type: n, id: s, name: r, viewer: "image", objectUrl: m, size: (h == null ? void 0 : h.contentLength) ?? null }, content: "", revoke: () => jt(m) };
  }
  if (o === "pdf" && e.readBytes) {
    const { body: m, contentLength: h } = await e.readBytes(s), w = m instanceof Uint8Array ? m : new Uint8Array(m), v = w.buffer.slice(w.byteOffset, w.byteOffset + w.byteLength), y = new Blob([v], { type: "application/pdf" }), z = URL.createObjectURL(y);
    return { currentFile: { type: n, id: s, name: r, viewer: "pdf", objectUrl: z, size: h ?? null }, content: "", revoke: () => jt(z) };
  }
  ...
  if (o === "json") {
    const { text: m, contentLength: h, lastModified: w } = await e.readText(s);
    let v = m;
    if (m.length <= 1e5) try {
    ...
    return { currentFile: { type: n, id: s, name: r, viewer: "json", content: v, ...h != null ? { size: h } : {}, ...w != null ? { lastModified: w } : {} }, content: v };
  }
  if (o === "html" || o === "htm" || o === "svg") {
    const { text: m, contentLength: h, lastModified: w } = await e.readText(s);
    return { currentFile: { type: n, id: s, name: r, viewer: o === "svg" ? "svg" : "html", content: m, ...h != null ? { size: h } : {}, ...w != null ? { lastModified: w } : {} }, content: m };
  }
  if (o === "md" || o === "markdown" || o === "" || Kt(s) || Kt(r)) {
    const { text: m, contentLength: h, lastModified: w } = await e.readText(s);
    if (Kt(s) || Kt(r)) {
      const v = await yi(s, m);
      return v.status === "need-password" ? { currentFile: { type: n, id: s, name: r, viewer: "markdown", content: "", ...h != null ? { size: h } : {}, encMd: true, ...w != null ? { lastModified: w } : {} }, content: "", needsEncMdPassword: true } : { currentFile: { type: n, id: s, name: r, viewer: "markdown", content: v.text, ...h != null ? { size: h } : {}, encMd: true, ...w != null ? { lastModified: w } : {} }, content: v.text };
    }
    return { currentFile: { type: n, id: s, name: r, viewer: "markdown", content: m, ...h != null ? { size: h } : {}, ...w != null ? { lastModified: w } : {} }, content: m };
  }
...
function _d({ content: e, onChange: n, onSave: s, currentFile: r, onResolveWikiImageUrl: o, llmProviderProfiles: a = [], isActiveFile: c = true, registerToolbar: f, registerFileManagement: u }) {
  const { showToast: d } = Si(), { showAlert: x } = ji(), m = Ci(), h = wd(), { storageMode: w, s3Tree: v, localTree: y, webdavTree: z, localRootHandle: N, getBackendForType: j, loadLocalFolderChildren: b, loadWebdavFolderChildren: $ } = Ni(), { openAdvancedSearchFile: k, selectFileRaw: S } = $i(), I = i.useCallback((l) => {
  ...
  }, [a, I, M.llmOpts]), T = i.useCallback((l, p, g) => {
    const C = (p instanceof Error ? p.message : "") || g;
    if (Bc(C)) {
      I(C);
      return;
    }
...
`)) {
    ...
    const { text: g } = await p.readText(l);
    ...
    if (L == null ? void 0 : L.writeText) try {
      const R = await Rc({ quizFilePath: g, logKey: p, job: C, writeText: (U, G) => L.writeText(U, G, "text/markdown; charset=utf-8") });
      h.setJobLogPath(l, R);
    } catch {
    }
  }, [r == null ? void 0 : r.id, h, j, _]), He = i.useCallback((l, p, g) => {
    h.updateJobStep(l, g), oe(l, p);
  }, [h, oe]), Y = i.useCallback(async (l) => {
  ...
  cs.current = de;
  const [eo, Pe] = i.useState({}), [ue, wn] = i.useState({}), [Oe, we] = i.useState({}), et = i.useRef(Oe);
  et.current = Oe;
  const [Ot, nt] = i.useState({}), [me, Ue] = i.useState(null), [pe, tt] = i.useState({}), [xe, Qt] = i.useState(false), [yn, ft] = i.useState("all"), [vn, ds] = i.useState(false), [Tt, mt] = i.useState(false), [to, pt] = i.useState(null), [no, Sn] = i.useState(false), [xt, jn] = i.useState(null), [Ve, he] = i.useState(null), [us, _t] = i.useState(false), [ge, Dt] = i.useState(null), [st, Cn] = i.useState(null), [fs, Nn] = i.useState(false), [Ge, Ft] = i.useState(null), [so, Bt] = i.useState({}), $n = i.useRef(null), Pn = i.useRef(null), Ce = i.useRef(null), ht = i.useRef(null), ms = i.useRef(null), ps = i.useRef(null), [ye, gt] = i.useState(() => $t()), [ro, zn] = i.useState(0), ie = yd({ initialLog: ye, hydrateKey: ro, onLogChange: gt }), xs = i.useRef(() => 0);
  xs.current = () => ie.displayMs;
  const oo = i.useMemo(() => E.questions.map((l) => ({ id: l.id, displayLabel: l.displayLabel })), [E.questions]);
  Pl({ scrollRootRef: ht, questions: oo, running: ie.running, getElapsedMs: () => xs.current(), timeLog: ye, onLogChange: gt });
  const Xe = i.useCallback(() => Dn({ questions: fe.current.questions, userAnswers: re, gradedQuestions: de, subjectiveGrades: pe, isSubmitted: xe, ..._n(ye) ? {} : { timeLog: ye }, wrongChoiceExplanations: Xn(Oe), ...vt(ue) ? {} : { questionMemos: ue } }), [re, de, pe, xe, ye, Oe, ue]), qt = i.useCallback(() => {
    ...
    const g = wr(l.config, l.questions, p);
    q.current = true, A.current = g, n(g);
  }, [n]), Gt = i.useCallback(() => {
  ...
  const hs = i.useCallback(async () => {
    ...
    try {
      ...
      await g.writeText(C, l.markdown, "text/markdown; charset=utf-8"), await k(C), d({ message: `\uD2C0\uB9B0 \uBB38\uC81C ${l.questions.length}\uAC1C\uB97C \uC0C8 \uD034\uC988\uB85C \uCD94\uCD9C\uD588\uC2B5\uB2C8\uB2E4.`, durationMs: 4e3 });
    } catch (C) {
  ...
  const ke = i.useCallback((l) => {
    ...
    const g = { ...l, questions: p.questions, config: Xs(l.config, p.questions) };
    se(g);
    const C = Dn({ questions: g.questions, userAnswers: p.userAnswers, gradedQuestions: de, subjectiveGrades: pe, isSubmitted: xe, ..._n(ye) ? {} : { timeLog: ye }, wrongChoiceExplanations: p.wrongChoiceExplanations, ...vt(ue) ? {} : { questionMemos: ue } });
    be(g, C), d({ message: `${p.shuffledQuestionCount}\uAC1C \uBB38\uD56D\uC758 \uC120\uD0DD\uC9C0 \uC21C\uC11C\uB97C \uBCC0\uACBD\uD588\uC2B5\uB2C8\uB2E4.`, durationMs: 3200 });
  }, [re, Oe, Ot, de, pe, xe, ye, ue, be, d]);
  i.useEffect(() => {
    if (!(!c || !u)) return u({ extractWrongQuestions: hs, shuffleChoiceOptions: gs, hasUnsavedProgress: qt, flushBeforeSave: Gt }), () => u(null);
  }, [c, u, hs, gs, qt, Gt]);
  const En = i.useCallback((l) => {
    const p = fe.current;
    ke({ ...p, config: zi(p.config, l) }), pt((g) => g === l ? null : g);
  }, [ke]), io = i.useCallback((l, p) => {
    const g = fe.current;
    ke({ ...g, config: Ei(g.config, l, p) });
  }, [ke]), ao = i.useCallback((l) => {
    if (Jr()) {
      jn(l);
      return;
    }
  ...
  const Ss = i.useCallback((l, p) => l !== _ ? null : rn(O, p) || on(O, p), [_, O]), js = (r == null ? void 0 : r.id) || null, Cs = i.useCallback((l) => {
    ...
    const g = fe.current, C = [.../* @__PURE__ */ new Set([...g.config.sourcePaths, ...l])].sort((L, R) => L.localeCompare(R));
    ke({ ...g, config: { ...g.config, sourcePaths: C } }), d({ message: `\uADFC\uAC70 \uBB38\uC11C ${l.length}\uAC1C \uCD94\uAC00`, durationMs: 2500 });
  ...
  const H = i.useMemo(() => uc({ questions: E.questions, userAnswers: re, gradedQuestions: de, isSubmitted: xe, subjectiveGrades: pe }), [E.questions, re, de, xe, pe]), $s = c && H.total > 0, uo = mr(ht, ms, $s, E.questions.length), fo = mr(ht, ps, $s, E.questions.length), mo = i.useMemo(() => Ar(E.questions, E.config.choiceCount), [E.questions, E.config.choiceCount]), Ps = i.useMemo(() => Mi(E.config), [E.config.sourcePaths, E.config.disabledSourcePaths]), po = i.useMemo(() => {
    const l = {};
    for (const [p, g] of Object.entries(Oe)) {
      const C = p.indexOf("_"), L = C >= 0 ? p.slice(0, C) : p, R = l[L] ?? (l[L] = {});
      R[p] = g;
    }
    return l;
  }, [Oe]), Ht = i.useMemo(() => me && E.questions.find((l) => l.id === me.questionId) || null, [me, E.questions]), xo = i.useCallback((l, p, g) => {
    Ue({ questionId: l, option: p, mode: g });
  }, []), ve = a, zs = i.useCallback(() => {
    Ke({}), qe({}), Pe({}), we({}), nt({}), Ue(null), tt({}), Qt(false), gt($t()), zn((l) => l + 1), be(fe.current, zt({ ...vt(ue) ? {} : { questionMemos: ue } }));
  }, [be, ue]), ho = i.useCallback(() => {
    Ke({}), qe({}), Pe({}), we({}), nt({}), Ue(null), tt({}), Qt(false);
    const l = Nt($t(), "start", 0);
    gt(l), zn((p) => p + 1), be(fe.current, zt({ timeLog: l, ...vt(ue) ? {} : { questionMemos: ue } }));
  ...
  }, []), bo = i.useCallback((l, p) => {
    cs.current[l] || Ke((g) => ({ ...g, [l]: p }));
  }, []), ko = i.useCallback((l) => {
    ie.examInProgress || (qe((p) => ({ ...p, [l.id]: true })), Pe((p) => ({ ...p, [l.id]: true })));
  }, [ie.examInProgress]), wo = i.useCallback(async (l, p) => {
    var _a2;
    if (ie.examInProgress) return;
    const g = String(p ?? re[l.id] ?? "").trim();
    if (!g) {
      d({ message: "\uB2F5\uC548\uC744 \uC785\uB825\uD558\uC138\uC694.", durationMs: 2200 });
      return;
    }
    if (!await B()) return;
    he(l.id), (_a2 = Ce.current) == null ? void 0 : _a2.abort();
    const C = new AbortController();
    Ce.current = C;
    try {
      const L = await ur({ profiles: ve, question: l, userAnswer: g, signal: C.signal });
  ...
  }, [B, ve, T, d, ie.examInProgress, re]), yo = i.useCallback((l, p) => {
    Ke((g) => g[l] === p ? g : { ...g, [l]: p });
  }, []), vo = i.useCallback((l) => {
    Dt(l), _t(true);
  }, []), So = i.useCallback((l) => {
  ...
  const Po = async () => {
    ...
    const p = l.filter((C) => C.kind === "choice"), g = l.filter((C) => C.kind === "subjective");
    if (p.length > 0 && (qe((C) => {
      const L = { ...C };
    ...
    if (!await B()) return;
    he(`sim-${l.id}`);
    const p = Xt(E.config, l), g = h.createSimilarJob({ displayLabel: String(l.displayLabel || l.id), preview: l.question, hasRag: p.length > 0 }), C = g;
    try {
      const L = await Wc({ profiles: ve, question: l, config: E.config, sourcePaths: p, readText: te, onStep: (X) => He(g, C, X) }), R = String(l.displayLabel || l.id).split("-\uC720\uC0AC")[0] || "1";
      let U = 0;
      ...
      h.updateJobStep(g, { step: "finalize", status: "running", detail: "\uBB38\uC11C\uC5D0 \uCD94\uAC00 \uC911\u2026" }), oe(g, ee.id);
      const K = E.questions.findIndex((X) => X.id === l.id), ne = [...E.questions];
      ne.splice(K + 1, 0, ee), ft("all"), Bt((X) => ({ ...X, [ee.id]: true })), ke({ ...E, questions: ne }), h.setJobResultQuestionId(g, ee.id), h.updateJobStep(g, { step: "finalize", status: "done", detail: Z, llmResponse: JSON.stringify(ee, null, 2) }), h.completeJob(g, Z), oe(g, ee.id), d({ message: `${Z} \uC720\uC0AC\uBB38\uC81C \uCD94\uAC00`, durationMs: 2500 }), await rt(), window.setTimeout(() => {
        bt(ee.id);
      }, 80);
    } catch (L) {
      const R = (L instanceof Error ? L.message : "") || "\uC720\uC0AC\uBB38\uC81C \uC0DD\uC131 \uC2E4\uD328";
      h.failJob(g, R), oe(g, C), T("\uC720\uC0AC\uBB38\uC81C \uC0DD\uC131 \uC2E4\uD328", L, "\uC720\uC0AC\uBB38\uC81C \uC0DD\uC131 \uC2E4\uD328");
    } finally {
      he(null);
    }
  }, Ms = async (l, p) => {
    ...
    he(R), (_a2 = Ce.current) == null ? void 0 : _a2.abort();
    const U = new AbortController();
    Ce.current = U;
    try {
      const G = Xt(E.config, l), Z = await Kc({ profiles: ve, question: l, missingPoint: C, missingExplanation: L, sourcePaths: G, readText: te, ...g, signal: U.signal });
    ...
    if (!await B()) return;
    he(`derived-${l.id}`);
    const g = Xt(E.config, l), C = h.createDerivedJob({ displayLabel: String(l.displayLabel || l.id), preview: l.question, hasRag: g.length > 0 }), L = C;
    try {
      const R = await Jc({ profiles: ve, question: l, config: E.config, target: p, sourcePaths: g, readText: te, onStep: (K) => He(C, L, K) }), U = Cc(E.questions, String(l.displayLabel || l.id)), G = { ...R, id: `gen-${Date.now()}`, displayLabel: U, isGenerated: true, similarOf: { id: l.id, displayLabel: String(l.displayLabel || l.id) }, ...g.length ? { sourcePaths: g } : {} };
      h.updateJobStep(C, { step: "finalize", status: "running", detail: "\uBB38\uC11C\uC5D0 \uCD94\uAC00 \uC911\u2026" }), oe(C, G.id);
      const Z = E.questions.findIndex((K) => K.id === l.id), ee = [...E.questions];
      ee.splice(Z + 1, 0, G), ft("all"), Bt((K) => ({ ...K, [G.id]: true })), ke({ ...E, questions: ee }), h.setJobResultQuestionId(C, G.id), h.updateJobStep(C, { step: "finalize", status: "done", detail: U, llmResponse: JSON.stringify(G, null, 2) }), h.completeJob(C, U), oe(C, G.id), Cn(null), d({ message: `${U} \uD30C\uC0DD\uBB38\uC81C \uCD94\uAC00`, durationMs: 2500 }), await rt(), window.setTimeout(() => {
        bt(G.id);
      }, 80);
    } catch (R) {
      const U = (R instanceof Error ? R.message : "") || "\uD30C\uC0DD\uBB38\uC81C \uC0DD\uC131 \uC2E4\uD328";
      h.failJob(C, U), oe(C, L), T("\uD30C\uC0DD\uBB38\uC81C \uC0DD\uC131 \uC2E4\uD328", R, "\uD30C\uC0DD\uBB38\uC81C \uC0DD\uC131 \uC2E4\uD328");
    } finally {
      he(null);
    }
  }, zo = i.useCallback((l, p) => {
    var _a2;
    const g = Ot[l.id], C = ((_a2 = l.options) == null ? void 0 : _a2.length) || 0;
    return g != null && g >= 1 && g <= C ? g : p != null && p >= 1 && p <= C ? p : 1;
  }, [Ot]), Ls = async (l, p, g, C = "create") => {
    var _a2, _b;
    ...
    if (C === "followup") {
      ...
      he(ne), (_a2 = Ce.current) == null ? void 0 : _a2.abort();
      const ze = new AbortController();
      Ce.current = ze;
      const Ne = K.slice(0, 60);
      try {
        const Ee = await Gc({ profiles: ve, question: l, selectedOption: p, existingAnalysis: X, userQuestion: K, ...R, signal: ze.signal, onChunk: (Wo) => {
          const Jo = Ai(X, Wo);
          we((Ho) => ({ ...Ho, [ne]: Jo }));
        } }), kt = Li(Ee, Ne), Go = Oi(X, kt, Ne), On = { ...et.current, [ne]: Go };
    ...
    he(G), C !== "regenerate" && we((K) => ({ ...K, [G]: "" })), (_b = Ce.current) == null ? void 0 : _b.abort();
    ...
    var _a2, _b, _c2;
    const p = E.config.sourcePaths.length, g = br(E.config);
    if (!p) {
    ...
    if (!await B()) return;
    he("gen-sources"), (_a2 = Ce.current) == null ? void 0 : _a2.abort();
    const C = new AbortController();
    Ce.current = C;
    const L = h.createSourceJob({ preview: ((_b = E.questions[0]) == null ? void 0 : _b.question) || "\uADFC\uAC70 \uAE30\uBC18 \uCD9C\uC81C", topic: l }), R = L;
    try {
      const U = await Vc({ profiles: ve, config: E.config, sourcePaths: g, topic: l, kind: "choice", count: 1, exampleQuestions: E.questions, readText: te, signal: C.signal, onStep: (Ne) => He(L, R, Ne) });
      if (!U.length) throw new Error("\uC0DD\uC131\uB41C \uBB38\uD56D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.");
      const G = Number.parseInt(es(E.questions), 10) || 1, Z = Date.now(), ee = U.map((Ne, Ee) => ({ ...Ne, id: `gen-src-${Z}-${Ee}`, displayLabel: String(G + Ee), isGenerated: true, ...g.length ? { sourcePaths: [...g] } : {} })), K = (_c2 = ee[0]) == null ? void 0 : _c2.id, ne = ee.map((Ne) => Ne.displayLabel).join(", "), X = K || L;
      h.updateJobStep(L, { step: "finalize", status: "running", detail: "\uBB38\uC11C\uC5D0 \uCD94\uAC00 \uC911\u2026" }), oe(L, X);
      const ze = [...E.questions, ...ee];
      ft("all"), K && Bt((Ne) => {
        const Ee = { ...Ne };
        for (const kt of ee) Ee[kt.id] = true;
        return Ee;
      }), ke({ ...E, questions: ze }), K && h.setJobResultQuestionId(L, K), h.updateJobStep(L, { step: "finalize", status: "done", detail: ne, llmResponse: JSON.stringify(ee, null, 2) }), h.completeJob(L, ne), oe(L, X), d({ message: `\uADFC\uAC70 \uAE30\uBC18 \uBB38\uC81C ${ee.length}\uAC1C \uCD94\uAC00`, durationMs: 2500 }), await rt(), K && window.setTimeout(() => {
        bt(K);
      }, 80);
    } catch (U) {
      if (C.signal.aborted) {
        h.failJob(L, "\uCDE8\uC18C\uB428"), oe(L, R);
        return;
      }
      const G = (U instanceof Error ? U.message : "") || "\uBB38\uC81C \uC0DD\uC131 \uC2E4\uD328";
      h.failJob(L, G), oe(L, R), T("\uBB38\uC81C \uC0DD\uC131 \uC2E4\uD328", U, "\uBB38\uC81C \uC0DD\uC131 \uC2E4\uD328");
    } finally {
      he(null);
    }
  }, Qs = i.useRef(Os);
  Qs.current = Os;
  const Eo = i.useCallback((l) => {
    Qs.current(l);
  }, []), Io = i.useCallback(async ({ instructions: l, form: p }) => {
    var _a2, _b;
    if (!ge || !await B()) return null;
    (_a2 = Ce.current) == null ? void 0 : _a2.abort();
    const g = new AbortController();
    Ce.current = g;
    const C = Tr(p, ge.displayLabel);
    C.id = ge.id, C.displayLabel = ge.displayLabel, ge.similarOf && (C.similarOf = ge.similarOf), ge.isGenerated && (C.isGenerated = ge.isGenerated);
    const L = Xt(E.config, C);
    try {
      const R = await ed({ profiles: ve, question: C, config: E.config, userInstructions: l, sourcePaths: L, readText: te, signal: g.signal }), U = Te(C, E.config.choiceCount), G = { kind: R.kind, displayLabel: ge.displayLabel, question: R.question, point: R.point, explanation: R.explanation, ...((_b = p.sourcePaths) == null ? void 0 : _b.length) ? { sourcePaths: p.sourcePaths } : {} };
      ...
      return g.signal.aborted || T("\uBB38\uC81C \uACE0\uCE58\uAE30 \uC2E4\uD328", R, "\uBB38\uC81C \uACE0\uCE58\uAE30 \uC2E4\uD328"), null;
    }
  }, [E.config, ge, B, ve, te, T, d]), Ro = i.useMemo(() => ({ getPresignedUrl: o, currentNotePath: (r == null ? void 0 : r.id) ?? null }), [r == null ? void 0 : r.id, o]), Ts = i.useRef(Ls);
  Ts.current = Ls;
  ...
  Bs.current = As;
  const Mo = i.useCallback((l) => {
    _s.current(l);
  }, []), Ao = i.useCallback((l, p) => {
    Ds.current(l, p);
  }, []), Lo = i.useCallback((l) => {
    const p = Fs.current, g = Mn.current;
    !p || !g || Ts.current(p, g.option, l, g.mode);
  }, []), Oo = i.useCallback(() => {
    const l = Mn.current;
    if (!l) return;
  ...
  }, [Ve]), To = i.useCallback((l) => {
    const p = An.current;
    p && Bs.current(p, l);
  }, []), _o = i.useCallback(() => ds(false), []), Do = i.useCallback((l) => {
    ft("all"), bt(l);
  }, [bt]), Fo = i.useCallback(() => {
