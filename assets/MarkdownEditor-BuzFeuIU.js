...
import { j as o, r as l, u as Zn, c as mo, a as po } from "./vendor-react-BFxggocB.js";
import { A as ho, B as Bt, S as er, l as Ke, D as tr, F as rn, W as go, G as nr, H as Ue, J as Se, M as rr, j as Ot, V as Vt, O as or, m as ce, P as xo, Q as bo, R as wo, T as yo, U as vo, X as kt, Y as on, Z as ko, $ as Eo, c as So, a0 as Co, a1 as sr, v as No, a2 as jo, a3 as Mo, K as Lo, a4 as To, a5 as Ro, a6 as Ao, a7 as Po, a8 as Do, a9 as Io, aa as Fo, ab as Ho, ac as $o, ad as _o, ae as Bo, af as Oo, ag as Vo, ah as Ko, ai as zo, aj as qo, ak as Wo, al as Uo, am as Yo, an as Go } from "./vendor-md-editor-DgMIfYwZ.js";
import { a$ as Le, b0 as sn, b1 as Xo, ak as ir, al as ar, b2 as an, b3 as Qo, a2 as mt, ag as Jo, b4 as cn, D as ln, b5 as Zo, b6 as es, b7 as ts, b8 as dn, b9 as cr, ba as ns, bb as rs, bc as os, bd as ss, be as is, bf as lr, bg as as, bh as Kt, aa as zt, bi as cs, bj as ls, bk as ds, bl as us, bm as fs, bn as ms, bo as dr, bp as Ve, bq as ps, br as hs, bs as gs, bt as xs, bu as bs, bv as ur, bw as ws, bx as ys, by as un, bz as vs, bA as ks, A as Es, bB as Ss, bC as st, bD as Cs, bE as Ns, bF as Oe, bG as js, bH as Ms, bI as Ls, bJ as fn, ao as Et, bK as St, ap as Ts, bL as mn, bM as Rs, aq as As, ar as Ps, ac as Ds, as as Is, am as Fs, an as Hs, T as $s, M as _s, bN as Bs, bO as Os, aO as pn, bP as Vs, bQ as Ct, bR as Nt, bS as hn, bT as gn, bU as jt, bV as xn, bW as Ks, bX as bn, bY as wn, aX as zs, bZ as qs, au as Ws, b_ as Us, b$ as Ys, c0 as Gs, c1 as Xs, c2 as Qs, c3 as yn, c4 as be, c5 as Js, c6 as Mt, c7 as Lt, c8 as Zs } from "./index-BFytel-U.js";
import { S as ei, a4 as ti, a5 as vn, a6 as Tt, a7 as Rt, a8 as ni, c as ri, a9 as qt, aa as oi, ab as fr, ac as si, ad as ii, X as Wt, y as ai, ae as ci, af as li, k as Ut, ag as di, ah as ui, a0 as fi, ai as mi, D as pi, L as hi } from "./vendor-lucide-BpsjM9FN.js";
import { b as gi, D as At, E as Pt, G as xi, H as bi, J as wi, K as yi, M as vi, N as ki, Q as Ei, U as Si, V as Ci, W as Ni, S as mr, g as pr, d as kn, T as En, e as Sn, f as Cn, A as Nn } from "./vendor-radix-DQGgQNt2.js";
import { M as ji } from "./MdEditorToolbarTooltips-Cjo7_TC4.js";
import { C as Mi, u as Li, b as Ti, P as Ri, T as Ai, a as Pi, H as Di } from "./previewFootnoteScroll-dqLZwLP-.js";
import { N as Ii, u as Fi, W as Hi } from "./useTocTitleWrap-LODzZd8F.js";
import { a as pt } from "./vendor-motion-b8oTnHK_.js";
import { c as $i } from "./clipboardImageFiles-DogIlQNG.js";
import { u as _i } from "./useWikiImageHydration-CGCbpXrk.js";
...
function Yi({ onToggle: e, active: t = false }) {
...
function Qi({ markdown: e = "", onMarkdownChange: t }) {
  ...
  return o.jsxs("div", { className: "space-y-3 text-xs text-slate-100", children: [o.jsxs("div", { className: "grid grid-cols-2 gap-2 sm:grid-cols-4", children: [o.jsxs("div", { className: "col-span-2 sm:col-span-1 relative overflow-hidden rounded-xl border border-indigo-500/30 bg-gradient-to-br from-indigo-900/40 via-slate-900 to-slate-900 p-3", children: [o.jsx("div", { className: "pointer-events-none absolute -right-2 -top-2 opacity-10", children: o.jsx(ti, { className: "h-16 w-16 text-indigo-400" }) }), o.jsx("span", { className: "text-[10px] font-semibold uppercase tracking-wider text-indigo-300", children: "\uC804\uCCB4 \uC9C4\uD589\uB960" }), o.jsx("div", { className: "my-1.5 flex items-baseline gap-1", children: o.jsxs("span", { className: "text-3xl font-extrabold text-white", children: [w.percentage, "%"] }) }), o.jsx("div", { className: "h-1.5 w-full overflow-hidden rounded-full bg-slate-800", children: o.jsx("div", { className: "h-full bg-gradient-to-r from-indigo-500 to-emerald-400 transition-all duration-700 ease-out", style: { width: `${w.percentage}%` } }) })] }), o.jsxs("div", { className: "flex flex-col justify-between rounded-xl border border-slate-800 bg-slate-950 p-3", children: [o.jsxs("div", { className: "flex items-center justify-between text-slate-400", children: [o.jsx("span", { className: "text-[10px] font-medium", children: "\uCD1D \uD0DC\uC2A4\uD06C" }), o.jsx(vn, { className: "h-3.5 w-3.5 text-slate-500" })] }), o.jsxs("div", { className: "mt-1 text-xl font-bold text-slate-100", children: [w.totalTasks, " ", o.jsx("span", { className: "text-[10px] font-normal text-slate-500", children: "\uAC1C" })] })] }), o.jsxs("div", { className: "flex flex-col justify-between rounded-xl border border-slate-800 bg-slate-950 p-3", children: [o.jsxs("div", { className: "flex items-center justify-between text-emerald-400", children: [o.jsx("span", { className: "text-[10px] font-medium", children: "\uC644\uB8CC\uB428" }), o.jsx(Tt, { className: "h-3.5 w-3.5" })] }), o.jsxs("div", { className: "mt-1 text-xl font-bold text-emerald-400", children: [w.completedTasks, " ", o.jsx("span", { className: "text-[10px] font-normal text-slate-500", children: "\uAC1C" })] })] }), o.jsxs("div", { className: "flex flex-col justify-between rounded-xl border border-slate-800 bg-slate-950 p-3", children: [o.jsxs("div", { className: "flex items-center justify-between text-amber-400", children: [o.jsx("span", { className: "text-[10px] font-medium", children: "\uC9C4\uD589 \uC608\uC815" }), o.jsx(Rt, { className: "h-3.5 w-3.5" })] }), o.jsxs("div", { className: "mt-1 text-xl font-bold text-amber-400", children: [w.pendingTasks, " ", o.jsx("span", { className: "text-[10px] font-normal text-slate-500", children: "\uAC1C" })] })] })] }), o.jsxs("div", { className: "space-y-3 rounded-xl border border-slate-800 bg-slate-950 p-3", children: [o.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2 border-b border-slate-800/80 pb-2", children: [o.jsxs("div", { className: "flex rounded-lg border border-slate-800 bg-slate-900 p-0.5", children: [o.jsxs("button", { type: "button", onClick: () => k("dashboard"), className: `inline-flex items-center gap-1 rounded-md px-2 py-1 text-[11px] font-medium transition ${x === "dashboard" ? "bg-indigo-600 text-white shadow-md" : "text-slate-400 hover:text-slate-200"}`, children: [o.jsx(ni, { className: "h-3 w-3" }), o.jsx("span", { children: "\uCE74\uD14C\uACE0\uB9AC" })] }), o.jsxs("button", { type: "button", onClick: () => k("checklist"), className: `inline-flex items-center gap-1 rounded-md px-2 py-1 text-[11px] font-medium transition ${x === "checklist" ? "bg-indigo-600 text-white shadow-md" : "text-slate-400 hover:text-slate-200"}`, children: [o.jsx(vn, { className: "h-3 w-3" }), o.jsx("span", { children: "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8" })] })] }), o.jsxs("div", { className: "flex min-w-0 flex-1 flex-wrap items-center justify-end gap-1.5", children: [o.jsxs("div", { className: "relative min-w-[120px] flex-1", children: [o.jsx(ri, { className: "absolute left-2 top-1/2 h-3 w-3 -translate-y-1/2 text-slate-500" }), o.jsx("input", { type: "text", value: n, onChange: (E) => r(E.target.value), placeholder: "\uAC80\uC0C9...", className: "w-full rounded-md border border-slate-800 bg-slate-900 py-1 pl-7 pr-2 text-[11px] text-slate-200 focus:border-indigo-500 focus:outline-none" })] }), o.jsxs("select", { value: i, onChange: (E) => s(E.target.value), className: "rounded-md border border-slate-800 bg-slate-900 px-2 py-1 text-[11px] text-slate-300 focus:border-indigo-500 focus:outline-none", children: [o.jsx("option", { value: "all", children: "\uC804\uCCB4" }), o.jsx("option", { value: "completed", children: "\uC644\uB8CC\uB9CC" }), o.jsx("option", { value: "pending", children: "\uBBF8\uC644\uB8CC\uB9CC" })] })] })] }), x === "dashboard" && o.jsx("div", { className: "max-h-[min(42vh,360px)] space-y-2 overflow-y-auto pr-0.5", children: w.categories.length === 0 ? o.jsxs("div", { className: "py-8 text-center text-slate-500", children: [o.jsx(qt, { className: "mx-auto mb-2 h-8 w-8 opacity-40" }), o.jsx("p", { children: "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8 \uD56D\uBAA9\uC744 \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4." }), o.jsx("code", { className: "mt-1 inline-block rounded bg-slate-900 px-1.5 py-0.5 text-[10px] text-indigo-400", children: "- [ ] \uD560 \uC77C" })] }) : w.categories.map((E, T) => {
    ...
    return F.length === 0 ? null : o.jsxs("div", { className: "space-y-1", children: [o.jsxs("div", { className: "sticky top-0 border-b border-slate-800/80 bg-slate-950 py-1 text-[10px] font-bold uppercase tracking-wider text-indigo-400", children: [E.name, " (", F.length, ")"] }), F.map(($) => o.jsxs("button", { type: "button", onClick: () => A($.lineIndex), style: { paddingLeft: `${$.indent * 10 + 6}px` }, className: "flex w-full items-start gap-2 rounded-md border border-slate-800/40 bg-slate-900/40 p-1.5 text-left text-[11px] hover:bg-slate-800/60", children: [o.jsx("span", { className: "mt-0.5 shrink-0", children: $.completed ? o.jsx(Tt, { className: "h-3.5 w-3.5 text-emerald-400" }) : o.jsx(Rt, { className: "h-3.5 w-3.5 text-slate-600" }) }), o.jsx("span", { className: `leading-relaxed ${$.completed ? "text-slate-500 line-through" : "text-slate-200"}`, children: $.text })] }, $.id))] }, `${E.name}-list-${T}`);
  }) })] })] });
}
...
function ta({ editorRef: e, onChange: t, open: n, onOpenChange: r }) {
  const [i, s] = l.useState(() => Ji()), [u, f] = l.useState(""), [x, k] = l.useState({ from: 0, to: 0 }), w = l.useRef({ active: false, startX: 0, startY: 0, startLeftVw: 0, startTopVh: 0 }), A = l.useCallback(() => {
    const { text: T, from: F, to: $ } = sn(e);
    return f(T), k({ from: F, to: $ }), T;
  }, [e]);
  l.useEffect(() => {
    if (n) {
      if (Ln()) {
    ...
    if (!n) return;
    const T = window.matchMedia(gr), F = ($) => {
  ...
  const N = l.useCallback((T) => {
    ...
    T.preventDefault();
    const F = T.clientX, $ = T.clientY;
    w.current = { active: true, startX: F, startY: $, startLeftVw: i.leftVw, startTopVh: i.topVh };
    const q = (y) => {
      if (!w.current.active) return;
      Math.hypot(y.clientX - F, y.clientY - $) <= ea;
      const D = window.innerWidth || 1, ee = window.innerHeight || 1, K = (y.clientX - w.current.startX) / D * 100, H = (y.clientY - w.current.startY) / ee * 100;
      s({ leftVw: Math.min(92, Math.max(0, w.current.startLeftVw + K)), topVh: Math.min(90, Math.max(0, w.current.startTopVh + H)) });
    }, z = () => {
      w.current.active && (w.current.active = false, document.removeEventListener("pointermove", q), document.removeEventListener("pointerup", z), s((y) => (Zi(y), y)));
    };
    document.addEventListener("pointermove", q), document.addEventListener("pointerup", z);
  }, [i.leftVw, i.topVh]), L = l.useCallback((T) => {
    f(T);
    const { view: F } = sn(e), { from: $, to: q } = x;
    Xo(F, $, q, T, t) && k({ from: $, to: $ + T.length });
  }, [e, x, t]), E = () => {
    r == null ? void 0 : r(false);
  };
...
function ma({ isOpen: e, markdown: t, selectedMarkdown: n = "", onClose: r, onApply: i }) {
  ...
  const $ = l.useMemo(() => Qo(F, x, { maxLevel: dn, renumberOutline: w, outlineStyle: N, outlineStart: E }), [F, x, w, N, E]), q = (y) => {
...
function ya({ isOpen: e, onClose: t, onConfirm: n }) {
  ...
  }, onKeyDown: A, placeholder: "https://\u2026", className: "w-full rounded border border-gray-300 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-500/40 dark:border-odp-borderStrong dark:bg-odp-bgSoft" })] }), f ? o.jsx("p", { className: "text-xs text-red-600 dark:text-red-300", children: f }) : null, o.jsxs("div", { className: "flex justify-end gap-2", children: [o.jsxs("button", { type: "button", onClick: t, className: "inline-flex items-center gap-1.5 rounded bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-200 dark:bg-odp-bgSoft dark:text-odp-fgStrong dark:hover:bg-odp-focusBg", children: [o.jsx(Wt, { size: 16 }), "\uCDE8\uC18C"] }), o.jsxs("button", { type: "button", onClick: w, className: "inline-flex items-center gap-1.5 rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-700", children: [o.jsx(Ut, { size: 16 }), "\uC0BD\uC785"] })] })] }) });
}
...
function Ea() {
  const [e, t] = l.useState(Ht), n = l.useCallback((r) => {
    t((i) => {
...
const Cr = er.define({ create() {
  ...
  t.docChanged && n.length && (n = n.map(({ from: i, to: s }) => ({ from: t.changes.mapPos(i, 1), to: t.changes.mapPos(s, -1) })).filter(({ from: i, to: s }) => i < s));
  let r = n !== e;
  for (const i of t.effects) if (i.is(Ue)) Sr(n, i.value.from, i.value.to) || (n = [...n, i.value], r = true);
  else if (i.is(Se)) {
...
async function Qa(e, t) {
  ...
  n === $t && Ce(e.state) && e.dispatch({ effects: Se.of(t) }), r.remove();
}
async function Ja(e, t) {
  ++$t, e.dispatch({ effects: Ue.of(t) });
  const n = Ce(e.state);
  if (!n) return;
  const r = Tr(e, n);
  if (r) {
...
function In(e, t) {
  ...
  return e.dispatch({ effects: n ? Ue.of(t) : Se.of(t) }), true;
}
function Fn(e) {
  const t = Ce(e.state);
  if (!t) return false;
...
function Za(e, t) {
  ...
  t && !r ? e.dispatch({ effects: Se.of(n) }) : !t && r && e.dispatch({ effects: Ue.of(n) });
}
function ec() {
  return Vt.fromClass(class {
    ...
    syncKeyAndMaybeRestore() {
      ...
      za(e).then((r) => {
        n === this.loadGen && r != null && Za(this.view, r);
      });
    }
  });
}
function tc(e) {
  return e.transactions.some((t) => t.effects.some((n) => n.is(Se) || n.is(Ue)));
}
function nc() {
  return [Ya(null), nr({ preparePlaceholder(e, t) {
    const n = Ce(e);
...
function $n(e, t) {
  e && (e.classList.toggle("md-note-cover-placeholder--pending", t === "pending"), e.classList.toggle("md-note-cover-placeholder--ready", t === "ready"), e.classList.toggle("md-note-cover-placeholder--empty", t === "empty"), t === "pending" ? Hn(e, oc) : t === "empty" && Hn(e, sc));
}
function ic(e, t, n) {
  let r = ut.get(e);
...
async function yc(e) {
  if (!e) return null;
  const t = await Hr.get(e);
  return !t || !Array.isArray(t.collapsedIds) ? null : t.collapsedIds.filter((n) => typeof n == "string" && n.length > 0);
}
async function vc(e, t) {
  e && await Hr.put({ key: e, collapsedIds: Array.from(new Set(t.filter(Boolean))), updatedAt: Date.now() });
}
...
function jc(e) {
  ...
  function k(L) {
    n && r === L || (n == null ? void 0 : n.disconnect(), r = L, n = new MutationObserver((E) => {
      E.some((F) => {
        const $ = [...F.addedNodes, ...F.removedNodes];
        return $.length === 0 ? F.type === "characterData" || F.type === "attributes" : $.some((q) => {
          var _a2, _b;
...
function Dc(e) {
  ...
  function ne(M) {
    const C = ee(M.target);
    !C || !H(C, M.target) || (K(C, M.target), C === "editor" ? me() : pe());
  }
  function le(M) {
    const C = ee(M.target);
  ...
  function Ie() {
    E = true, T(), F(), $(), q(), x && (x.removeEventListener("scroll", ne), x = null), k && (k.removeEventListener("scroll", ne), k = null), w && (w.removeEventListener("scroll", ne, true), w.removeEventListener("wheel", le, true), w.removeEventListener("touchmove", le, true), w = null), N && (N.removeEventListener("load", B, true), N.removeEventListener("error", B, true), N = null), A = null, t = false, L = "none";
  }
...
async function Wn({ key: e, stack: t, index: n }) {
  if (!e) return;
  const r = Yt(t), i = Math.max(0, Math.min(n ?? r.length - 1, r.length - 1));
...
function Kc({ currentFile: e, value: t, onChange: n, editorRef: r, enabled: i = true }) {
  ...
  N.current = t;
  const $ = l.useCallback(async (H, h, P) => {
    if (H) try {
      await Wn({ key: H, stack: h, index: P });
    } catch (J) {
      console.warn("[editor-undo-history] save failed:", J);
    }
  }, []), q = l.useCallback((H, h, P) => {
    H && (A.current && clearTimeout(A.current), A.current = setTimeout(() => {
      A.current = null, $(H, h, P);
    }, 300));
  }, [$]), z = l.useCallback(() => {
    w.current && (clearTimeout(w.current), w.current = null);
  }, []), y = l.useCallback(() => {
    const H = N.current ?? "", h = at(u.current, f.current, H);
    return u.current = h.stack, f.current = h.index, h;
  }, []), D = l.useCallback((H) => {
    const h = Yn(r), P = Vc(h), J = Un(h);
    if (!P) return false;
    const Y = ++T.current;
    k.current = true;
    try {
      ...
      requestAnimationFrame(() => {
        requestAnimationFrame(() => {
          T.current === Y && (k.current = false);
        });
      });
    }
    return true;
  }, [r]), ee = l.useCallback((H, h) => {
    var _a2, _b;
    const P = N.current ?? "", J = ((_a2 = h == null ? void 0 : h.stack) == null ? void 0 : _a2.length) ? h.stack : [P], Y = ((_b = h == null ? void 0 : h.stack) == null ? void 0 : _b.length) ? h.index ?? h.stack.length - 1 : 0, Q = at(J, Y, P);
    u.current = Q.stack, f.current = Q.index, E.current = H, L.current = false, F.current = P;
    const Z = Q.stack.slice(0, Q.index + 1), me = (pe) => {
      x.current === H && (D(Z) || pe <= 0 || setTimeout(() => me(pe - 1), 50));
    };
    me(40), q(H, Q.stack, Q.index);
  }, [D, q]);
  return l.useEffect(() => {
    i && _c().catch(() => {
    });
    ...
    var _a2;
    if (!i) return;
    const H = x.current, h = s;
    if (z(), A.current && (clearTimeout(A.current), A.current = null), H && H !== h) {
      const Q = y();
      $(H, Q.stack, Q.index);
    }
    x.current = h, E.current = null, L.current = false;
    const P = Yn(r);
    if ((_a2 = Un(P)) == null ? void 0 : _a2(), !h) {
    ...
    return (async () => {
      ...
      try {
        ...
        console.warn("[editor-undo-history] load failed:", Z);
      }
      Y || T.current !== J || x.current === h && ee(h, Q);
    })(), () => {
      Y = true;
    };
  }, [i, s, r, z, y, $, ee]), l.useEffect(() => {
    if (!i || !s || E.current !== s || L.current || k.current || t === F.current) return;
    const H = t ?? "";
    F.current = H;
    const h = at(u.current, f.current, H);
    ...
    if (i) return () => {
      ...
      Wn({ key: H, stack: h.stack, index: h.index }).catch(() => {
      });
    };
  }, [i, z]), { onChange: l.useCallback((H) => {
    k.current || (F.current = H, L.current = true, n == null ? void 0 : n(H), !(!i || !x.current) && (z(), w.current = setTimeout(() => {
      if (w.current = null, k.current) return;
      const h = x.current;
      if (!h) return;
      const P = Bc(u.current, f.current, H);
...
const wl = [{ key: "Alt-h", preventDefault: true, run: (e) => lt(e, Wo) }, { key: "Alt-j", preventDefault: true, run: (e) => lt(e, Uo) }, { key: "Alt-k", preventDefault: true, run: (e) => lt(e, Yo) }, { key: "Alt-l", preventDefault: true, run: (e) => lt(e, Go) }];
No({ editorConfig: { languageUserDefined: { "ko-KR": Lo }, renderDelay: ur() ? 500 : 0 }, codeMirrorExtensions(e, { keyBindings: t }) {
  ...
  }), i = [{ key: "ArrowLeft", run: (s) => yn(s, -1) }, { key: "ArrowRight", run: (s) => yn(s, 1) }, { key: "Ctrl-ArrowLeft", mac: "Alt-ArrowLeft", run: (s) => be(s, -1, _o), shift: (s) => be(s, -1, $o) }, { key: "Ctrl-ArrowRight", mac: "Alt-ArrowRight", run: (s) => be(s, 1, Oo), shift: (s) => be(s, 1, Bo) }, { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: (s) => be(s, -1, Ko), shift: (s) => be(s, -1, Vo) }, { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: (s) => be(s, 1, qo), shift: (s) => be(s, 1, zo) }, ...wl, { key: "Alt--", preventDefault: true, run: rl }, { key: "Ctrl-Tab", run: ol }, { key: "Ctrl-d", mac: "Cmd-d", preventDefault: true, run: (s) => (Ao(s), true) }, { key: "Ctrl-b", mac: "Cmd-b", preventDefault: true, run: Yc }, { key: "Ctrl-i", mac: "Cmd-i", preventDefault: true, run: Gc }, { key: "Ctrl-u", mac: "Cmd-u", preventDefault: true, run: Qc, shift: sl }, { key: "Ctrl-o", mac: "Cmd-o", preventDefault: true, run: il }, { key: "Shift-Ctrl-s", mac: "Shift-Cmd-s", preventDefault: true, run: Xc }, { key: "Ctrl-ArrowUp", mac: "Cmd-ArrowUp", preventDefault: true, run: Jc }, { key: "Ctrl-ArrowDown", mac: "Cmd-ArrowDown", preventDefault: true, run: Zc }, ...[1, 2, 3, 4, 5, 6, 7, 8, 9].map((s) => ({ key: `Ctrl-${s}`, mac: `Cmd-${s}`, preventDefault: true, run: (u) => Gn(u, s) })), { key: "Ctrl-0", mac: "Cmd-0", preventDefault: true, run: (s) => Gn(s, 10) }, { any: (s, u) => (u.ctrlKey || u.metaKey) && u.altKey && u.code === "KeyC" ? Kr(s) : zr(s, u) }, { key: "Mod-Alt-ArrowUp", run: To }, { key: "Mod-Alt-ArrowDown", run: Ro }, ...r];
  ...
  }) }, { type: "multiCursorPreview", extension: Io({ minSelectionLength: 2, maxMatches: 200 }) }, { type: "keymap", extension: sr.of(i) }, { type: "base64ImageFold", extension: Aa(Ht()) }, { type: "mermaidBase64Fold", extension: $a(Ht()) }, { type: "autocompleteGate", extension: Ke.updateListener.of((s) => {
    Ec(s), !cr() && Fo(s.state) === "active" && Ho(s.view);
  }) }), n;
}, markdownItPlugins(e) {
  return Qs(e);
} });
function $l({ value: e, onChange: t, onSave: n, theme: r = "light", currentFile: i = null, previewOnly: s = false, isMobileLayout: u = false, onUploadImage: f, isUploadingEditorImage: x = false, uploadImagePercent: k = 0, onCancelUploadImage: w, onResolveWikiImageUrl: A, snippetConfig: N = { snippets: [] }, llmProviderProfiles: L = [], getImgbbApiKey: E, onOpenViewPath: T, onRequestConvertAllImagesToWiki: F, onRegisterConvertAllImagesToWiki: $, isActiveFile: q = true }) {
  var _a2, _b;
  const z = gs(), y = Zn(), { showAlert: D } = xs(), ee = l.useId(), K = l.useMemo(() => Oi(ee), [ee]), H = l.useMemo(() => Vi(K), [K]), h = l.useRef(null), P = l.useRef(null), J = l.useRef(null), Y = l.useRef(null), Q = l.useRef(N), Z = l.useRef(e), me = l.useRef(i), pe = l.useRef(r), ne = l.useRef("");
  l.useEffect(() => {
    Z.current = e, me.current = i, pe.current = r;
  }, [e, i, r]), l.useEffect(() => {
    const { issues: a } = dr(e ?? "");
    if (!a.length) {
      ne.current = "";
...
${c}` }));
  ...
  const le = l.useCallback((a = {}) => {
    const c = Z.current ?? "", d = me.current;
  ...
  }, [y]), { onChange: B } = Kc({ currentFile: i, value: e, onChange: t, editorRef: h, enabled: !s }), te = Li({ getMarkdown: () => Z.current ?? "", setMarkdown: (a) => {
  ...
  const [Qt, Je] = l.useState(null), [re, He] = l.useState(null), [qr, ke] = l.useState(false), [$e, gt] = l.useState(null), [Wr, xt] = l.useState(false), [fe, Ur] = l.useState(null), [Ze, bt] = l.useState(null), ge = l.useRef(null), [wt, Jt] = Fi(), [_e, Zt] = Ea(), [en, tn] = Sa(), [Yr, et] = Ca(), ae = l.useMemo(() => ur(), []), oe = ae ? false : Yr, yt = l.useRef(null);
  l.useEffect(() => {
    if (s) return;
    const a = () => {
      var _a3, _b2, _c2;
...
`;
  ...
  l.useEffect(() => {
    ...
    return vt({ editorRef: h, getEditorApi: a, onChange: B, getMarkdown: () => {
      ...
      return ((_f = (_e2 = (_d = (_c2 = (_b2 = (_a3 = a()) == null ? void 0 : _a3.getEditorView) == null ? void 0 : _b2.call(_a3)) == null ? void 0 : _c2.state) == null ? void 0 : _d.doc) == null ? void 0 : _e2.toString) == null ? void 0 : _f.call(_e2)) ?? Z.current ?? "";
    } });
    ...
    return ks({ getMarkdown: () => {
      var _a3;
      return ((_a3 = a()) == null ? void 0 : _a3.state.doc.toString()) ?? Z.current ?? "";
    }, insertExisting: (m) => {
      c();
      const p = a(), b = (p == null ? void 0 : p.state.doc.toString()) ?? Z.current ?? "", g = p == null ? void 0 : p.state.selection.main, v = Js(b, (g == null ? void 0 : g.from) ?? 0, (g == null ? void 0 : g.to) ?? 0, m);
      d(v.next, v.caret);
    }, openCompose: () => {
      var _a3;
      c();
  ...
  l.useEffect(() => {
    ...
    if (fe) return Ui(fe, { getEditorRoot: () => P.current, mdHeadingId: (a) => H(a) });
  }, [fe, H]), _i(P, e, A, (i == null ? void 0 : i.id) ?? null), Cs(P, { layoutKey: r }), l.useEffect(() => {
    const a = P.current;
    if (!a || !e) return;
    let c = 0;
    const d = () => {
    ...
    const p = (S) => S instanceof Element ? Ct(S) ? true : !!S.closest("a, button, input, textarea, select, .md-editor-code-action, [data-transform-handle]") : false, b = (S) => {
      ...
      const U = (_e2 = (_d = ((_c2 = h.current) == null ? void 0 : _c2.value) ?? h.current) == null ? void 0 : _d.getEditorView) == null ? void 0 : _e2.call(_d);
      U && ((G == null ? void 0 : G.rangeCount) && R.contains(G.getRangeAt(0).commonAncestorContainer) && jt(R, { allowCollapsed: true }), xn(U, R, { focus: true, target: S }), Mt(), (_f = Y.current) == null ? void 0 : _f.schedule({ withRetries: true }));
      ...
      if (!(!R || !(S.target instanceof Node) || !R.contains(S.target)) && !p(S.target)) {
        if (Nt(a)) {
          ...
          const U = (_c2 = (_b2 = ((_a3 = h.current) == null ? void 0 : _a3.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2), W = S.target instanceof Element ? hn(S.target, R) : null;
          U && W && (Mt(), gn(W, U, R, S.clientX, S.clientY));
          return;
        }
      ...
      if (!(!R || !(S.target instanceof Node) || !R.contains(S.target)) && !p(S.target)) {
        if (Nt(a)) {
          if (!d()) return;
          const de = (_c2 = (_b2 = ((_a3 = h.current) == null ? void 0 : _a3.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2), U = (_d = S.changedTouches) == null ? void 0 : _d[0], W = S.target instanceof Element ? hn(S.target, R) : null;
          de && W && U && (Mt(), gn(W, de, R, U.clientX, U.clientY));
          return;
        }
      ...
      const G = S.target, de = G instanceof Node && R.contains(G), U = (_a3 = window.getSelection) == null ? void 0 : _a3.call(window), W = (U == null ? void 0 : U.rangeCount) > 0 && R.contains(U.getRangeAt(0).commonAncestorContainer);
      if (!de && !W) return;
      const Ee = (_d = (_c2 = ((_b2 = h.current) == null ? void 0 : _b2.value) ?? h.current) == null ? void 0 : _c2.getEditorView) == null ? void 0 : _d.call(_c2);
      Ee && (Ee.hasFocus || (W ? (jt(R, { allowCollapsed: true }), xn(Ee, R, { focus: true }), (_e2 = Y.current) == null ? void 0 : _e2.schedule({ withRetries: true })) : Ee.focus()));
    };
    ...
    var _a3, _b2, _c2, _d;
    if (s) {
      (_a3 = J.current) == null ? void 0 : _a3.stop(), J.current = null, (_b2 = Y.current) == null ? void 0 : _b2.stop(), Y.current = null, Lt();
      return;
    }
    const a = P.current, c = () => {
      var _a4;
    ...
    (_c2 = J.current) == null ? void 0 : _c2.stop();
    const m = Dc({ getPreviewRoot: c, getView: d });
    J.current = m, (_d = Y.current) == null ? void 0 : _d.stop(), Y.current = null, oe ? Y.current = jc({ getPreviewRoot: c, getView: d }) : Lt();
    const p = kc((b, g) => {
      var _a4;
      const v = d();
      !v || b !== v || (m.schedule({ withRetries: g.docChanged }), oe && ((_a4 = Y.current) == null ? void 0 : _a4.schedule({ withRetries: g.docChanged })));
    });
    return () => {
      var _a4, _b3;
      p(), (_a4 = Y.current) == null ? void 0 : _a4.stop(), Y.current = null, (_b3 = J.current) == null ? void 0 : _b3.stop(), J.current = null;
    };
  }, [s, oe]), l.useEffect(() => {
    if (s || ae || !oe) {
      js();
    ...
    if (Ls(), !!c && ((_b2 = J.current) == null ? void 0 : _b2.schedule({ withRetries: true }), !ae)) {
      if (oe && !Ve(c)) {
        (_c2 = Y.current) == null ? void 0 : _c2.schedule({ withRetries: true });
        return;
      }
      oe || Oe(c);
    }
...
`), V = ((_c2 = (_b2 = ((_a4 = h.current) == null ? void 0 : _a4.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2)) ?? v;
    ...
    const c = (d) => {
      ...
      if (b && a.contains(b)) {
        ...
        if (X) {
          const { from: V, to: ie } = X.state.selection.main, S = Z.current ?? "";
          if (zs(S, V, ie)) {
      ...
      d.preventDefault();
      const j = v.kind === "wiki" ? Ws(a, g, v.key) : Us(a, g, v.key);
    ...
    const c = (p) => {
      ...
      if (g && a.contains(g)) {
        p.preventDefault(), p.stopPropagation(), y(Ys({ id: g.getAttribute("data-chat-id") || "", href: g.getAttribute("data-chat-href") || g.getAttribute("href") || "" }));
        return;
      }
  ...
  const Jr = l.useCallback(({ width: a, height: c }) => {
    const d = I;
  ...
  }, [I, B, e]), Zr = l.useCallback(async ({ file: a }) => {
    var _a3;
    const c = I;
  ...
  const xe = l.useCallback((a) => {
    ...
    c.style.width = `${m}px`, c.style.height = `${p}px`, ge.current = b, He(b), ke(false);
  }, [xe, I]);
  l.useEffect(() => {
    if (!re) {
      gt(null);
    ...
    const c = (p) => {
      ...
      const v = p.pointerType === "touch", j = ge.current || re, _ = p.clientX, X = p.clientY, V = j.heightPx > 0 ? j.widthPx / j.heightPx : 1, ie = (R) => {
        ...
        let U = j.widthPx, W = j.heightPx;
        if (g.includes("e") && (U = j.widthPx + G), g.includes("w") && (U = j.widthPx - G), g.includes("s") && (W = j.heightPx + de), g.includes("n") && (W = j.heightPx - de), U = Math.max(24, U), W = Math.max(24, W), v || R.shiftKey) {
          const uo = Math.abs((U - j.widthPx) / Math.max(1, j.widthPx)), fo = Math.abs((W - j.heightPx) / Math.max(1, j.heightPx));
          uo >= fo ? W = Math.max(24, U / Math.max(1e-4, V)) : U = Math.max(24, W * V);
        }
        U = Math.max(24, Math.round(U)), W = Math.max(24, Math.round(W)), a.style.width = `${U}px`, a.style.height = `${W}px`;
        const Ee = { ...ge.current || j, widthPx: U, heightPx: W };
        ge.current = Ee, He(Ee);
      }, S = () => {
  ...
  const ro = l.useCallback(() => {
    ...
    a && (nn(a), He(null), ge.current = null, ke(false));
  }, [nn, re]), oo = l.useCallback(() => {
    const a = ge.current || re;
    if (!a) return;
    const c = xe(a);
    c && (c.style.width = `${a.originalWidthPx}px`, c.style.height = `${a.originalHeightPx}px`), He(null), ge.current = null, ke(false);
...
`), Je(null);
  ...
  const io = l.useMemo(() => [o.jsx(sa, { value: e, theme: r, currentFile: i, language: "ko-KR" }, "export-pdf"), o.jsx(ia, { editorRef: h }, "insert-pgbr"), o.jsx(aa, { onOpen: ot }, "heading-remap"), o.jsx(Yi, { active: !!(z == null ? void 0 : z.open), onToggle: () => {
    var _a3;
    (_a3 = z == null ? void 0 : z.toggleAssist) == null ? void 0 : _a3.call(z);
  } }, "llm-assist"), o.jsx(oa, { onOpen: () => {
    O(true);
  } }, "checklist-progress"), o.jsx(pa, { checked: wt, onChange: Jt, theme: r }, "toc-title-wrap"), o.jsx(ha, { checked: _e, onChange: Zt, theme: r }, "base64-image-fold"), o.jsx(ga, { checked: en, onChange: tn, theme: r }, "editor-autocomplete"), ae ? null : o.jsx(xa, { checked: oe, onChange: et, theme: r }, "mirror-edit"), o.jsx(ba, { disabled: typeof f != "function", onRequestLink: () => Me(true), onRequestUpload: (a) => {
    rt(a);
  }, onRequestClip: (a) => Je(a) }, "image-toolbar")], [e, r, i, wt, Jt, _e, Zt, en, tn, ae, oe, et, f, rt, ot, z == null ? void 0 : z.open, z == null ? void 0 : z.toggleAssist]), ao = l.useMemo(() => ["bold", "underline", "italic", "-", "strikeThrough", "sub", "sup", "quote", "unorderedList", "orderedList", "task", "-", "codeRow", "code", "link", 9, "table", "mermaid", "katex", 1, 2, 3, 4, "-", "revoke", "next", 0, "=", 6, 7, ...ae ? [] : [8], "pageFullscreen", "fullscreen", "previewOnly", "preview", "htmlPreview", ...fe ? [5] : [], "catalog"], [fe, ae]), co = l.useMemo(() => {
  ...
  return o.jsxs("div", { ref: P, className: `h-full w-full flex flex-col relative${wt ? " toc-titles-wrap" : ""}`, style: { "--md-catalog-width": `${tt}px`, ...Qr }, children: [(nt == null ? void 0 : nt.webfontCss) ? o.jsx("style", { "data-s3haim-document-webfonts": "1", children: nt.webfontCss }) : null, Ze && po.createPortal(o.jsx($s, { handleProps: Xr, isResizing: Gr, visibleOnHover: true, label: "TOC resize handle", style: { position: "fixed", top: Ze.top, left: Ze.left, height: Ze.height, bottom: "auto", zIndex: 10003 } }), document.body), x && o.jsxs("div", { className: "absolute top-0 left-0 right-0 bottom-0 z-10 flex items-center justify-center gap-2 py-2 text-sm bg-blue-300/40 dark:bg-blue-800/50 text-blue-700 dark:text-blue-300 border-b border-blue-500/20", "aria-live": "polite", children: [o.jsx(hi, { size: 16, className: "animate-spin shrink-0" }), o.jsxs("span", { children: ["Uploading image... ", Math.max(0, Math.min(100, Math.round(k))), "%"] }), typeof w == "function" && o.jsx("button", { type: "button", onClick: w, className: "ml-2 rounded-md border border-blue-600/50 bg-white/80 px-2 py-1 text-xs font-medium text-blue-800 hover:bg-white dark:border-blue-300/40 dark:bg-blue-950/60 dark:text-blue-100 dark:hover:bg-blue-950", children: "Cancel" })] }), o.jsx(So, { ref: h, id: K, modelValue: e, onChange: B, mdHeadingId: H, className: "h-full! max-h-dvh", theme: r, language: "ko-KR", codeTheme: Bs, customIcon: _s, previewOnly: s, noMermaid: true, autoDetectCode: true, scrollAuto: false, footers: ["markdownTotal"], toolbars: ao, defToolbars: io, onUploadImg: co }, `footnotes-${ue}`), o.jsx(ji, { containerRef: P }), o.jsx(Ri, { containerRef: P }), o.jsx(Hi, { isOpen: !!I, onClose: () => se(null), path: (I == null ? void 0 : I.key) ?? "", kind: (I == null ? void 0 : I.kind) ?? "wiki", initialWidth: (I == null ? void 0 : I.width) ?? "", initialHeight: (I == null ? void 0 : I.height) ?? "", imageSrc: (I == null ? void 0 : I.imageSrc) ?? "", onApply: Jr, onStartFreeTransform: no, onCrop: Zr, onConvertToWiki: eo, onConvertToImgbb: to }, I ? `${I.kind}|${I.key}|${I.width ?? ""}|${I.height ?? ""}|${I.occurrence ?? 0}` : "wiki-image-size-modal"), o.jsx(wa, { isOpen: ye, onClose: () => Me(false), onConfirm: ({ desc: a, url: c }) => {
    Be(`![${a || ""}](${c})
`);
  } }), o.jsx(ya, { isOpen: Xe, onClose: () => ve(false), onConfirm: ({ line1: a, line2: c }) => {
    var _a3, _b2, _c2, _d, _e2;
    const m = (_c2 = (_b2 = ((_a3 = h.current) == null ? void 0 : _a3.value) ?? h.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2), p = (m == null ? void 0 : m.state.doc.toString()) ?? Z.current ?? "", { from: b, to: g } = Qe.current, v = Os(p, b, g, a, c);
    ...
    if (c === "selection" && je) {
      const { from: d, to: m } = je, p = Z.current ?? e, b = `${p.slice(0, d)}${a}${p.slice(m)}`;
      b !== p && B(b);
    } else a !== e && B(a);
    he(false), Ie(null);
