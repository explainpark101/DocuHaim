                          ...
                          onClick: async () => {
                            try {
                              const { createWebdavBackend: d } = await hr(async () => {
                                const { createWebdavBackend: Q } = await import("./index-y-7LfBXB.js").then(async (m2) => {
                                  await m2.__tla;
                                  return m2;
                                }).then(($e) => $e.gY);
                                return {
