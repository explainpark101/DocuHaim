...
import { au as T, ac as _, av as W } from "./index-DZXxTXv9.js";
import { E as D, k as V, aD as P } from "./vendor-lucide-CLhpI-Mc.js";
...
function A({ value: i = "", mode: t = "html", theme: r = "light", readOnly: c = false, onChange: x, onSave: g }) {
  ...
  const S = () => {
    p((d) => {
      const M = n.indexOf(d);
      return n[(M + 1) % n.length];
    });
  }, s = b[o] ?? b.dual, k = s.icon, f = l.useMemo(() => t === "svg" ? "SVG preview" : "HTML preview", [t]);
  return e.jsxs("div", { className: "flex h-full min-h-0 flex-1 flex-col overflow-hidden", children: [e.jsxs("div", { className: "flex shrink-0 items-center justify-between gap-2 border-b border-gray-200 bg-gray-50/90 px-3 py-1.5 dark:border-odp-borderSoft dark:bg-odp-bgSoft/90", role: "toolbar", "aria-label": t === "svg" ? "SVG editor" : "HTML editor", children: [e.jsx("span", { className: "text-xs font-medium text-gray-600 dark:text-odp-muted", children: t === "svg" ? "SVG" : "HTML" }), e.jsxs(_, { type: "button", variant: "secondary", size: "sm", onClick: S, title: s.title, "aria-label": s.title, children: [e.jsx(k, { size: 14, "aria-hidden": true }), e.jsxs("span", { className: "hidden sm:inline", children: [" ", s.label] })] })] }), e.jsxs("div", { className: "flex min-h-0 flex-1 overflow-hidden", children: [a && e.jsx("div", { className: "flex min-h-0 min-w-0 flex-1 flex-col p-2", children: e.jsx(N, { value: i, language: j, theme: r, readOnly: c, onChange: x, onSave: g }) }), a && h && e.jsxs("div", { className: "relative shrink-0 border-l border-gray-200 dark:border-odp-borderSoft", style: { width: v }, children: [e.jsx(W, { handleProps: E, isResizing: y, label: "Resize preview panel" }), e.jsx("iframe", { title: f, srcDoc: m, sandbox: "allow-scripts allow-forms allow-modals", className: "h-full w-full border-0 bg-white dark:bg-odp-bg" })] }), !a && h && e.jsx("div", { className: "min-h-0 min-w-0 flex-1 overflow-hidden", children: e.jsx("iframe", { title: f, srcDoc: m, sandbox: "allow-scripts allow-forms allow-modals", className: "h-full w-full border-0 bg-white dark:bg-odp-bg" }) })] })] });
}
export {
  A as default
};
