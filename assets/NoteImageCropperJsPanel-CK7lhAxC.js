...
import { _ as T, __tla as __tla_0 } from "./vendor-md-editor-CyUZNHY0.js";
import { r as a, j as n, __tla as __tla_1 } from "./vendor-react-SY5QCjFA.js";
import { f as A } from "./storageImageHydration-DefkOGje.js";
import { v as P, b6 as D, aI as M } from "./vendor-lucide-CLhpI-Mc.js";
import { K as Y, M as O } from "./vendor-radix-Do7C1uSR.js";
import { __tla as __tla_2 } from "./index-DYocwnql.js";
      ...
      const o = async () => {
        ...
        try {
          const { default: i } = await T(async () => {
            const { default: l } = await import("./vendor-image-crop-Loz3ogoo.js").then((m) => m.c);
            return {
              default: l
            };
          }, __vite__mapDeps([0,1]));
          ...
          K(r.getCropperSelection()), d.current = r, v(true);
        } catch (i) {
    ...
    const _ = async () => {
      ...
      if (!(!t || w || !b)) {
        ...
        try {
          ...
          const f = o.$getTransform(), i = q(r, f), c = await r.$toCanvas({
            width: i.width,
            height: i.height,
            ...y ? {} : {
              beforeDraw: (x, z) => {
