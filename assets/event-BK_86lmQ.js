import { invoke as n, transformCallback as d } from "./core-DhEqZVGG.js";
var i;
(function(e) {
...
async function _(e, r) {
  window.__TAURI_EVENT_PLUGIN_INTERNALS__.unregisterListener(e, r), await n("plugin:event|unlisten", { event: e, eventId: r });
}
async function u(e, r, t) {
  var a;
  const l = typeof (t == null ? void 0 : t.target) == "string" ? { kind: "AnyLabel", label: t.target } : (a = t == null ? void 0 : t.target) !== null && a !== void 0 ? a : { kind: "Any" };
  return n("plugin:event|listen", { event: e, target: l, handler: d(r) }).then((D) => async () => _(e, D));
}
...
async function o(e, r) {
  await n("plugin:event|emit", { event: e, payload: r });
}
async function s(e, r, t) {
  await n("plugin:event|emit_to", { target: typeof e == "string" ? { kind: "AnyLabel", label: e } : e, event: r, payload: t });
}
export {
  i as TauriEvent,
  o as emit,
