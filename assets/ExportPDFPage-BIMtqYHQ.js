import { r as d, j as t, a as ss, f as va, u as ka } from "./vendor-react-BFxggocB.js";
import { A as ja } from "./vendor-md-editor-B7IajafM.js";
import { aC as Fe, aD as Ve, aE as Ce, aF as _e, aG as Nt, aH as vn, aI as Oi, aJ as _i, aK as Sa, aL as ks, aM as Fi, aN as js, aO as Na, aP as Ca, aQ as is, aR as pn, aS as Ss, a1 as Bi, Y as wr, aT as Ea, aU as qr, aV as Pa, aW as os, aX as Ta, aY as Xs, aZ as Hi, a_ as Ae, ah as kr, a$ as sn, $ as as, b0 as ls, b1 as cs, b2 as Ra, b3 as Ma, b4 as La, b5 as za, b6 as Aa, b7 as Wi, b8 as Ki, b9 as Ia, ba as Da, bb as Gi, bc as Xi, bd as Ui, be as Bn, bf as Lr, bg as $a, bh as Oa, a8 as _a, bi as Vi, bj as Br, bk as vr, bl as Us, bm as Vs, bn as Zr, bo as Jr, bp as Ys, bq as Fa, br as Ba, bs as Ha, bt as Wa, bu as Ka, bv as Ga, bw as Xa, bx as Ua, by as Va, bz as Ya, bA as qa, bB as Za, bC as Ja, bD as qs, bE as Qa, bF as el, T as Yi, a9 as tl, bG as on, bH as rl, bI as Hn, bJ as nl, bK as sl, bL as ds, bM as us, bN as il, bO as ol, bP as al, bQ as ll, bR as cl, bS as dl, bT as ul, bU as fl, bV as pl, bW as ml, bX as hl, bY as xl, bZ as gl, b_ as bl, b$ as wl, A as Wn, c0 as Kn, P as Zs, c1 as yl, c2 as vl, c3 as kl, c4 as jl, c5 as Sl, aq as ot, c6 as Nl, c7 as Gn, c8 as Qr, c9 as Cl, ca as El, cb as Pl, cc as Js, cd as Qs, ce as Tl, au as Xn, cf as Un, av as Rl, cg as ei, ch as Ml, aw as Ll, ax as zl, ab as Al, ay as Il, ci as Dl, cj as $l, ck as Ol, cl as _l, cm as en, cn as Fl, co as Bl, M as Hl, cp as Wl, cq as Kl, aA as Gl, cr as Xl, cs as Ul } from "./index-DPH8WKK6.js";
import { J as mt, k as St, m as Vl, K as Yl, N as ql, C as Zl, O as Jl, Q as qi, x as Zi, R as Ji, V as Ns, W as Cs, Y as Es, Z as Ps, a as Ql, _ as ec, $ as tc, a0 as rc, a1 as nc, a2 as Ts, a3 as Rs, a4 as kn, a5 as jn, a6 as Sn, a7 as Nn, a8 as Qi, a9 as Cn, aa as En, ab as Pn, ac as eo, l as to, ad as ro, ae as no, af as sc, T as an, ag as ln, D as so, ah as ic, ai as io, I as Vn, aj as oc, ak as ac, al as Yn, am as lc, an as cc, ao as dc, ap as uc, aq as fc, ar as pc, as as mc, at as hc, A as ti, au as xc, z as gc, y as bc, av as wc, aw as yc } from "./vendor-lucide-BiQHrkcf.js";
import { r as Ft, s as Bt, t as Ht, v as Wt, w as Kt, x as Gt, y as Xt, z as Ut, B as Vt, D as Yt, S as tr, g as rr, E as vc, G as kc, H as jc, I as Sc, b as Nc, d as zt, T as At, e as It, f as Dt, A as $t, J as Cc, K as Ec } from "./vendor-radix-ACO_3onn.js";
import { C as Ir, g as fs, a as cn, c as oo, n as ri, b as Pc, d as Tc, e as Rc, f as Mc, u as Lc, w as zc, r as Ac, h as Ic, H as Dc, P as $c } from "./previewFootnoteScroll-Di1g0QJJ.js";
import { c as Oc, C as ni, a as ft, b as _c, d as jt } from "./ChatImageBackgroundPicker-DWgmZqz6.js";
import { S as kt, g as Fc } from "./SliderWithScrubInput-BzazJItT.js";
import { N as Bc, u as Hc, t as Wc, W as Kc } from "./useTocTitleWrap-DULyMXvh.js";
import { m as ao } from "./vendor-motion-b8oTnHK_.js";
import { T as Gc } from "./TocTitleWrapToggle-DXgcoeyk.js";
import { u as Xc } from "./useWikiImageHydration-B8bs0Nrl.js";
...
function Jc(e, r) {
  const n = [...new Set(r)].filter((x) => e.elements.some((m) => m.id === x));
  ...
  for (const x of e.elements) {
    ...
    const m = i.get(x.id);
    if (!m) continue;
    const w = x.groupId ? o.get(x.groupId) : void 0, y = { ...x, id: m };
  ...
  for (const [x, m] of o) {
    ...
    c.push({ id: m, name: (w == null ? void 0 : w.name) ? `${w.name} \uBCF5\uC0AC` : "\uADF8\uB8F9", childIds: y });
  }
  u = { ...u, groups: [...u.groups, ...c], elements: [...u.elements, ...a] };
  const b = Ve(e, n).map((x) => i.get(x) ?? o.get(x)).filter((x) => !!x);
  for (const x of [...b].reverse()) u = { ...u, rootLayerIds: [x, ...(u.rootLayerIds ?? []).filter((m) => m !== x)] };
...
function hs(e, r) {
  const n = Fe(e), s = Ve(n, r), i = s.length ? s : [...r];
  return vn(n, i);
}
function xs(e, r, n) {
  return Na(e, r, n);
...
function od(e, r, n = {}) {
  ...
  const m = (re) => u > 0 ? re / u * 100 : b, w = (re) => c > 0 ? re / c * 100 : b, y = o != null && u > 0 ? m(o) : b, g = o != null && c > 0 ? w(o) : b, k = a != null && u > 0 ? m(a) : x, N = a != null && c > 0 ? w(a) : x, L = e.x, C = e.x + e.w, E = e.x + e.w / 2, _ = e.y, O = e.y + e.h, z = e.y + e.h / 2, G = [], U = [];
  if (s) for (const re of r) G.push(re.x, re.x + re.w / 2, re.x + re.w), U.push(re.y, re.y + re.h / 2, re.y + re.h);
  const R = [L, E, C], I = [_, z, O], se = s ? _t(R, G, y) : null, Y = s ? _t(I, U, g) : null, ie = i ? _t([E], [50], k) : null, ke = i ? _t([z], [50], N) : null, de = (re, V) => re ? V ? Math.abs(re.delta) <= Math.abs(V.delta) ? re : V : re : V, $ = de(se, ie), q = de(Y, ke);
...
function ld(e, r, n, s = {}) {
  ...
  const x = (I) => c > 0 ? I / c * 100 : Ir, m = (I) => f > 0 ? I / f * 100 : Ir, w = a != null && c > 0 ? x(a) : Ir, y = a != null && f > 0 ? m(a) : Ir, g = [], k = [];
  ...
  if (G) {
    ...
    const I = N, se = N + C, Y = _t([I], g, w);
    if (Y) {
      const ie = yr(I + Y.delta, 0, se - b);
      C = se - ie, N = ie, _.push(Y.guide);
    }
  }
  if (R) {
    ...
    const I = L, se = L + E, Y = _t([I], k, y);
    if (Y) {
      const ie = yr(I + Y.delta, 0, se - b);
      E = se - ie, L = ie, O.push(Y.guide);
    }
  }
...
function ho(e, r) {
  const n = Fe(e), s = Ve(n, r), i = s.length === 1 && _e(n, s[0]) ? s[0] : null, o = [];
  for (const a of s) {
    const u = mo(n, a);
    u && o.push(u);
  }
...
function dd(e, r, n, s = 0) {
  ...
  const i = Math.max(0, s), o = { x: Math.min(...r.map((m) => m.bounds.x)), y: Math.min(...r.map((m) => m.bounds.y)), right: Math.max(...r.map((m) => m.bounds.x + m.bounds.w)), bottom: Math.max(...r.map((m) => m.bounds.y + m.bounds.h)) }, a = o.right - o.x, u = o.bottom - o.y, c = /* @__PURE__ */ new Map(), f = (m, w, y) => {
    for (const g of m.memberIds) c.set(g, { dx: w, dy: y });
  };
  if (n === "left") for (const m of r) f(m, o.x - m.bounds.x, 0);
  else if (n === "centerX") {
    const m = o.x + a / 2;
    for (const w of r) f(w, m - (w.bounds.x + w.bounds.w / 2), 0);
  } else if (n === "right") for (const m of r) f(m, o.right - (m.bounds.x + m.bounds.w), 0);
  else if (n === "top") for (const m of r) f(m, 0, o.y - m.bounds.y);
  else if (n === "centerY") {
    const m = o.y + u / 2;
    for (const w of r) f(w, 0, m - (w.bounds.y + w.bounds.h / 2));
  } else if (n === "bottom") for (const m of r) f(m, 0, o.bottom - (m.bounds.y + m.bounds.h));
  else if (n === "distributeX") {
    const m = [...r].sort((w, y) => w.bounds.x - y.bounds.x);
    if (m.length === 2) {
      const w = m[0], y = m[1], g = w.bounds.x + w.bounds.w + i;
      f(y, g - y.bounds.x, 0);
    } else {
      const w = m[0], k = (m[m.length - 1].bounds.x - w.bounds.x) / (m.length - 1);
      m.slice(1, -1).forEach((N, L) => {
        const C = w.bounds.x + k * (L + 1);
        f(N, C - N.bounds.x, 0);
      });
    }
  } else if (n === "distributeY") {
    const m = [...r].sort((w, y) => w.bounds.y - y.bounds.y);
    if (m.length === 2) {
      const w = m[0], y = m[1], g = w.bounds.y + w.bounds.h + i;
      f(y, 0, g - y.bounds.y);
    } else {
      const w = m[0], k = (m[m.length - 1].bounds.y - w.bounds.y) / (m.length - 1);
      m.slice(1, -1).forEach((N, L) => {
  ...
  if (!e.elements.filter((m) => c.has(m.id)).length) return e;
  const x = /* @__PURE__ */ new Map();
  for (const m of r) {
    const w = m.memberIds[0];
    if (!w) continue;
    const y = c.get(w);
    if (!y) continue;
    let { dx: g, dy: k } = y;
    for (const N of m.memberIds) {
    ...
    for (const N of m.memberIds) x.set(N, { dx: g, dy: k });
  }
  return { ...e, elements: e.elements.map((m) => {
    const w = x.get(m.id);
    return !w || w.dx === 0 && w.dy === 0 ? m : { ...m, x: di(m.x + w.dx, 0, 100 - m.w), y: di(m.y + w.dy, 0, 100 - m.h) };
  }) };
}
...
function fd(e, r, n, s, i, o) {
  if (o) {
    ...
    let m = 0, w = 0;
    r.includes("e") && (m += n), r.includes("w") && (m -= n), r.includes("s") && (w += s), r.includes("n") && (w -= s);
    const y = Math.max(i, 2 * Math.min(b, 100 - b)), g = Math.max(i, 2 * Math.min(x, 100 - x)), k = le(e.w + 2 * m, i, y), N = le(e.h + 2 * w, i, g);
...
function pd(e, r, n, s, i, o, a) {
  ...
  const b = e.w / Math.max(e.h, 1e-3) * (i / o), x = e.naturalAspect && e.naturalAspect > 0 ? e.naturalAspect : b, m = (C) => C * i / (o * x), w = (C) => C * o * x / i;
  if (c) {
    ...
    const U = r.length === 2;
    let R, I;
    return U ? Math.abs(n) * i >= Math.abs(s) * o ? (R = le(e.w + 2 * z, 4, _), I = m(R), I > O && (I = O, R = le(w(I), 4, _))) : (I = le(e.h + 2 * G, 4, O), R = w(I), R > _ && (R = _, I = le(m(R), 4, O))) : r === "e" || r === "w" ? (R = le(e.w + 2 * z, 4, _), I = m(R), I > O && (I = O, R = le(w(I), 4, _))) : (I = le(e.h + 2 * G, 4, O), R = w(I), R > _ && (R = _, I = le(m(R), 4, O))), { ...e, x: C - R / 2, y: E - I / 2, w: R, h: I };
  }
  ...
  if (r.length === 2) if (Math.abs(n) * i >= Math.abs(s) * o) {
    ...
    N = m(k), r.includes("n") && (g = le(e.y + e.h - N, 0, 100 - N)), g + N > 100 && (N = 100 - g, k = w(N), r.includes("w") && (y = le(e.x + e.w - k, 0, 100 - k)));
  } else {
    if (r.includes("s") && (N = le(e.h + s, 4, 100 - e.y)), r.includes("n")) {
      const E = le(e.h - s, 4, e.y + e.h);
      g = le(e.y + (e.h - E), 0, 100 - E), N = E;
    }
    k = w(N), r.includes("w") && (y = le(e.x + e.w - k, 0, 100 - k)), y + k > 100 && (k = 100 - y, N = m(k), r.includes("n") && (g = le(e.y + e.h - N, 0, 100 - N)));
  }
  else if (r === "e" || r === "w") {
    ...
    N = m(k), g = le(e.y + (e.h - N) / 2, 0, 100 - N);
  } else {
...
function md({ isOpen: e, onClose: r, fonts: n, onFontsChange: s }) {
  ...
  return t.jsx(Bi, { isOpen: e, onClose: r, onConfirm: a ? void 0 : m, ignoreEnterInFields: true, children: t.jsxs("div", { className: "p-6 flex flex-col gap-4", children: [t.jsx("h2", { className: "text-lg font-bold text-gray-800 dark:text-odp-fgStrong", children: "\uD504\uB9B0\uD2B8 \uD3F0\uD2B8 \uC124\uC815" }), t.jsx("p", { className: "text-xs text-gray-500 dark:text-odp-muted", children: "PDF\uB85C \uB0B4\uBCF4\uB0BC \uB54C \uC801\uC6A9\uB420 \uD3F0\uD2B8\uB97C \uC124\uC815\uD569\uB2C8\uB2E4. \uBE44\uC6CC\uB450\uBA74 \uAE30\uBCF8 \uD3F0\uD2B8\uAC00 \uC0AC\uC6A9\uB429\uB2C8\uB2E4. \uC6F9\uD3F0\uD2B8\uB294 \uC124\uC815 \u2192 \uC6F9\uD3F0\uD2B8(CSS)\uC5D0\uC11C \uCD94\uAC00\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4." }), t.jsxs("div", { className: "grid gap-4", children: [t.jsxs("label", { className: "block", children: [t.jsx("span", { className: "block text-sm font-medium text-gray-700 dark:text-odp-fgStrong mb-1", children: "\uBCF8\uBB38" }), t.jsx(wr, { id: "print-font-body", value: i.body, onChange: (y) => x("body", y), options: b, placeholder: "\uC608: Noto Sans KR, serif" })] }), t.jsxs("label", { className: "block", children: [t.jsx("span", { className: "block text-sm font-medium text-gray-700 dark:text-odp-fgStrong mb-1", children: "\uC81C\uBAA9 (h1~h10)" }), t.jsx(wr, { id: "print-font-heading", value: i.heading, onChange: (y) => x("heading", y), options: b, placeholder: "\uC608: Noto Serif KR, Georgia" })] }), t.jsxs("label", { className: "block", children: [t.jsx("span", { className: "block text-sm font-medium text-gray-700 dark:text-odp-fgStrong mb-1", children: "\uAD75\uC740 \uAE00\uC528 (b, strong)" }), t.jsx(wr, { id: "print-font-bold", value: i.bold, onChange: (y) => x("bold", y), options: b, placeholder: "\uC608: Noto Sans KR, sans-serif" })] }), t.jsxs("label", { className: "block", children: [t.jsx("span", { className: "block text-sm font-medium text-gray-700 dark:text-odp-fgStrong mb-1", children: "\uCF54\uB4DC \uBE14\uB85D (code, pre)" }), t.jsx(wr, { id: "print-font-code", value: i.code, onChange: (y) => x("code", y), options: b, placeholder: "\uC608: Consolas, monospace" })] })] }), t.jsxs("div", { className: "flex items-center justify-between gap-2 pt-2", children: [t.jsx("button", { type: "button", onClick: w, className: "text-sm text-gray-500 hover:text-gray-700 dark:text-odp-muted dark:hover:text-odp-fg", children: "\uAE30\uBCF8\uAC12\uC73C\uB85C \uCD08\uAE30\uD654" }), t.jsxs("div", { className: "flex gap-2", children: [t.jsx("button", { type: "button", onClick: r, className: "px-4 py-2 text-sm font-medium text-gray-700 dark:text-odp-fgStrong bg-gray-100 dark:bg-odp-bgSoft hover:bg-gray-200 dark:hover:bg-odp-focusBg rounded transition", children: "\uCDE8\uC18C" }), t.jsx("button", { type: "button", onClick: m, disabled: a, className: "px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded transition disabled:opacity-50 disabled:cursor-not-allowed", children: a ? "\uC800\uC7A5 \uC911\u2026" : "\uC801\uC6A9" })] })] })] }) });
}
function hd({ maxWidth: e, maxHeight: r, widthFallback: n = "718px", heightFallback: s = "1047px", onChange: i }) {
  const [o, a] = d.useState(e), [u, c] = d.useState(r), [f, b] = d.useState(false), [x, m] = d.useState(false), w = d.useRef(null), y = d.useRef(null), g = d.useRef({ maxWidth: e, maxHeight: r, onChange: i, widthFallback: n, heightFallback: s });
  ...
  const k = (C) => /^\d+px$/i.test(C.trim()), N = (C) => {
    ...
    m(false), c(E), E !== r && i({ maxWidth: e, maxHeight: E });
  };
  return d.useEffect(() => {
    ...
    const _ = (G, U) => {
      const R = (I) => {
        ...
        const se = I.deltaY < 0 ? 1 : -1, { maxWidth: Y, maxHeight: ie, onChange: ke, widthFallback: de, heightFallback: $ } = g.current, q = G.value, T = U === "width" ? de : $, H = Pa(q, se, { shiftKey: I.shiftKey, altKey: I.altKey, emptyFallback: T });
        if (H !== null) {
          if (U === "width") {
            a(H), b(false), H !== Y && ke({ maxWidth: H, maxHeight: ie });
            return;
          }
          c(H), m(false), H !== ie && ke({ maxWidth: Y, maxHeight: H });
        }
      };
    ...
    c(E);
    const _ = qr(E);
    m(_ === null), _ !== null && k(E) && _ !== r && i({ maxWidth: e, maxHeight: _ });
...
const Jn = [{ value: "scroll", label: "\uC2A4\uD06C\uB864", Icon: Vl }, { value: "flip", label: "\uB118\uAE30\uAE30", Icon: Yl }];
...
function Cd(e) {
  const { viewportWidth: r, viewportHeight: n, pageWidthPx: s, pageHeightPx: i, pageCols: o, gapPx: a = nr, paddingPx: u = 32 } = e, c = Math.max(1, r - u * 2), f = Math.max(1, n - u * 2), b = s * o + (o > 1 ? a : 0), x = i, m = Math.min(c / b, f / x), w = Math.floor(m * 100 / Fr) * Fr;
...
function Bd(e) {
  ...
  for (const n of r) {
    ...
    const u = (c) => {
      let f = c;
      const b = [...o.entries()].sort((x, m) => m[0].length - x[0].length);
      for (const [x, m] of b) f = f.split(x).join(m);
      return f;
    };
...
function Hd(e) {
  ...
  for (const w of n.querySelectorAll("[id]")) w.id && m.add(w.id);
  for (const w of r.querySelectorAll("[id]")) m.has(w.id) && w.removeAttribute("id");
...
function jo(e, r = true, n = {}) {
  ...
  d.useEffect(() => {
    ...
    return s && (window.addEventListener("keydown", f, true), window.addEventListener("keyup", b, true), window.addEventListener("blur", x)), e.addEventListener("pointerdown", m, true), e.addEventListener("pointermove", w), e.addEventListener("pointerup", y), e.addEventListener("pointercancel", y), e.addEventListener("lostpointercapture", g), i && e.addEventListener("auxclick", k), () => {
      s && (window.removeEventListener("keydown", f, true), window.removeEventListener("keyup", b, true), window.removeEventListener("blur", x)), e.removeEventListener("pointerdown", m, true), e.removeEventListener("pointermove", w), e.removeEventListener("pointerup", y), e.removeEventListener("pointercancel", y), e.removeEventListener("lostpointercapture", g), i && e.removeEventListener("auxclick", k), e.style.cursor = "", e.style.userSelect = "";
    };
  }, [e, r, s, i]);
}
...
function Xd({ navigation: e, pages: r, firstPageSingle: n, zoomPercent: s, onZoomChange: i, pageSizeId: o, bodyPageCount: a, pagesHostRef: u, packLayoutKey: c, hasCover: f, coverNode: b, flipIndex: x, onFlipIndexChange: m, onVisibleLogicalPagesChange: w }) {
  ...
  d.useEffect(() => {
    ...
    if (!$) return;
    const q = E + nr, T = () => {
      const H = s / 100, B = Math.max(1, q * H), ue = $.scrollTop, re = $.clientHeight, V = Math.max(0, Math.floor(ue / B)), ye = Math.min(O.length - 1, Math.floor((ue + re) / B)), me = [];
      for (let ee = V; ee <= ye; ee += 1) {
        const Ee = O[ee];
        Ee && me.push(...fi(Ee));
      }
      U(me);
  ...
  const R = d.useCallback(() => {
    ...
    m(Math.min(O.length - 1, z + 1));
  }, [m, O.length, z]), se = z > 0, Y = z < O.length - 1;
  d.useEffect(() => {
    if (e !== "flip") return;
    const $ = (q) => {
      const T = q.target;
    ...
    return $.addEventListener("touchstart", re, { passive: true }), $.addEventListener("touchend", V, { passive: true }), $.addEventListener("wheel", ye, { passive: true }), () => {
      $.removeEventListener("touchstart", re), $.removeEventListener("touchend", V), $.removeEventListener("wheel", ye);
    };
  }, [I, R, e]);
...
function Ud({ pairs: e, rowH: r, scale: n, scrollRef: s, overscan: i, hasCover: o, coverNode: a, bodyPageCount: u, pagesHostRef: c, packLayoutKey: f, widthPx: b, heightPx: x }) {
  const [m, w] = d.useState({ first: 0, last: 2 });
  d.useEffect(() => {
    const g = s.current;
    if (!g) return;
    const k = () => {
  ...
  const y = [];
  for (let g = m.first; g <= m.last; g += 1) {
    const k = e[g];
...
function Jd(e, r, n, s) {
  ...
  for (const x of b) {
    ...
    const m = Number(x.getAttribute(qt) ?? "0");
    c.push(m + 1 + f);
  }
  return c.length ? c : [1];
}
function Qd({ pagesHostRef: e, scrollRef: r, coverRef: n, hasCover: s = false, bodyPageCount: i, overridePages: o = null }) {
  ...
  d.useEffect(() => {
    ...
    const x = e.current, m = r.current;
    if (!x || !m) return;
    let w = 0;
    const y = () => {
      const k = Jd(x, m, (n == null ? void 0 : n.current) ?? null, s);
    ...
    return y(), m.addEventListener("scroll", g, { passive: true }), window.addEventListener("scroll", g, { passive: true }), window.addEventListener("resize", g), (_a2 = window.visualViewport) == null ? void 0 : _a2.addEventListener("resize", g), (_b = window.visualViewport) == null ? void 0 : _b.addEventListener("scroll", g), () => {
      var _a3, _b2;
      w && window.cancelAnimationFrame(w), m.removeEventListener("scroll", g), window.removeEventListener("scroll", g), window.removeEventListener("resize", g), (_a3 = window.visualViewport) == null ? void 0 : _a3.removeEventListener("resize", g), (_b2 = window.visualViewport) == null ? void 0 : _b2.removeEventListener("scroll", g);
    };
  }, [i, n, s, o, e, r]);
...
function xn({ value: e, onChange: r, min: n = 0, max: s = 100, step: i = 1, suffix: o = "", disabled: a = false, resetValue: u, "aria-label": c = "\uAC12", decreaseLabel: f = "\uAC10\uC18C", increaseLabel: b = "\uC99D\uAC00", className: x = "" }) {
  const [m, w] = d.useState(false), [y, g] = d.useState(String(e)), k = d.useRef(null), N = d.useRef(false), L = d.useRef(null), C = `${e}${o}`;
  d.useEffect(() => () => {
  ...
  return t.jsxs("div", { className: `inline-flex h-8 items-center gap-0.5 rounded-md border border-gray-300 bg-white dark:border-odp-borderStrong dark:bg-odp-surface ${x}`, children: [t.jsx("button", { type: "button", disabled: a || e <= n, onClick: () => _(-1), className: "inline-flex h-full w-7 items-center justify-center text-gray-600 hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-40 dark:text-odp-fg dark:hover:bg-odp-focusBg", "aria-label": f, title: f, children: t.jsx(Zi, { size: 14 }) }), m ? t.jsx("input", { ref: k, type: "text", inputMode: "numeric", disabled: a, value: y, "aria-label": c, className: "h-full w-14 border-x border-gray-200 bg-transparent px-1 text-center text-xs tabular-nums text-gray-800 outline-none dark:border-odp-borderSoft dark:text-odp-fgStrong", onChange: (O) => g(O.target.value), onKeyDown: (O) => {
...
function Ro({ cover: e, targetId: r, selectedIds: n, onChange: s, onSelectIds: i, onRequestDelete: o, onImageCrop: a, onRestoreImageAspect: u, onToggleImageLockAspect: c }) {
  const f = n.includes(r) ? n : [r], b = Ve(e, f), x = b.length === 1 && _e(e, b[0]) ? b[0] : null, m = f.length > 1 && !x, w = !!x, y = f.length === 1 ? e.elements.find((_) => _.id === f[0]) ?? null : null, g = f.length > 0 && f.every((_) => {
  ...
  return t.jsxs(t.Fragment, { children: [t.jsxs(Ae, { className: ft, onSelect: () => {
    ...
    x && s(Mn(e, x));
  }, children: [t.jsx(Es, { size: 16, className: "shrink-0" }), "\uADF8\uB8F9 \uD574\uC81C"] }), t.jsx(Qt, {}), t.jsxs("div", { className: "px-1 py-1", onPointerDown: (_) => _.stopPropagation(), children: [t.jsx(gn, { children: "\uC815\uB82C" }), t.jsx(yi, { disabled: !L, onAlign: C })] })] }) : null, m ? t.jsxs(t.Fragment, { children: [t.jsxs(Ae, { className: ft, disabled: !E, onSelect: () => {
    const _ = Rn(e, f);
...
async function jr(e, r) {
  ...
  if (n === "webdav") {
    ...
    let m = e.type;
    (!m || m === "application/octet-stream") && (m = await za(e) || m);
    const w = Ia(m), y = `${b}${x}${w}`.replace(/\/+/g, "/").replace(/^\//, ""), g = new Uint8Array(await e.arrayBuffer());
    return await f.writeBytes(y, g, m || "application/octet-stream"), y;
  }
...
function mu(e, r, n, s, i) {
  if (i == null ? void 0 : i.fromCenter) {
    ...
    let x = 0, m = 0;
    r.includes("e") && (x += n), r.includes("w") && (x -= n), r.includes("s") && (m += s), r.includes("n") && (m -= s);
    const w = Math.max(vt, 2 * Math.min(f, 100 - f)), y = Math.max(vt, 2 * Math.min(b, 100 - b)), g = Re(e.w + 2 * x, vt, w), k = Re(e.h + 2 * m, vt, y);
...
const rn = { w: 40, h: 25 };
function bu({ cover: e, selectedIds: r, onSelectIds: n, onChange: s, getPresignedUrl: i, currentFile: o = null, centerSnapEnabled: a = true, centerSnapTolerance: u = Xi, objectSnapEnabled: c = false, onObjectSnapEnabledChange: f, objectSnapTolerance: b = Ui, textContainerOutlineEnabled: x = false, placePreviewEnabled: m = true, placeMode: w = null, onPlaceModeChange: y, onUndo: g, onRedo: k, className: N = "" }) {
  const { showToast: L } = Da(), C = d.useRef(null), [E, _] = d.useState(null), [O, z] = d.useState(null), [G, U] = d.useState(null), [R, I] = d.useState(null), [se, Y] = d.useState(null), [ie, ke] = d.useState({ v: [], h: [] }), [de, $] = d.useState(null), [q, T] = d.useState(null), H = Gi(), [B, ue] = d.useState(null), re = d.useRef(false);
  re.current = !!q;
  const [V, ye] = d.useState(0), [me, ee] = d.useState(false), Ee = d.useRef(false), Me = d.useRef(false), Ke = d.useRef(null);
  Ee.current = V > 0 || Me.current;
  const Te = () => {
  ...
  d.useEffect(() => () => Te(), []);
  const Le = d.useRef(null), Z = d.useRef(e), xe = d.useRef(r), we = d.useRef(w), Ct = d.useRef(a), ze = d.useRef(u), et = d.useRef(c), X = d.useRef(b), Ye = d.useRef(f), ht = d.useRef(false);
  Z.current = e, xe.current = r, we.current = w, Ct.current = a, ze.current = u, et.current = c, X.current = b, Ye.current = f;
  const Et = d.useCallback((l) => Z.current.elements.find((h) => h.id === l) ?? null, []), tt = d.useCallback((l) => {
    const h = Le.current;
    if (!h) return;
    if (h.kind === "marquee") {
      const ne = (l.clientX - h.originClientX) / h.frameW * 100, S = (l.clientY - h.originClientY) / h.frameH * 100, W = Re(h.startXPct + ne, 0, 100), J = Re(h.startYPct + S, 0, 100);
      Le.current = { ...h, curXPct: W, curYPct: J }, $(ps({ x: h.startXPct, y: h.startYPct, w: W - h.startXPct, h: J - h.startYPct }));
      return;
    }
    const v = (l.clientX - h.startX) / h.frameW * 100, P = (l.clientY - h.startY) / h.frameH * 100;
    if (h.kind === "move") {
      if (!h.moved && Math.hypot(l.clientX - h.startX, l.clientY - h.startY) >= vi) {
        h.moved = true;
        const ve = h.pendingShiftClick;
        ve && !ve.wasFullySelected && n([.../* @__PURE__ */ new Set([...ve.selectionAtDown, ...ve.targetIds])]);
      }
      if (!h.ids.length) return;
      if (h.pendingDuplicate) if (Math.hypot(l.clientX - h.startX, l.clientY - h.startY) >= vi) {
        const ve = Jc(Z.current, h.ids);
        s(ve.cover), n(ve.newIds), h.ids = ve.newIds, h.origElements = ve.cover.elements.map((Ze) => ({ ...Ze })), h.pendingDuplicate = false;
      } else return;
      let ne = v, S = P;
      l.shiftKey && (Math.abs(ne) >= Math.abs(S) ? S = 0 : ne = 0);
      const W = { ...Z.current, elements: h.origElements.map((pe) => ({ ...pe })) };
      let J = qn(W, h.ids, ne, S);
      const ge = Ct.current, te = et.current;
      if ((ge || te) && !l.shiftKey) {
        const pe = J.elements.filter((Ze) => h.ids.includes(Ze.id)), ve = mn(pe);
        if (ve) {
          const Ze = te ? ci(J, h.ids) : [], Oe = od(ve, Ze, { objectSnapEnabled: te, frameCenterSnapEnabled: ge, objectThresholdPx: X.current, frameCenterThresholdPx: ze.current, frameWidthPx: h.frameW, frameHeightPx: h.frameH }), ur = Oe.x - ve.x, Pr = Oe.y - ve.y;
          (ur !== 0 || Pr !== 0) && (J = qn(J, h.ids, ur, Pr)), ke({ v: Oe.verticalGuides, h: Oe.horizontalGuides });
        }
      } else ke({ v: [], h: [] });
      s(J);
      return;
    ...
    ke({ v: [], h: [] });
    const M = h.orig, F = l.shiftKey;
    let D = M.type === "image" ? pd(M, h.handle, v, P, h.frameW, h.frameH, { fromCenter: F }) : mu(M, h.handle, v, P, { fromCenter: F });
    const ae = Ct.current, fe = et.current;
    if ((ae || fe) && !l.shiftKey) {
      const ne = fe ? ci(Z.current, [h.id]) : [], S = ld({ x: D.x, y: D.y, w: D.w, h: D.h }, h.handle, ne, { objectSnapEnabled: fe, frameCenterSnapEnabled: ae, objectThresholdPx: X.current, frameCenterThresholdPx: ze.current, frameWidthPx: h.frameW, frameHeightPx: h.frameH, minSizePct: vt });
      D = { ...D, x: S.x, y: S.y, w: S.w, h: S.h }, ke({ v: S.verticalGuides, h: S.horizontalGuides });
    }
    s(er(Z.current, h.id, D));
  }, [s, n]), Pe = d.useCallback((l) => {
    const h = Le.current;
    if ((h == null ? void 0 : h.kind) === "marquee") {
      const v = ps({ x: h.startXPct, y: h.startYPct, w: h.curXPct - h.startXPct, h: h.curYPct - h.startYPct }), P = ii(Z.current.elements, v), M = ms(Z.current, P);
      if (h.additive && M.length) {
        const F = new Set(xe.current);
        M.forEach((D) => F.add(D)), n([...F]);
      } else n(M);
      $(null);
    } else if ((h == null ? void 0 : h.kind) === "move" && h.pendingShiftClick && (l == null ? void 0 : l.type) === "pointerup") {
      const v = h.pendingShiftClick;
      if (!h.moved) if (v.wasFullySelected) {
  ...
  d.useEffect(() => () => Pe(), [Pe]);
  const $e = (l, h, v) => ({ xPct: Re((l - v.left) / v.width * 100, 0, 100), yPct: Re((h - v.top) / v.height * 100, 0, 100) }), Ie = (l, h, v, P) => ({ x: Re(l, 0, Math.max(0, 100 - v)), y: Re(h, 0, Math.max(0, 100 - P)), w: v, h: P }), xt = d.useCallback((l, h) => {
    const P = l > 1 ? l : 800, M = h > 1 ? h : 1100;
    return { w: Re(36 * 0.65 * 5 / P * 100, 6, 40), h: Re(36 * 1.4 / M * 100, 3, 20), fontSize: 36 };
  }, []), gt = d.useCallback((l, h, v) => v && v > 0 && l > 1 && h > 1 ? zs(v, l, h, 50) : { w: 50, h: 35 }, []), ir = d.useCallback((l, h, v) => {
    var _a2, _b;
    ...
    const W = Ie(l, h, ne, S), J = Bn({ ...W, text: D, textAlign: "left", fontSize: ae, ...(v == null ? void 0 : v.fontWeight) != null ? { fontWeight: v.fontWeight } : {} });
    s(Lr(Z.current, J)), n([J.id]), (v == null ? void 0 : v.clearPlaceMode) !== false && (y == null ? void 0 : y(null));
  }, [s, y, n, xt]), or = d.useCallback(async (l, h, v) => {
    var _a2;
    try {
      ...
      if (M && M.width > 1 && M.height > 1) {
        ...
        try {
          ...
          fe && fe > 0 && (D = Zn(D, fe, M.width, M.height, true), D = { ...D, x: Re(h, 0, Math.max(0, 100 - D.w)), y: Re(v, 0, Math.max(0, 100 - D.h)) });
        } finally {
  ...
  }, [o, s, n, se, gt]), ar = d.useCallback((l, h, v) => {
    const P = Ie(h, v, rn.w, rn.h), M = Oa(l, { ...P, text: "", textAlign: "center", textVAlign: "middle", fontSize: 24, color: "#0c4a6e", fontWeight: "bold", paddingPct: 2 });
    s(Lr(Z.current, M)), n([M.id]), y == null ? void 0 : y(null);
  }, [s, y, n]);
  d.useEffect(() => {
    if ((w == null ? void 0 : w.kind) !== "image" || !w.files[0]) {
      Y(null), I((M) => (M && URL.revokeObjectURL(M), null));
      return;
    }
    const l = w.files[0];
    let h = false;
    ...
    const l = (h) => {
      var _a2;
      if (z({ x: h.clientX, y: h.clientY }), !m) {
        U(null);
        return;
      }
      ...
      const { xPct: P, yPct: M } = $e(h.clientX, h.clientY, v);
      if (w.kind === "text") {
  ...
  const lr = (l) => {
    ...
    const F = h.metaKey || h.ctrlKey, D = h.altKey, ae = h.shiftKey, fe = ae && !F && !D, ne = (F || ae) && !D, S = ne ? Zc(Z.current, l, xe.current) : Yc(Z.current, l, xe.current), W = xe.current, J = S.length > 0 && S.every((Oe) => W.includes(Oe)), ge = J && W.length === S.length && S.every((Oe) => W.includes(Oe));
    let te = W, pe;
    ...
    const Ze = D || F && J;
    Le.current = { kind: "move", ids: ve, startX: h.clientX, startY: h.clientY, origElements: Z.current.elements.map((Oe) => ({ ...Oe })), frameW: M.width, frameH: M.height, moved: false, ...Ze ? { pendingDuplicate: true } : {}, ...pe ? { pendingShiftClick: pe } : {} }, window.addEventListener("pointermove", tt), window.addEventListener("pointerup", Pe), window.addEventListener("pointercancel", Pe);
  }, Ge = (l, h, v) => {
    const P = C.current, M = Et(l);
    if (!P || !M || sr(Z.current, M)) return;
    const F = P.getBoundingClientRect();
    F.width < 1 || F.height < 1 || (h.preventDefault(), h.stopPropagation(), n([l]), Le.current = { kind: "resize", id: l, handle: v, startX: h.clientX, startY: h.clientY, orig: { ...M }, frameW: F.width, frameH: F.height }, window.addEventListener("pointermove", tt), window.addEventListener("pointerup", Pe), window.addEventListener("pointercancel", Pe));
  }, at = d.useCallback((l, h) => {
    var _a2;
    const v = Z.current.elements.find((ne) => ne.id === l);
    if (!v || v.type !== "image") return;
    const P = !(v.naturalAspect && v.naturalAspect > 0), M = P;
    if (!P && !M) return;
    const F = (_a2 = C.current) == null ? void 0 : _a2.getBoundingClientRect(), D = (F == null ? void 0 : F.width) ?? 1, ae = (F == null ? void 0 : F.height) ?? 1, fe = Zn(v, h, D, ae, M);
    fe.naturalAspect === v.naturalAspect && fe.w === v.w && fe.h === v.h && fe.x === v.x && fe.y === v.y || s(er(Z.current, l, fe));
  }, [s]), cr = d.useCallback((l) => {
    const h = Z.current.elements.find((P) => P.id === l);
    if (!h || h.type !== "image") return;
    const v = { ...h };
    h.lockAspect ? delete v.lockAspect : v.lockAspect = true, s(er(Z.current, l, v));
  }, [s]), lt = d.useCallback((l) => {
    var _a2;
    const h = Z.current.elements.find((P) => P.id === l);
    if (!h || h.type !== "image") return;
    const v = (_a2 = C.current) == null ? void 0 : _a2.getBoundingClientRect();
    !v || v.width < 1 || v.height < 1 || s(er(Z.current, l, ud(h, v.width, v.height)));
  }, [s]), qe = d.useCallback((l) => {
    if (!l.length) return;
    xe.current = l, n(l);
    const h = dn(Z.current, l);
    Te(), Me.current = false, ee(h), ye(1);
    ...
    try {
      const h = await _a(l.path, i) || "";
      if (!h) {
        window.alert("\uC774\uBBF8\uC9C0\uB97C \uBD88\uB7EC\uC62C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.");
        return;
      }
      T({ id: l.id, path: l.path, imageSrc: h });
    } catch (h) {
      console.error(h), window.alert(h instanceof Error ? h.message : "\uC774\uBBF8\uC9C0\uB97C \uBD88\uB7EC\uC62C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.");
    }
  }, [i, n]), Cr = d.useCallback(async (l, h) => {
    var _a2;
    if (!q) return;
    ...
    const M = h.width / Math.max(1, h.height), F = (_a2 = C.current) == null ? void 0 : _a2.getBoundingClientRect(), D = (F == null ? void 0 : F.width) ?? 1, ae = (F == null ? void 0 : F.height) ?? 1, fe = Zn({ ...P, path: v }, M, D, ae, true);
  ...
  d.useEffect(() => {
    ...
    return l.addEventListener("contextmenu", h), () => l.removeEventListener("contextmenu", h);
  }, []), d.useEffect(() => {
    const l = (h) => {
      var _a2;
      if (hr(h.target) || ht.current) return;
      const v = Us(h.clipboardData), P = Vs(h.clipboardData);
      let M = String(((_a2 = h.clipboardData) == null ? void 0 : _a2.getData("text/plain")) ?? "").trim();
      !v.length && !M && !P || (h.preventDefault(), h.stopPropagation(), (async () => {
        ht.current = true;
        try {
          ...
          if (fe && (Ys(M) || !M) && (M = ""), ae.length && (y == null ? void 0 : y({ kind: "image", files: ae })), M) {
    ...
    const l = { current: false }, h = (D) => {
      ...
      return S && (Ys(W) || !W) && (W = ""), { files: ne, text: W };
    }, M = (D) => {
      h(D.dataTransfer) && (hr(D.target) || (D.preventDefault(), D.dataTransfer && (D.dataTransfer.dropEffect = "copy")));
    }, F = (D) => {
      if (!D.dataTransfer || hr(D.target) || !h(D.dataTransfer) || l.current || ht.current) return;
      D.preventDefault(), D.stopPropagation();
      const ae = Us(D.dataTransfer), fe = Vs(D.dataTransfer);
      (async () => {
        l.current = true;
        try {
    ...
    const M = (S) => du * Fc({ altKey: S.altKey, shiftKey: S.shiftKey, ctrlKey: S.ctrlKey, metaKey: S.metaKey }), F = (S) => {
      ...
      if (S.key === "Tab" && S.shiftKey && !W && !S.altKey && !S.repeat) {
        ...
        const te = !et.current;
        et.current = te, (_a2 = Ye.current) == null ? void 0 : _a2.call(Ye, te), L(te ? "\uAC1C\uCCB4 \uC2A4\uB0C5 \uCF1C\uC9D0" : "\uAC1C\uCCB4 \uC2A4\uB0C5 \uAEBC\uC9D0");
        return;
      }
      if (S.key === "Escape") {
      ...
      if (S.preventDefault(), S.stopPropagation(), S.shiftKey) {
        const te = Vc(Z.current, xe.current);
        if (!te) return;
        s(Mn(Z.current, te));
        return;
      }
  ...
  const Er = new Set(r), Xe = r.length === 1 ? Et(r[0]) : null, bt = d.useMemo(() => {
    const l = Ve(e, r), h = [], v = /* @__PURE__ */ new Set();
    for (const P of l) {
      if (!_e(e, P)) continue;
      const M = Ce(e, P);
      ...
      const F = mn(Uc(e, M));
      if (F) {
        h.push({ id: P, bounds: F });
        for (const D of M) v.add(D);
      }
    }
    return { outlines: h, memberIds: v };
  }, [e, r]), Be = d.useMemo(() => !de || de.w < 0.05 && de.h < 0.05 ? /* @__PURE__ */ new Set() : new Set(ii(e.elements, de)), [e.elements, de]), rt = (l, h, v) => {
    const P = sr(e, l), M = bt.memberIds.has(l.id), F = ["absolute", "box-border"];
    return P && h ? F.push("ring-2", "ring-yellow-400", "ring-offset-0") : h && M ? F.push("ring-2", "ring-blue-300", "ring-offset-0") : h ? F.push("ring-2", "ring-blue-500", "ring-offset-0") : v ? F.push("outline", "outline-2", "outline-dashed", "outline-blue-500", "-outline-offset-1") : F.push("hover:ring-1", "hover:ring-blue-300"), x && l.type === "text" && F.push("shadow-[inset_0_0_0_1px_rgba(248,113,113,0.7)]"), F.join(" ");
  };
  return t.jsxs(cn, { cover: e, getPresignedUrl: i, showFrameOutline: true, renderElements: false, className: `shadow-[0_8px_28px_rgba(15,23,42,0.12)] print:shadow-none ${N}`, children: [t.jsxs("div", { ref: C, className: `absolute inset-0 ${w ? "cursor-crosshair" : ""}`, tabIndex: 0, role: "application", "aria-label": "\uD45C\uC9C0 \uD3B8\uC9D1 \uCE94\uBC84\uC2A4", onPointerDown: (l) => {
    Pt(l);
  }, children: [ie.v.map((l) => t.jsx("div", { className: "pointer-events-none absolute top-0 bottom-0 z-40 w-px bg-pink-500/80", style: { left: `${l}%` }, "aria-hidden": true }, `snap-v-${l}`)), ie.h.map((l) => t.jsx("div", { className: "pointer-events-none absolute left-0 right-0 z-40 h-px bg-pink-500/80", style: { top: `${l}%` }, "aria-hidden": true }, `snap-h-${l}`)), de && (de.w > 0.05 || de.h > 0.05) ? t.jsx("div", { className: "pointer-events-none absolute z-50 border border-dashed border-blue-500 bg-blue-500/10", style: { left: `${de.x}%`, top: `${de.y}%`, width: `${de.w}%`, height: `${de.h}%` }, "aria-hidden": true }) : null, bt.outlines.map(({ id: l, bounds: h }) => t.jsx("div", { className: "pointer-events-none absolute z-40 border-2 border-blue-500", style: { left: `${h.x}%`, top: `${h.y}%`, width: `${h.w}%`, height: `${h.h}%` }, "aria-hidden": true }, `group-sel-${l}`)), w && m && G ? t.jsx("div", { className: "pointer-events-none absolute z-45 overflow-hidden rounded-sm border border-dashed border-blue-500 bg-blue-500/15", style: { left: `${G.x}%`, top: `${G.y}%`, width: `${G.w}%`, height: `${G.h}%` }, "aria-hidden": true, children: w.kind === "text" ? t.jsx("div", { className: "flex h-full w-full items-start justify-start px-0.5 text-left font-bold text-gray-800/40 dark:text-white/35", style: { fontSize: 36, lineHeight: 1.25 }, children: "\uC81C\uBAA9" }) : w.kind === "shape" ? t.jsx("div", { className: "h-full w-full border border-blue-500/50 bg-sky-200/40", style: { borderRadius: w.shapeType === "ellipse" ? "50%" : w.shapeType === "roundRect" ? "8%" : 0 } }) : R ? t.jsx("img", { src: R, alt: "", className: "h-full w-full object-fill opacity-45", draggable: false }) : t.jsx("div", { className: "h-full w-full bg-blue-400/20" }) }) : null, e.elements.map((l, h) => {
    const v = Er.has(l.id), P = Be.has(l.id), M = sr(e, l), F = !M && (l.type === "text" || kr(l)), D = F && l.id === E, ae = v && r.length === 1 && !D && !M, fe = rt(l, v, P), ne = t.jsxs(t.Fragment, { children: [D && l.type === "text" ? t.jsx("textarea", { className: "h-full w-full resize-none border-0 bg-transparent p-0 outline-none", style: oo(l), value: l.text, autoFocus: true, onChange: (W) => {
      ...
      Ge(l.id, J, W.id);
    } }, W.id)) : null] }), S = t.jsx("div", { "data-cover-el": l.id, "data-cover-locked": M ? "1" : void 0, className: fe, style: { left: `${l.x}%`, top: `${l.y}%`, width: `${l.w}%`, height: `${l.h}%`, zIndex: v || P ? 20 + h : 10 + h, cursor: D ? "text" : M ? "default" : "move" }, onContextMenu: (W) => {
  ...
  })] }), H && B ? t.jsx(Vi, { open: !!B, onOpenChange: (l) => {
    l || ue(null);
  }, title: (() => {
    const l = e.elements.find((h) => h.id === B);
    return l ? Br(l) : "\uCEE4\uBC84 \uC694\uC18C";
    ...
    ue(null), dr(l);
  }, onRestoreImageAspect: lt, onToggleImageLockAspect: cr }) }) }) }) : null, Xe ? t.jsxs("span", { className: "sr-only", children: ["Selected ", Xe.type, " ", Xe.id] }) : r.length > 1 ? t.jsxs("span", { className: "sr-only", children: ["Selected ", r.length, " layers"] }) : null, t.jsx(Bi, { isOpen: !!q, onClose: () => T(null), contentClassName: "max-w-2xl w-[min(96vw,42rem)] max-h-[90vh] h-[min(90vh,720px)]", resizeHeight: true, children: q ? t.jsx(Bc, { imageSrc: q.imageSrc, fileName: q.path, onCancel: () => T(null), onConfirm: Cr }) : null }), t.jsx(vr, { isOpen: V > 0, title: V === 2 ? "\uC7A0\uAE34 \uAC1C\uCCB4 \uC0AD\uC81C" : "\uAC1C\uCCB4 \uC0AD\uC81C", message: V === 2 ? "\uC7A0\uAE34 \uAC1C\uCCB4\uAC00 \uD3EC\uD568\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4. \uC815\uB9D0 \uC0AD\uC81C\uD560\uAE4C\uC694?" : "\uC120\uD0DD\uD55C \uAC1C\uCCB4\uB97C \uC0AD\uC81C\uD560\uAE4C\uC694?", confirmLabel: "\uC0AD\uC81C", cancelLabel: "\uCDE8\uC18C", variant: "danger", onConfirm: () => {
    if (me && V === 1) {
      Sr();
      return;
    }
  ...
  }, onCancel: Qe }, `cover-delete-confirm-${V}`), w && O ? ss.createPortal(t.jsx("div", { className: "pointer-events-none fixed z-[100001] rounded-md border border-gray-200 bg-white px-2 py-1 text-[11px] font-medium text-gray-800 shadow-md dark:border-odp-borderStrong dark:bg-odp-surface dark:text-odp-fgStrong", style: m ? { left: O.x + 14, top: O.y - 8, transform: "translateY(-100%)" } : { left: O.x + 14, top: O.y + 18 }, children: "\uD074\uB9AD\uD574\uC11C \uC0BD\uC785\uD558\uAE30" }), document.body) : null] });
}
...
function Si({ displayValue: e, editValue: r, placeholder: n, isEditing: s, className: i, onStartEdit: o, onCommit: a, onCancel: u }) {
  const [c, f] = d.useState(r), b = d.useRef(r), x = d.useRef(null), m = d.useRef(false);
  if (d.useEffect(() => {
    if (!s) return;
    m.current = false, b.current = r, f(r);
  ...
  const w = () => {
    m.current || (m.current = true, a(b.current));
  }, y = () => {
    m.current || (m.current = true, u());
  }, g = (k) => {
    if (k.key === "Enter") {
...
function Su({ children: e, cover: r, targetId: n, kind: s, selectedIds: i, onChange: o, onSelectIds: a, onRequestDeleteLayers: u, onStartRename: c }) {
  var _a2, _b;
  const f = Fe(r), b = s === "group" ? Ce(f, n) : [n], x = s === "group" ? b.length ? b : [] : i.includes(n) ? i : [n], m = s === "group" ? n : ((_a2 = f.elements.find((L) => L.id === n)) == null ? void 0 : _a2.groupId) ?? null, w = (() => {
    if (s !== "element" || x.length < 1) return false;
    const L = Ve(f, x);
    return !(L.length === 1 && _e(f, L[0]));
  })(), y = !!m, g = Hr(r, n), k = s === "group" ? ((_b = Nt(f, n)) == null ? void 0 : _b.name) ?? "\uADF8\uB8F9" : (() => {
...
function Cu({ id: e, kind: r, depth: n, cover: s, selectedIds: i, selectedSet: o, collapsed: a, dropHint: u, isRenaming: c, onStartRename: f, onFinishRename: b, onToggleCollapse: x, onSelectElement: m, onSelectGroup: w, onChange: y, onSelectIds: g, onRequestDeleteLayers: k }) {
  ...
  U.current = s;
  const R = r === "group" ? Nt(G, e) : null, I = r === "element" ? G.elements.find((V) => V.id === e) : null, se = r === "group" ? Ce(G, e) : [], Y = r === "group" && se.length > 0 && se.every((V) => o.has(V)), ie = r === "group" && !Y && se.some((V) => o.has(V)), ke = r === "element" && o.has(e), de = Hr(s, e), $ = `${Lo} relative ${r === "group" ? Y ? ws : ie ? "bg-blue-50/50 dark:bg-blue-950/20" : "" : ke ? ws : ""} ${de ? "ring-1 ring-inset ring-yellow-400/80" : ""}`, q = c ? {} : { ...N, ...L }, T = (V) => {
    var _a2;
    const ye = U.current;
    if (r === "group") {
      const me = Nt(ye, e), ee = V.trim() || "\uADF8\uB8F9";
      if (me && me.name === ee) {
        b();
        return;
      }
      ...
      if (me) {
        const ee = V.trim(), Ee = ((_a2 = me.name) == null ? void 0 : _a2.trim()) ?? "";
        if (ee === Ee) {
          b();
          return;
        }
    ...
    b();
  }, H = t.jsx("span", { role: "button", tabIndex: -1, "data-no-dnd": true, className: `shrink-0 rounded p-0.5 hover:bg-gray-200 dark:hover:bg-odp-borderStrong ${de ? "text-yellow-600 dark:text-yellow-400" : "text-gray-400"}`, title: de ? "\uC7A0\uAE08 \uD574\uC81C" : "\uC7A0\uAE08", "aria-label": de ? "\uC7A0\uAE08 \uD574\uC81C" : "\uC7A0\uAE08", onClick: (V) => {
    V.stopPropagation(), y(po(s, e));
  }, onPointerDown: (V) => V.stopPropagation(), children: de ? t.jsx(Cs, { size: 12 }) : t.jsx(Ns, { size: 12 }) }), B = u === "before" ? t.jsx("div", { className: "pointer-events-none absolute inset-x-1 -top-0.5 z-10 h-0.5 rounded bg-blue-500" }) : u === "after" ? t.jsx("div", { className: "pointer-events-none absolute inset-x-1 -bottom-0.5 z-10 h-0.5 rounded bg-blue-500" }) : u === "inside" ? t.jsx("div", { className: "pointer-events-none absolute inset-0 z-10 rounded ring-2 ring-inset ring-blue-400/70" }) : null, ue = (V) => {
    c || V.target instanceof Element && V.target.closest("[data-no-dnd]") || (r === "group" ? w(e, V) : m(e, V));
  }, re = r === "group" && R ? t.jsxs("div", { ref: C, style: z, className: `${$} cursor-grab active:cursor-grabbing`, "aria-selected": Y, role: "option", onClick: ue, ...q, children: [B, t.jsx("button", { type: "button", className: "shrink-0 rounded p-0.5 hover:bg-gray-200 dark:hover:bg-odp-borderStrong", onClick: (V) => {
    V.stopPropagation(), x();
  }, "aria-label": a ? "\uADF8\uB8F9 \uD3BC\uCE58\uAE30" : "\uADF8\uB8F9 \uC811\uAE30", children: a ? t.jsx(qi, { size: 12 }) : t.jsx(mt, { size: 12 }) }), t.jsx(sc, { size: 12, className: "shrink-0 opacity-70" }), t.jsx(Si, { displayValue: R.name, editValue: R.name, isEditing: c, className: "min-w-0 flex-1 truncate font-medium", onStartEdit: () => f(e), onCommit: T, onCancel: b }), c ? null : t.jsx("span", { className: "shrink-0 text-[9px] text-gray-400", children: se.length }), H] }) : I ? t.jsxs("div", { ref: C, style: z, className: `${$} cursor-grab active:cursor-grabbing`, "aria-selected": ke, onClick: ue, ...q, role: "option", children: [B, ju(I), t.jsx(Si, { displayValue: Br(I), editValue: qs(I), isEditing: c, className: "min-w-0 flex-1 truncate", onStartEdit: () => f(e), onCommit: T, onCancel: b }), H, !c && i.length === 1 && i[0] === e ? t.jsxs("span", { className: "flex shrink-0 gap-0.5", children: [t.jsx("span", { role: "button", tabIndex: -1, className: "rounded px-1 text-[9px] hover:bg-gray-200 dark:hover:bg-odp-borderStrong", onClick: (V) => {
    V.stopPropagation(), y(xs(s, e, 1));
  }, children: "\u2191" }), t.jsx("span", { role: "button", tabIndex: -1, className: "rounded px-1 text-[9px] hover:bg-gray-200 dark:hover:bg-odp-borderStrong", onClick: (V) => {
    V.stopPropagation(), y(xs(s, e, -1));
  }, children: "\u2193" })] }) : null] }) : null;
...
function Pu({ cover: e, selectedIds: r, onSelectIds: n, onChange: s, collapsedGroups: i, onCollapsedGroupsChange: o, onRequestDeleteLayers: a }) {
  const u = d.useMemo(() => Fe(e), [e]), c = d.useMemo(() => Fa(u, i), [u, i]), f = d.useMemo(() => c.map((T) => T.id), [c]), b = d.useMemo(() => new Set(r), [r]), x = d.useRef(null), [m, w] = d.useState(null), [y, g] = d.useState(null), [k, N] = d.useState("before"), [L, C] = d.useState(null), E = d.useRef(null), _ = d.useRef(null), O = Ba(Ha(Wa, { activationConstraint: { distance: 5 } }));
  d.useEffect(() => {
  ...
  const z = (T) => _e(u, T) ? Ce(e, T) : [T], G = (T, H) => {
    ...
    const re = Math.min(B, ue), V = Math.max(B, ue), ye = [];
    for (let me = re; me <= V; me += 1) {
      const ee = c[me];
      ee && ye.push(...z(ee.id));
    }
    n([...new Set(ye)]);
    ...
    if (H.metaKey || H.ctrlKey) {
      const ue = new Set(r);
      B.length > 0 && B.every((V) => ue.has(V)) ? B.forEach((V) => ue.delete(V)) : B.forEach((V) => ue.add(V)), n([...ue]);
      return;
    }
    x.current = T, n(B);
  }, I = (T) => {
    ...
    const re = _e(u, B), V = (_a2 = T.over) == null ? void 0 : _a2.rect;
    if (V) {
      ...
      ue = ji(B, re, { top: V.top, height: V.height }, ye);
    }
    s(Fi(e, H, B, ue));
  }, de = () => {
    _.current = null, w(null), g(null), E.current = null;
  }, $ = m ? c.find((T) => T.id === m) ?? null : null, q = (() => {
    var _a2;
    if (!$) return "";
...
function _u({ cover: e, selectedIds: r, onSelectIds: n, onChange: s, currentFile: i = null, topPx: o = 0, width: a, isResizing: u = false, resizeHandleProps: c = {}, layersDetached: f, onLayersDetachedChange: b, layersWidth: x, layersIsResizing: m = false, layersResizeHandleProps: w = {}, centerSnapEnabled: y = true, onCenterSnapEnabledChange: g, centerSnapTolerance: k = Xi, onCenterSnapToleranceChange: N, objectSnapEnabled: L = false, onObjectSnapEnabledChange: C, objectSnapTolerance: E = Ui, onObjectSnapToleranceChange: _, textContainerOutlineEnabled: O = false, onTextContainerOutlineEnabledChange: z, placePreviewEnabled: G = true, onPlacePreviewEnabledChange: U, canUndo: R = false, canRedo: I = false, onUndo: se, onRedo: Y, placeMode: ie = null, onPlaceModeChange: ke, className: de = "" }) {
  const $ = d.useRef(null), q = d.useRef(null), [T, H] = d.useState({}), [B, ue] = d.useState(zu), [re, V] = d.useState(0), [ye, me] = d.useState(null), [ee, Ee] = d.useState(null), [Me, Ke] = d.useState(0), [Te, Qe] = d.useState(false), [Sr, Le] = d.useState(null), Z = d.useRef(false), xe = d.useRef(null), we = () => {
  ...
  const et = d.useMemo(() => Ss(), [re]), X = r.length === 1 ? e.elements.find((l) => l.id === r[0]) ?? null : null, Ye = d.useMemo(() => {
    var _a2;
    ...
    return !h || !l.every((v) => v === h) ? null : h;
  }, [e.elements, r]), ht = d.useMemo(() => {
    if (r.length < 1) return false;
    const l = Ve(e, r);
    return !(l.length === 1 && _e(e, l[0]));
  }, [e, r]), Et = !!Ye, tt = d.useMemo(() => go(e, r), [e, r]), Pe = tt.enabled, $e = tt.soleGroupId;
  d.useEffect(() => {
  ...
  const Ie = (l) => {
    ...
    if (l) try {
      ...
      if (h && (X == null ? void 0 : X.type) === "image") {
        s(De(e, X.id, { path: v }));
        return;
      }
    } catch (v) {
    ...
    if (l) try {
      const h = await jr(l, i);
      s({ ...e, bg: { ...e.bg, imagePath: h } });
    } catch (h) {
      console.error(h), window.alert(h instanceof Error ? h.message : "\uBC30\uACBD \uC774\uBBF8\uC9C0 \uC5C5\uB85C\uB4DC\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.");
    }
  }, lr = () => {
    const l = Rn(e, r);
    ...
    Le({ ids: l, mode: h }), Qe(true), Ke(1);
  }, cr = () => {
    r.length && at(r, "elements");
  }, lt = () => {
    var _a2;
    const h = ((_a2 = document.querySelector('[data-cover-frame="1"]')) == null ? void 0 : _a2.getBoundingClientRect().height) ?? 0, v = Ac(e.elements, e.layout.gapPx, h);
    s({ ...e, elements: v });
  }, qe = (l) => {
    var _a2;
    if (!Pe) return;
    ...
    const P = (_a2 = document.querySelector('[data-cover-frame="1"]')) == null ? void 0 : _a2.getBoundingClientRect(), M = l === "distributeX" ? (P == null ? void 0 : P.width) ?? 0 : (P == null ? void 0 : P.height) ?? 0, F = fs(e.layout.gapPx, M);
    me($e), Ee(null), s(Dr(e, h, l, F, { insideGroupId: $e }));
  ...
  return t.jsx(Nc, { delayDuration: 250, skipDelayDuration: 0, children: t.jsxs(t.Fragment, { children: [t.jsxs("aside", { className: `fixed bottom-0 z-30 flex border-r border-gray-200 bg-white/95 backdrop-blur-sm print:hidden dark:border-odp-borderSoft dark:bg-odp-bgSoft/95 ${de}`, style: { top: o, left: 0, width: a }, "aria-label": "\uD45C\uC9C0 \uC124\uC815", children: [t.jsxs("div", { className: "relative flex min-h-0 w-full flex-col overflow-y-auto pb-16", children: [rt, t.jsxs("div", { className: "sticky top-0 z-10 flex items-center gap-2 border-b border-gray-200 bg-white/95 px-3 py-2 dark:border-odp-borderSoft dark:bg-odp-bgSoft/95", children: [t.jsx("div", { className: "flex-1 text-xs font-semibold uppercase tracking-wide text-gray-700 dark:text-odp-fgStrong", children: "\uD45C\uC9C0" }), t.jsx(he, { tip: "\uC2E4\uD589 \uCDE8\uC18C (Mod+Z)", className: Ne, disabled: !R, onClick: () => se == null ? void 0 : se(), children: t.jsx(lc, { size: 15 }) }), t.jsx(he, { tip: "\uB2E4\uC2DC \uC2E4\uD589 (Mod+Shift+Z / Mod+Y)", className: Ne, disabled: !I, onClick: () => Y == null ? void 0 : Y(), children: t.jsx(cc, { size: 15 }) })] }), t.jsx(Mt, { title: "\uC124\uC815", icon: dc, open: B.settings, onToggle: () => Ie("settings"), children: t.jsxs("div", { className: "space-y-2 rounded-md border border-gray-200 bg-gray-50 p-2.5 dark:border-odp-borderStrong dark:bg-odp-bg/50", children: [t.jsxs("div", { className: "flex items-center justify-between gap-2", children: [t.jsx("span", { className: Ar, children: "\uD45C\uC9C0 \uC0AC\uC6A9" }), t.jsxs(zt, { children: [t.jsx(At, { asChild: true, children: t.jsx(tr, { className: xr(e.enabled), checked: e.enabled, onCheckedChange: (l) => s({ ...e, enabled: l }), "aria-label": "\uD45C\uC9C0 \uC0AC\uC6A9", children: t.jsx(rr, { className: gr }) }) }), t.jsx(It, { children: t.jsxs(Dt, { className: Ot, side: "top", sideOffset: 6, children: ["\uD45C\uC9C0 \uC0AC\uC6A9", t.jsx($t, { className: "fill-white dark:fill-odp-surface" })] }) })] })] }), t.jsxs("div", { className: "space-y-1.5", children: [t.jsxs("div", { className: "flex items-center justify-between gap-2", children: [t.jsx("span", { className: Ar, children: "\uAC00\uC6B4\uB370 \uC2A4\uB0C5" }), t.jsxs(zt, { children: [t.jsx(At, { asChild: true, children: t.jsx(tr, { className: xr(y), checked: y, onCheckedChange: (l) => g == null ? void 0 : g(l), "aria-label": "\uAC00\uB85C\xB7\uC138\uB85C \uAC00\uC6B4\uB370 \uC2A4\uB0C5", children: t.jsx(rr, { className: gr }) }) }), t.jsx(It, { children: t.jsxs(Dt, { className: Ot, side: "top", sideOffset: 6, children: ["\uAC00\uB85C\xB7\uC138\uB85C \uAC00\uC6B4\uB370 \uC2A4\uB0C5", t.jsx($t, { className: "fill-white dark:fill-odp-surface" })] }) })] })] }), t.jsxs("label", { className: "block space-y-1", children: [t.jsx("span", { className: "text-[10px] text-gray-400", children: "\uD5C8\uC6A9 \uC624\uCC28" }), t.jsx(kt, { unit: "css", suffix: "px", min: 0.1, max: 100, step: 0.1, value: k, disabled: !N, "aria-label": "\uAC00\uC6B4\uB370 \uC2A4\uB0C5 \uD5C8\uC6A9 \uC624\uCC28", onChange: (l) => N == null ? void 0 : N(l) })] })] }), t.jsxs("div", { className: "space-y-1.5", children: [t.jsxs("div", { className: "flex items-center justify-between gap-2", children: [t.jsx("span", { className: Ar, children: "\uAC1C\uCCB4 \uC2A4\uB0C5" }), t.jsxs(zt, { children: [t.jsx(At, { asChild: true, children: t.jsx(tr, { className: xr(L), checked: L, onCheckedChange: (l) => C == null ? void 0 : C(l), "aria-label": "\uAC1C\uCCB4 \uD14C\uB450\uB9AC\xB7\uAC00\uC6B4\uB370\uC120 \uC2A4\uB0C5", children: t.jsx(rr, { className: gr }) }) }), t.jsx(It, { children: t.jsxs(Dt, { className: Ot, side: "top", sideOffset: 6, children: ["\uB2E4\uB978 \uAC1C\uCCB4\uC758 \uD14C\uB450\uB9AC\xB7\uAC00\uC6B4\uB370\uC120\uC5D0 \uB9DE\uCDA4 (Shift+Tab \uD1A0\uAE00 \xB7 \uADF8\uB8F9\uC740 \uD1B5\uC9F8\uB85C, \uADF8\uB8F9 \uC548\uC5D0\uC11C\uB294 sibling\uACFC\uB3C4)", t.jsx($t, { className: "fill-white dark:fill-odp-surface" })] }) })] })] }), t.jsxs("label", { className: "block space-y-1", children: [t.jsx("span", { className: "text-[10px] text-gray-400", children: "\uD5C8\uC6A9 \uC624\uCC28" }), t.jsx(kt, { unit: "css", suffix: "px", min: 0.1, max: 100, step: 0.1, value: E, disabled: !_, "aria-label": "\uAC1C\uCCB4 \uC2A4\uB0C5 \uD5C8\uC6A9 \uC624\uCC28", onChange: (l) => _ == null ? void 0 : _(l) })] })] }), t.jsxs("div", { className: "flex items-center justify-between gap-2", children: [t.jsx("span", { className: Ar, children: "\uD14D\uC2A4\uD2B8 \uC0C1\uC790 \uD45C\uC2DC" }), t.jsxs(zt, { children: [t.jsx(At, { asChild: true, children: t.jsx(tr, { className: xr(O), checked: O, onCheckedChange: (l) => z == null ? void 0 : z(l), "aria-label": "\uBAA8\uB4E0 \uD14D\uC2A4\uD2B8 \uC0C1\uC790 \uD14C\uB450\uB9AC \uD45C\uC2DC", children: t.jsx(rr, { className: gr }) }) }), t.jsx(It, { children: t.jsxs(Dt, { className: Ot, side: "top", sideOffset: 6, children: ["\uC120\uD0DD\uACFC \uBB34\uAD00\uD558\uAC8C \uBAA8\uB4E0 \uD14D\uC2A4\uD2B8 \uC0C1\uC790\uB97C \uC605\uC740 \uBD89\uC740 \uC2E4\uC120\uC73C\uB85C \uD45C\uC2DC", t.jsx($t, { className: "fill-white dark:fill-odp-surface" })] }) })] })] }), t.jsxs("div", { className: "flex items-center justify-between gap-2", children: [t.jsx("span", { className: Ar, children: "\uC0BD\uC785 \uBBF8\uB9AC\uBCF4\uAE30" }), t.jsxs(zt, { children: [t.jsx(At, { asChild: true, children: t.jsx(tr, { className: xr(G), checked: G, onCheckedChange: (l) => U == null ? void 0 : U(l), "aria-label": "\uD074\uB9AD \uC0BD\uC785 \uBBF8\uB9AC\uBCF4\uAE30", children: t.jsx(rr, { className: gr }) }) }), t.jsx(It, { children: t.jsxs(Dt, { className: Ot, side: "top", sideOffset: 6, children: ["\uD14D\uC2A4\uD2B8\xB7\uC774\uBBF8\uC9C0\xB7\uB3C4\uD615 \uD074\uB9AD \uC0BD\uC785 \uC2DC \uCEE4\uC11C \uC704\uCE58\uC5D0 \uBC18\uD22C\uBA85 \uBBF8\uB9AC\uBCF4\uAE30 \uD45C\uC2DC", t.jsx($t, { className: "fill-white dark:fill-odp-surface" })] }) })] })] })] }) }), !f && t.jsx(Mt, { title: "\uB808\uC774\uC5B4", icon: Yn, open: B.layers, onToggle: () => Ie("layers"), headerRight: t.jsx(he, { tip: "\uB808\uC774\uC5B4\uB97C \uBCC4\uB3C4 \uC0AC\uC774\uB4DC\uBC14\uB85C \uBD84\uB9AC", className: Ne, onClick: () => b(true), children: t.jsx(uc, { size: 15 }) }), children: Be }), t.jsxs(Mt, { title: "\uBC30\uACBD", icon: so, open: B.background, onToggle: () => Ie("background"), children: [t.jsx(jt, { value: e.bg.color, onChange: (l) => s({ ...e, bg: { ...e.bg, color: l || "#ffffff" } }), allowNone: false, label: "\uC0C9", compact: true }), t.jsxs("div", { className: "mt-2 flex gap-1.5", children: [t.jsx(he, { tip: "\uBC30\uACBD \uC774\uBBF8\uC9C0 \uC5C5\uB85C\uB4DC", className: `${Lt} flex-1`, onClick: () => {
    ...
    const l = X.naturalAspect, h = X.x + X.w / 2, v = X.y + X.h / 2, F = X.w * 210 / (297 * l);
    let D = h - X.w / 2, ae = v - F / 2;
...
function Uu({ currentFile: e = null, enabled: r, cover: n, applyCover: s }) {
  const i = r ? Wu(e) : null, o = d.useRef([]), a = d.useRef(0), u = d.useRef(false), c = d.useRef(null), f = d.useRef(null), b = d.useRef(null), x = d.useRef(null), m = d.useRef(s);
  m.current = s;
  ...
  const L = d.useCallback((z) => {
    m.current(z), !(u.current || !x.current) && (b.current = Ei(z), c.current && clearTimeout(c.current), c.current = setTimeout(() => {
      c.current = null, N();
    }, Bu));
  }, [N]), C = d.useCallback(() => {
...
function Yu(e, r, n) {
  d.useLayoutEffect(() => {
    ...
    let o = 0;
    const a = () => {
      const x = i.getBoundingClientRect(), m = x.width, w = x.height;
      if (m < 1 || w < 1) return;
      const y = s.getBoundingClientRect().width || m, g = [...s.querySelectorAll("img")];
      for (const k of g) {
        if (k.hasAttribute("data-print-free-transform")) continue;
        const N = k.naturalWidth, L = k.naturalHeight;
        if (!N || !L) continue;
        const C = Vu(k, N, L, y), E = Math.min(m / C.width, w / C.height, 1), _ = Math.max(1, Math.round(C.width * E)), O = Math.max(1, Math.round(C.height * E)), z = `${_}px`, G = `${O}px`;
      ...
      if (!(f < 1)) {
        ...
        try {
          ...
          for (const x of b) {
            ...
            const m = x.scrollWidth, w = x.offsetHeight;
            if (m <= f + 1) {
              x.style.maxWidth = `${f}px`, x.setAttribute(ys, "1");
              continue;
            }
            const y = Math.max(0.05, Math.min(1, f / m));
            x.style.maxWidth = "none", x.style.transformOrigin = "top left", x.style.transform = `scale(${y})`, x.style.marginRight = `${-Math.round(m * (1 - y))}px`, x.style.marginBottom = `${-Math.round(w * (1 - y))}px`, x.setAttribute(ys, String(Number(y.toFixed(4))));
          }
        } finally {
          i = false;
        }
...
function ef(e, r, n, s) {
  ...
  return d.useLayoutEffect(() => {
    ...
    return () => {
      m = true, x && window.cancelAnimationFrame(x), k.disconnect(), N.disconnect();
...
function of(e) {
  ...
  for (; i; ) {
    ...
    for (const f of u) {
      let b = -1, x = -1;
      for (let m = c; m < a.length; m += 1) {
        s.setStart(o, m), s.setEnd(o, m + 1);
...
function lf(e, r, n) {
  ...
  if (i < 0 && (i = s.findIndex((c) => {
    ...
    let c = 1 / 0;
    s.forEach((f, b) => {
      const x = Math.min(...f.map((y) => y.top)), m = Math.max(...f.map((y) => y.bottom)), w = n < x ? x - n : n > m ? n - m : 0;
      w < c && (c = w, i = b);
    });
  }
...
`);
  ...
  for (let u = 0; u < i.length; u += 1) {
    ...
    if (o) continue;
    const f = df(c), b = wn(c), x = wn(c.slice(f)), m = b === s || x === s, w = !m && s.length >= 8 && (b.includes(s) || x.includes(s));
    if ((m || w ? x === s || x.includes(s) ? f : 0 : uf(c, s)) < 0 && !m && !w || (a += 1, a !== n)) continue;
    if ((() => {
      let N = u - 1;
  ...
  return !o && (!i || !Number.isInteger(n) || n < 0) ? { markdown: e, updated: false } : zn(e, (a) => {
    ...
    if (o && (u = mf(a, s)), u < 0 && i) {
      ...
      for (let m = 0; m < b.length; m += 1) {
        ...
        const y = b[m + 1], g = (y == null ? void 0 : y.type) === "inline" ? String(y.content ?? "") : "";
        if (zi(g) === i && (x += 1, x === n)) {
          u = w.map[0] ?? -1;
          break;
        }
...
function Nf({ containerEl: e, containerRef: r, paperContentRef: n, getMarkdown: s, setMarkdown: i }) {
  const o = Gi(), [a, u] = d.useState(false), [c, f] = d.useState(null), [b, x] = d.useState(false), m = d.useRef(null), w = d.useRef(s), y = d.useRef(i);
  w.current = s, y.current = i;
  const g = d.useCallback((z) => {
    m.current = z, f(z), x(false), u(true);
  }, []), k = d.useCallback(() => {
    u(false), x(false), f(null), m.current = null;
  }, []), N = d.useCallback((z) => {
    z && (Sf(z, w.current, y.current), m.current = null, u(false), x(false), f(null));
  }, []);
  d.useEffect(() => {
    ...
    const G = (R) => {
      ...
      for (const Y of z.querySelectorAll(I)) {
      ...
      const I = n.current, se = R.target instanceof Element ? R.target : (_a2 = R.target) == null ? void 0 : _a2.parentElement, Y = (() => {
        var _a3, _b2, _c3;
      ...
      if (!Y) return;
      const ie = I && I.clientWidth > 0 ? I : Y, ke = (_c2 = (_b = R.target) == null ? void 0 : _b.closest) == null ? void 0 : _c2.call(_b, '.md-pgbr[data-md-pgbr="1"], .md-pgbr');
      if (ke && Y.contains(ke)) {
        R.preventDefault(), R.stopPropagation();
        const H = [...Y.querySelectorAll('.md-pgbr[data-md-pgbr="1"], .md-pgbr')].findIndex((B) => B === ke);
        if (H < 0) return;
      ...
      if (de instanceof HTMLElement && Y.contains(de)) {
        R.preventDefault(), R.stopPropagation();
        const { text: T, occurrence: H, headingIndex: B } = yf(Y, de), ue = de.getBoundingClientRect();
      ...
      if ($ instanceof HTMLElement && Y.contains($)) {
        R.preventDefault(), R.stopPropagation();
        const H = [...Y.querySelectorAll("hr")].findIndex((ue) => ue === $);
        if (H < 0) return;
        const B = $.getBoundingClientRect();
        g({ kind: "hr", x: R.clientX, y: R.clientY, hrIndex: H, preview: ns(ie, B.top), label: "\uAD6C\uBD84\uC120" });
        return;
      }
      if (!(R.target instanceof Node) || !Y.contains(R.target)) return;
      const q = lf(Y, R.clientX, R.clientY);
  ...
  return t.jsxs(t.Fragment, { children: [_, o ? t.jsx(Vi, { open: a, onOpenChange: (z) => {
    z ? u(true) : k();
...
function qf({ documentValue: e = "", documentFile: r = null, openCoverEdit: n = false, isDocumentLoading: s = false, hasNavigationSession: i = false }) {
  var _a2, _b, _c2, _d2;
  const o = va(), a = ka(), { showAlert: u } = ll(), { s3Creds: c } = cl(), f = d.useCallback(() => ((c == null ? void 0 : c.imgbbApiKey) || "").trim(), [c == null ? void 0 : c.imgbbApiKey]), b = o.state && typeof o.state == "object" ? o.state : null, x = dl(o.pathname), m = typeof (b == null ? void 0 : b.value) == "string" ? b.value : typeof e == "string" ? e : "", w = (b == null ? void 0 : b.currentFile) ?? r ?? null, y = !!((b == null ? void 0 : b.openCoverEdit) ?? n), [g, k] = d.useState(() => m), N = d.useRef(""), [L, C] = d.useState(() => m), [E, _] = d.useState(() => w), O = d.useRef(m), z = d.useRef(w), G = d.useRef(false);
  O.current = g, z.current = E;
  const [U, R] = d.useState(false), [I, se] = d.useState(() => ({ ...is })), [Y, ie] = d.useState(() => ul()), [ke, de] = d.useState(false), [$, q] = d.useState(true), [T, H] = d.useState(0), [B, ue] = d.useState([]), [re, V] = Hc(), [ye, me] = d.useState([]), [ee, Ee] = d.useState(null), [Me, Ke] = d.useState(null), [Te, Qe] = d.useState(null), [Sr, Le] = d.useState(false), [Z, xe] = d.useState(null), [we, Ct] = d.useState(() => !!y), [ze, et] = d.useState([]), [X, Ye] = d.useState(null), [ht, Et] = d.useState(() => fl()), [tt, Pe] = d.useState(() => pl()), [$e, Ie] = d.useState(() => ml()), [xt, gt] = d.useState(() => hl()), [ir, or] = d.useState(() => xl()), [ar, lr] = d.useState(() => gl()), [Pt, Nr] = d.useState(() => $u()), [Ge, at] = d.useState(() => Ed()), [cr, lt] = d.useState(0), [qe, dr] = d.useState(null), [Cr, Er] = d.useState(0), Xe = d.useRef(null), bt = d.useRef(null), Be = d.useRef(null), [rt, l] = d.useState(null), h = d.useCallback((p) => {
    Be.current = p, l(p);
  }, []), v = d.useRef(null), P = d.useRef(null), M = d.useRef(null), F = d.useRef(null), D = `${Y.pageSizeId}|${Y.imageMaxWidth}|${Y.imageMaxHeight}`, { metricRef: ae, pageInnerHeightPx: fe } = Qu(D);
  Yu(v, F, D), qu(v, `${D}|${g}`), bl(v, { eager: true, layoutKey: `${D}|${g}` }), Ju(v, F, `${D}|${g}`);
  const ne = wl(Y.pageSizeId), S = fe > 1 ? fe : ne.heightPx, W = `${D}|${g}|${S}`, { pageCount: J } = ef(v, P, S, W), ge = d.useRef(null), te = d.useRef(false), pe = d.useRef(null), ve = d.useRef(0), { width: Ze, isResizing: Oe, handleProps: ur } = Wn({ storageKey: Cf, defaultWidth: Ef, minWidth: 180, collapseBelowWidth: 90, maxWidth: 640, edge: "right", onCollapseBelowMin: () => q(false) }), { width: Pr, isResizing: Ho, handleProps: Wo } = Wn({ storageKey: Tu, defaultWidth: Ru, minWidth: 220, maxWidth: 480, edge: "left" }), { width: $s, isResizing: Ko, handleProps: Go } = Wn({ storageKey: Mu, defaultWidth: Lu, minWidth: 200, maxWidth: 420, edge: "left" }), Xo = Pr + (Pt ? $s : 0), [Uo, Os] = d.useState(() => Kn());
  d.useEffect(() => {
    const p = () => Os(Kn());
    return window.addEventListener(Zs, p), Os(Kn()), () => window.removeEventListener(Zs, p);
  }, []);
  ...
  d.useEffect(() => {
    ...
    _s.current = r.id, _(r);
    const p = typeof e == "string" ? e : "";
    k(p), C(p);
  }, [r, e, b]);
  const fr = d.useMemo(() => {
    const { meta: p } = vl(g);
    return p ?? kl;
  }, [g]), Wr = d.useMemo(() => jl(g), [g]), An = d.useMemo(() => ds(g), [g]), Kr = An.cover, oe = Kr, Fs = !!(oe == null ? void 0 : oe.enabled), In = we ? "scroll" : Ge.navigation, pr = we ? 1 : Ge.pages, ct = In === "scroll" && pr === 1, Dn = !!we, Je = d.useCallback((p) => {
    at((j) => {
      const A = { ...j, ...p };
      return Object.prototype.hasOwnProperty.call(p, "zoomPercent") && (A.zoomPercent = Ln(p.zoomPercent)), zr(A), A;
    });
  }, []), Vo = d.useCallback((p) => {
    Je({ zoomPercent: p });
  }, [Je]), Gr = d.useCallback((p) => {
    if (!p) return;
    ...
    const Q = Vd(j, A, !!(oe == null ? void 0 : oe.enabled)), K = ((oe == null ? void 0 : oe.enabled) ? 1 : 0) + Math.max(1, J), ce = Yd(Q, K, pr, Ge.firstPageSingle);
    lt(ce);
...
${j}` }));
  ...
  }, [E]), { onCoverChange: Tt, undo: Bs, redo: Hs, canUndo: Yo, canRedo: qo } = Uu({ currentFile: E, enabled: !!(we && oe), cover: oe, applyCover: $n }), Rr = d.useCallback(() => {
    Ct((p) => {
      const j = !p;
      return j || (et([]), Ye(null)), j;
    }), k((p) => {
      if (we || ds(p).cover) return p;
      const j = Nl({ pageSizeId: Y.pageSizeId }), A = us(p, j);
      return ot({ currentFile: E, editorContent: A }), A;
    });
  }, [we, E, Y.pageSizeId]);
  d.useEffect(() => {
    !we || !(oe == null ? void 0 : oe.pageSizeId) || oe.pageSizeId !== Y.pageSizeId && ie((p) => {
      if (p.pageSizeId === oe.pageSizeId) return p;
      const j = { ...p, pageSizeId: oe.pageSizeId };
      return Gn(j), j;
    });
  }, [oe == null ? void 0 : oe.pageSizeId, we, Y.pageSizeId]);
  const Zo = d.useCallback((p) => {
    Et(p), Qr("settings-cover-center-snap", p);
  }, []), Jo = d.useCallback((p) => {
    Pe(p), Cl(p);
  }, []), Qo = d.useCallback((p) => {
    Ie(p), Qr("settings-cover-object-snap", p);
  }, []), ea = d.useCallback((p) => {
    gt(p), El(p);
  }, []), ta = d.useCallback((p) => {
    or(p), Qr("settings-cover-text-outline", p);
  }, []), ra = d.useCallback((p) => {
    lr(p), Qr("settings-cover-place-preview", p);
  }, []), na = d.useCallback((p) => {
    Nr(p), Ou(p);
  }, []);
  Xc(Be, Wr, Tr ?? void 0, E == null ? void 0 : E.id), d.useEffect(() => {
    ...
    return window.addEventListener(Js, p), () => window.removeEventListener(Js, p);
  }, []), d.useEffect(() => {
    ...
    p(), window.addEventListener("resize", p), window.addEventListener("scroll", p, true);
    let j = null;
    return typeof ResizeObserver < "u" && bt.current && (j = new ResizeObserver(p), j.observe(bt.current)), () => {
      window.removeEventListener("resize", p), window.removeEventListener("scroll", p, true), j == null ? void 0 : j.disconnect();
    };
  }, []), d.useEffect(() => {
    if (rt) return Ic(rt);
  }, [rt]), d.useEffect(() => {
    ...
    const p = B.map((je) => document.getElementById(je.id)).filter(Boolean);
    if (!p.length) {
      me([]);
      return;
    }
    ...
    if (!j) return;
    const A = p.querySelector(`button[data-toc-id="${j}"]`);
    if (!A) return;
    const Q = p.getBoundingClientRect(), K = A.getBoundingClientRect();
  ...
  const mr = d.useCallback((p, j = z.current) => {
    G.current = true, ot({ currentFile: j, editorContent: typeof p == "string" ? p : "" });
  }, []);
  d.useLayoutEffect(() => (G.current = false, () => {
    G.current || ot({ currentFile: z.current, editorContent: O.current ?? "" });
  }), []);
  const On = d.useCallback(() => {
    const p = document.querySelector("[data-export-pdf-pages]");
    !p || p.children.length === 0 || window.print();
  ...
  const sa = d.useCallback(() => Fn.current, []), { isBlocked: ia, proceed: Xr, reset: oa } = Tl({ isDirty: sa }), Ws = d.useCallback(() => {
    ...
    const p = ((_a3 = z.current) == null ? void 0 : _a3.id) || x;
    if (p) {
      a(`/view/${p}`);
      return;
    }
    ...
    try {
      ...
      return alert(`\uC800\uC7A5 \uC2E4\uD328: ${(p == null ? void 0 : p.message) || p}`), false;
    } finally {
      R(false);
    }
  }, [E, U, g, Y, mr]), aa = d.useCallback(async () => {
    await Zt() && Xr();
  ...
  d.useEffect(() => {
    ...
    const j = '.export-pdf-cover, [data-note-cover="1"]', A = (K) => {
      ...
      for (const je of p.querySelectorAll(j)) {
    ...
    return p.addEventListener("contextmenu", Q), () => p.removeEventListener("contextmenu", Q);
  }, []);
  const da = d.useCallback(({ width: p, height: j }) => {
    const A = ee;
    if (!(A == null ? void 0 : A.key)) return;
    const Q = A.kind === "wiki" ? Xn(g, { path: A.key, occurrence: A.occurrence ?? 0, width: p, height: j }) : Un(g, { src: A.key, occurrence: A.occurrence ?? 0, width: p, height: j });
    !Q.updated || Q.markdown === g || (k(Q.markdown), ot({ currentFile: E, editorContent: Q.markdown }));
  }, [E, g, ee]), ua = d.useCallback(async ({ file: p }) => {
    const j = ee;
    if (!(j == null ? void 0 : j.key)) throw new Error("\uC790\uB97C \uC774\uBBF8\uC9C0\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.");
    const A = await jr(p, E), Q = j.kind === "wiki" ? Rl(g, { path: j.key, occurrence: j.occurrence ?? 0, nextPath: A }) : ei(g, { src: j.key, occurrence: j.occurrence ?? 0, nextPath: A });
    !Q.updated || Q.markdown === g || (k(Q.markdown), ot({ currentFile: E, editorContent: Q.markdown }));
  }, [E, g, ee]), fa = d.useCallback(async ({ width: p, height: j }) => {
    const A = ee;
    ...
    const ce = ei(g, { src: A.key, occurrence: A.occurrence ?? 0, nextPath: K, width: p, height: j });
  ...
  }, [E, g, ee]), pa = d.useCallback(async ({ width: p, height: j }) => {
    const A = ee;
    ...
    let be = g;
    const nt = A.kind === "wiki" ? Xn(be, { path: A.key, occurrence: je, width: p, height: j }) : Un(be, { src: A.key, occurrence: je, width: p, height: j });
  ...
  }, [E, f, g, ee]), dt = d.useCallback((p) => {
    const j = Be.current;
    if (!j || !(p == null ? void 0 : p.kind) || !(p == null ? void 0 : p.key)) return null;
    const A = p.kind === "wiki" ? "img[data-wiki-path]" : "img[data-md-src]";
    return [...j.querySelectorAll(A)].filter((ce) => (p.kind === "wiki" ? ce.getAttribute("data-wiki-path") : ce.getAttribute("data-md-src")) === p.key)[p.occurrence ?? 0] ?? null;
  }, []), ma = d.useCallback(() => {
    const p = ee;
    if (!(p == null ? void 0 : p.kind) || !(p == null ? void 0 : p.key)) return;
    const j = dt(p);
    if (!j) return;
    const A = j.getBoundingClientRect(), Q = Math.max(24, Math.round(A.width)), K = Math.max(24, Math.round(A.height)), ce = { kind: p.kind, key: p.key, occurrence: p.occurrence ?? 0, widthPx: Q, heightPx: K, originalWidthPx: Q, originalHeightPx: K };
  ...
  d.useEffect(() => {
    ...
    const j = (K) => {
      ...
      if (!Se) return;
      const je = K.pointerType === "touch", be = Xe.current || Te, nt = K.clientX, ut = K.clientY, wt = be.heightPx > 0 ? be.widthPx / be.heightPx : 1, Vr = (Mr) => {
        const Yr = Mr.clientX - nt, Ks = Mr.clientY - ut;
        let st = be.widthPx, it = be.heightPx;
        if (Se.includes("e") && (st = be.widthPx + Yr), Se.includes("w") && (st = be.widthPx - Yr), Se.includes("s") && (it = be.heightPx + Ks), Se.includes("n") && (it = be.heightPx - Ks), st = Math.max(24, st), it = Math.max(24, it), je || Mr.shiftKey) {
        ...
        st = Math.max(24, Math.round(st)), it = Math.max(24, Math.round(it)), p.style.width = `${st}px`, p.style.height = `${it}px`;
        const Gs = { ...Xe.current || be, widthPx: st, heightPx: it };
        Xe.current = Gs, Qe(Gs);
      }, Jt = () => {
        document.removeEventListener("pointermove", Vr, true), document.removeEventListener("pointerup", Jt, true);
      };
      document.addEventListener("pointermove", Vr, true), document.addEventListener("pointerup", Jt, true);
    }, A = (K) => {
      var _a3, _b2, _c3, _d3;
  ...
  const ha = d.useCallback(() => {
    var _a3;
    const p = Xe.current || Te;
    if (!(p == null ? void 0 : p.key)) return;
    const j = `${Math.round(p.widthPx)}px`, A = `${Math.round(p.heightPx)}px`, Q = p.kind === "wiki" ? Xn(g, { path: p.key, occurrence: p.occurrence ?? 0, width: j, height: A }) : Un(g, { src: p.key, occurrence: p.occurrence ?? 0, width: j, height: A });
    Q.updated && Q.markdown !== g && (k(Q.markdown), ot({ currentFile: E, editorContent: Q.markdown })), (_a3 = dt(p)) == null ? void 0 : _a3.removeAttribute("data-print-free-transform"), Qe(null), Xe.current = null, Le(false);
  }, [E, dt, Te, g]), xa = d.useCallback(() => {
    const p = Me;
    if (!p) return;
    const j = O.current ?? "", A = Bo(j, p.headingText || "", 0, p.headingIndex);
    A.updated && A.markdown !== j && (k(A.markdown), ot({ currentFile: z.current, editorContent: A.markdown })), Ke(null);
  }, [Me]), ga = d.useCallback(() => {
    const p = Xe.current || Te;
    if (!p) return;
    const j = dt(p);
    j && (j.style.width = `${p.originalWidthPx}px`, j.style.height = `${p.originalHeightPx}px`, j.removeAttribute("data-print-free-transform")), Qe(null), Xe.current = null, Le(false);
  }, [dt, Te]), Ur = d.useCallback((p) => {
    ie((j) => {
      const A = { ...j, ...p };
      return Gn(A), A;
    }), p.pageSizeId && oe && p.pageSizeId !== oe.pageSizeId && $n({ ...oe, pageSizeId: p.pageSizeId });
  }, [oe, $n]);
  d.useEffect(() => {
    const p = { "print-save": () => {
      Zt();
      ...
      we || Rr(), Ye((j) => (j == null ? void 0 : j.kind) === "text" ? null : { kind: "text" });
    }, "print-cover-place-rect": () => {
      we || Rr(), Ye((j) => (j == null ? void 0 : j.kind) === "shape" && j.shapeType === "rect" ? null : { kind: "shape", shapeType: "rect" });
    }, "print-cover-place-ellipse": () => {
      we || Rr(), Ye((j) => (j == null ? void 0 : j.kind) === "shape" && j.shapeType === "ellipse" ? null : { kind: "shape", shapeType: "ellipse" });
    ...
    for (const j of os) p[Dl(j.id)] = () => {
      Ur({ pageSizeId: j.id });
    };
    return $l(p);
  }, [Zt, On, Ur, Je, we, Rr, oe, ze, Tt]), d.useEffect(() => Ol(({ headingId: p }) => {
    Gr(p);
  }), [Gr]), d.useEffect(() => _l(() => B.map((p) => ({ id: p.id, text: p.text, level: p.level }))), [B]), d.useEffect(() => {
    const p = Be.current;
    if (!p) return;
    const j = (A) => {
...
${(Me == null ? void 0 : Me.headingText) || "(\uC81C\uBAA9 \uD14D\uC2A4\uD2B8 \uC5C6\uC74C)"}`, confirmLabel: "\uC0BD\uC785", cancelLabel: "\uCDE8\uC18C", onConfirm: xa, onCancel: () => Ke(null) }), t.jsx(Nf, { containerEl: rt, containerRef: Be, paperContentRef: v, getMarkdown: () => O.current ?? "", setMarkdown: (p) => {
    k(p), ot({ currentFile: z.current, editorContent: p });
