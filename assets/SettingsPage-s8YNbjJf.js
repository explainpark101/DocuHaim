...
import { T as xa } from "./TableStyleTemplateEditor-BAe0dXIZ.js";
...
import { G as fa, O as ya } from "./OpenAiCompatibleModelSelect-DJS9uQ4D.js";
                          ...
                          onClick: async () => {
                            try {
                              const { createWebdavBackend: r } = await or(async () => {
                                const { createWebdavBackend: Q } = await import("./index-BGi2DbIx.js").then(async (m2) => {
                                  await m2.__tla;
                                  return m2;
                                }).then((Te) => Te.gg);
                                return {
