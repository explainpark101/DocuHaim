import { r as N, j as t } from "./vendor-react-SY5QCjFA.js";
import { t as E, O } from "./index-CG4BSG42.js";
import { j as h, dp as $, dq as p } from "./index-BFoGIzMz.js";
import { Q as I, X as T, U as _, V as z } from "./vendor-radix-BgY9OwZN.js";
const P = "inline-flex max-w-full items-center justify-between gap-1 rounded-md border border-gray-300 dark:border-odp-borderStrong bg-white dark:bg-odp-surface px-2 py-1 text-sm text-gray-800 dark:text-odp-fgStrong outline-none focus-visible:ring-2 focus-visible:ring-blue-400 disabled:opacity-50", M = "z-100010 max-h-[min(280px,var(--radix-select-content-available-height))] min-w-[var(--radix-select-trigger-width)] overflow-hidden rounded-md border border-gray-200 bg-white shadow-lg dark:border-odp-borderStrong dark:bg-odp-bgSoft", X = "relative flex cursor-pointer select-none items-center gap-2 rounded-sm py-1.5 pl-7 pr-3 text-sm text-gray-800 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-40 data-[highlighted]:bg-gray-100 dark:text-odp-fg dark:data-[highlighted]:bg-odp-focusBg", F = "z-[220] min-w-[160px] overflow-hidden rounded-lg border border-gray-200 bg-white p-1 shadow-lg dark:border-odp-borderStrong dark:bg-odp-bgSoft", K = "flex cursor-pointer select-none items-center gap-2 rounded-md px-3 py-2 text-sm text-gray-700 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-40 data-[highlighted]:bg-gray-100 dark:text-odp-fg dark:data-[highlighted]:bg-odp-focusBg", L = "flex cursor-pointer select-none items-center gap-2 rounded-md px-3 py-2 text-sm text-red-600 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-40 data-[highlighted]:bg-red-50 dark:text-red-400 dark:data-[highlighted]:bg-red-950/40", V = "fixed inset-0 z-[200] bg-black/40", q = "fixed left-1/2 top-1/2 z-[201] w-[min(92vw,360px)] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-gray-200 bg-white p-4 shadow-xl outline-none dark:border-odp-borderStrong dark:bg-odp-bgSoft", Q = "w-full rounded-md border border-gray-300 bg-transparent px-2 py-1.5 text-sm text-gray-800 outline-none focus-visible:ring-2 focus-visible:ring-blue-400 dark:border-odp-borderStrong dark:text-odp-fgStrong", x = [{ id: "none", label: "\uC5C6\uC74C", value: null }, { id: "white", label: "\uD770\uC0C9", value: "#ffffff", swatch: "#ffffff" }, { id: "black", label: "\uAC80\uC815", value: "#000000", swatch: "#000000" }, { id: "gray", label: "\uD68C\uC0C9", value: "#e5e7eb", swatch: "#e5e7eb" }], H = "data-chat-color-picker";
function U({ value: f = null, onChange: n, compact: m = false, label: w = "\uBC30\uACBD\uC0C9", className: k = "", tone: y = "light", allowNone: v = true, noneLabel: C = "\uC5C6\uC74C" }) {
