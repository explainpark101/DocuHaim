...
import { au as T, ac as _, av as W } from "./index-B7Eblbsj.js";
import { E as V, k as D, aE as P } from "./vendor-lucide-BWX_GyjE.js";
...
function A({ value: i = "", mode: t = "html", theme: r = "light", readOnly: c = false, onChange: x, onSave: g }) {
  const [o, p] = l.useState("dual"), [m, u] = l.useState(() => w(i, t, r)), { width: v, isResizing: E, handleProps: y } = T({ storageKey: z, defaultWidth: 480, minWidth: 200, maxWidth: 960, edge: "right" }), j = t === "svg" ? "xml" : "html", a = o === "dual" || o === "editor", h = o === "dual" || o === "preview";
  l.useEffect(() => {
