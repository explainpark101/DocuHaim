...
import { fX as Z, fY as q, fZ as W, e0 as Y, eZ as H, f_ as L, eX as Q, eY as V } from "./index-y7w1bGot.js";
import { v as O, ap as $ } from "./vendor-lucide-DpPvFd8E.js";
import { a0 as ee, a1 as te, a2 as re, a3 as ne, a4 as R } from "./vendor-radix--fTcLYkF.js";
...
async function je({ apiKey: e, model: r, instruction: t, selectedText: n, images: s }) {
  const o = (r || Z()).trim() || q, a = (t || "").trim(), i = (n || "").trim(), c = Array.isArray(s) ? s.filter((m) => (m == null ? void 0 : m.mimeType) && (m == null ? void 0 : m.dataBase64)) : [];
...
async function Ne({ baseUrl: e, apiKey: r, model: t, instruction: n, selectedText: s, images: o }) {
  const a = K(e), i = (t || W()).trim(), c = (n || "").trim(), l = (s || "").trim(), m = Array.isArray(o) ? o.filter((y) => (y == null ? void 0 : y.mimeType) && (y == null ? void 0 : y.dataBase64)) : [];
