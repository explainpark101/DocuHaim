...
import { T as xa } from "./TableStyleTemplateEditor-By68cXEI.js";
...
import { G as fa, O as ya } from "./OpenAiCompatibleModelSelect-pwjqd6SR.js";
                          ...
                          onClick: async () => {
                            try {
                              const { createWebdavBackend: r } = await or(async () => {
                                const { createWebdavBackend: Q } = await import("./index-v578Jj5i.js").then(async (m2) => {
                                  await m2.__tla;
                                  return m2;
                                }).then((Te) => Te.gi);
                                return {
