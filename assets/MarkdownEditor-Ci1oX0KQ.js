...
import { j as o, r as l, u as wo, a as yo, c as vs } from "./vendor-react-kfkzeLNk.js";
import { B as ks, D as Zn, S as vo, l as Tt, F as ko, G as cr, W as Cs, H as Co, J as Dt, M as st, O as Eo, j as er, V as So, P as No, m as De, Q as Es, R as Ss, T as Ns, U as js, X as Ms, Y as wn, Z as ur, $ as Rs, a0 as Ts, c as Ls, a1 as Ps, a2 as jo, v as As, a3 as Ds, a4 as Is, K as $s, a5 as Fs, a6 as _s, a7 as Hs, a8 as Os, a9 as Bs, aa as Ks, ab as zs, ac as Vs, ad as Ws, ae as qs, af as Us, ag as Xs, ah as Ys, ai as Gs, aj as Qs, ak as Js, al as Zs, am as ea, an as ta, ao as na } from "./vendor-md-editor-Bjw10uWE.js";
import { o as ra, dN as Mo, dO as un, dP as Ie, dQ as Ro, aa as pt, dR as dr, dS as oa, ah as To, ai as Lo, dT as fr, dU as sa, U as It, ad as aa, dV as mr, F as pr, dW as ia, dX as la, dY as ca, dZ as hr, d_ as Po, d$ as ua, e0 as da, e1 as fa, e2 as ma, e3 as pa, e4 as Ao, e5 as ha, a4 as on, cC as Do, aA as ga, au as xa, e6 as ba, q as wa, e7 as gr, e8 as ya, e9 as va, x as ka, O as yn, ea as Ca, N as vn, eb as Ea, y as kn, w as Sa, cJ as Io, dc as zn, aC as Na, ay as sn, ec as xr, aB as ja, ed as Ma, ee as Ra, ef as Ta, dd as La, eg as Pa, eh as Vn, a5 as Aa, d4 as tr, a0 as nr, ei as Da, ej as Ia, ek as $a, dg as Fa, cn as _a, dI as Ha, d9 as $o, el as Rt, em as Oa, en as Ba, eo as Ka, de as za, dv as Va, ep as Fo, eq as Wa, er as qa, es as br, et as Ua, eu as Xa, E as Ya, ds as Ga, dH as Yt, dn as Qa, ev as Ja, ew as Nt, ex as Za, ey as ei, ez as ti, bD as wr, al as Cn, dA as En, am as ni, dB as yr, dC as ri, an as oi, ao as si, a2 as ai, ap as ii, aj as li, ak as ci, T as ui, M as di, dK as fi, eA as mi, eB as pi, eC as Sn, eD as Nn, eE as vr, eF as kr, eG as jn, eH as Cr, eI as hi, eJ as Er, eK as Sr, dL as gi, ar as xi, dM as bi, eL as wi, eM as yi, eN as vi, eO as ki, eP as Nr, eQ as qe, eR as Ci, eS as Mn, eT as Rn, bw as Ei } from "./index-C0ZoiHxN.js";
import { S as Si, ax as Ni, ay as jr, az as Tn, aj as Ln, aA as ji, O as Mi, aB as rr, aC as Ri, J as _o, aD as Ti, R as Li, X as dn, v as Pi, aE as Ai, aF as Di, i as fn, aG as Ii, aH as $i, aI as Ho, aJ as Fi, x as _i, aK as an, am as Hi, an as Oi, av as Mr, aL as Pn, aM as Rr, aN as Bi, ag as Ki, j as zi, aO as Tr, aP as Vi, aQ as Wi, aR as qi, aS as Ui, G as ht, z as Xi, L as Yi } from "./vendor-lucide-DUUE-0mU.js";
import { d as Oo, r as An, s as Dn, B as Gi, E as Qi, G as Ji, H as Zi, I as el, J as tl, K as nl, M as rl, N as ol, Q as sl, S as or, b as sr, e as Wn, T as qn, f as Un, g as Xn, A as Yn, l as al, F as Ue, L as rt, m as Gt, V as il, W as ll, X as cl, U as ul, _ as Lr, $ as dl, a0 as fl, a1 as ml, a2 as pl, a3 as Pr } from "./vendor-radix-BifzBLLM.js";
import { M as hl } from "./MdEditorToolbarTooltips-XJDtzy_X.js";
import { a as gl, h as xl, P as bl, H as wl } from "./previewFootnoteScroll-DLQ-DriC.js";
import { N as yl, u as vl, W as kl } from "./useTocTitleWrap-ACXBcBnx.js";
import { H as In, T as Cl } from "./TableStyleTemplateEditor-Dn80Xtfb.js";
import { a as mn } from "./vendor-motion-9P87yVtW.js";
import { c as El } from "./clipboardImageFiles-BExtTEiN.js";
import { u as Sl } from "./useWikiImageHydration-CyFV48Mq.js";
import "./vendor-aws-ockC6VaD.js";
import "./vendor-zip-Bez6qchM.js";
import "./vendor-google-genai-BXoTgYIl.js";
import "./vendor-image-crop-BfNSF_Kw.js";
import "./storageImageHydration-DrpNPHCH.js";
...
function $l(e, t, n) {
  ...
  return s < p ? p += 1 : m > 0 && s >= a - m && (m += 1), { grid: { rows: u, aligns: [...e.aligns] }, meta: (() => {
    var _a2;
    const x = { ...t, headerRows: p, footerRows: m, merges: Tl(t.merges, s), cells: Nl(t.cells, s) };
    if ((_a2 = t.rowHeights) == null ? void 0 : _a2.length) {
      const T = Mo(t.rowHeights, s);
      T && (x.rowHeights = T);
    }
    return x;
  })() };
...
function Fl(e, t, n) {
  ...
  return c.splice(a, 0, null), { grid: { rows: s, aligns: c }, meta: (() => {
    var _a2;
    const u = { ...t, merges: Ll(t.merges, a), cells: jl(t.cells, a) };
    if ((_a2 = t.colWidths) == null ? void 0 : _a2.length) {
      const p = Mo(t.colWidths, a);
      p && (u.colWidths = p);
    }
    return u;
  })() };
...
function _l(e, t, n) {
  ...
  const a = Dl(e, t, n), s = [...a.grid.rows.slice(0, n), ...a.grid.rows.slice(n + 1)];
  let c = a.meta.headerRows, u = a.meta.footerRows;
  n < c ? c = Math.max(0, c - 1) : u > 0 && n >= r - u && (u = Math.max(0, u - 1));
  const p = s.length;
  c + u > p && (u = Math.max(0, p - c));
  const m = { ...a.meta, headerRows: c, footerRows: u, merges: Pl(a.meta.merges, n), cells: Ml(a.meta.cells, n) };
  if ((_a2 = a.meta.rowHeights) == null ? void 0 : _a2.length) {
    const x = Ro(a.meta.rowHeights, n);
...
function Hl(e, t, n) {
  ...
  if (r <= 1) return { grid: e, meta: t };
  if (n < 0 || n >= r) return { grid: e, meta: t };
  const a = Il(e, t, n), s = a.grid.rows.map((p) => {
    const m = [...p];
  ...
  for (; c.length < r; ) c.push(null);
  c.splice(n, 1);
  const u = { ...a.meta, merges: Al(a.meta.merges, n), cells: Rl(a.meta.cells, n) };
  if ((_a2 = a.meta.colWidths) == null ? void 0 : _a2.length) {
    const p = Ro(a.meta.colWidths, n);
...
const Ar = ".md-editor-catalog-link", Wl = "md-preview-heading-folded", Dr = "md-preview-heading-section-hidden", ql = 2;
function Ul(e, t) {
  ...
  for (let t = 0; t < 8; t += 1) {
    ...
    for (; s && !a; ) {
      if (s instanceof HTMLElement && (s.classList.contains(Dr) || s.hasAttribute("hidden"))) {
        ...
        for (; u; ) {
          if (u instanceof HTMLElement && u.classList.contains(Wl)) {
...
function Yl(e, t) {
  const n = (r) => {
    ...
    r.preventDefault(), r.stopPropagation(), typeof r.stopImmediatePropagation == "function" && r.stopImmediatePropagation(), Xl(x);
    const T = pt(x);
    if (!T) {
      x.scrollIntoView({ block: "start", behavior: "smooth" });
      return;
    }
    const j = x.previousElementSibling ? 0 : Number.parseFloat(getComputedStyle(x).marginBlockStart || "0") || 0, R = Ul(x, T) - ql - j;
...
function Gl({ onToggle: e, active: t = false }) {
  return o.jsx("button", { type: "button", className: ["md-editor-toolbar-item", t ? "md-editor-toolbar-active !bg-violet-200 hover:!bg-violet-300 dark:!bg-violet-800/85 dark:hover:!bg-violet-700/90" : ""].filter(Boolean).join(" "), onClick: () => e == null ? void 0 : e(), title: t ? "AI \uB3C4\uC6B0\uBBF8 \uB2EB\uAE30" : "AI \uB3C4\uC6B0\uBBF8", "aria-label": t ? "AI \uB3C4\uC6B0\uBBF8 \uB2EB\uAE30" : "AI \uB3C4\uC6B0\uBBF8", "aria-pressed": t, children: o.jsx(Si, { className: "md-editor-icon", size: 16 }) });
}
function Ql(e) {
...
function Zl({ markdown: e = "", onMarkdownChange: t }) {
  const [n, r] = l.useState(""), [a, s] = l.useState("all"), [c, u] = l.useState({}), [p, m] = l.useState("dashboard"), x = l.useMemo(() => Ql(e), [e]);
  l.useEffect(() => {
    const N = {};
...
const Ko = "s3haim-checklist-progress-modal-position", $n = { leftVw: 58, topVh: 14 };
function ec() {
  try {
...
function tc({ leftVw: e, topVh: t }) {
  try {
    localStorage.setItem(Ko, JSON.stringify({ leftVw: Math.min(95, Math.max(0, e)), topVh: Math.min(95, Math.max(0, t)) }));
  } catch {
  }
}
const zo = "(max-width: 768px)", nc = 5;
function Ir() {
  return typeof window < "u" && window.matchMedia(zo).matches;
}
function rc({ editorRef: e, onChange: t, open: n, onOpenChange: r }) {
  const [a, s] = l.useState(() => ec()), [c, u] = l.useState(""), [p, m] = l.useState({ from: 0, to: 0 }), x = l.useRef({ active: false, startX: 0, startY: 0, startLeftVw: 0, startTopVh: 0 }), T = l.useCallback(() => {
  ...
  l.useEffect(() => {
    ...
    if (!n) return;
    const L = window.matchMedia(zo), B = (I) => {
  ...
  const j = l.useCallback((L) => {
    ...
    const Z = (k) => {
      ...
      Math.hypot(k.clientX - B, k.clientY - I) <= nc;
      ...
      x.current.active && (x.current.active = false, document.removeEventListener("pointermove", Z), document.removeEventListener("pointerup", Q), s((k) => (tc(k), k)));
    };
    ...
    oa(B, I, Z, L, t) && m({ from: I, to: I + L.length });
  }, [e, p, t]), N = () => {
    r == null ? void 0 : r(false);
  };
  return !n || Ir() ? null : o.jsxs("div", { className: "fixed z-[10050] w-[min(92vw,440px)] rounded-lg border border-indigo-400/40 bg-slate-950/95 shadow-2xl backdrop-blur-md", style: { left: `${a.leftVw}vw`, top: `${a.topVh}vh` }, role: "dialog", "aria-modal": "false", "aria-label": "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8 \uC9C4\uD589\uB960", children: [o.jsxs("div", { className: "flex cursor-grab items-center justify-between gap-2 border-b border-indigo-500/30 bg-indigo-950/50 px-3 py-2 active:cursor-grabbing", onPointerDown: j, children: [o.jsxs("div", { className: "flex min-w-0 items-center gap-2 text-sm font-semibold text-indigo-100", children: [o.jsx(Ti, { size: 16, className: "shrink-0 opacity-60", "aria-hidden": true }), o.jsx(rr, { size: 16, className: "shrink-0", "aria-hidden": true }), o.jsx("span", { className: "truncate", children: "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8 \uC9C4\uD589\uB960" })] }), o.jsxs("div", { className: "flex shrink-0 items-center gap-1", children: [o.jsxs("button", { type: "button", onPointerDown: (L) => L.stopPropagation(), onClick: T, className: "inline-flex items-center gap-1 rounded px-1.5 py-1 text-[11px] text-indigo-200 hover:bg-indigo-900/50", title: "\uC120\uD0DD \uC601\uC5ED \uC0C8\uB85C\uACE0\uCE68", "aria-label": "\uC120\uD0DD \uC601\uC5ED \uC0C8\uB85C\uACE0\uCE68", children: [o.jsx(Li, { size: 14 }), o.jsx("span", { className: "hidden sm:inline", children: "\uC0C8\uB85C\uACE0\uCE68" })] }), o.jsx("button", { type: "button", onPointerDown: (L) => L.stopPropagation(), onClick: N, className: "rounded p-1 text-indigo-200 hover:bg-indigo-900/50", title: "\uB2EB\uAE30", "aria-label": "\uB2EB\uAE30", children: o.jsx(dn, { size: 15 }) })] })] }), o.jsx("div", { className: "max-h-[min(72vh,640px)] overflow-y-auto p-3", children: c.trim() ? o.jsx(Zl, { markdown: c, onMarkdownChange: R }) : o.jsxs("p", { className: "rounded-lg border border-dashed border-slate-700 bg-slate-900/60 px-3 py-6 text-center text-xs text-slate-400", children: ["\uC5D0\uB514\uD130\uC5D0\uC11C \uCCB4\uD06C\uB9AC\uC2A4\uD2B8\uAC00 \uD3EC\uD568\uB41C \uD14D\uC2A4\uD2B8\uB97C \uC120\uD0DD\uD55C \uB4A4", o.jsx("br", {}), "\uD234\uBC14 \uBC84\uD2BC\uC744 \uB204\uB974\uAC70\uB098 \uC0C8\uB85C\uACE0\uCE68\uD558\uC138\uC694."] }) })] });
}
const oc = "(max-width: 768px)";
function sc() {
  return typeof window < "u" && window.matchMedia(oc).matches;
}
function ac({ onOpen: e }) {
...
function ic({ value: e = "", theme: t = "light", currentFile: n = null, disabled: r, trigger: a }) {
  const s = wo(), c = l.useCallback(() => {
    r || (To({ currentFile: n, editorContent: e }), s(Lo(n == null ? void 0 : n.id), { state: { value: e, theme: t, currentFile: n } }));
  }, [s, e, t, r, n]);
  return o.jsx("button", { type: "button", className: "md-editor-toolbar-item", onClick: c, disabled: r, title: "PDF\uB85C \uB0B4\uBCF4\uB0B4\uAE30", "aria-label": "PDF\uB85C \uB0B4\uBCF4\uB0B4\uAE30", children: a ?? o.jsx(Pi, { className: "md-editor-icon", size: 16 }) });
}
function lc({ editorRef: e }) {
...
`;
  ...
  return o.jsx("button", { type: "button", className: "md-editor-toolbar-item", onClick: t, title: "Insert print page break (<pgbr/>)", "aria-label": "Insert print page break", children: o.jsx(Ai, { className: "md-editor-icon", size: 16 }) });
}
function cc({ onOpen: e }) {
  return o.jsx("button", { type: "button", className: "md-editor-toolbar-item", title: "\uCD5C\uB300 heading \uBCC0\uACBD", "aria-label": "\uCD5C\uB300 heading \uBCC0\uACBD", onClick: () => e(), children: o.jsx(Di, { className: "md-editor-icon", size: 16 }) });
}
const uc = [{ value: "selection", title: "\uC120\uD0DD \uC601\uC5ED", description: "\uD604\uC7AC \uC120\uD0DD\uB41C \uD14D\uC2A4\uD2B8\uB9CC \uBCC0\uACBD" }, { value: "document", title: "\uC804\uCCB4 \uBB38\uC11C", description: "\uBB38\uC11C \uC804\uCCB4 heading\uC744 \uBCC0\uACBD" }], dc = [{ value: "flat", title: "1. \uD615\uC2DD", description: "\uCD5C\uB300 heading\uC744 \uD55C \uC790\uB9AC \uBC88\uD638\uB85C \uC2DC\uC791" }, { value: "nested", title: "2.1. \uD615\uC2DD", description: "heading \uC218\uC900\uB9CC\uD07C \uBC88\uD638\uB97C \uBD99\uC784" }], fc = [{ value: 1, title: "1\uBD80\uD130", description: "\uCD5C\uB300 heading\uC774 1. / 1.1. \u2026" }, { value: 2, title: "2\uBD80\uD130", description: "\uCD5C\uB300 heading\uC774 2. / 2.1. \u2026" }], mc = (e) => ["relative inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border outline-none transition-all duration-200 focus-visible:ring-2 focus-visible:ring-blue-400", e ? "border-blue-500 bg-blue-500 shadow-sm dark:border-blue-500 dark:bg-blue-500" : "border-transparent bg-gray-300 dark:border-odp-borderStrong dark:bg-odp-borderStrong"].join(" "), pc = "block h-4 w-4 translate-x-0.5 rounded-full bg-white shadow transition-transform will-change-transform data-[state=checked]:translate-x-[1.125rem]", $r = "z-100010 max-w-[min(92vw,320px)] rounded-md border border-gray-200 bg-white px-2.5 py-1.5 text-xs text-gray-800 shadow-md dark:border-odp-borderStrong dark:bg-odp-surface dark:text-odp-fgStrong";
function hc({ isOpen: e, markdown: t, selectedMarkdown: n = "", onClose: r, onApply: a }) {
  ...
  const I = l.useMemo(() => sa(B, p, { maxLevel: hr, renumberOutline: x, outlineStyle: j, outlineStart: N }), [B, p, x, j, N]), Z = (k) => {
    if (k !== "selection" && k !== "document" || k === "selection" && !s) return;
    u(k), m(fr(k === "selection" ? n : t));
  }, Q = () => {
    if (!I.sourceMax) return;
    const k = ca(B, p, { maxLevel: hr, renumberOutline: x, outlineStyle: j, outlineStart: N });
    k !== B && a(k, c), r();
  };
  return o.jsx(It, { isOpen: e, onClose: r, onConfirm: Q, contentClassName: "max-w-3xl", children: o.jsx(Oo, { delayDuration: 250, skipDelayDuration: 0, children: o.jsxs("div", { className: "flex min-h-0 flex-1 flex-col p-6", children: [o.jsx("h2", { className: "text-lg font-bold text-gray-800 dark:text-odp-fgStrong", children: "\uCD5C\uB300 heading \uBCC0\uACBD" }), o.jsxs("p", { className: "mt-1 text-sm text-gray-500 dark:text-odp-muted", children: ["\uAC10\uC9C0\uB41C \uCD5C\uB300 heading\uC744 \uC120\uD0DD\uD55C \uB2E8\uACC4\uB85C \uBC14\uAFB8\uACE0, \uD558\uC704 heading\uB3C4 \uAC19\uC740 \uAC04\uACA9\uC73C\uB85C \uC774\uB3D9\uD569\uB2C8\uB2E4.", " ", "\uC22B\uC790 \uD0A4 1\u20139\uB85C \uCD5C\uB300 heading\uC744 \uBC14\uAFC0 \uC218 \uC788\uC2B5\uB2C8\uB2E4."] }), o.jsxs("div", { className: "mt-4", children: [o.jsx("div", { className: "mb-2 text-xs font-medium text-gray-500 dark:text-odp-muted", children: "\uC801\uC6A9 \uBC94\uC704" }), o.jsx(An, { className: "flex items-center gap-2", value: c, onValueChange: Z, "aria-label": "\uCD5C\uB300 heading \uC801\uC6A9 \uBC94\uC704", children: uc.map((k) => {
  ...
  }) })] }), o.jsxs("div", { className: "mt-4", children: [o.jsx("label", { htmlFor: "editor-heading-max", className: "mb-2 block text-xs font-medium text-gray-500 dark:text-odp-muted", children: "\uCD5C\uB300 heading" }), o.jsxs(Gi, { value: String(p), onValueChange: (k) => {
    const P = Number(k);
    mr(P) && m(P);
  }, children: [o.jsxs(Qi, { id: "editor-heading-max", "aria-label": "\uCD5C\uB300 heading", className: "inline-flex w-full items-center justify-between gap-2 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-800 outline-none focus-visible:ring-2 focus-visible:ring-blue-400 dark:border-odp-borderStrong dark:bg-odp-surface dark:text-odp-fgStrong", children: [o.jsx(Ji, {}), o.jsx(Zi, { className: "text-gray-500", children: o.jsx(_o, { size: 14 }) })] }), o.jsx(el, { children: o.jsx(tl, { className: "z-100010 max-h-60 min-w-(--radix-select-trigger-width) overflow-hidden rounded-md border border-gray-200 bg-white shadow-lg dark:border-odp-borderStrong dark:bg-odp-bgSoft", position: "popper", sideOffset: 4, children: o.jsx(nl, { className: "p-1", children: aa.map((k) => o.jsxs(rl, { value: String(k), className: "relative flex cursor-pointer select-none items-center rounded-sm py-1.5 pl-7 pr-3 text-sm text-gray-800 outline-none data-highlighted:bg-gray-100 dark:text-odp-fg dark:data-highlighted:bg-odp-focusBg", children: [o.jsx(ol, { className: "absolute left-1.5 inline-flex items-center", children: o.jsx(fn, { size: 12 }) }), o.jsx(sl, { children: `h${k}` })] }, k)) }) }) })] })] }), o.jsxs("div", { className: "mt-4 rounded-lg border border-gray-200 p-3 dark:border-odp-borderSoft", children: [o.jsxs("div", { className: "flex items-center justify-between gap-3", children: [o.jsxs("div", { className: "min-w-0", children: [o.jsx("div", { className: "text-sm font-medium text-gray-800 dark:text-odp-fgStrong", children: "outline \uBC88\uD638 \uB9DE\uCD94\uAE30" }), o.jsx("p", { className: "mt-0.5 text-[11px] leading-snug text-gray-500 dark:text-odp-muted", children: "\uC81C\uBAA9 \uC55E\uC758 1. / 2.1. \uAC19\uC740 \uBC88\uD638\uB97C \uD604\uC7AC heading \uC218\uC900\uC5D0 \uB9DE\uAC8C \uB2E4\uC2DC \uBD99\uC785\uB2C8\uB2E4." })] }), o.jsx(or, { className: mc(x), checked: x, onCheckedChange: T, "aria-label": "outline \uBC88\uD638 \uB9DE\uCD94\uAE30", children: o.jsx(sr, { className: pc }) })] }), x ? o.jsxs("div", { className: "mt-3 space-y-3 border-t border-gray-100 pt-3 dark:border-odp-borderSoft/60", children: [o.jsxs("div", { children: [o.jsx("div", { className: "mb-2 text-xs font-medium text-gray-500 dark:text-odp-muted", children: "\uCD5C\uB300 heading \uBC88\uD638 \uD615\uC2DD" }), o.jsx(An, { className: "flex items-center gap-2", value: j, onValueChange: (k) => {
    (k === "flat" || k === "nested") && R(k);
  }, "aria-label": "\uCD5C\uB300 heading \uBC88\uD638 \uD615\uC2DD", children: dc.map((k) => {
    const P = j === k.value;
...
function gc({ checked: e = false, onChange: t, theme: n = "light" }) {
  return o.jsx(pn, { checked: e, onChange: t, theme: n, icon: Ii, title: e ? "\uBAA9\uCC28 \uC81C\uBAA9 \uC904\uBC14\uAFC8 \uCF1C\uC9D0" : "\uBAA9\uCC28 \uC81C\uBAA9 \uB9D0\uC904\uC784(...)", ariaLabel: "\uBAA9\uCC28 \uC81C\uBAA9 \uC904\uBC14\uAFC8" });
}
function xc({ checked: e = false, onChange: t, theme: n = "light" }) {
  return o.jsx(pn, { checked: e, onChange: t, theme: n, icon: $i, title: e ? "base64 \uC774\uBBF8\uC9C0 \uC811\uD798" : "base64 \uC774\uBBF8\uC9C0 \uD3BC\uCE68", ariaLabel: "base64 \uC774\uBBF8\uC9C0 \uC811\uAE30" });
}
function bc({ checked: e = true, onChange: t, theme: n = "light" }) {
  return o.jsx(pn, { checked: e, onChange: t, theme: n, icon: Ho, title: e ? "\uC790\uB3D9\uC644\uC131 \uCD94\uCC9C \uCF1C\uC9D0" : "\uC790\uB3D9\uC644\uC131 \uCD94\uCC9C \uAEBC\uC9D0", ariaLabel: "\uC790\uB3D9\uC644\uC131 \uCD94\uCC9C" });
}
function wc({ checked: e = false, onChange: t, theme: n = "light" }) {
  return o.jsx(pn, { checked: e, onChange: t, theme: n, icon: Fi, title: e ? "Mirror Edit on \u2014 dual caret + instant preview sync" : "Mirror Edit off", ariaLabel: "Mirror Edit" });
}
function yc({ onRequestLink: e, onRequestUpload: t, onRequestClip: n, disabled: r = false }) {
  const [a, s] = l.useState(false), c = l.useRef(null), u = l.useRef(null), p = l.useCallback(() => s(false), []);
  return o.jsxs(o.Fragment, { children: [o.jsx(ks, { title: "\uC774\uBBF8\uC9C0", visible: a, onChange: s, disabled: r, overlay: o.jsxs("ul", { className: "md-editor-menu", role: "menu", onClick: p, children: [o.jsx("li", { className: "md-editor-menu-item md-editor-menu-item-image", role: "menuitem", tabIndex: 0, onClick: () => e(), onKeyDown: (m) => {
  ...
  }, children: "\uC798\uB77C\uC11C \uC5C5\uB85C\uB4DC" })] }), children: o.jsx(_i, { className: "md-editor-icon", size: 16, "aria-hidden": true }) }), o.jsx("input", { ref: c, type: "file", accept: "image/*", multiple: true, className: "hidden", tabIndex: -1, "aria-hidden": true, onChange: (m) => {
...
function vc({ isOpen: e, onClose: t, onConfirm: n }) {
  ...
  return o.jsx(It, { isOpen: e, onClose: t, onConfirm: m, ignoreEnterInFields: true, children: o.jsxs("div", { className: "flex flex-col gap-4 p-6", children: [o.jsx("h2", { className: "text-lg font-bold text-gray-800 dark:text-odp-fgStrong", children: "\uC774\uBBF8\uC9C0 \uB9C1\uD06C" }), o.jsxs("label", { className: "block", children: [o.jsx("span", { className: "mb-1 block text-sm font-medium text-gray-700 dark:text-odp-fgStrong", children: "\uC124\uBA85 (alt)" }), o.jsx("input", { type: "text", value: r, onChange: (x) => a(x.target.value), placeholder: "\uC120\uD0DD", className: "w-full rounded border border-gray-300 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-500/40 dark:border-odp-borderStrong dark:bg-odp-bgSoft" })] }), o.jsxs("label", { className: "block", children: [o.jsx("span", { className: "mb-1 block text-sm font-medium text-gray-700 dark:text-odp-fgStrong", children: "URL" }), o.jsx("input", { type: "text", value: s, onChange: (x) => c(x.target.value), placeholder: "https://\u2026", className: "w-full rounded border border-gray-300 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-500/40 dark:border-odp-borderStrong dark:bg-odp-bgSoft" })] }), u ? o.jsx("p", { className: "text-xs text-red-600 dark:text-red-300", children: u }) : null, o.jsxs("div", { className: "flex justify-end gap-2", children: [o.jsxs("button", { type: "button", onClick: t, className: "inline-flex items-center gap-1.5 rounded bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-200 dark:bg-odp-bgSoft dark:text-odp-fgStrong dark:hover:bg-odp-focusBg", children: [o.jsx(dn, { size: 16 }), "\uCDE8\uC18C"] }), o.jsxs("button", { type: "button", onClick: m, className: "inline-flex items-center gap-1.5 rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-700", children: [o.jsx(fn, { size: 16 }), "\uC0BD\uC785"] })] })] }) });
}
function kc({ isOpen: e, onClose: t, onConfirm: n }) {
  ...
  return o.jsx(It, { isOpen: e, onClose: t, ignoreEnterInFields: true, children: o.jsxs("div", { className: "flex flex-col gap-4 p-6", children: [o.jsx("h2", { className: "text-lg font-bold text-gray-800 dark:text-odp-fgStrong", children: "\uAC01\uC8FC \uC0BD\uC785" }), o.jsxs("p", { className: "text-xs leading-5 text-gray-500 dark:text-odp-muted", children: ["\uCCAB \uC904\uC740 \uC81C\uBAA9, \uB458\uC9F8 \uC904\uC740 URL\uC785\uB2C8\uB2E4. \uBCF8\uBB38 \uCEE4\uC11C\uC5D0", " ", o.jsx("code", { className: "rounded bg-gray-100 px-1 dark:bg-odp-bgSoft", children: "[^N]" }), "\uC774 \uB4E4\uC5B4\uAC00\uACE0, \uBB38\uC11C \uD558\uB2E8 Sources\uC5D0 \uB450 \uC904\uC774 \uCD94\uAC00\uB429\uB2C8\uB2E4. Ctrl+Enter \uB610\uB294 \u2318+Enter\uB85C \uC0BD\uC785\uD569\uB2C8\uB2E4."] }), o.jsxs("label", { className: "block", children: [o.jsx("span", { className: "mb-1 block text-sm font-medium text-gray-700 dark:text-odp-fgStrong", children: "\uC81C\uBAA9 (1\uC904)" }), o.jsx("input", { ref: m, type: "text", value: r, onChange: (j) => {
  ...
  }, onKeyDown: T, placeholder: "https://\u2026", className: "w-full rounded border border-gray-300 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-500/40 dark:border-odp-borderStrong dark:bg-odp-bgSoft" })] }), u ? o.jsx("p", { className: "text-xs text-red-600 dark:text-red-300", children: u }) : null, o.jsxs("div", { className: "flex justify-end gap-2", children: [o.jsxs("button", { type: "button", onClick: t, className: "inline-flex items-center gap-1.5 rounded bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-200 dark:bg-odp-bgSoft dark:text-odp-fgStrong dark:hover:bg-odp-focusBg", children: [o.jsx(dn, { size: 16 }), "\uCDE8\uC18C"] }), o.jsxs("button", { type: "button", onClick: x, className: "inline-flex items-center gap-1.5 rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-700", children: [o.jsx(fn, { size: 16 }), "\uC0BD\uC785"] })] })] }) });
}
function Cc({ isOpen: e, file: t, onClose: n, onConfirm: r }) {
  ...
  }, [e, t]), o.jsx(It, { isOpen: e && !!t, onClose: n, contentClassName: "max-w-2xl w-[min(96vw,42rem)] max-h-[90vh] h-[min(90vh,720px)]", resizeHeight: true, children: a ? o.jsx(yl, { imageSrc: a, ...(t == null ? void 0 : t.name) ? { fileName: t.name } : {}, onCancel: n, onConfirm: r }) : null });
}
const Vo = "s3haim_md_editor_base64_image_fold";
function Gn() {
  if (typeof window > "u") return true;
  try {
    const e = window.localStorage.getItem(Vo);
...
function Ec(e) {
  if (!(typeof window > "u")) try {
    window.localStorage.setItem(Vo, e ? "1" : "0");
  } catch {
  }
}
function Sc() {
...
const Mc = 48, Fr = /data:image\/([a-z0-9.+-]+);base64,([a-z0-9+/=]+)/gi, Wo = ko.define(), qo = ko.define(), Uo = new Zn();
function Rc(e) {
  const t = [];
  Fr.lastIndex = 0;
  let n;
...
class Lc extends Cs {
  ...
  toDOM(t) {
    ...
    return n.textContent = this.label, n.className = "cm-base64-image-fold", n.title = "Click to expand base64 image data", n.addEventListener("mousedown", (r) => {
      r.preventDefault(), r.stopPropagation(), t.dispatch({ selection: { anchor: this.from }, effects: Wo.of({ from: this.from, to: this.to }) }), t.focus();
...
function _r(e, t) {
  ...
  for (let a = 1; a <= e.doc.lines; a += 1) {
    ...
    for (const c of Rc(s.text)) {
      const u = s.from + c.from, p = s.from + c.to;
      if (Pc(t, u, p)) {
        r.push({ from: u, to: p });
        continue;
      }
      n.push(cr.replace({ widget: new Lc(Tc(c.mime, p - u), u, p) }).range(u, p));
    }
  }
  return { deco: cr.set(n, true), expanded: r };
}
const Xo = vo.define({ create(e) {
  return _r(e, []);
}, update(e, t) {
  let n = e.expanded;
  t.docChanged && n.length && (n = n.map(({ from: a, to: s }) => ({ from: t.changes.mapPos(a, 1), to: t.changes.mapPos(s, -1) })).filter(({ from: a, to: s }) => a < s));
  let r = n !== e.expanded;
  for (const a of t.effects) a.is(Wo) ? (n = [{ from: a.value.from, to: a.value.to }], r = true) : a.is(qo) && n.length > 0 && (n = [], r = true);
  return t.docChanged || r ? _r(t.state, n) : e;
}, provide: (e) => Tt.decorations.from(e, (t) => t.deco) }), Ac = Tt.domEventHandlers({ mousedown(e, t) {
  const n = t.state.field(Xo, false);
  if (!n || n.expanded.length === 0) return false;
  const r = e.target;
  if (!(r instanceof Node) || !t.dom.contains(r)) return false;
  const a = t.posAtDOM(r, 0);
  return a !== -1 && n.expanded.some(({ from: s, to: c }) => a >= s && a <= c) || t.dispatch({ effects: qo.of(null) }), false;
} });
function Yo() {
  return [Xo, Ac];
}
...
function Ic(e, t) {
  if (e) try {
    e.dispatch({ effects: Uo.reconfigure(t ? Yo() : []) });
  } catch {
  }
}
const Go = new Zn();
...
const Jo = vo.define({ create() {
  return [];
}, update(e, t) {
  let n = e;
  t.docChanged && n.length && (n = n.map(({ from: a, to: s }) => ({ from: t.changes.mapPos(a, 1), to: t.changes.mapPos(s, -1) })).filter(({ from: a, to: s }) => a < s));
  let r = n !== e;
  for (const a of t.effects) if (a.is(Dt)) Qo(n, a.value.from, a.value.to) || (n = [...n, a.value], r = true);
  else if (a.is(st)) {
...
function Hr(e) {
  const t = e.state.field(Jo), n = [];
  for (const r of Fc(e.state)) Qo(t, r.from, r.to) || $c(e.state, r.from, r.to) || n.push(st.of(r));
  n.length > 0 && e.dispatch({ effects: n });
}
const _c = So.fromClass(class {
  constructor(e) {
    Hr(e);
  }
  update(e) {
...
function Bc(e, t) {
  if (e) try {
    e.dispatch({ effects: Go.reconfigure(t ? Zo() : []) });
  } catch {
  }
}
const Kc = `<br/>
`;
function zc(e) {
  if (!ha() || !(e == null ? void 0 : e.state)) return false;
  const t = e.state.selection.main, n = Kc;
...
function Uc({ enabled: e, historyKey: t, meta: n, grid: r, applySnapshot: a }) {
  ...
  const [j, R] = l.useState(0), N = l.useCallback(() => R((K) => K + 1), []), L = l.useCallback(() => {
    ...
    if (K == null) return;
    x.current = null;
    const _ = qc(s.current, c.current, K);
...
const Xc = ["thead", "tbody", "tfoot"], Fn = 10, zr = 36, Vr = 44, xt = 4, Qt = 14, Yc = "h-3.5 w-3.5 shrink-0", ae = "h-3 w-3 shrink-0", _n = "__none__", Gc = (e) => ["relative inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border outline-none transition-all duration-200 focus-visible:ring-2 focus-visible:ring-blue-400", e ? "border-blue-500 bg-blue-500 shadow-sm dark:border-blue-500 dark:bg-blue-500" : "border-transparent bg-gray-300 dark:border-odp-borderStrong dark:bg-odp-borderStrong"].join(" "), Qc = "block h-4 w-4 translate-x-0.5 rounded-full bg-white shadow transition-transform will-change-transform data-[state=checked]:translate-x-[1.125rem]", Wr = 288, es = 200, Jc = 480, Zc = 380, eu = 560, qr = 16, jt = 6, tu = [{ value: "full", label: "\uD398\uC774\uC9C0 \uC804\uCCB4 (full)" }, { value: "fit", label: "\uB0B4\uC6A9\uB9CC\uD07C (fit)" }], nu = [{ value: "left", label: "\uC67C\uCABD" }, { value: "right", label: "\uC624\uB978\uCABD" }], ru = "pointer-events-none z-100050 max-w-[240px] rounded-md border border-gray-200 bg-white px-2 py-1 text-[11px] leading-snug text-gray-800 shadow-md dark:border-odp-borderStrong dark:bg-odp-surface dark:text-odp-fgStrong", ou = "z-100050 min-w-[168px] overflow-hidden rounded-lg border border-gray-200 bg-white p-1 shadow-lg dark:border-odp-borderStrong dark:bg-odp-bgSoft", Ur = "flex cursor-pointer select-none items-center gap-2 rounded-md px-3 py-2 text-sm text-red-600 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-40 data-[highlighted]:bg-red-50 dark:text-red-400 dark:data-[highlighted]:bg-red-950/40", ts = typeof navigator < "u" && (/Mac|iPhone|iPad|iPod/i.test(navigator.platform) || /Mac|iPhone|iPad|iPod/i.test(navigator.userAgent ?? "")), at = ts ? "\u2318" : "Ctrl", su = `${at}+E`, au = `${at}+Shift+E`, iu = `${at}+Shift+>`, lu = `${at}+Shift+<`, Hn = `${at}+Z`, On = ts ? `${at}+Shift+Z` : `${at}+Y`, cu = 14;
...
function mt(e) {
  return Math.min(Jc, Math.max(es, Math.round(e)));
}
...
function Gr(e, t, n, r, a, s) {
  ...
  return { kind: "row", index: e, x: m, y: u, edge: { left: c, top: u - xt / 2, width: p, height: xt }, ghost: { left: c, top: u - zr / 2, width: p, height: zr }, label: du(e, s) };
}
function Qr(e, t, n, r, a, s) {
  const c = r.top - a.top, u = t - a.left, p = r.height, m = Math.min(Math.max(n - a.top, c), c + p);
  return { kind: "col", index: e, x: u, y: m, edge: { left: u - xt / 2, top: c, width: xt, height: p }, ghost: { left: u - Vr / 2, top: c, width: Vr, height: p }, label: fu(e, s) };
}
function mu({ tip: e, onDoubleClick: t, style: n }) {
  return o.jsxs(Wn, { open: true, children: [o.jsx(qn, { asChild: true, children: o.jsx("button", { type: "button", "aria-label": e, style: n, onClick: (r) => {
    ...
    r.preventDefault(), r.stopPropagation();
  }, "data-haim-edge-add": "", className: "haim-table-insert-btn pointer-events-auto absolute z-30 flex h-5 w-5 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-blue-400/80 bg-white text-blue-600 shadow-sm hover:bg-blue-50 dark:border-blue-400/70 dark:bg-odp-surface dark:text-blue-300 dark:hover:bg-blue-950/60", children: o.jsx(Xi, { className: "h-3 w-3", "aria-hidden": true }) }) }), o.jsx(Un, { children: o.jsxs(Xn, { className: ru, side: "top", sideOffset: 8, children: [e, o.jsx(Yn, { className: "fill-white dark:fill-odp-surface" })] }) })] });
}
function pu({ insert: e, tip: t, allowResize: n, onDoubleClickInsert: r, onResizePointerDown: a }) {
  const s = e.kind === "row", c = s ? { left: e.edge.left, top: e.edge.top + xt / 2 - Qt / 2, width: e.edge.width, height: Qt } : { left: e.edge.left + xt / 2 - Qt / 2, top: e.edge.top, width: Qt, height: e.edge.height };
...
function gu({ kind: e, indices: t, table: n, wrap: r, colCount: a }) {
...
function bu(e, t, n) {
  ...
  return !Number.isInteger(s) || !Number.isInteger(c) ? null : Ma(n, s, c);
}
function Jr(e, t, n) {
  return e === "col" ? n.colspan > 1 && n.c < t && t < n.c + n.colspan : n.rowspan > 1 && n.r < t && t < n.r + n.rowspan;
}
function Mt(e, t, n, r, a, s, c) {
  ...
  const x = xu(e), T = ns(e, s), j = bu(n, r, c);
  let R = null;
...
function wu({ isOpen: e, initialMeta: t, initialGrid: n, onClose: r, onSave: a }) {
  var _a2, _b, _c2, _d2, _e2, _f;
  const [s, c] = l.useState(on()), [u, p] = l.useState(n), [m, x] = l.useState(null), [T, j] = l.useState(false), [R, N] = l.useState("thead"), [L, B] = l.useState([]), [I, Z] = l.useState(false), [Q, k] = l.useState(null), [P, J] = l.useState(null), [K, _] = l.useState(false), [C, z] = l.useState(0), [Y, ne] = l.useState(null), [se, ee] = l.useState(null), we = l.useRef(null), [G, re] = l.useState(null), oe = G !== null, q = Do(), [ie, Xe] = l.useState(Wr), [Te, Ye] = l.useState(Wr), [je, ye] = l.useState(false), [Ee, Oe] = l.useState(false), [H, $] = l.useState(() => typeof window < "u" ? window.innerWidth : 1280), [X, W] = l.useState(() => typeof window < "u" ? window.matchMedia("(orientation: landscape)").matches : true), pe = l.useRef(null), he = l.useRef(null), ge = l.useRef(null), Be = l.useRef(null), $e = l.useRef(false), Me = l.useRef(null), me = l.useRef(null), Ke = l.useRef(false), Le = l.useRef(false), Ge = l.useRef({ x: 0, y: 0 });
  ...
  Qe.current = t, xe.current = n, l.useEffect(() => {
    ...
    c(i ? { ...i } : on()), p({ rows: d.rows.map((b) => [...b]), aligns: [...d.aligns] }), x(null), j(false), Me.current = null, J(null), ye(false), Oe(false), re(null), ee(null), z((b) => b + 1), ga().then((b) => B(b.templates)), xa().then((b) => ba(b));
  }, [e]);
  const Je = l.useCallback((i) => {
    c(i.meta), p({ rows: i.grid.rows.map((d) => [...d]), aligns: [...i.grid.aligns ?? []] }), x(null), j(false), Me.current = null, J(null);
  }, []), { undo: yt, redo: Pe, canUndo: Ze, canRedo: vt, recordNow: Ft } = Uc({ enabled: e, historyKey: C, meta: s, grid: u, applySnapshot: Je }), lt = l.useRef(false);
  l.useEffect(() => {
    lt.current && !K && Ft(), lt.current = K;
  }, [K, Ft]), l.useEffect(() => {
    if (!e) return;
    const i = (d) => {
      if (!(d.metaKey || d.ctrlKey) || d.altKey) return;
      const E = d.key.toLowerCase(), v = E === "z" && !d.shiftKey, A = E === "y" || E === "z" && d.shiftKey;
      !v && !A || (d.preventDefault(), d.stopPropagation(), d.stopImmediatePropagation(), A ? Pe() : yt());
    };
  ...
  const ve = l.useMemo(() => wa(s.merges), [s.merges]), be = u.rows.length, fe = Math.max(1, ...u.rows.map((i) => i.length), u.aligns.length), ke = l.useMemo(() => {
    if (!m) return [];
    ...
    return i;
  }, [m, ve]), le = ke[0] ?? null, ct = !!le, kt = l.useRef(ie), Ve = l.useRef(Te);
  kt.current = ie, Ve.current = Te;
  const ut = l.useMemo(() => {
    const i = H * 0.95;
    return Math.max(es, i - qr - jt - Zc);
  }, [H]), _t = l.useCallback((i) => {
    const d = kt.current, b = Ve.current, E = d + b;
    let v = mt(d + i), A = mt(E - v);
    v = mt(E - A), A = mt(E - v), Xe(v), Ye(A);
  }, []), Ht = l.useCallback((i) => {
    Ye((d) => {
      const b = mt(d + i);
      if (ie + jt + b <= ut) return b;
      const v = ut - ie - jt;
      return mt(v);
    });
  }, [ut, ie]), gn = l.useMemo(() => {
    ...
    const d = ie + jt + Te;
    return { width: Math.min(i, qr + d + jt + eu), maxWidth: "95dvw", height: "95dvh", maxHeight: "95dvh" };
  ...
  const Ot = l.useCallback((i) => {
    ue($l(Ce.current, Fe.current, i));
  }, [ue]), Bt = l.useCallback((i) => {
    ue(Fl(Ce.current, Fe.current, i));
    ...
    Y && (Y.kind === "row" ? ue(Ol(Ce.current, Fe.current, Y.indices)) : ue(Bl(Ce.current, Fe.current, Y.indices)), ne(null), ee(null));
  }, [ue, Y]), _e = !!(m && !(m.r0 === m.r1 && m.c0 === m.c1)), ft = l.useCallback(() => {
    !m || m.r0 === m.r1 && m.c0 === m.c1 || c((i) => ({ ...i, merges: ya(i.merges, m.r0, m.c0, m.r1, m.c1) }));
  }, [m]), Ct = l.useCallback(() => {
    m && c((i) => ({ ...i, merges: va(i.merges, m.r0, m.c0, m.r1, m.c1) }));
  }, [m]), Wt = l.useCallback((i) => {
    ke.length && c((d) => {
      var _a3;
      const b = { ...d.cells }, E = (_a3 = d.style) == null ? void 0 : _a3.fontSize;
      for (const { r: v, c: A } of ke) {
        const V = Ie(v, A), ce = b[V] ?? {};
        b[V] = { ...ce, fontSize: uu(ce.fontSize ?? E, i) };
      }
      return { ...d, cells: b };
    });
  }, [ke]);
    ...
    const i = (d) => {
      if (!(!(d.metaKey || d.ctrlKey) || d.altKey)) {
        if (d.shiftKey) {
          ...
          if (b || E) {
            if (!ke.length) return;
            d.preventDefault(), d.stopPropagation(), Wt(b ? 1 : -1);
            return;
          }
        }
        d.code !== "KeyE" && d.key.toLowerCase() !== "e" || (d.preventDefault(), d.stopPropagation(), d.shiftKey ? Ct() : ft());
      }
    };
    return window.addEventListener("keydown", i, true), () => window.removeEventListener("keydown", i, true);
  }, [e, ft, Wt, ke.length, Ct]);
  const bn = l.useCallback((i) => {
    ...
    if (!d || !b) return;
    const E = Mt(d, b, i.clientX, i.clientY, be, fe, s.merges);
  ...
  const h = l.useCallback(() => {
    ...
    const d = i.target;
    d && (d.closest("[data-haim-table-sidebars]") || d.closest("[data-haim-table-canvas] table, [data-haim-edge-hit], [data-haim-edge-add], [data-haim-insert-preview]") || me.current && Ut());
  }, [Ut, Ee, je]), S = l.useCallback((i, d, b, E) => {
    let v = i + b, A = d + E;
  ...
  }, [fe, ve, qt, be]), D = l.useCallback((i, d, b) => {
    ...
    const b = ka({ row: i, col: d, rowCount: be, colCount: fe, meta: s, template: U }), E = {};
  ...
  return o.jsxs(o.Fragment, { children: [o.jsxs(It, { isOpen: e, onClose: () => {
    if (Y !== null) {
      ne(null);
      return;
    }
    r();
  }, overlayClassName: "p-[2.5dvh]", contentClassName: "h-[95dvh] max-h-[95dvh] max-w-[95dvw]", contentStyle: gn, resizeHeight: true, children: [o.jsxs(al, { className: "flex h-full min-h-0 flex-col", onSubmit: (i) => i.preventDefault(), onPointerDownCapture: M, children: [o.jsxs("header", { className: "flex shrink-0 flex-wrap items-center justify-between gap-2 border-b border-gray-100 px-3 py-2 dark:border-odp-border", children: [o.jsxs("h2", { className: "inline-flex items-center gap-1.5 text-sm font-bold text-gray-800 dark:text-odp-fgStrong", children: [o.jsx(an, { className: Yc, "aria-hidden": true }), "\uD45C \uD3B8\uC9D1"] }), o.jsxs("div", { className: "flex items-center gap-2", children: [o.jsxs("button", { type: "button", disabled: !Ze, title: `\uC2E4\uD589 \uCDE8\uC18C (${Hn})`, "aria-label": `\uC2E4\uD589 \uCDE8\uC18C (${Hn})`, onClick: () => yt(), className: "inline-flex items-center gap-1 rounded px-2 py-1.5 text-xs text-gray-600 hover:bg-gray-100 disabled:opacity-40 dark:text-odp-muted dark:hover:bg-odp-bgSoft", children: [o.jsx(Hi, { className: ae, "aria-hidden": true }), "\uC2E4\uD589 \uCDE8\uC18C"] }), o.jsxs("button", { type: "button", disabled: !vt, title: `\uB2E4\uC2DC \uC2E4\uD589 (${On})`, "aria-label": `\uB2E4\uC2DC \uC2E4\uD589 (${On})`, onClick: () => Pe(), className: "inline-flex items-center gap-1 rounded px-2 py-1.5 text-xs text-gray-600 hover:bg-gray-100 disabled:opacity-40 dark:text-odp-muted dark:hover:bg-odp-bgSoft", children: [o.jsx(Oi, { className: ae, "aria-hidden": true }), "\uB2E4\uC2DC \uC2E4\uD589"] }), o.jsxs("button", { type: "button", onClick: r, className: "inline-flex items-center gap-1 rounded px-3 py-1.5 text-xs text-gray-600 hover:bg-gray-100 dark:text-odp-muted dark:hover:bg-odp-bgSoft", children: [o.jsx(dn, { className: ae, "aria-hidden": true }), "\uCDE8\uC18C"] }), o.jsxs("button", { type: "button", onClick: () => a(s, u), className: "inline-flex items-center gap-1 rounded bg-blue-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-blue-700", children: [o.jsx(fn, { className: ae, "aria-hidden": true }), "\uC801\uC6A9"] })] })] }), o.jsxs("div", { className: "flex min-h-0 flex-1 flex-col landscape:flex-row", children: [o.jsxs("div", { "data-haim-table-sidebars": "", className: "order-2 flex max-h-[42%] min-h-0 w-full shrink-0 flex-col gap-2 overflow-hidden border-t border-gray-100 bg-gray-50/80 p-2 dark:border-odp-border dark:bg-odp-bgSoft/40 portrait:max-h-[42%] landscape:order-1 landscape:max-h-none landscape:w-auto landscape:flex-row landscape:gap-0 landscape:border-t-0 landscape:border-r-0", children: [o.jsxs("aside", { className: "flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto rounded-lg border border-gray-200 bg-white dark:border-odp-borderStrong dark:bg-odp-surface landscape:flex-none landscape:shrink-0", style: X ? { width: ie } : void 0, children: [o.jsx("div", { className: "sticky top-0 z-[1] border-b border-gray-100 bg-white px-2.5 py-1.5 dark:border-odp-border dark:bg-odp-surface", children: o.jsxs("h3", { className: "inline-flex items-center gap-1 text-[11px] font-semibold text-gray-700 dark:text-odp-fgStrong", children: [o.jsx(an, { className: ae, "aria-hidden": true }), "\uD45C \xB7 \uADF8\uB8F9"] }) }), o.jsxs("div", { className: "space-y-2 p-2.5", children: [o.jsxs("div", { className: "flex flex-wrap gap-2", children: [o.jsxs(Ue, { name: "template", className: "flex min-w-0 flex-1 flex-col gap-0.5 text-[10px] text-gray-500 dark:text-odp-muted", children: [o.jsx(rt, { asChild: true, children: o.jsx("span", { children: o.jsx(ot, { icon: o.jsx(Mr, { className: ae }), children: "\uD15C\uD50C\uB9BF" }) }) }), o.jsx(yn, { "aria-label": "\uD45C \uD15C\uD50C\uB9BF", value: s.templateId ?? _n, onValueChange: (i) => {
    if (i === _n) {
      c((b) => {
        const E = { ...b };
  ...
  }, children: [o.jsx(Mr, { className: ae, "aria-hidden": true }), "\uAD00\uB9AC"] })] }), o.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [o.jsxs(Ue, { name: "noHeader", className: "col-span-2 flex flex-col gap-0.5 text-[10px] text-gray-500 dark:text-odp-muted", children: [o.jsx(rt, { asChild: true, children: o.jsx("span", { children: o.jsx(ot, { icon: o.jsx(Pn, { className: ae }), children: "noHeader" }) }) }), o.jsxs("label", { className: "flex cursor-pointer items-center justify-between gap-2 rounded-md border border-gray-200 bg-white px-2 py-1.5 dark:border-odp-borderSoft dark:bg-odp-surface", children: [o.jsx("span", { className: "min-w-0 text-[11px] leading-snug text-gray-600 dark:text-odp-muted", children: "thead/th \uC5C6\uC774 \uBAA8\uB450 tbody/td" }), o.jsx(or, { className: Gc(!!s.noHeader), checked: !!s.noHeader, onCheckedChange: (i) => c((d) => {
    if (i) return { ...d, noHeader: true };
    const { noHeader: b, ...E } = d;
    return E;
  }), "aria-label": "noHeader", children: o.jsx(sr, { className: Qc }) })] })] }), o.jsxs(Ue, { name: "headerRows", className: `flex flex-col gap-0.5 text-[10px] text-gray-500 dark:text-odp-muted ${s.noHeader ? "opacity-40" : ""}`, children: [o.jsx(rt, { asChild: true, children: o.jsx("span", { children: o.jsx(ot, { icon: o.jsx(Pn, { className: ae }), children: "headerRows" }) }) }), o.jsx(Gt, { asChild: true, children: o.jsx("input", { type: "number", min: 0, max: be, value: s.headerRows, disabled: !!s.noHeader, onChange: (i) => c((d) => ({ ...d, headerRows: Math.max(0, Number(i.target.value) || 0) })), className: vn }) })] }), o.jsxs(Ue, { name: "footerRows", className: "flex flex-col gap-0.5 text-[10px] text-gray-500 dark:text-odp-muted", children: [o.jsx(rt, { asChild: true, children: o.jsx("span", { children: o.jsx(ot, { icon: o.jsx(Rr, { className: ae }), children: "footerRows" }) }) }), o.jsx(Gt, { asChild: true, children: o.jsx("input", { type: "number", min: 0, max: be, value: s.footerRows, onChange: (i) => c((d) => ({ ...d, footerRows: Math.max(0, Number(i.target.value) || 0) })), className: vn }) })] }), o.jsxs(Ue, { name: "width", className: "flex flex-col gap-0.5 text-[10px] text-gray-500 dark:text-odp-muted", children: [o.jsx(rt, { asChild: true, children: o.jsx("span", { children: o.jsx(ot, { icon: o.jsx(Bi, { className: ae }), children: "\uB108\uBE44" }) }) }), o.jsx(yn, { "aria-label": "\uD45C \uB108\uBE44", value: s.width, onValueChange: (i) => c((d) => ({ ...d, width: i === "fit" ? "fit" : "full" })), options: [...tu], className: "w-full" })] }), o.jsxs(Ue, { name: "align", className: `flex flex-col gap-0.5 text-[10px] text-gray-500 dark:text-odp-muted ${s.width !== "fit" ? "opacity-40" : ""}`, children: [o.jsx(rt, { asChild: true, children: o.jsx("span", { children: o.jsx(ot, { icon: s.align === "right" ? o.jsx(Ki, { className: ae }) : o.jsx(zi, { className: ae }), children: "\uC815\uB82C" }) }) }), o.jsx(yn, { "aria-label": "\uD45C \uC815\uB82C", value: s.align, disabled: s.width !== "fit", onValueChange: (i) => c((d) => ({ ...d, align: i === "right" ? "right" : "left" })), options: [...nu], className: "w-full" })] })] }), o.jsxs("div", { className: "space-y-1 border-t border-gray-100 pt-2 dark:border-odp-border", children: [o.jsx("p", { className: "text-[10px] font-medium text-gray-600 dark:text-odp-muted", children: "\uD45C \uAE30\uBCF8 \uD3F0\uD2B8\xB7\uC2A4\uD0C0\uC77C" }), o.jsx("p", { className: "text-[10px] text-gray-400 dark:text-odp-muted", children: "\uC140\xB7\uADF8\uB8F9 \uAC12\uC774 \uC788\uC73C\uBA74 \uADF8\uCABD\uC774 \uC6B0\uC120\uD569\uB2C8\uB2E4." }), o.jsx(In, { compact: true, idPrefix: "table-edit-table", value: s.style ?? {}, onChange: (i) => c((d) => ({ ...d, style: gr(i) ? {} : i })) })] }), o.jsxs("div", { className: "space-y-1 border-t border-gray-100 pt-2 dark:border-odp-border", children: [o.jsxs("p", { className: "inline-flex items-center gap-1 text-[10px] font-medium text-gray-600 dark:text-odp-muted", children: [o.jsx(Tr, { className: ae, "aria-hidden": true }), "\uADF8\uB8F9 \uC2A4\uD0C0\uC77C"] }), o.jsx("p", { className: "text-[10px] text-gray-400 dark:text-odp-muted", children: "thead / tbody / tfoot \uAD6C\uC5ED" }), o.jsx("div", { className: "mb-1 flex flex-wrap gap-1", children: Xc.map((i) => o.jsxs("button", { type: "button", onClick: () => N(i), className: `inline-flex items-center gap-1 rounded px-2 py-0.5 text-[11px] ${R === i ? "bg-blue-600 text-white" : "bg-gray-100 dark:bg-odp-bgSoft"}`, children: [Se(i), i] }, i)) }), o.jsx(In, { compact: true, idPrefix: `table-edit-${R}`, value: s.sections[R] ?? {}, onChange: (i) => c((d) => ({ ...d, sections: { ...d.sections, [R]: i } })) })] })] })] }), o.jsx(Xr, { ariaLabel: "\uD45C \uC0AC\uC774\uB4DC\uBC14\uC640 \uC140 \uC0AC\uC774\uB4DC\uBC14 \uC0AC\uC774 \uB108\uBE44 \uC870\uC808", onDelta: _t }), o.jsx("aside", { "aria-hidden": !ct, className: `flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto rounded-lg border border-blue-200 bg-white dark:border-blue-900/50 dark:bg-odp-surface landscape:flex-none landscape:shrink-0 ${ct ? "" : "pointer-events-none portrait:hidden landscape:invisible"}`, style: X ? { width: Te } : void 0, children: le ? o.jsxs(o.Fragment, { children: [o.jsx("div", { className: "sticky top-0 z-[1] border-b border-blue-100 bg-white px-2.5 py-1.5 dark:border-blue-900/40 dark:bg-odp-surface", children: o.jsxs("h3", { className: "inline-flex items-center gap-1 text-[11px] font-semibold text-gray-700 dark:text-odp-fgStrong", children: [o.jsx(Vi, { className: ae, "aria-hidden": true }), "\uC140", o.jsxs("span", { className: "font-normal text-gray-400 dark:text-odp-muted", children: ["(", le.r + 1, "\uD589 ", le.c + 1, "\uC5F4", ke.length > 1 ? ` \xB7 ${ke.length}\uCE78` : "", ")"] })] }) }), o.jsxs("div", { className: "space-y-2 p-2.5", children: [o.jsxs("div", { className: "flex flex-wrap gap-1.5", children: [o.jsxs("button", { type: "button", disabled: !_e, title: `\uBCD1\uD569 (${su})`, className: "inline-flex flex-1 items-center justify-center gap-1 rounded-md bg-gray-100 px-2 py-1.5 text-[11px] disabled:opacity-40 dark:bg-odp-bgSoft", onClick: ft, children: [o.jsx(Wi, { className: ae, "aria-hidden": true }), "\uBCD1\uD569"] }), o.jsxs("button", { type: "button", disabled: !m, title: `\uBCD1\uD569 \uD574\uC81C (${au})`, className: "inline-flex flex-1 items-center justify-center gap-1 rounded-md bg-gray-100 px-2 py-1.5 text-[11px] disabled:opacity-40 dark:bg-odp-bgSoft", onClick: Ct, children: [o.jsx(qi, { className: ae, "aria-hidden": true }), "\uBCD1\uD569 \uD574\uC81C"] })] }), o.jsxs("p", { className: "text-[10px] text-gray-400 dark:text-odp-muted", children: ["\uAE00\uC790 \uD06C\uAE30: ", iu, " / ", lu] }), o.jsxs(Ue, { name: "cell-text", className: "flex flex-col gap-0.5 text-[10px] text-gray-500 dark:text-odp-muted", children: [o.jsx(rt, { asChild: true, children: o.jsx("span", { children: o.jsx(ot, { icon: o.jsx(Ho, { className: ae }), children: "\uC140 \uD14D\uC2A4\uD2B8" }) }) }), o.jsx(Gt, { asChild: true, children: o.jsx("input", { type: "text", value: O, onChange: (i) => nt(le.r, le.c, i.target.value), placeholder: "\uC140 \uB0B4\uC6A9 \uC785\uB825", className: Ea }) })] }), o.jsx(In, { compact: true, idPrefix: "table-edit-cell", value: dt, onChange: Re })] })] }) : null }), o.jsx(Xr, { ariaLabel: "\uC0AC\uC774\uB4DC\uBC14\uC640 \uD45C \uC0AC\uC774 \uB108\uBE44 \uC870\uC808", onDelta: Ht })] }), o.jsxs("div", { ref: pe, "data-haim-table-canvas": "", className: `order-1 flex min-h-0 min-w-0 flex-1 flex-col overflow-auto border-t border-gray-100 p-3 landscape:order-2 landscape:border-t-0 landscape:border-l dark:border-odp-border ${Ee ? "cursor-grabbing select-none" : je && !m ? "cursor-grab select-none" : ""}`, onMouseLeave: () => {
    K || J(null);
  }, onPointerDown: g, onPointerMove: w, onPointerUp: y, onPointerCancel: y, onAuxClick: (i) => {
    i.button === 1 && i.preventDefault();
  }, children: [o.jsxs("p", { className: "mb-2 inline-flex shrink-0 items-center gap-1 text-[10px] text-gray-400", children: [o.jsx(Ui, { className: ae, "aria-hidden": true }), "\uB354\uBE14\uD074\uB9AD \uB4DC\uB798\uADF8\xB7Shift+\uD074\uB9AD: \uBC94\uC704 \uC120\uD0DD \xB7 \uC6B0\uD074\uB9AD: \uD589/\uC5F4 \uC0AD\uC81C \xB7 \uD720\uD074\uB9AD/\uC2A4\uD398\uC774\uC2A4+\uB4DC\uB798\uADF8: \uD328\uB2DD \xB7 ", Hn, "/", On, ": \uC2E4\uD589 \uCDE8\uC18C/\uB2E4\uC2DC \uC2E4\uD589 \xB7 \uD14C\uB450\uB9AC \uB354\uBE14\uD074\uB9AD: \uD589\xB7\uC5F4 \uCD94\uAC00"] }), o.jsx("div", { ref: he, className: "relative inline-block min-w-full p-5", "data-haim-inserting": (P == null ? void 0 : P.kind) ?? void 0, onMouseMove: bn, onMouseLeave: () => {
    K || J(null);
  }, children: o.jsxs(Oo, { delayDuration: 0, skipDelayDuration: 0, children: [o.jsxs("table", { ref: ge, className: `border-collapse text-sm ${((_a2 = s.colWidths) == null ? void 0 : _a2.some((i) => i && i.trim())) ? "w-max max-w-full" : "w-full"}`, style: { tableLayout: ((_b = s.colWidths) == null ? void 0 : _b.some((i) => i && i.trim())) || ((_c2 = s.rowHeights) == null ? void 0 : _c2.some((i) => i && i.trim())) ? "fixed" : void 0, ...((_d2 = s.style) == null ? void 0 : _d2.fontFamily) ? { fontFamily: s.style.fontFamily } : {}, ...((_e2 = s.style) == null ? void 0 : _e2.fontSize) ? { fontSize: s.style.fontSize } : {}, ...((_f = s.style) == null ? void 0 : _f.fontWeight) ? { fontWeight: s.style.fontWeight } : {} }, children: [o.jsx("colgroup", { children: Array.from({ length: fe }, (i, d) => {
    ...
    return o.jsx("tr", { style: b ? { height: b } : void 0, children: Array.from({ length: fe }, (E, v) => {
      ...
      const A = Sa(s.merges, d, v), V = te(d, v), ce = kn(s.colWidths, v), ze = o.jsx("td", { "data-edit-r": d, "data-edit-c": v, colSpan: A == null ? void 0 : A.colspan, rowSpan: A == null ? void 0 : A.rowspan, className: `min-h-11 cursor-pointer border-2 border-gray-300 p-0 transition-[box-shadow,outline-color] dark:border-odp-borderStrong ${ce ? "" : "min-w-28"} ${V ? "relative z-[1] outline outline-2 outline-offset-[-2px] outline-blue-500 ring-0" : "hover:relative hover:z-[1] hover:outline hover:outline-2 hover:outline-offset-[-2px] hover:outline-blue-400/70"}`, onContextMenu: () => {
        ...
        {
          const Ae = ge.current, St = he.current;
          if (Ae && St && Mt(Ae, St, F.clientX, F.clientY, be, fe, s.merges)) {
            F.preventDefault();
            return;
          }
        }
        if (F.shiftKey) {
          F.preventDefault(), Xt(d, v);
          return;
        }
        if (F.detail >= 2) {
          F.preventDefault(), Et(d, v);
          return;
        }
        He(d, v);
      }, onDoubleClick: (F) => {
        const Ne = ge.current, Ae = he.current;
        if (Ne && Ae && Mt(Ne, Ae, F.clientX, F.clientY, be, fe, s.merges)) {
        ...
        f(d, v);
      }, children: o.jsx(Ue, { name: `cell-${d}-${v}`, className: "contents", children: o.jsx(Gt, { asChild: true, children: o.jsx("input", { type: "text", value: i[v] ?? "", onChange: (F) => nt(d, v, F.target.value), onKeyDown: (F) => D(F, d, v), onMouseDown: (F) => {
        var _a3, _b2;
        if (F.button !== 1 && F.button === 0 && !Le.current && !(Ke.current && !me.current)) {
          ...
          if (F.shiftKey) {
            F.preventDefault(), F.stopPropagation(), Xt(d, v);
            return;
          }
          if (F.detail >= 2) {
            F.preventDefault();
        ...
        F.preventDefault(), F.stopPropagation(), Et(d, v);
      }, onFocus: () => {
      ...
      return q ? ze : o.jsxs(il, { onOpenChange: (F) => {
        re(F ? { r: d, c: v } : null), F ? J(null) : We();
      }, children: [o.jsx(ll, { asChild: true, children: ze }), o.jsx(cl, { children: o.jsxs(ul, { className: ou, onCloseAutoFocus: (F) => F.preventDefault(), children: [o.jsxs(Lr, { className: Ur, disabled: be <= 1, onPointerEnter: () => zt(d), onPointerLeave: We, onFocus: () => zt(d), onBlur: We, onSelect: () => {
        et(d);
      }, children: [o.jsx(ht, { className: ae, "aria-hidden": true }), "\uD589 \uC0AD\uC81C"] }), o.jsxs(Lr, { className: Ur, disabled: fe <= 1, onPointerEnter: () => Vt(v), onPointerLeave: We, onFocus: () => Vt(v), onBlur: We, onSelect: () => {
        Kt(v);
      }, children: [o.jsx(ht, { className: ae, "aria-hidden": true }), "\uC5F4 \uC0AD\uC81C"] })] }) })] }, v);
    }) }, d);
  }) })] }), se ? o.jsx(gu, { kind: se.kind, indices: se.indices, table: ge.current, wrap: he.current, colCount: fe }) : null, q && G ? o.jsxs(Io, { open: oe, onOpenChange: (i) => {
    i || (re(null), We());
    ...
    Kt(G.c), re(null);
  }, children: [o.jsx(ht, { className: ae, "aria-hidden": true }), "\uC5F4 \uC0AD\uC81C"] })] }) : null, P && !oe ? o.jsxs(o.Fragment, { children: [o.jsx(hu, { insert: P }, `preview-${P.kind}-${P.index}`), o.jsx(pu, { insert: P, allowResize: P.index !== 0, tip: P.index === 0 ? P.label : `${P.label} \xB7 ${Yr(P.kind)}`, onDoubleClickInsert: () => {
    const { kind: i, index: d } = P;
    i === "row" ? Ot(d) : Bt(d);
  }, onResizePointerDown: (i) => tt(i, P) }, `hit-${P.kind}-${P.index}`), o.jsx(mu, { tip: P.index === 0 ? P.label : `${P.label} \xB7 ${Yr(P.kind)}`, onDoubleClick: () => {
    const { kind: i, index: d } = P;
    i === "row" ? Ot(d) : Bt(d);
  }, style: { left: P.x, top: P.y } }, `btn-${P.kind}-${P.index}`)] }) : null] }) })] })] })] }), o.jsx(Cl, { isOpen: I, template: Q, onClose: () => {
    Z(false), k(null);
  }, onSave: (i) => {
    const b = [...ja().templates.filter((E) => E.id !== (Q == null ? void 0 : Q.id) && E.id !== i.id), i];
    Na({ templates: b }).then((E) => {
      B(E.templates), Z(false), k(null);
    });
  } })] }), typeof document < "u" ? yo.createPortal(o.jsx("div", { className: "relative z-[100060]", children: o.jsx(sn, { isOpen: Y !== null, variant: "danger", title: (Y == null ? void 0 : Y.kind) === "col" ? "\uC5F4 \uC0AD\uC81C" : "\uD589 \uC0AD\uC81C", message: (Y == null ? void 0 : Y.kind) === "col" ? Y.indices.length > 1 ? `\uC120\uD0DD\uD55C ${Y.indices.length}\uAC1C \uC5F4\uC744 \uC0AD\uC81C\uD560\uAE4C\uC694?` : `${(Y.indices[0] ?? 0) + 1}\uC5F4\uC744 \uC0AD\uC81C\uD560\uAE4C\uC694?` : Y ? Y.indices.length > 1 ? `\uC120\uD0DD\uD55C ${Y.indices.length}\uAC1C \uD589\uC744 \uC0AD\uC81C\uD560\uAE4C\uC694?` : `${(Y.indices[0] ?? 0) + 1}\uD589\uC744 \uC0AD\uC81C\uD560\uAE4C\uC694?` : "", confirmLabel: "\uC0AD\uC81C", cancelLabel: "\uCDE8\uC18C", onConfirm: xn, onCancel: () => ne(null) }) }), document.body) : null] });
}
const yu = "z-100050 min-w-[168px] overflow-hidden rounded-lg border border-gray-200 bg-white p-1 shadow-lg dark:border-odp-borderStrong dark:bg-odp-bgSoft", Zr = "flex cursor-pointer select-none items-center gap-2 rounded-md px-3 py-2 text-sm text-gray-800 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-40 data-[highlighted]:bg-gray-100 dark:text-odp-fg dark:data-[highlighted]:bg-odp-surface", eo = "flex cursor-pointer select-none items-center gap-2 rounded-md px-3 py-2 text-sm text-red-600 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-40 data-[highlighted]:bg-red-50 dark:text-red-400 dark:data-[highlighted]:bg-red-950/40", Jt = "h-3.5 w-3.5 shrink-0";
function vu({ containerRef: e, getMarkdown: t, setMarkdown: n, onEditTable: r, onEditFailed: a }) {
  const s = Do(), [c, u] = l.useState(false), [p, m] = l.useState(null), [x, T] = l.useState(null), j = l.useRef(null);
  j.current = p;
  ...
  const N = () => {
    ...
    const k = j.current;
    if (!k) return;
    const P = Bo(t(), k.table, k.previewRoot);
    if (!P) {
      a == null ? void 0 : a();
      return;
    }
    ...
    u(false), m(null);
  }, Q = o.jsxs(o.Fragment, { children: [o.jsxs("button", { type: "button", className: s ? La : Zr, onClick: () => {
    N(), Z();
  }, children: [o.jsx(an, { className: Jt, "aria-hidden": true }), "\uD45C \uD3B8\uC9D1\uAE30"] }), o.jsxs("button", { type: "button", className: s ? zn : eo, onClick: () => {
    L(), Z();
  }, children: [o.jsx(ht, { className: Jt, "aria-hidden": true }), "\uD45C \uC0AD\uC81C"] })] });
  return o.jsxs(o.Fragment, { children: [s ? o.jsx(Io, { open: c, onOpenChange: (k) => {
    u(k), k || m(null);
  }, title: "\uBBF8\uB9AC\uBCF4\uAE30 \uD45C", subtitle: "\uB9C8\uD06C\uB2E4\uC6B4 \uD14C\uC774\uBE14", children: Q }) : o.jsxs(dl, { open: c, onOpenChange: (k) => {
    u(k), k || m(null);
  }, modal: true, children: [o.jsx(fl, { asChild: true, children: o.jsx("button", { type: "button", "aria-hidden": true, tabIndex: -1, className: "pointer-events-none fixed h-px w-px opacity-0", style: { left: I.x, top: I.y } }) }), o.jsx(ml, { children: o.jsxs(pl, { className: yu, side: "bottom", align: "start", sideOffset: 2, collisionPadding: 12, onCloseAutoFocus: (k) => k.preventDefault(), children: [o.jsxs(Pr, { className: Zr, onSelect: N, children: [o.jsx(an, { className: Jt, "aria-hidden": true }), "\uD45C \uD3B8\uC9D1\uAE30"] }), o.jsxs(Pr, { className: eo, onSelect: L, children: [o.jsx(ht, { className: Jt, "aria-hidden": true }), "\uD45C \uC0AD\uC81C"] })] }) })] }), o.jsx(sn, { isOpen: x !== null, variant: "danger", title: "\uD45C \uC0AD\uC81C", message: "\uC774 \uD45C\uB97C \uB9C8\uD06C\uB2E4\uC6B4\uC5D0\uC11C \uC0AD\uC81C\uD560\uAE4C\uC694?", confirmLabel: "\uC0AD\uC81C", cancelLabel: "\uCDE8\uC18C", onConfirm: B, onCancel: () => T(null) })] });
}
function ku(e) {
  ...
  const s = l.useCallback((m, x = m) => {
    ...
    return j ? (n({ block: j, meta: j.meta ?? on(), grid: j.grid }), true) : false;
  }, []), c = l.useCallback((m, x) => {
    const T = r.current(), j = Bo(T, m, x);
    return j ? (n({ block: j, meta: j.meta ?? on(), grid: j.grid }), true) : false;
  }, []), u = l.useCallback(() => n(null), []), p = l.useCallback((m, x) => {
    if (!t) return;
    const T = r.current(), j = Vn(T, t.block.start, t.block.start + 1) ?? t.block, R = Aa(T, j, m, x);
    a.current(R), n(null);
  }, [t]);
  return { editState: t, openAtOffset: s, openPreviewTable: c, close: u, apply: p, isOpen: !!t };
}
const rs = new nr("s3haim-note-cover-fold");
rs.version(1).stores({ folds: "key, updatedAt" });
const os = rs.folds;
function Cu(e, t) {
  return `cover-fold:${tr(e, t)}`;
}
function Eu(e) {
  return !(e == null ? void 0 : e.id) || e.type !== "s3" && e.type !== "local" && e.type !== "webdav" ? null : Cu(e.type, e.id);
}
async function Su(e) {
  if (!e) return null;
  const t = await os.get(e);
  return !t || typeof t.collapsed != "boolean" ? null : t.collapsed;
}
async function Nu(e, t) {
  e && await os.put({ key: e, collapsed: !!t, updatedAt: Date.now() });
}
function bt(e) {
  const t = Math.min(e.length, 2e6);
  return Da(e.sliceString(0, t));
}
function it(e) {
  const t = bt(e.doc);
  if (!t) return null;
...
function Lt(e, t) {
  let n = false;
  return No(e).between(t.from, t.to, () => {
    n = true;
  }), n;
}
function ju(e, t) {
...
function Bn(e, t) {
  ...
  if (!Mu(e, t)) return null;
  const r = e.doc.lineAt(t), a = js(e, r.from, r.to);
  return !a || a.from >= a.to ? null : { ...a, kind: "heading" };
}
const Pt = Es.define({ combine: (e) => e[e.length - 1] ?? null }), ss = new Zn();
function Ru(e) {
  return ss.of(Pt.of(e));
}
function Tu(e, t) {
  e.dispatch({ effects: ss.reconfigure(Pt.of(t)) });
}
function Lu(e, t) {
...
async function Pu(e, t) {
  ...
  try {
    await mn(r, { height: 0, opacity: 0.35 }, { duration: 0.22, ease: "easeInOut" });
  } catch {
  }
  n === Qn && it(e.state) && e.dispatch({ effects: st.of(t) }), r.remove();
}
async function Au(e, t) {
  ++Qn, e.dispatch({ effects: Dt.of(t) });
  const n = it(e.state);
  if (!n) return;
  const r = as(e, n);
  if (r) {
    try {
      await mn(r, { height: 0, opacity: 0 }, { duration: 0.22, ease: "easeInOut" });
    } catch {
    }
    r.remove();
  }
...
function is(e, t) {
  ...
  n instanceof SVGElement && mn(n, { transform: t ? "rotate(0deg)" : "rotate(-90deg)" }, { duration: 0.18, ease: "easeInOut" });
}
function no(e, t) {
  const n = Lt(e.state, t);
  return e.dispatch({ effects: n ? Dt.of(t) : st.of(t) }), true;
}
function ro(e) {
  const t = it(e.state);
  if (!t) return false;
  const r = !Lt(e.state, t), a = e.dom.querySelector('.cm-note-cover-fold-chevron[data-fold-kind="cover"]');
  return is(a, !r), (async () => {
    r ? await Pu(e, t) : await Au(e, t);
    const s = e.state.facet(Pt);
    s && Nu(s, r);
  })(), true;
}
function Du(e, t) {
  const n = it(e.state);
  if (!n) return;
  const r = Lt(e.state, n);
  t && !r ? e.dispatch({ effects: st.of(n) }) : !t && r && e.dispatch({ effects: Dt.of(n) });
}
function Iu() {
  return So.fromClass(class {
    constructor(e) {
    ...
    update(e) {
      const t = e.state.facet(Pt) !== this.lastKey, r = !!bt(e.state.doc), a = r && !this.hadCover;
      this.hadCover = r, (t || a) && this.syncKeyAndMaybeRestore();
    }
    syncKeyAndMaybeRestore() {
      const e = this.view.state.facet(Pt);
      this.lastKey = e;
      const t = bt(this.view.state.doc);
      if (this.hadCover = !!t, !e || !t) return;
      const n = ++this.loadGen;
      Su(e).then((r) => {
        n === this.loadGen && r != null && Du(this.view, r);
      });
    }
  });
}
function $u(e) {
  return e.transactions.some((t) => t.effects.some((n) => n.is(st) || n.is(Dt)));
}
function Fu() {
  return [Ru(null), Co({ preparePlaceholder(e, t) {
    const n = it(e);
    return n && ju(n, t) ? "cover" : "heading";
  ...
  }), Ss({ class: "cm-note-cover-fold-gutter", lineMarker(e, t) {
    const n = Bn(e.state, t.from);
    if (!n) return null;
    const r = !Lt(e.state, n);
    return new to(r, n.kind);
  }, lineMarkerChange: (e) => e.docChanged || e.viewportChanged || $u(e), initialSpacer: () => new to(true, "heading"), domEventHandlers: { mousedown(e, t, n) {
    ...
    if (r.kind === "cover") {
      ...
      is(a, Lt(e.state, r)), no(e, r);
    }
    return n.preventDefault(), n.stopPropagation(), true;
  } } }), Ns({ domEventHandlers: { mousedown(e, t, n) {
    if (!(n instanceof MouseEvent) || n.button !== 0) return false;
  ...
  } } }), Iu(), Tt.theme({ ".cm-note-cover-fold-gutter": { width: "1.1rem" }, ".cm-note-cover-fold-gutter .cm-gutterElement": { display: "flex", alignItems: "center", justifyContent: "center", padding: "0" }, ".cm-note-cover-fold-chevron": { display: "inline-flex", alignItems: "center", justifyContent: "center", width: "1rem", height: "1rem", padding: "0", margin: "0", border: "none", background: "transparent", color: "inherit", opacity: "0.65", cursor: "pointer", lineHeight: "1" }, ".cm-note-cover-fold-chevron:hover": { opacity: "1" }, ".cm-note-cover-fold-chevron svg": { display: "block" } })];
}
function _u({ cover: e, getPresignedUrl: t }) {
  const n = Ia(e.pageSizeId) ? e.pageSizeId : $a, r = l.useMemo(() => ({ ...Fa(), pageSizeId: n }), [n]), a = l.useMemo(() => _a(n), [n]), s = l.useMemo(() => Ha(r), [r]);
  return o.jsx("div", { className: "md-note-cover-preview-light w-full bg-white text-gray-900", "data-note-cover-preview": "1", "data-color-mode": "light", "data-cover-page-size": n, style: s, children: o.jsx(gl, { cover: e, getPresignedUrl: t, className: "md-note-cover-preview-slide mx-auto max-w-full shadow-[0_4px_16px_rgba(15,23,42,0.1)]", style: { width: "100%", height: "auto", aspectRatio: `${a.widthMm} / ${a.heightMm}` } }) });
}
const ln = /* @__PURE__ */ new WeakMap(), Hu = "\uD45C\uC9C0 \uBD88\uB7EC\uC624\uB294 \uC911\u2026", Ou = "\uD45C\uC9C0";
function ls(e) {
  const t = ln.get(e);
  t && (t.unmount(), ln.delete(e));
}
function oo(e, t) {
  if (!e) return;
...
function so(e, t) {
  e && (e.classList.toggle("md-note-cover-placeholder--pending", t === "pending"), e.classList.toggle("md-note-cover-placeholder--ready", t === "ready"), e.classList.toggle("md-note-cover-placeholder--empty", t === "empty"), t === "pending" ? oo(e, Hu) : t === "empty" && oo(e, Ou));
}
function Bu(e, t, n) {
  let r = ln.get(e);
  r || (r = vs.createRoot(e), ln.set(e, r)), r.render(l.createElement(_u, { cover: t, getPresignedUrl: n ?? void 0 }));
}
function Ku(e, t, n, r) {
  if (!e || typeof e.querySelectorAll != "function") return 0;
  const { cover: a } = $o(t ?? ""), s = Array.from(e.querySelectorAll("[data-note-cover-mount]"));
...
function zu(e) {
  ...
  for (const n of t) ls(n);
}
const Vu = "h1, h2, h3, h4, h5, h6", cs = "md-preview-heading-fold-chevron", ao = "md-preview-heading-foldable", Zt = "md-preview-heading-folded", Wu = "md-preview-heading-section-hidden", rn = "data-md-preview-heading-fold";
function qu(e) {
  if (!e) return false;
  const t = e.tagName;
...
function us(e) {
  ...
  for (; r && !(qu(r) && io(r) <= t || r.hasAttribute("data-note-cover-placeholder")); ) r instanceof HTMLElement && n.push(r), r = r.nextElementSibling;
  return n;
}
function Xu(e) {
...
function Qu(e, t) {
  ...
  n instanceof SVGElement && (mn(n, { transform: t ? "rotate(0deg)" : "rotate(-90deg)" }, { duration: 0.18, ease: "easeInOut" }), e.setAttribute("aria-label", t ? "\uD5E4\uB529 \uC811\uAE30" : "\uD5E4\uB529 \uD3BC\uCE58\uAE30"), e.title = t ? "\uD5E4\uB529 \uC811\uAE30" : "\uD5E4\uB529 \uD3BC\uCE58\uAE30");
}
function Kn(e, t) {
  for (const n of e) n.classList.toggle(Wu, t), t ? n.setAttribute("hidden", "") : n.removeAttribute("hidden");
}
function Ju(e, t = {}) {
  if (!e || typeof e.querySelectorAll != "function") return () => {
  };
  const n = new Set(Array.from(t.collapsedIds ?? []).filter((s) => typeof s == "string" && s)), r = [];
  return ds(e).forEach((s, c) => {
    var _a2;
    if (s.getAttribute(rn) === "1") return;
    const u = us(s);
    if (u.length === 0) return;
    const p = Uu(s, c);
    s.id || (s.id = p), s.setAttribute(rn, "1"), s.classList.add(ao), (_a2 = s.querySelector(`:scope > .${cs}`)) == null ? void 0 : _a2.remove();
    const x = !n.has(p), T = Gu(x);
    s.insertBefore(T, s.firstChild);
    const j = (N) => {
      s.classList.toggle(Zt, N), Kn(u, N), Qu(T, !N);
    };
    x || (s.classList.add(Zt), Kn(u, true));
    const R = (N) => {
      var _a3;
      N.preventDefault(), N.stopPropagation();
      const L = !s.classList.contains(Zt);
      j(L), L ? n.add(p) : n.delete(p), (_a3 = t.onCollapsedChange) == null ? void 0 : _a3.call(t, Array.from(n));
    };
    T.addEventListener("click", R), r.push(() => {
      T.removeEventListener("click", R), T.remove(), s.classList.remove(ao, Zt), s.removeAttribute(rn), Kn(u, false);
    });
  }), () => {
    for (const s of r) s();
  };
}
const fs = new nr("s3haim-preview-heading-fold");
fs.version(1).stores({ folds: "key, updatedAt" });
const ms = fs.folds;
function Zu(e, t) {
  return `heading-fold:${tr(e, t)}`;
}
function ed(e) {
  return !(e == null ? void 0 : e.id) || e.type !== "s3" && e.type !== "local" && e.type !== "webdav" ? null : Zu(e.type, e.id);
}
async function td(e) {
  if (!e) return null;
...
async function nd(e, t) {
  e && await ms.put({ key: e, collapsedIds: Array.from(new Set(t.filter(Boolean))), updatedAt: Date.now() });
}
...
function od(e) {
  if (!(!e.selectionSet && !e.docChanged) && !(e.view.composing || e.view.compositionStarted) && cn.size !== 0) for (const t of cn) try {
    t(e.view, e);
  } catch {
  }
}
const sd = [0, 16, 48, 100, 180, 320];
function ad(e) {
  ...
  function u() {
    ...
    return !R || !N || Rt(R) ? false : Oa(N, R, { allowCollapsed: true });
  }
  function p() {
  ...
  function x(R) {
    ...
    if (N && m(N), u(), !!(R == null ? void 0 : R.withRetries)) {
      c();
      for (const L of sd) t.push(setTimeout(() => {
        if (s) return;
...
const lo = [0, 16, 48, 120, 280], id = 50, ld = 40, co = 32, cd = 32;
function uo(e) {
...
function md(e) {
  ...
  function Y() {
    ...
    const X = k($), W = P(H);
    if (!W) return;
    const pe = X.scrollTop, he = $.lineBlockAtHeight(pe), ge = $.state.doc.lineAt(he.from).number - 1, Be = ud(H, ge);
    if (!Be) return;
  ...
  function ne() {
    ...
    const X = k($), W = P(H);
    if (!W) return;
    const pe = W.scrollTop + co, he = dd(H, W, pe);
    if (!he) return;
...
const At = new nr("s3haim-editor-undo-history");
At.version(1).stores({ histories: "key, updatedAt" });
const mo = 100, hs = 10080 * 60 * 1e3, pd = 500;
function hd(e, t) {
  return tr(e, t);
}
function gd(e) {
  return !(e == null ? void 0 : e.id) || e.type !== "s3" && e.type !== "local" ? null : hd(e.type, e.id);
}
async function xd(e) {
  if (!e) return null;
  const t = await At.histories.get(e);
  return t ? typeof t.updatedAt == "number" && Date.now() - t.updatedAt > hs ? (await At.histories.delete(e), null) : !Array.isArray(t.stack) || t.stack.length === 0 ? null : t : null;
}
function ar(e) {
...
async function po({ key: e, stack: t, index: n }) {
  ...
  await At.histories.put({ key: e, stack: r, index: a, updatedAt: Date.now() });
}
async function bd() {
  const e = Date.now() - hs;
  await At.histories.where("updatedAt").below(e).delete();
}
function en(e, t, n) {
  const r = Array.isArray(e) && e.length > 0 ? [...e] : [""];
...
function kd({ currentFile: e, value: t, onChange: n, editorRef: r, enabled: a = true }) {
  const s = a ? gd(e) : null, c = l.useRef([""]), u = l.useRef(0), p = l.useRef(null), m = l.useRef(false), x = l.useRef(null), T = l.useRef(null), j = l.useRef(t), R = l.useRef(false), N = l.useRef(null), L = l.useRef(0), B = l.useRef(t);
  j.current = t;
  const I = l.useCallback(async (_, C, z) => {
    ...
    const _ = j.current ?? "", C = en(c.current, u.current, _);
    return c.current = C.stack, u.current = C.index, C;
  }, []), P = l.useCallback((_) => {
    const C = go(r), z = vd(C), Y = ho(C);
    if (!z) return false;
    const ne = ++L.current;
    m.current = true;
    try {
    ...
    var _a2, _b;
    const z = j.current ?? "", Y = ((_a2 = C == null ? void 0 : C.stack) == null ? void 0 : _a2.length) ? C.stack : [z], ne = ((_b = C == null ? void 0 : C.stack) == null ? void 0 : _b.length) ? C.index ?? C.stack.length - 1 : 0, se = en(Y, ne, z);
  ...
  return l.useEffect(() => {
    ...
    const _ = t ?? "";
    B.current = _;
    const C = en(c.current, u.current, _);
    ...
    if (a) return () => {
      ...
      const _ = p.current;
      if (!_) return;
      const C = en(c.current, u.current, j.current ?? "");
    ...
    m.current || (B.current = _, R.current = true, n == null ? void 0 : n(_), !(!a || !p.current) && (Q(), x.current = setTimeout(() => {
      ...
      const C = p.current;
      if (!C) return;
      const z = wd(c.current, u.current, _);
      z.changed && (c.current = z.stack, u.current = z.index, Z(C, z.stack, z.index));
    }, pd)));
  }, [a, n, Q, Z]) };
}
const ir = /^(\s*)([-+*])(\s+)(.*)$/, lr = /^(\s*)(\d+)([.)])(\s+)(.*)$/, gs = /^(\s*(?:[-+*]|\d+[.)])\s+)\[([ xX])\](.*)$/, Cd = /^(#{1,10})\s+(.*)$/;
function Ed(e) {
  if (!e) return false;
  const t = e[0];
...
function wt(e, t, n = t) {
  ...
  const r = e.state.selection.ranges.map((a) => Sd(e.state.doc, a, t, n));
  return bs(e, r);
}
function jd(e) {
  return wt(e, "**");
...
function ws(e) {
  ...
  const t = e.state.selection.ranges.map((n) => Nd(e.state.doc, n) ?? { next: n });
  return bs(e, t);
}
function Ad(e) {
...
function _d(e) {
  return $t(e, (t) => {
    ...
    if (n) {
      const a = n[1] ?? "", s = n[4] ?? "";
      return gs.test(t) ? `${a}- ${s.replace(/^\[[ xX]\]\s?/, "")}` : `${a}${s}`;
    }
    const r = t.match(lr);
    return r ? `${r[1] ?? ""}- ${r[5] ?? ""}` : `- ${t}`;
  });
...
const Vd = "s3haim_md_editor_toc_width", Wd = 360;
function bo(e) {
...
const qd = Is({ nonTightLists: false });
function Ud(e) {
  var _a2, _b;
...
function Xd(e) {
  return qd(e) ? (Ud(e), true) : zc(e) ? true : Ds(e);
}
const Yd = Ps.highest(jo.of([{ key: "Enter", run: Xd }]));
function Gd(e) {
  var _a2, _b;
  if (!(e == null ? void 0 : e.state)) return;
...
const Jd = [{ key: "Alt-h", preventDefault: true, run: (e) => nn(e, Zs) }, { key: "Alt-j", preventDefault: true, run: (e) => nn(e, ea) }, { key: "Alt-k", preventDefault: true, run: (e) => nn(e, ta) }, { key: "Alt-l", preventDefault: true, run: (e) => nn(e, na) }];
As({ editorConfig: { languageUserDefined: { "ko-KR": $s }, renderDelay: Fo() ? 500 : 0 }, codeMirrorExtensions(e, { keyBindings: t }) {
  ...
  }), a = [{ key: "ArrowLeft", run: (s) => Nr(s, -1) }, { key: "ArrowRight", run: (s) => Nr(s, 1) }, { key: "Ctrl-ArrowLeft", mac: "Alt-ArrowLeft", run: (s) => qe(s, -1, qs), shift: (s) => qe(s, -1, Ws) }, { key: "Ctrl-ArrowRight", mac: "Alt-ArrowRight", run: (s) => qe(s, 1, Xs), shift: (s) => qe(s, 1, Us) }, { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: (s) => qe(s, -1, Gs), shift: (s) => qe(s, -1, Ys) }, { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: (s) => qe(s, 1, Js), shift: (s) => qe(s, 1, Qs) }, ...Jd, { key: "Alt--", preventDefault: true, run: $d }, { key: "Ctrl-Tab", run: Fd }, { key: "Ctrl-d", mac: "Cmd-d", preventDefault: true, run: (s) => (Hs(s), true) }, { key: "Ctrl-b", mac: "Cmd-b", preventDefault: true, run: jd }, { key: "Ctrl-i", mac: "Cmd-i", preventDefault: true, run: Md }, { key: "Ctrl-u", mac: "Cmd-u", preventDefault: true, run: Td, shift: _d }, { key: "Ctrl-o", mac: "Cmd-o", preventDefault: true, run: Hd }, { key: "Shift-Ctrl-s", mac: "Shift-Cmd-s", preventDefault: true, run: Rd }, { key: "Ctrl-ArrowUp", mac: "Cmd-ArrowUp", preventDefault: true, run: Ld }, { key: "Ctrl-ArrowDown", mac: "Cmd-ArrowDown", preventDefault: true, run: Pd }, ...[1, 2, 3, 4, 5, 6, 7, 8, 9].map((s) => ({ key: `Ctrl-${s}`, mac: `Cmd-${s}`, preventDefault: true, run: (c) => xo(c, s) })), { key: "Ctrl-0", mac: "Cmd-0", preventDefault: true, run: (s) => xo(s, 10) }, { any: (s, c) => (c.ctrlKey || c.metaKey) && c.altKey && c.code === "KeyC" ? ws(s) : ys(s, c) }, { key: "Mod-Alt-ArrowUp", run: Fs }, { key: "Mod-Alt-ArrowDown", run: _s }, ...r];
  return n.some((s) => s.type === "drawSelection") || n.push({ type: "drawSelection", extension: Os() }), n.push({ type: "markdownSingleNewlineEnter", extension: Yd }, { type: "lineNumbers", extension: Fu() }, { type: "allowMultipleSelections", extension: Bs.allowMultipleSelections.of(true) }, { type: "clickAddsSelectionRange", extension: Tt.clickAddsSelectionRange.of((s) => {
    const c = /Mac|iPod|iPhone|iPad/.test(navigator.platform);
    return s.altKey || (c ? s.metaKey : s.ctrlKey);
  }) }, { type: "multiCursorPreview", extension: Ks({ minSelectionLength: 2, maxMatches: 200 }) }, { type: "keymap", extension: jo.of(a) }, { type: "base64ImageFold", extension: Dc(Gn()) }, { type: "mermaidBase64Fold", extension: Oc(Gn()) }, { type: "autocompleteGate", extension: Tt.updateListener.of((s) => {
    od(s), !Po() && zs(s.state) === "active" && Vs(s.view);
  }) }), n;
}, markdownItPlugins(e) {
  return ki(e);
} });
function wf({ value: e, onChange: t, onSave: n, theme: r = "light", currentFile: a = null, previewOnly: s = false, isMobileLayout: c = false, onUploadImage: u, isUploadingEditorImage: p = false, uploadImagePercent: m = 0, onCancelUploadImage: x, onResolveWikiImageUrl: T, snippetConfig: j = { snippets: [] }, llmProviderProfiles: R = [], getImgbbApiKey: N, onOpenViewPath: L, onRequestConvertAllImagesToWiki: B, onRegisterConvertAllImagesToWiki: I, isActiveFile: Z = true }) {
  var _a2, _b;
  const Q = Ka(), k = wo(), { showAlert: P } = za(), J = l.useId(), K = l.useMemo(() => zl(J), [J]), _ = l.useMemo(() => Vl(K), [K]), C = l.useRef(null), z = l.useRef(null), Y = l.useRef(null), ne = l.useRef(null), se = l.useRef(j), ee = l.useRef(e), we = l.useRef(a), G = l.useRef(r), re = l.useRef("");
  l.useEffect(() => {
...
${h}` }));
  ...
  const oe = l.useCallback((f = {}) => {
    ...
    To({ currentFile: g, editorContent: h }), k(Lo(g == null ? void 0 : g.id), { state: { value: h, theme: G.current === "dark" ? "dark" : "light", currentFile: g, ...f.openCoverEdit ? { openCoverEdit: true } : {} } });
  }, [k]), { onChange: q } = kd({ currentFile: a, value: e, onChange: t, editorRef: C, enabled: !s }), ie = ku({ getMarkdown: () => ee.current ?? "", setMarkdown: (f) => {
  ...
  const [Ge, Qe] = l.useState(null), [xe, Je] = l.useState(null), [yt, Pe] = l.useState(false), [Ze, vt] = l.useState(null), [Ft, lt] = l.useState(false), [ve, be] = l.useState(null), [fe, ke] = l.useState(null), le = l.useRef(null), [ct, kt] = vl(), [Ve, ut] = Sc(), [_t, Ht] = Nc(), [gn, dt] = jc(), Re = l.useMemo(() => Fo(), []), ue = Re ? false : gn, Ce = l.useRef(null);
  l.useEffect(() => {
    if (s) return;
    const f = () => {
      var _a3, _b2, _c2;
...
`;
    ...
    for (const S of qa) S.directive && (M[S.id] = () => g(S.directive));
    ...
    return Xa({ getMarkdown: () => {
      var _a3;
      return ((_a3 = f()) == null ? void 0 : _a3.state.doc.toString()) ?? ee.current ?? "";
    }, insertExisting: (w) => {
      h();
      const y = f(), M = (y == null ? void 0 : y.state.doc.toString()) ?? ee.current ?? "", S = y == null ? void 0 : y.state.selection.main, D = Ci(M, (S == null ? void 0 : S.from) ?? 0, (S == null ? void 0 : S.to) ?? 0, w);
      g(D.next, D.caret);
    }, openCompose: () => {
      var _a3;
      h();
  ...
  const { width: Fe, isResizing: Ot, handleProps: Bt } = Ya({ storageKey: Vd, defaultWidth: Wd, minWidth: 160, collapseBelowWidth: 80, maxWidth: 640, edge: "right", onCollapseBelowMin: () => {
    var _a3, _b2, _c2;
    ...
    return f ? { "--print-font-body": Yt(f.body), "--print-font-heading": Yt(f.heading), "--print-font-bold": Yt(f.bold), "--print-font-code": Yt(f.code, "mono") } : {};
  }, [et]);
  l.useEffect(() => {
    ...
    const f = () => {
      var _a3, _b2, _c2;
      const y = (_c2 = (_b2 = ((_a3 = C.current) == null ? void 0 : _a3.value) ?? C.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2);
      return y ? (Ic(y, Ve), Bc(y, Ve), true) : false;
    };
    if (f()) return;
    ...
    if (ve) return Yl(ve, { getEditorRoot: () => z.current, mdHeadingId: (f) => _(f) });
  }, [ve, _]), Sl(z, e, T, (a == null ? void 0 : a.id) ?? null), Qa(z, { layoutKey: `${r}|${e}` }), l.useEffect(() => {
    const f = z.current;
    if (!f || !e) return;
    let h = 0;
    const g = () => {
    ...
    const g = () => {
      ...
      return !M || M === h ? !!M : (f == null ? void 0 : f(), h = M, f = pi(M), true);
    };
    if (g()) return () => {
      f == null ? void 0 : f();
    };
    ...
    const f = z.current;
    if (!f) return;
    const h = ed(a), g = { current: [] };
    let w = false, y = null, M = null, S = [];
    const D = () => f.querySelector(".md-editor-preview"), O = () => {
      if (w) return;
      const te = D();
      if (!te || !Yu(te)) return;
      const Se = Ju(te, { collapsedIds: g.current, onCollapsedChange: (d) => {
        g.current = d, h && nd(h, d);
      } }), i = y;
      y = () => {
        i == null ? void 0 : i(), Se();
      };
    ...
    const y = (i) => i instanceof Element ? Sn(i) ? true : !!i.closest("a, button, input, textarea, select, .md-editor-code-action, [data-transform-handle]") : false, M = (i) => {
      ...
      if (!g()) {
        ...
        (A == null ? void 0 : A.rangeCount) && d.contains(A.getRangeAt(0).commonAncestorContainer) && !A.getRangeAt(0).collapsed ? jn(d, { allowCollapsed: false }) : Nt(d);
        return;
      }
    ...
    }, S = (i) => i.button === 2 || i.button === 0 && i.ctrlKey, D = (i, d) => Er(d, i.clientX, i.clientY) ? true : Sr(i.clientX, i.clientY) ? vi(d) : false, O = (i) => {
      var _a3, _b2, _c2, _d2;
      const d = h();
      if (!d) return;
      const b = i.target;
      ...
      if (d.contains(b)) {
        w = { x: i.clientX, y: i.clientY }, !Sn(b) && !g() && Nt(d);
        return;
      }
    ...
    return f.addEventListener("mousedown", O, true), f.addEventListener("contextmenu", U, true), f.addEventListener("mouseup", de), f.addEventListener("touchend", te, { passive: true }), f.addEventListener("keydown", Se, true), () => {
      Nt(h()), f.removeEventListener("mousedown", O, true), f.removeEventListener("contextmenu", U, true), f.removeEventListener("mouseup", de), f.removeEventListener("touchend", te), f.removeEventListener("keydown", Se, true);
    };
  }, [s, ue, Re]), l.useEffect(() => {
    var _a3, _b2, _c2, _d2;
    if (s) {
    ...
    const w = md({ getPreviewRoot: h, getView: g });
    Y.current = w, (_d2 = ne.current) == null ? void 0 : _d2.stop(), ne.current = null, ue ? ne.current = ad({ getPreviewRoot: h, getView: g }) : Rn();
    const y = rd((M, S) => {
      var _a4;
      const D = g();
    ...
    const f = z.current;
    if (f) return ei(f, { getPreviewRoot: () => f.querySelector(".md-editor-preview"), getView: () => {
      var _a3, _b2, _c2;
    ...
    if (ti(), !!h && ((_b2 = Y.current) == null ? void 0 : _b2.schedule({ withRetries: true }), !Re)) {
      if (ue && !Rt(h)) {
...
`), te = ((_c2 = (_b2 = ((_a4 = C.current) == null ? void 0 : _a4.value) ?? C.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2)) ?? D;
        ...
        var _a4;
        if (!w) return;
        if (!w.composing && Qd(g) && ws(w) || !w.composing && ys(w, g)) return g.preventDefault(), g.stopPropagation(), true;
        const y = bo(g);
        if (!y) return;
        if (y === "mod+shift+enter") return g.preventDefault(), g.stopPropagation(), Gd(w), false;
        if (y === "mod+s") return;
        const S = ((_a4 = se.current) == null ? void 0 : _a4.snippets) || [], D = tn(y), O = S.find((U) => tn(U.prefix) === D && (U.body || "").trim());
    ...
    const f = (h) => {
      ...
      const O = ((_e2 = se.current) == null ? void 0 : _e2.snippets) || [], U = tn(g), de = O.find((te) => tn(te.prefix) === U && (te.body || "").trim());
    ...
    const h = (g) => {
      ...
      g.preventDefault();
      const O = D.kind === "wiki" ? xi(f, S, D.key) : bi(f, S, D.key);
    ...
    const h = (y) => {
      ...
      if (S && f.contains(S)) {
        y.preventDefault(), y.stopPropagation(), k(wi({ id: S.getAttribute("data-chat-id") || "", href: S.getAttribute("data-chat-href") || S.getAttribute("href") || "" }));
        return;
      }
      ...
      const O = D.getAttribute("href") || "", U = yi(O, { currentViewPath: (a == null ? void 0 : a.type) ? a.id : null });
  ...
  const zt = l.useCallback(({ width: f, height: h }) => {
    const g = W;
  ...
  }, [W, q, e]), Vt = l.useCallback(async ({ file: f }) => {
    var _a3;
    const h = W;
    ...
    const y = h.kind === "wiki" ? ni(e, { path: h.key, occurrence: h.occurrence ?? 0, nextPath: w }) : yr(e, { src: h.key, occurrence: h.occurrence ?? 0, nextPath: w });
    ...
    const w = await ri({ markdownSrc: g.key, displaySrc: g.imageSrc, currentNotePath: (a == null ? void 0 : a.id) ?? null });
    let y = "";
    ...
    const y = oi({ path: g.key, imageSrc: g.imageSrc });
    if (!y) throw new Error("Cannot determine image source URL for upload.");
    const S = (await si({ apiKey: w, image: y, name: ai(g.key) ? "image" : void 0 })).url, D = g.occurrence ?? 0;
    let O = e;
    ...
    const de = await ii(O, { kind: g.kind === "wiki" ? "wiki" : "markdown", key: g.key, occurrence: D }, S);
  ...
  l.useEffect(() => {
    if (typeof I == "function") return I(async () => {
      ...
      if (typeof q != "function") throw new Error("Cannot apply change.");
      if (!li(e)) return { markdown: e, converted: 0, failed: [] };
      const f = await ci(e, { currentNotePath: (a == null ? void 0 : a.id) ?? null, uploadFiles: async (h) => {
        if (typeof u != "function") throw new Error("Upload handler not available.");
        return u(h);
      } });
  ...
  l.useEffect(() => {
    ...
    const g = () => {
      ...
      vt({ left: w.left, top: w.top, width: w.width, height: w.height }), h = requestAnimationFrame(g);
    };
...
`);
  ...
  const qt = l.useCallback(async (f) => {
    var _a3;
...
`), Qe(null);
  ...
  const Ut = l.useMemo(() => [o.jsx(ic, { value: e, theme: r, currentFile: a, language: "ko-KR" }, "export-pdf"), o.jsx(lc, { editorRef: C }, "insert-pgbr"), o.jsx(cc, { onOpen: He }, "heading-remap"), o.jsx(Gl, { active: !!(Q == null ? void 0 : Q.open), onToggle: () => {
    var _a3;
    (_a3 = Q == null ? void 0 : Q.toggleAssist) == null ? void 0 : _a3.call(Q);
  } }, "llm-assist"), o.jsx(ac, { onOpen: () => {
    X(true);
  } }, "checklist-progress"), o.jsx(gc, { checked: ct, onChange: kt, theme: r }, "toc-title-wrap"), o.jsx(xc, { checked: Ve, onChange: ut, theme: r }, "base64-image-fold"), o.jsx(bc, { checked: _t, onChange: Ht, theme: r }, "editor-autocomplete"), Re ? null : o.jsx(wc, { checked: ue, onChange: dt, theme: r }, "mirror-edit"), o.jsx(yc, { disabled: typeof u != "function", onRequestLink: () => $e(true), onRequestUpload: (f) => {
    nt(f);
  }, onRequestClip: (f) => Qe(f) }, "image-toolbar")], [e, r, a, ct, kt, Ve, ut, _t, Ht, Re, ue, dt, u, nt, He, Q == null ? void 0 : Q.open, Q == null ? void 0 : Q.toggleAssist]), Xt = l.useMemo(() => ["bold", "underline", "italic", "-", "strikeThrough", "sub", "sup", "quote", "unorderedList", "orderedList", "task", "-", "codeRow", "code", "link", 9, "table", "mermaid", "katex", 1, 2, 3, 4, "-", "revoke", "next", 0, "=", 6, 7, ...Re ? [] : [8], "pageFullscreen", "fullscreen", "previewOnly", "preview", "htmlPreview", ...ve ? [5] : [], "catalog"], [ve, Re]), Et = l.useMemo(() => {
  ...
  return o.jsxs("div", { ref: z, className: `h-full w-full flex flex-col relative${ct ? " toc-titles-wrap" : ""}`, style: { "--md-catalog-width": `${Fe}px`, ...Kt }, children: [(et == null ? void 0 : et.webfontCss) ? o.jsx("style", { "data-s3haim-document-webfonts": "1", children: et.webfontCss }) : null, fe && yo.createPortal(o.jsx(ui, { handleProps: Bt, isResizing: Ot, visibleOnHover: true, label: "TOC resize handle", style: { position: "fixed", top: fe.top, left: fe.left, height: fe.height, bottom: "auto", zIndex: 10003 } }), document.body), p && o.jsxs("div", { className: "absolute top-0 left-0 right-0 bottom-0 z-10 flex items-center justify-center gap-2 py-2 text-sm bg-blue-300/40 dark:bg-blue-800/50 text-blue-700 dark:text-blue-300 border-b border-blue-500/20", "aria-live": "polite", children: [o.jsx(Yi, { size: 16, className: "animate-spin shrink-0" }), o.jsxs("span", { children: ["Uploading image... ", Math.max(0, Math.min(100, Math.round(m))), "%"] }), typeof x == "function" && o.jsx("button", { type: "button", onClick: x, className: "ml-2 rounded-md border border-blue-600/50 bg-white/80 px-2 py-1 text-xs font-medium text-blue-800 hover:bg-white dark:border-blue-300/40 dark:bg-blue-950/60 dark:text-blue-100 dark:hover:bg-blue-950", children: "Cancel" })] }), o.jsx(Ls, { ref: C, id: K, modelValue: e, onChange: q, mdHeadingId: _, className: "h-full! max-h-dvh", theme: r, language: "ko-KR", codeTheme: fi, customIcon: di, previewOnly: s, noMermaid: true, autoDetectCode: true, scrollAuto: false, footers: ["markdownTotal"], toolbars: Xt, defToolbars: Ut, onUploadImg: Et }, `footnotes-${he}`), o.jsx(hl, { containerRef: z }), o.jsx(bl, { containerRef: z }), o.jsx(kl, { isOpen: !!W, onClose: () => pe(null), path: (W == null ? void 0 : W.key) ?? "", kind: (W == null ? void 0 : W.kind) ?? "wiki", initialWidth: (W == null ? void 0 : W.width) ?? "", initialHeight: (W == null ? void 0 : W.height) ?? "", imageSrc: (W == null ? void 0 : W.imageSrc) ?? "", onApply: zt, onStartFreeTransform: Ct, onCrop: Vt, onConvertToWiki: We, onConvertToImgbb: xn }, W ? `${W.kind}|${W.key}|${W.width ?? ""}|${W.height ?? ""}|${W.occurrence ?? 0}` : "wiki-image-size-modal"), o.jsx(vc, { isOpen: Be, onClose: () => $e(false), onConfirm: ({ desc: f, url: h }) => {
    tt(`![${f || ""}](${h})
`);
  } }), o.jsx(kc, { isOpen: Me, onClose: () => me(false), onConfirm: ({ line1: f, line2: h }) => {
    var _a3, _b2, _c2, _d2, _e2;
    const w = (_c2 = (_b2 = ((_a3 = C.current) == null ? void 0 : _a3.value) ?? C.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2), y = (w == null ? void 0 : w.state.doc.toString()) ?? ee.current ?? "", { from: M, to: S } = Ke.current, D = mi(y, M, S, f, h);
    ...
    ye(false), Oe(null);
  } }), o.jsx(rc, { editorRef: C, onChange: q, open: $, onOpenChange: X })] });
}
export {
  wf as default
};
