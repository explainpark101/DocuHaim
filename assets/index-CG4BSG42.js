import { b as f, r as s } from "./vendor-react-SY5QCjFA.js";
function k() {
...
var y = function(e, t, n) {
  ...
  var t = e.onMove, n = e.onKey, r = e.onEnd, a = R(e, ["onMove", "onKey", "onEnd"]), o = s.useRef(null), u = x(t), c = x(n), l = x(r), i = s.useRef(null), v = s.useRef(false), m = s.useMemo(function() {
    var D = function(p) {
      A(p), (N(p) ? p.touches.length > 0 : p.buttons > 0) && o.current ? u(q(o.current, p, i.current)) : (b(false), l());
    }, w = function() {
      b(false), l();
    };
    function b(p) {
...
var ne = typeof window < "u" ? s.useLayoutEffect : s.useEffect, re = function() {
...
}, T = /* @__PURE__ */ new WeakMap(), oe = function(e) {
  ne(function() {
    var t = e.current;
  ...
  return f.createElement(ie, k({}, r, { escape: a, format: t ? $ : void 0, process: $, validate: o }));
};
export {
  ve as O,
  fe as t
