const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NoteImageCropperJsPanel-BVQ_-Ooc.js","assets/vendor-md-editor-3uoZigMr.js","assets/vendor-react-kfkzeLNk.js","assets/storageImageHydration-DXQ4AKQZ.js","assets/index-y-7LfBXB.js","assets/vendor-aws-DoHMlT-9.js","assets/vendor-lucide-MHeIhp6j.js","assets/vendor-zip-Bez6qchM.js","assets/vendor-motion-9P87yVtW.js","assets/vendor-radix-BympcaAE.js","assets/vendor-google-genai-BXoTgYIl.js","assets/index-TvgKAYXY.css"])))=>i.map(i=>d[i]);
import { r, j as n, a as Ve, __tla as __tla_0 } from "./vendor-react-kfkzeLNk.js";
import { a0 as Ze, a1 as Je, U as Qe, a2 as Le, a3 as et, __tla as __tla_1 } from "./index-y-7LfBXB.js";
import { _ as tt, __tla as __tla_2 } from "./vendor-md-editor-3uoZigMr.js";
import { g as rt, s as nt } from "./vendor-image-crop-BfNSF_Kw.js";
import { g as st, c as ot, o as at, a as it, b as ct } from "./storageImageHydration-DXQ4AKQZ.js";
import { L as J, g as lt, A as ut, a as Ue, I as dt, U as ft, h as ht, X as pt, i as gt } from "./vendor-lucide-MHeIhp6j.js";
import { n as mt, o as xt, p as Re, q as Se, S as Ne, b as je } from "./vendor-radix-BympcaAE.js";
let _t, Kt, Xt, Yt;
let __tla = Promise.all([
  ...
  function Pt(e, o, i, f) {
    ...
    if (x - B < Y) if (C != null && j == null) x = B + e.width;
    else if (j != null && C == null) B = x - e.width;
    else {
      const S = (v + b) / 2;
      B = S - e.width / 2, x = S + e.width / 2;
    }
    if (R - z < Y) if (N != null && A == null) R = z + e.height;
  ...
  _t = function({ imageSrc: e, fileName: o, onCancel: i, onConfirm: f }) {
    ...
    const We = r.useCallback(() => ({
      ...
      g.current = true, j.current = false, D(t.lockRatio), ee.current = t.lockRatio, te.current = t.keepTransparency, t.cropSize ? (a.current = t.cropSize, P(t.cropSize)) : (a.current = null, P(null)), Z.current = t.crop, K.current = t.zoom, z(t.crop), T(t.zoom), t.croppedArea && (q.current = t.croppedArea), window.requestAnimationFrame(() => {
        g.current = false;
      });
    }, []), Fe = r.useCallback((t) => {
      ...
      j.current || N.current || g.current || (Z.current = t, z(t), se());
    }, [
      se
    ]);
    r.useEffect(() => () => {
      ...
      B("easy"), z({
        x: 0,
        y: 0
      }), T(1), a.current = null, P(null), D(false), L(true), d(false), E(""), q.current = null, Q(null), p.current = null, h.current = null, v.current = null, u.current = false, j.current = false, re.current = null, O(null), w(null), F(null), le(null);
    }, [
      e
    ]), r.useEffect(() => {
      if (!e) return;
                ...
                n.jsxs("div", {
                  ...
                  children: [
                    oe ? n.jsx(nt, {
                      ...
                      onCropChange: qe,
                      onZoomChange: (t) => {
                        j.current || N.current || g.current || (K.current = t, T(t), se());
                      },
                      onCropComplete: Ce,
                      onCropAreaChange: Ce,
                      onCropSizeChange: Ye,
  ...
  Kt = function({ isOpen: e, onClose: o, path: i = "", kind: f = "wiki", initialWidth: l, initialHeight: a, imageSrc: p = "", onApply: h, onStartFreeTransform: v, onCrop: b, onConvertToWiki: u, onConvertToImgbb: g }) {
    const [C, j] = r.useState(() => ie(l)), [N, A] = r.useState(() => ie(a)), [B, x] = r.useState(""), [z, R] = r.useState(false), [T, S] = r.useState(false), [P, U] = r.useState(false);
    r.useEffect(() => {
      e && (j(ie(l)), A(ie(a)), x(""), R(false), S(false), U(false));
    }, [
      e,
      l,
      a,
