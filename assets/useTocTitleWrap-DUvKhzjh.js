const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NoteImageCropperJsPanel-CSGNHJY8.js","assets/vendor-md-editor-DQ2k84v8.js","assets/vendor-react-kfkzeLNk.js","assets/storageImageHydration-CaMD9OgW.js","assets/index-siMg0SyX.js","assets/vendor-aws-DjU81Y0s.js","assets/vendor-lucide-B9iB2q4-.js","assets/vendor-zip-Bez6qchM.js","assets/vendor-motion-9P87yVtW.js","assets/vendor-radix-CyZ5tkEq.js","assets/index-CqNGOs1m.css"])))=>i.map(i=>d[i]);
import { r, j as n, a as Ze, __tla as __tla_0 } from "./vendor-react-kfkzeLNk.js";
import { Y as Ve, Z as Je, M as Qe, _ as Le, $ as et, __tla as __tla_1 } from "./index-siMg0SyX.js";
import { _ as tt, __tla as __tla_2 } from "./vendor-md-editor-DQ2k84v8.js";
import { g as rt, s as nt } from "./vendor-image-crop-BfNSF_Kw.js";
import { g as st, c as ot, o as at, a as it, b as ct } from "./storageImageHydration-CaMD9OgW.js";
import { L as J, i as lt, A as ut, a as Ue, I as dt, U as ft, j as ht, X as pt, k as gt } from "./vendor-lucide-B9iB2q4-.js";
import { n as mt, o as xt, p as Re, q as Se, S as je, b as Ne } from "./vendor-radix-CyZ5tkEq.js";
let _t, Kt, Xt, Yt;
let __tla = Promise.all([
  ...
  const De = new Ve("s3haim-image-crop-undo-history");
  De.version(1).stores({
  ...
  _t = function({ imageSrc: e, fileName: o, onCancel: i, onConfirm: f }) {
    const l = r.useRef(null), a = r.useRef(null), p = r.useRef(null), h = r.useRef(null), v = r.useRef(null), b = r.useRef(null), u = r.useRef(false), g = r.useRef(false), C = r.useRef(0), N = r.useRef(false), j = r.useRef(null), [A, B] = r.useState("easy"), [x, z] = r.useState({
      x: 0,
      y: 0
    }), [R, T] = r.useState(1), [S, P] = r.useState(null), [U, D] = r.useState(false), [I, L] = r.useState(true), [y, d] = r.useState(false), [M, E] = r.useState(""), [W, Q] = r.useState(null), [X, w] = r.useState(null), [k, O] = r.useState(null), [H, F] = r.useState(null), [He, le] = r.useState(null), q = r.useRef(null), V = r.useRef(x), K = r.useRef(R), ee = r.useRef(U), te = r.useRef(I), re = r.useRef(null);
    V.current = x, K.current = R, ee.current = U, te.current = I;
    const We = r.useCallback(() => ({
      ...
      g.current = true, N.current = false, D(t.lockRatio), ee.current = t.lockRatio, te.current = t.keepTransparency, t.cropSize ? (a.current = t.cropSize, P(t.cropSize)) : (a.current = null, P(null)), V.current = t.crop, K.current = t.zoom, z(t.crop), T(t.zoom), t.croppedArea && (q.current = t.croppedArea), window.requestAnimationFrame(() => {
        g.current = false;
      });
    }, []), Fe = r.useCallback((t) => {
      ...
      N.current || j.current || g.current || (V.current = t, z(t), se());
    }, [
      se
    ]);
    r.useEffect(() => () => {
    ...
    const ue = r.useCallback(() => {
      ...
      const c = p.current;
      if (!c) return;
      const m = Tt(c), _ = (_a = l.current) == null ? void 0 : _a.getBoundingClientRect(), Z = Math.max(Y, ((_ == null ? void 0 : _.width) ?? c.width) - 16), Ge = Math.max(Y, ((_ == null ? void 0 : _.height) ?? c.height) - 16), ve = !!(s == null ? void 0 : s.fitNatural) || !a.current ? 1 : Math.min(4, Math.max(1, K.current)), he = Ae({
        width: t.width * m * ve,
        height: t.height * m * ve
      }, Z, Ge);
      a.current = he, P(he);
      const pe = rt(t, c, 0, he, 1, 4);
      g.current = true, V.current = pe.crop, K.current = Math.min(4, Math.max(1, pe.zoom)), z(pe.crop), T(K.current), q.current = t, window.requestAnimationFrame(() => {
        g.current = false;
      });
