import { ac as g, ad as P, au as q, av as l, ay as i, ah as c, t as r, al as R, ai as p } from "./vendor-md-editor-D4hOzNKK.js";
import "./vendor-react-SY5QCjFA.js";
const b = 1, $ = 33, m = 34, v = 35, x = 36, d = new p((O) => {
  let e = O.pos;
  for (; ; ) {
    if (O.next == 10) {
      O.advance();
