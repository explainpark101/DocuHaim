import { y as ae, H as j, I as oe, J as T, L as $, K as se, N as de, O as ne } from "./index-siMg0SyX.js";
import { r as o, j as e } from "./vendor-react-kfkzeLNk.js";
import { A as le } from "./vendor-md-editor-DQ2k84v8.js";
import { u as ie, M as pe } from "./useLazyMermaidRender-0X9iJIqW.js";
import { O as ce, G as xe } from "./OpenAiCompatibleModelSelect-DtPJ-zKB.js";
import { r as D, L, e as be } from "./llmAssistImages-Ca7ILDRO.js";
import { R as ge, L as M, I as ue, X as me, S as fe, g as he, E as ye, h as ve } from "./vendor-lucide-B9iB2q4-.js";
function Ie(a) {
...
const m = "s3haim-llm-assist", Ae = { READY: `${m}:ready`, SYNC: `${m}:sync`, ACTION: `${m}:action`, PARENT_CLOSING: `${m}:parent-closing` };
function Oe(a) {
...
function Pe({ theme: a = "light", profiles: s = [], selectedProfileId: d = "", onSelectedProfileIdChange: n = () => {
  ...
  const A = o.useCallback(async (r) => {
    ...
    var _a;
    r.preventDefault(), r.stopPropagation(), await A((_a = r.dataTransfer) == null ? void 0 : _a.files);
  };
  return o.useEffect(() => {
    const r = async (c) => {
