...
import { A as G, m as J } from "./vendor-motion-9P87yVtW.js";
import { d as Q, e as Z, T as tt, f as et, g as nt, A as rt } from "./vendor-radix-BifzBLLM.js";
import { o as ot, a4 as it, a5 as st, a6 as at, a7 as W, _ as ct, a8 as lt, a9 as ut, aa as dt } from "./index-C0ZoiHxN.js";
function ft(t) {
...
function Qt(t) {
  const e = t % 6 * 3;
  return { x: I(18 + e, 0, 70), y: I(28 + e, 0, 70) };
}
...
function te({ containerRef: t, getMarkdown: e, setMarkdown: n, enabled: o = true }) {
  ...
  const E = m.useCallback((f, i) => {
    ...
    const F = (P) => {
      ...
      const _ = { ...v, widthPx: T, heightPx: C };
      a.current = _, l(_);
    }, A = () => {
...
function ee({ cover: t, getPresignedUrl: e, className: n = "", style: o, showFrameOutline: s = false, renderElements: l = true, children: d }) {
  ...
  return u.jsxs("div", { className: `export-pdf-cover relative z-2 overflow-hidden bg-white text-gray-900 ${n}`, style: { width: "var(--print-page-width)", height: "var(--print-page-height)", backgroundColor: a, ...o }, "data-note-cover": "1", onContextMenu: (r) => {
    r.stopPropagation();
  }, children: [u.jsx(Rt, { cover: t }), t.bg.imagePath ? u.jsx(Ot, { path: t.bg.imagePath, getPresignedUrl: e }) : null, u.jsxs("div", { className: `absolute top-0 bottom-0 ${s ? "outline outline-1 outline-dashed outline-blue-400/70" : ""}`, style: { left: `${g.leftPct}%`, width: `${g.widthPct}%` }, "data-cover-frame": "1", children: [l ? t.elements.map((r) => r.type === "text" ? u.jsx("div", { "data-cover-el": r.id, style: { ...O(r), ...pt(r) }, children: r.text }, r.id) : lt(r) ? u.jsx("div", { "data-cover-el": r.id, style: O(r), children: u.jsx(Nt, { el: r }) }, r.id) : u.jsx("div", { "data-cover-el": r.id, style: O(r), children: u.jsx(jt, { path: r.path, getPresignedUrl: e }) }, r.id)) : null, d] })] });
}
const Bt = "data-md-footnote-to", Y = "data-md-footnote-back-button", Ft = 2, _t = "is-hidden";
let N = null;
...
function B(t) {
  ...
  if (!e) return;
  const n = !!(t && k.get(t));
  e.classList.toggle(_t, !n), e.toggleAttribute("aria-hidden", !n), e.toggleAttribute("disabled", !n), e.setAttribute("data-footnote-return-target", (t && k.get(t)) ?? "");
}
function j(t) {
...
function ne(t) {
  ...
  const e = (n) => {
    ...
    if (s instanceof HTMLElement && t.contains(s)) {
      ...
      if (!E) return;
      n.preventDefault(), n.stopPropagation(), $(E, c), j(c);
      return;
    }
    ...
    const d = l.getAttribute(Bt) || "", g = l.getAttribute("href") || "", a = d || (It(g) ? g.slice(1) : "");
    if (!a) return;
