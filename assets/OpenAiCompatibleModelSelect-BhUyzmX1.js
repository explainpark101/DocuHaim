...
import { el as N, gc as Z, gd as Y, ge as ee, e5 as te, ff as re, gf as v, fd as ne, fe as se, __tla as __tla_1 } from "./index-BlCj9gGP.js";
  ...
  async function Se(e, t) {
    ...
    if (N()) {
      const { invoke: s } = await oe(async () => {
        const { invoke: i } = await import("./index-BlCj9gGP.js").then(async (m) => {
          await m.__tla;
          return m;
        }).then((c) => c.gt);
        return {
