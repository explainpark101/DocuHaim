import { r as a, $ as R } from "./vendor-react-kfkzeLNk.js";
function re(e, t) {
...
function oe(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? ne(Object(r), true).forEach(function(n) {
      be(e, n, r[n]);
...
function Ee(e, t) {
  if (e) {
    ...
    return r === "Object" && e.constructor && (r = e.constructor.name), r === "Map" || r === "Set" ? Array.from(e) : r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? re(e, t) : void 0;
  }
}
function Re(e, t, r) {
...
var xe = { initialIsRequired: "initial state is required", initialType: "initial state should be an object", initialContent: "initial state shouldn't be an empty object", handlerType: "handler should be an object or a function", handlersType: "all handlers should be a functions", selectorType: "selector should be a function", changeType: "provided value of changes should be an object", changeField: 'it seams you want to change a field in the state which is not specified in the "initial" state', default: "an unknown error accured in `state-local` package" }, P = $(Ve)(xe), q = { changes: Le, selector: $e, handler: Ae, initial: De };
function Ne(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  q.initial(e), q.handler(t);
  var r = { current: e }, n = $(Fe)(r, t), o = $(ze)(r), i = $(q.changes)(e), c = $(qe)(r);
  function s() {
...
function ze(e, t) {
  return e.current = ae(ae({}, e.current), t), t;
}
function Fe(e, t, r) {
...
function Ke(e) {
  return e || ue("configIsRequired"), Be(e) || ue("configType"), e.urls ? (Ge(), { paths: { vs: e.urls.monacoBase } }) : e;
}
function Ge() {
...
var ce = { configIsRequired: "the configuration object is required", configType: "the configuration object should be an object", default: "an unknown error accured in `@monaco-editor/loader` package", deprecation: `Deprecation warning!
  ...
  ` }, ue = We(Ye)(ce), _e = { config: Ke }, Je = function() {
...
var Xe = ["monaco"], Ze = Ue.create({ config: He, isInitialized: false, resolve: null, reject: null, monaco: null }), se = Me(Ze, 2), V = se[0], U = se[1];
function ke(e) {
  var t = _e.config(e), r = t.monaco, n = Oe(t, Xe);
  U(function(o) {
    return { config: le(o.config, n), monaco: r };
  });
}
function et() {
  var e = V(function(t) {
  ...
  if (!e.isInitialized) {
    ...
    if (window.monaco && window.monaco.editor) return fe(window.monaco), e.resolve(window.monaco), X(Z);
    Je(tt, nt)(ot);
  }
  return X(Z);
}
...
}), de = { config: ke, init: et, __getMonacoInstance: it }, at = { wrapper: { display: "flex", position: "relative", textAlign: "initial" }, fullWidth: { width: "100%" }, hide: { display: "none" } }, k = at, ut = { container: { display: "flex", height: "100%", width: "100%", justifyContent: "center", alignItems: "center" } }, ct = ut;
...
function dt({ width: e, height: t, isEditorReady: r, loading: n, _ref: o, className: i, wrapperProps: c }) {
  return R.createElement("section", { style: { ...k.wrapper, width: e, height: t }, ...c }, !r && R.createElement(ft, null, n), R.createElement("div", { ref: o, style: { ...k.fullWidth, ...!r && k.hide }, className: i }));
}
var pt = dt, pe = a.memo(pt);
function gt(e) {
  a.useEffect(e, []);
}
var ge = gt;
...
function bt({ original: e, modified: t, language: r, originalLanguage: n, modifiedLanguage: o, originalModelPath: i, modifiedModelPath: c, keepCurrentOriginalModel: s = false, keepCurrentModifiedModel: f = false, theme: p = "light", loading: j = "Loading...", options: O = {}, height: H = "100%", width: W = "100%", className: B, wrapperProps: K = {}, beforeMount: G = A, onMount: Y = A }) {
  ...
  return R.createElement(pe, { width: W, height: H, isEditorReady: y, loading: j, _ref: C, className: B, wrapperProps: K });
}
var yt = bt;
a.memo(yt);
function wt(e) {
...
var Ot = wt, z = /* @__PURE__ */ new Map();
function jt({ defaultValue: e, defaultLanguage: t, defaultPath: r, value: n, language: o, path: i, theme: c = "light", line: s, loading: f = "Loading...", options: p = {}, overrideServices: j = {}, saveViewState: O = true, keepCurrentModel: H = false, width: W = "100%", height: B = "100%", className: K, wrapperProps: G = {}, beforeMount: Y = A, onMount: y = A, onChange: I, onValidate: T = A }) {
  let [g, h] = a.useState(false), [d, C] = a.useState(true), m = a.useRef(null), u = a.useRef(null), S = a.useRef(null), x = a.useRef(y), N = a.useRef(Y), L = a.useRef(), l = a.useRef(n), v = Ot(i), ee = a.useRef(false), _ = a.useRef(false);
  ge(() => {
    let b = de.init();
    ...
    !u.current || n === void 0 || (u.current.getOption(m.current.editor.EditorOption.readOnly) ? u.current.setValue(n) : n !== u.current.getValue() && (_.current = true, u.current.executeEdits("", [{ range: u.current.getModel().getFullModelRange(), text: n, forceMoveMarkers: true }]), u.current.pushUndoStop(), _.current = false));
  }, [n], g), w(() => {
    var _a, _b;
  ...
  let te = a.useCallback(() => {
    var _a;
    if (!(!S.current || !m.current) && !ee.current) {
      N.current(m.current);
      let b = i || r, M = E(m.current, n || e || "", t || o || "", b || "");
      u.current = (_a = m.current) == null ? void 0 : _a.editor.create(S.current, { model: M, automaticLayout: true, ...p }, j), O && u.current.restoreViewState(z.get(b)), m.current.editor.setTheme(c), s !== void 0 && u.current.revealLine(s), h(true), ee.current = true;
    }
  ...
  function ve() {
    var _a, _b;
    (_a = L.current) == null ? void 0 : _a.dispose(), H ? O && z.set(i, u.current.saveViewState()) : (_b = u.current.getModel()) == null ? void 0 : _b.dispose(), u.current.dispose();
  }
  return R.createElement(pe, { width: W, height: B, isEditorReady: g, loading: f, _ref: S, className: K, wrapperProps: G });
}
var Mt = jt, Pt = a.memo(Mt), Et = Pt;
export {
  Et as F
};
