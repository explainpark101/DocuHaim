import{eD as p,eF as H}from"./index-Dnui2dvJ.js";function fe(e){if(p("collect:incoming",{hasData:!!e,filesLength:e?.files?.length??0,itemsLength:e?.items?.length??0}),!e)return p("collect:result",{count:0,reason:"no data"}),[];const r=[],t=new Set,n=i=>{if(!i||!i.size)return;const a=String(i.size);t.has(a)||(t.add(a),r.push(i))};if(e.files?.length)for(const i of e.files)i&&(i.type?.startsWith("image/")||!i.type&&i.size>0)&&n(i);if(e.items)for(const i of e.items){if(i.kind!=="file")continue;const a=i.type||"";if(a.startsWith("image/")||a===""){const s=i.getAsFile();s&&n(s)}}return p("collect:result",{count:r.length,files:H(r)}),r}function $(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e}function v(e,r){return Array(r+1).join(e)}function b(e){return e.replace(/^\n*/,"")}function S(e){for(var r=e.length;r>0&&e[r-1]===`
