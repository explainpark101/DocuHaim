import { r as a, b as R } from "./vendor-react-SY5QCjFA.js";
function re(e, t) {
...
function bt({ original: e, modified: t, language: r, originalLanguage: n, modifiedLanguage: o, originalModelPath: i, modifiedModelPath: c, keepCurrentOriginalModel: s = false, keepCurrentModifiedModel: f = false, theme: p = "light", loading: j = "Loading...", options: O = {}, height: H = "100%", width: W = "100%", className: B, wrapperProps: K = {}, beforeMount: G = $, onMount: Y = $ }) {
...
function jt({ defaultValue: e, defaultLanguage: t, defaultPath: r, value: n, language: o, path: i, theme: c = "light", line: s, loading: f = "Loading...", options: p = {}, overrideServices: j = {}, saveViewState: O = true, keepCurrentModel: H = false, width: W = "100%", height: B = "100%", className: K, wrapperProps: G = {}, beforeMount: Y = $, onMount: y = $, onChange: I, onValidate: T = $ }) {
