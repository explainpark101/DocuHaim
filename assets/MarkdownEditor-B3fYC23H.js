...
import { r as i, j as o, u as qo, a as Xo, c as Js } from "./vendor-react-kfkzeLNk.js";
import { B as Qs, D as wr, S as Yo, l as _t, F as Go, G as Rr, W as ea, H as Zo, J as zt, M as mt, O as Jo, j as yr, V as Qo, P as es, m as Ke, Q as ta, R as na, T as ra, U as oa, X as sa, Y as Rn, Z as Tr, $ as aa, a0 as ia, c as la, a1 as ca, a2 as ts, v as ua, a3 as da, a4 as fa, K as ma, a5 as pa, a6 as ha, a7 as ga, a8 as xa, a9 as ba, aa as wa, ab as ya, ac as va, ad as ka, ae as Ea, af as Sa, ag as Ca, ah as Na, ai as Ma, aj as ja, ak as La, al as Ra, am as Ta, an as Pa, ao as Aa } from "./vendor-md-editor-DQ2k84v8.js";
import { i as yt, j as or, k as Da, l as Ia, a as _a, s as $a, m as Fa, o as Rt, h as Ha, P as Oa, H as Ba, p as Tn, q as Pr, t as Ar, v as Dr, x as za, y as Ir, z as rt, A as Pn, B as An } from "./previewFootnoteScroll-BF_sV4cs.js";
import { f as Ka, dH as ns, dI as yn, dJ as Ve, dK as rs, ao as Va, I as Wa, aW as _r, dL as Ua, dM as $r, aY as Dn, aZ as qa, a6 as Fr, a7 as Hr, N as Xa, a4 as Or, dN as Ya, dO as Ga, dP as Za, ad as os, ae as ss, dQ as Br, dR as Ja, M as Kt, aa as Qa, dS as zr, j as Kr, dT as ei, dU as ti, dV as ni, dW as Vr, dX as as, dY as ri, dZ as oi, d_ as si, d$ as ai, e0 as ii, e1 as is, ap as pn, cz as ls, aC as li, aw as ci, e2 as ui, c as di, e3 as Wr, e4 as fi, e5 as mi, r as pi, y as In, e6 as hi, x as _n, e7 as gi, g as $n, m as xi, cG as cs, d8 as sr, aE as bi, aA as hn, e8 as Ur, aD as wi, e9 as yi, ea as vi, eb as ki, d9 as Ei, ec as Si, ed as ar, aq as Ci, d0 as vr, Y as kr, ee as Ni, ef as Mi, eg as ji, dc as Li, ck as Ri, dD as Ti, d5 as us, da as Pi, dq as Ai, eh as ds, ei as Di, ej as Ii, ek as qr, el as _i, em as $i, u as Fi, dm as Hi, dC as rn, bA as Xr, ah as Fn, dv as Hn, ai as Oi, dw as Yr, dx as Bi, aj as zi, ak as Ki, _ as Vi, al as Wi, af as Ui, ag as qi, T as Xi, O as Yi, en as Gi, dF as Zi, an as Ji, dG as Qi, eo as el, ep as tl, eq as nl, er as rl, bt as ol } from "./index-siMg0SyX.js";
import { g as sl, i as al, a as il } from "./OpenAiCompatibleModelSelect-DtPJ-zKB.js";
import { T as ll, c as cl } from "./clipboardImageFiles-D4Co0yQW.js";
import { u as ul, p as On, L as Tt, a as dl, i as fl, g as ml, b as pl, c as hl } from "./LlmAssistPanel-CwRcer61.js";
import { L as gl, n as xl } from "./llmAssistImages-Ca7ILDRO.js";
import { S as ir, az as fs, aA as bl, aB as wl, X as Vt, aC as yl, aD as Gr, aE as Bn, al as zn, aF as vl, V as kl, aG as Er, aH as El, N as ms, R as Sl, x as Cl, aI as Nl, aJ as Ml, k as vn, aK as jl, aL as Ll, aM as ps, aN as Rl, z as Tl, aO as gn, ao as Pl, ap as Al, ax as Zr, aP as Kn, aQ as Jr, aR as Dl, ai as Il, l as _l, aS as Qr, aT as $l, aU as Fl, aV as Hl, aW as Ol, K as vt, G as Bl, L as zl } from "./vendor-lucide-B9iB2q4-.js";
import { d as hs, s as Vn, t as Wn, E as Kl, G as Vl, H as Wl, I as Ul, J as ql, K as Xl, M as Yl, N as Gl, Q as Zl, U as Jl, S as Sr, b as Cr, e as lr, T as cr, f as ur, g as dr, A as fr, l as Ql, F as ot, L as ut, m as on, W as ec, X as tc, Y as nc, V as rc, $ as eo, a0 as oc, a1 as sc, a2 as ac, a3 as ic, a4 as to } from "./vendor-radix-CyZ5tkEq.js";
import { M as lc } from "./MdEditorToolbarTooltips-SJea2KfE.js";
import { N as cc, u as uc, W as dc } from "./useTocTitleWrap-DUvKhzjh.js";
import { u as fc, M as mc } from "./useLazyMermaidRender-0X9iJIqW.js";
import { H as Un, T as pc } from "./TableStyleTemplateEditor-CwJ9BQO5.js";
import { a as kn } from "./vendor-motion-9P87yVtW.js";
import { u as hc } from "./useWikiImageHydration-DtUlEuCQ.js";
import "./vendor-aws-DjU81Y0s.js";
import "./vendor-zip-Bez6qchM.js";
import "./vendor-google-genai-BXoTgYIl.js";
import "./vendor-image-crop-BfNSF_Kw.js";
import "./storageImageHydration-CaMD9OgW.js";
...
function kc(e, t) {
  ...
  for (const r of e) {
    if (r.r > t) {
      const a = kt({ ...r, r: r.r - 1 });
      a && n.push(a);
      continue;
    }
    if (r.r === t) {
      if (r.rowspan <= 1) continue;
      const a = kt({ ...r, rowspan: r.rowspan - 1 });
      a && n.push(a);
      continue;
    }
...
function Ec(e, t) {
  ...
  for (const r of e) {
    if (r.c > t) {
      const a = kt({ ...r, c: r.c - 1 });
      a && n.push(a);
      continue;
    }
    if (r.c === t) {
      if (r.colspan <= 1) continue;
      const a = kt({ ...r, colspan: r.colspan - 1 });
      a && n.push(a);
      continue;
    }
...
function Sc(e, t, n) {
  ...
  const a = e.rows.map((u) => [...u]), s = { ...t.cells }, l = n + 1;
  for (const u of r) {
    const p = a[n], m = a[l];
    if (!p || !m) continue;
    ...
    const h = p[u.c] ?? "";
    h && (m[u.c] = h, p[u.c] = "");
    const T = Ve(n, u.c), C = Ve(l, u.c), P = s[T];
    P && (s[C] = { ...P }, delete s[T]);
  }
...
function Cc(e, t, n) {
  ...
  if (r.length === 0) return { grid: e, meta: t };
  const a = e.rows.map((l) => [...l]), s = { ...t.cells };
  for (const l of r) {
    const u = a[l.r];
    if (!u) continue;
    ...
    const p = u[l.c] ?? "";
    p && (u[l.c + 1] = p, u[l.c] = "");
    const m = Ve(l.r, n), h = Ve(l.r, n + 1), T = s[m];
    T && (s[h] = { ...T }, delete s[m]);
  }
  return { grid: { rows: a, aligns: [...e.aligns] }, meta: { ...t, cells: s } };
}
function Nc(e, t, n) {
  const r = Math.max(1, ...e.rows.map((h) => h.length), e.aligns.length, 1), a = e.rows.length, s = Math.max(0, Math.min(n, a)), l = Array.from({ length: r }, () => ""), u = [...e.rows.slice(0, s), l, ...e.rows.slice(s)];
...
function Mc(e, t, n) {
  ...
  return l.splice(a, 0, null), { grid: { rows: s, aligns: l }, meta: (() => {
    var _a2;
    const u = { ...t, merges: vc(t.merges, a), cells: xc(t.cells, a) };
    if ((_a2 = t.colWidths) == null ? void 0 : _a2.length) {
      const p = ns(t.colWidths, a);
      p && (u.colWidths = p);
    }
    return u;
  })() };
...
function jc(e, t, n) {
  ...
  const a = Sc(e, t, n), s = [...a.grid.rows.slice(0, n), ...a.grid.rows.slice(n + 1)];
  let l = a.meta.headerRows, u = a.meta.footerRows;
  n < l ? l = Math.max(0, l - 1) : u > 0 && n >= r - u && (u = Math.max(0, u - 1));
  const p = s.length;
  l + u > p && (u = Math.max(0, p - l));
  const m = { ...a.meta, headerRows: l, footerRows: u, merges: kc(a.meta.merges, n), cells: bc(a.meta.cells, n) };
  if ((_a2 = a.meta.rowHeights) == null ? void 0 : _a2.length) {
    const h = rs(a.meta.rowHeights, n);
...
function Lc(e, t, n) {
  ...
  if (r <= 1) return { grid: e, meta: t };
  if (n < 0 || n >= r) return { grid: e, meta: t };
  const a = Cc(e, t, n), s = a.grid.rows.map((p) => {
    const m = [...p];
  ...
  for (; l.length < r; ) l.push(null);
  l.splice(n, 1);
  const u = { ...a.meta, merges: Ec(a.meta.merges, n), cells: wc(a.meta.cells, n) };
  if ((_a2 = a.meta.colWidths) == null ? void 0 : _a2.length) {
    const p = rs(a.meta.colWidths, n);
...
function Dc(e) {
  const t = `${e}-h`;
  return (n, r, a) => {
    const s = Number.isInteger(a) ? a : 0, l = typeof n == "object" && n !== null ? Number(n.index) : NaN, u = Number.isInteger(l) ? l : s;
    return `${t}-${u}`;
  };
}
...
function Hc(e, t) {
  const n = (r) => {
    ...
    const C = h.previousElementSibling ? 0 : Number.parseFloat(getComputedStyle(h).marginBlockStart || "0") || 0, P = $c(h, T) - _c - C;
    T.scrollTo({ top: Math.max(0, P), behavior: "smooth" });
  };
...
function Xn(e) {
  const t = window.innerWidth || 1, n = window.innerHeight || 1, r = Kc(), a = Math.min(Oc, Math.max(mr, e.width - 16)), s = Math.min(zc + Bc, Math.max(pr, e.height - 16)), l = { leftPx: r.leftVw / 100 * t, topPx: r.topVh / 100 * n, widthPx: a, heightPx: s };
  return ft(l, e);
}
function ft(e, t) {
  const n = Math.max(mr, t.width), r = Math.max(pr, t.height), a = Math.min(n, Math.max(mr, e.widthPx)), s = Math.min(r, Math.max(pr, e.heightPx)), l = t.right - a, u = t.bottom - s, p = Math.min(Math.max(t.left, e.leftPx), Math.max(t.left, l)), m = Math.min(Math.max(t.top, e.topPx), Math.max(t.top, u));
  return { leftPx: Math.round(p), topPx: Math.round(m), widthPx: Math.round(a), heightPx: Math.round(s) };
}
function Vc(e) {
...
function oo(e) {
  ...
  if (!r) return n;
  const a = r.getBoundingClientRect(), l = (_a2 = r.querySelector(".md-editor-toolbar-wrapper") || r.querySelector(".md-editor-toolbar")) == null ? void 0 : _a2.getBoundingClientRect(), u = l ? l.bottom : a.top, p = a.bottom, m = a.left, h = a.right;
  return { left: m, top: u, right: h, bottom: p, width: Math.max(0, h - m), height: Math.max(0, p - u) };
}
const so = 5, ao = "llm-assist-modal-resize-cursor-style", xn = "llm-assist-modal-corner-resize";
function Xc() {
...
function Jc(e, { enabled: t = true } = {}) {
  const n = i.useRef(oo(e)), [r, a] = i.useState(() => Vc(n.current)), s = i.useRef(null), l = i.useRef({ active: false, startX: 0, startY: 0, startLayout: r }), u = i.useRef(null), p = i.useCallback(() => {
    n.current = oo(e), a((A) => ft(A, n.current));
  }, [e]);
  i.useEffect(() => {
    var _a2, _b, _c2;
    if (!t) return;
  ...
  const m = i.useCallback((A) => {
    ...
    a(ft({ ...O.startLayout, leftPx: O.startLayout.leftPx + q, topPx: O.startLayout.topPx + b }, n.current));
  }, []), T = i.useCallback((A, { onTap: I } = {}) => {
    ...
    const R = (E) => {
      ...
      l.current.active && (l.current.active = false, document.removeEventListener("pointermove", R), document.removeEventListener("pointerup", X), a((E) => m(E)), b || (I == null ? void 0 : I()));
    };
    document.addEventListener("pointermove", R), document.addEventListener("pointerup", X);
  }, [h, r, m]), C = i.useCallback((A, { onTap: I } = {}) => {
    const O = A.changedTouches;
    if (!(O == null ? void 0 : O.length)) return;
    const q = O[0];
    if (!q) return;
    const b = q.identifier, R = q.clientX, X = q.clientY;
    A.preventDefault();
    let E = false;
    l.current = { active: true, startX: R, startY: X, startLayout: r, touchIdentifier: b };
    const D = (Q) => {
      if (!l.current.active) return;
      const re = Array.from(Q.touches).find((ie) => ie.identifier === b);
      re && (Math.hypot(re.clientX - R, re.clientY - X) > so && (E = true), h(re.clientX, re.clientY), Q.preventDefault());
    }, K = () => {
      l.current.active && (l.current.active = false, document.removeEventListener("touchmove", D), document.removeEventListener("touchend", J), document.removeEventListener("touchcancel", J), a((Q) => m(Q)), E || (I == null ? void 0 : I()));
    }, J = (Q) => {
      !l.current.active || !Array.from(Q.changedTouches).some((ie) => ie.identifier === b) || K();
    };
  ...
  }, [h, r, m]), P = i.useCallback((A, I) => {
    const O = u.current;
    if (!O) return;
    const q = A - O.startX, b = I - O.startY, R = O.startLayout;
    let X;
    O.corner === "se" ? X = { leftPx: R.leftPx, topPx: R.topPx, widthPx: R.widthPx + q, heightPx: R.heightPx + b } : X = { leftPx: R.leftPx + q, topPx: R.topPx, widthPx: R.widthPx - q, heightPx: R.heightPx + b }, a(ft(X, n.current));
  }, []), S = i.useCallback((A, I) => {
    ...
    const q = () => {
      u.current = null, Zc(), document.removeEventListener("pointermove", b), document.removeEventListener("pointerup", R), document.removeEventListener("pointercancel", R);
    }, b = (X) => {
      X.preventDefault(), P(X.clientX, X.clientY);
    }, R = () => {
      u.current && (q(), a((X) => m(X)));
    };
    document.addEventListener("pointermove", b, { passive: false }), document.addEventListener("pointerup", R), document.addEventListener("pointercancel", R);
  }, [P, r, m]), M = { left: r.leftPx, top: r.topPx, width: r.widthPx, height: r.heightPx };
  return { layout: r, panelRef: s, panelStyle: M, startPositionDrag: T, startPositionTouchDrag: C, startCornerResize: S, refreshBounds: p };
}
...
Sn.addRule("wikiImageData", { filter: (e) => {
  ...
  const n = t;
  return Va({ path: n.getAttribute("data-wiki-path"), width: n.getAttribute("data-wiki-width"), height: n.getAttribute("data-wiki-height"), background: n.getAttribute("data-wiki-bg") });
} });
...
function It(e) {
  const t = _e;
  if (!t) return;
  const r = `${su(t.block, t.snapshotBody)}${t.trailing}`, { from: a, to: s } = t, l = e.state.doc.sliceString(a, s);
  if (r === l) {
    $t(true);
    return;
  }
  $t(false), e.dispatch({ changes: { from: a, to: s, insert: r }, selection: { anchor: a + r.length } });
}
function io(e, t, n) {
  var _a2;
...
function bs(e, t, n, r, a) {
  if (_e) {
    if (_e.block === e) return io(e, r, a), true;
    It(t);
  }
  const s = Number(e.getAttribute("data-line"));
  if (!Number.isFinite(s)) return false;
  const { from: l, to: u } = Da(t, n, s, s), p = t.state.doc.sliceString(l, u);
  if (!p && l === u) return false;
  const { body: m, trailing: h } = eu(p), T = e.innerHTML;
  ...
  return e.addEventListener("keydown", C), e.addEventListener("paste", P), e.addEventListener("blur", S), _e = { block: e, snapshotHtml: T, snapshotBody: m, from: l, to: u, trailing: h, cleanup: () => {
    e.removeEventListener("keydown", C), e.removeEventListener("paste", P), e.removeEventListener("blur", S);
...
function au(e, t) {
  const n = (r) => {
    ...
    const s = or(r.target, a);
    if (!s) return;
    const l = t.getView();
    l && (r.preventDefault(), r.stopPropagation(), bs(s, l, a, r.clientX, r.clientY));
  };
...
function fu(e, { view: t = null, from: n = 0, to: r = 0 } = {}) {
  const a = t ?? Ft(e).view, s = du(e, a);
  return !!(fn(s) || !(a == null ? void 0 : a.state) || !a.hasFocus && n === r);
}
function mu(e, t) {
  return e ? e.endsWith(`
`) ? t : `
...
function hu({ editorRef: e, from: t, to: n, result: r, onChange: a, getMarkdown: s }) {
  var _a2, _b, _c2;
  const { view: l } = Ft(e);
  if (fu(e, { view: l, from: t, to: n })) {
    ...
    return typeof a == "function" ? (a(pu(p, r)), true) : false;
  }
  return hr(l, t, n, r, a);
}
function Ft(e) {
...
function gu({ editorRef: e, onChange: t, getMarkdown: n, llmProviderProfiles: r = [], open: a, onOpenChange: s, theme: l = "light" }) {
  const u = Array.isArray(r) ? r : [], [p, m] = i.useState(() => Uc()), [h, T] = i.useState(false), [C, P] = i.useState(""), [S, M] = i.useState({ from: 0, to: 0 }), [A, I] = i.useState([]), [O, q] = i.useState(""), [b, R] = i.useState(""), [X, E] = i.useState("text"), [D, K] = i.useState(false), [J, Q] = i.useState(""), [re, ie] = i.useState([]), [le, we] = i.useState(""), [te, W] = i.useState(""), [ee, pe] = i.useState(null), [Se, We, $e] = ul(u), ae = Wa(u, Se), [ue, Ce] = i.useState(() => ae ? _r(ae.id, ae.kind) : ""), de = i.useRef(null), { panelRef: Fe, panelStyle: z, startPositionDrag: B, startPositionTouchDrag: ne, startCornerResize: Z, refreshBounds: Ee } = Jc(e, { enabled: a }), he = i.useCallback(() => ({ selectedText: C, selectionRange: S, attachedImages: A, instruction: O, result: b, resultViewMode: X, loading: D, error: J, templates: re, selectedTemplateId: le, templateName: te, editingTemplateId: ee, profiles: u.map((j) => ({ id: j.id, name: j.name, kind: j.kind, baseUrl: j.baseUrl })), selectedProfileId: Se, model: ue, theme: l }), [C, S, A, O, b, X, D, J, re, le, te, ee, u, Se, ue, l]), ye = i.useCallback(() => {
    const j = de.current;
    !j || j.closed || On(j, Tt.SYNC, { state: he() });
  }, [he]), Ae = i.useCallback(() => {
    const j = de.current;
    if (j && !j.closed) try {
      j.close();
    ...
    de.current = null, T(false);
  }, []), fe = i.useCallback(() => {
    const { text: j, from: $, to: Y } = Ft(e);
    return P(j), M({ from: $, to: Y }), j;
  }, [e]), ge = i.useCallback(async () => {
    const j = await Ua();
    return ie(j), j;
  }, []);
  i.useEffect(() => {
    a && (m(false), Yn(false), Ee(), $e(), fe(), ge(), Q(""));
  }, [a, Ee, fe, ge, $e]), i.useEffect(() => {
    if (!(ae == null ? void 0 : ae.id) || !(ae == null ? void 0 : ae.kind)) {
      Ce("");
      return;
    }
    Ce(_r(ae.id, ae.kind));
  }, [ae == null ? void 0 : ae.id, ae == null ? void 0 : ae.kind]), i.useEffect(() => {
    const j = () => {
      we(""), pe(null), ge();
    };
  ...
  }, [a, p, h, fe]), i.useEffect(() => {
    ye();
  }, [ye]), i.useEffect(() => {
    if (!h) return;
    const j = setInterval(() => {
      const $ = de.current;
      (!$ || $.closed) && (de.current = null, T(false));
    }, 400);
  ...
  const me = i.useCallback((j) => {
    const $ = String(j || "").trim();
    Ce($), ae && (Dn(ae.id, $), ae.kind === qa ? Fr($) : Hr($));
  }, [ae]), De = i.useCallback(async () => {
    Q(""), K(true);
    try {
      const j = fe();
      if (!ae) throw new Error("\uC124\uC815\uC5D0\uC11C AI \uC81C\uACF5\uC790\uB97C \uCD94\uAC00\uD55C \uB4A4 \uC120\uD0DD\uD558\uC138\uC694.");
      if (ae.kind === Xa) {
        const Y = (ae.baseUrl || "").trim();
        if (!Y) throw new Error("\uC120\uD0DD\uD55C \uC81C\uACF5\uC790\uC758 Endpoint URL\uC774 \uC5C6\uC2B5\uB2C8\uB2E4. \uC124\uC815\uC5D0\uC11C \uC218\uC815\uD558\uC138\uC694.");
        Dn(ae.id, ue), Hr(ue);
        const et = await Or(ae.id, () => ae.apiKey || "", (at) => sl({ baseUrl: Y, apiKey: at, model: ue, instruction: O, selectedText: j, images: A }), { allowEmpty: true, missingKeyMessage: "OpenAI \uD638\uD658 API \uD0A4\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4. \uC124\uC815\uC5D0\uC11C \uC785\uB825\uD558\uC138\uC694." });
        R(et);
        return;
      }
      if (al(ue)) throw new Error(`\uC120\uD0DD\uD55C \uBAA8\uB378\uC740 \uBB34\uB8CC \uD50C\uB79C\uC5D0\uC11C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.
Gemini 2.0 Flash \uB610\uB294 Gemini 2.5 Flash\uB85C \uBCC0\uACBD\uD574 \uC8FC\uC138\uC694.`);
      Dn(ae.id, ue), Fr(ue);
      const $ = await Or(ae.id, () => ae.apiKey || "", (Y) => il({ apiKey: Y, model: ue, instruction: O, selectedText: j, images: A }), { missingKeyMessage: "Google AI Studio API \uD0A4\uAC00 \uC124\uC815\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4. \uC124\uC815 \uD398\uC774\uC9C0\uC5D0\uC11C \uC785\uB825\uD558\uC138\uC694." });
      R($);
    } catch (j) {
    ...
    fe();
  }, [b, e, S, t, n, fe]), He = i.useCallback((j) => {
    we(j);
    const $ = re.find((Y) => Y.id === j);
    $ && (q($.instruction), W($.name), pe($.id));
  }, [re]), Oe = i.useCallback(async () => {
    ...
    try {
      const Y = await Ya({ id: ee || Ga().id, name: j, instruction: $, updatedAt: Date.now() });
      pe(Y.id), we(Y.id), await ge();
    } catch (Y) {
      alert((Y == null ? void 0 : Y.message) || "\uD15C\uD50C\uB9BF \uC800\uC7A5\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.");
    }
  }, [te, O, ee, ge]), xe = i.useCallback(() => {
    pe(null), we(""), W(""), q("");
  }, []), Be = i.useCallback(async () => {
    if (ee && window.confirm("\uC774 \uC9C0\uC2DC\uC0AC\uD56D \uD15C\uD50C\uB9BF\uC744 \uC0AD\uC81C\uD560\uAE4C\uC694?")) try {
      await Za(ee), xe(), await ge();
    } catch (j) {
      alert((j == null ? void 0 : j.message) || "\uD15C\uD50C\uB9BF \uC0AD\uC81C\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.");
    }
  }, [ee, xe, ge]), Ge = i.useCallback(async (j) => {
  ...
  i.useEffect(() => {
    ...
    const j = ($) => {
      if ($.origin === window.location.origin && fl($.data)) {
        if ($.data.type === Tt.READY) {
          $.source && typeof $.source.postMessage == "function" && (de.current = $.source, T(true), On($.source, Tt.SYNC, { state: he() }));
          return;
        }
        $.data.type === Tt.ACTION && Ue($.data.action, $.data.payload);
      }
    };
  ...
  const st = () => {
    ...
    de.current = j, T(true);
  }, Ne = { theme: l, profiles: u, selectedProfileId: Se, onSelectedProfileIdChange: We, selectedProfile: ae, model: ue, onModelChange: me, selectedText: C, onRefreshSelection: fe, attachedImages: A, onAddImages: Ge, onRemoveImage: Le, instruction: O, onInstructionChange: q, result: b, onResultChange: R, resultViewMode: X, onResultViewModeChange: E, loading: D, error: J, templates: re, selectedTemplateId: le, onLoadTemplate: He, templateName: te, onTemplateNameChange: W, editingTemplateId: ee, onSaveTemplate: Oe, onNewTemplate: xe, onDeleteTemplate: Be, onRun: De, onApplyResult: je };
  if (!a) return null;
  if (p || h) {
...
`), n = [];
  ...
  t.forEach((u, p) => {
    ...
    if (h) {
      const T = Math.floor(h[1].length / 2), C = h[3].toLowerCase() === "x", P = h[4].trim();
      a += 1, C && (s += 1), r.tasks.push({ id: `line-${p}`, lineIndex: p, indent: T, completed: C, text: P, rawLine: u });
    }
  }), r.tasks.length > 0 && n.push(r);
  const l = a > 0 ? Math.round(s / a * 100) : 0;
  return { categories: n, totalTasks: a, completedTasks: s, pendingTasks: a - s, percentage: l };
}
function wu(e, t) {
...
function yu({ markdown: e = "", onMarkdownChange: t }) {
  const [n, r] = i.useState(""), [a, s] = i.useState("all"), [l, u] = i.useState({}), [p, m] = i.useState("dashboard"), h = i.useMemo(() => bu(e), [e]);
  i.useEffect(() => {
    const S = {};
...
function Su({ editorRef: e, onChange: t, open: n, onOpenChange: r }) {
  const [a, s] = i.useState(() => vu()), [l, u] = i.useState(""), [p, m] = i.useState({ from: 0, to: 0 }), h = i.useRef({ active: false, startX: 0, startY: 0, startLeftVw: 0, startTopVh: 0 }), T = i.useCallback(() => {
  ...
  const C = i.useCallback((M) => {
    ...
    h.current = { active: true, startX: A, startY: I, startLeftVw: a.leftVw, startTopVh: a.topVh };
    const O = (b) => {
      if (!h.current.active) return;
      Math.hypot(b.clientX - A, b.clientY - I) <= Eu;
      const R = window.innerWidth || 1, X = window.innerHeight || 1, E = (b.clientX - h.current.startX) / R * 100, D = (b.clientY - h.current.startY) / X * 100;
  ...
  }, [a.leftVw, a.topVh]), P = i.useCallback((M) => {
    u(M);
  ...
  return !n || co() ? null : o.jsxs("div", { className: "fixed z-[10050] w-[min(92vw,440px)] rounded-lg border border-indigo-400/40 bg-slate-950/95 shadow-2xl backdrop-blur-md", style: { left: `${a.leftVw}vw`, top: `${a.topVh}vh` }, role: "dialog", "aria-modal": "false", "aria-label": "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8 \uC9C4\uD589\uB960", children: [o.jsxs("div", { className: "flex cursor-grab items-center justify-between gap-2 border-b border-indigo-500/30 bg-indigo-950/50 px-3 py-2 active:cursor-grabbing", onPointerDown: C, children: [o.jsxs("div", { className: "flex min-w-0 items-center gap-2 text-sm font-semibold text-indigo-100", children: [o.jsx(fs, { size: 16, className: "shrink-0 opacity-60", "aria-hidden": true }), o.jsx(Er, { size: 16, className: "shrink-0", "aria-hidden": true }), o.jsx("span", { className: "truncate", children: "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8 \uC9C4\uD589\uB960" })] }), o.jsxs("div", { className: "flex shrink-0 items-center gap-1", children: [o.jsxs("button", { type: "button", onPointerDown: (M) => M.stopPropagation(), onClick: T, className: "inline-flex items-center gap-1 rounded px-1.5 py-1 text-[11px] text-indigo-200 hover:bg-indigo-900/50", title: "\uC120\uD0DD \uC601\uC5ED \uC0C8\uB85C\uACE0\uCE68", "aria-label": "\uC120\uD0DD \uC601\uC5ED \uC0C8\uB85C\uACE0\uCE68", children: [o.jsx(Sl, { size: 14 }), o.jsx("span", { className: "hidden sm:inline", children: "\uC0C8\uB85C\uACE0\uCE68" })] }), o.jsx("button", { type: "button", onPointerDown: (M) => M.stopPropagation(), onClick: S, className: "rounded p-1 text-indigo-200 hover:bg-indigo-900/50", title: "\uB2EB\uAE30", "aria-label": "\uB2EB\uAE30", children: o.jsx(Vt, { size: 15 }) })] })] }), o.jsx("div", { className: "max-h-[min(72vh,640px)] overflow-y-auto p-3", children: l.trim() ? o.jsx(yu, { markdown: l, onMarkdownChange: P }) : o.jsxs("p", { className: "rounded-lg border border-dashed border-slate-700 bg-slate-900/60 px-3 py-6 text-center text-xs text-slate-400", children: ["\uC5D0\uB514\uD130\uC5D0\uC11C \uCCB4\uD06C\uB9AC\uC2A4\uD2B8\uAC00 \uD3EC\uD568\uB41C \uD14D\uC2A4\uD2B8\uB97C \uC120\uD0DD\uD55C \uB4A4", o.jsx("br", {}), "\uD234\uBC14 \uBC84\uD2BC\uC744 \uB204\uB974\uAC70\uB098 \uC0C8\uB85C\uACE0\uCE68\uD558\uC138\uC694."] }) })] });
}
...
function ju({ value: e = "", theme: t = "light", currentFile: n = null, disabled: r, trigger: a }) {
  const s = qo(), l = i.useCallback(() => {
    r || (os({ currentFile: n, editorContent: e }), s(ss(n == null ? void 0 : n.id), { state: { value: e, theme: t, currentFile: n } }));
  }, [s, e, t, r, n]);
  return o.jsx("button", { type: "button", className: "md-editor-toolbar-item", onClick: l, disabled: r, title: "PDF\uB85C \uB0B4\uBCF4\uB0B4\uAE30", "aria-label": "PDF\uB85C \uB0B4\uBCF4\uB0B4\uAE30", children: a ?? o.jsx(Cl, { className: "md-editor-icon", size: 16 }) });
}
...
function _u({ isOpen: e, markdown: t, selectedMarkdown: n = "", onClose: r, onApply: a }) {
  ...
  i.useEffect(() => {
    ...
    const X = (E) => {
      ...
      E.key === "Escape" || E.key === "Enter" || b(E.target) && (E.preventDefault(), E.stopPropagation(), E.stopImmediatePropagation(), R());
    };
    return window.addEventListener("keydown", X, true), () => window.removeEventListener("keydown", X, true);
  }, [e]);
  const I = i.useMemo(() => Ja(A, p, { maxLevel: Vr, renumberOutline: h, outlineStyle: C, outlineStart: S }), [A, p, h, C, S]), O = (b) => {
    if (b !== "selection" && b !== "document" || b === "selection" && !s) return;
    u(b), m(Br(b === "selection" ? n : t));
  }, q = () => {
    if (!I.sourceMax) return;
    const b = ni(A, p, { maxLevel: Vr, renumberOutline: h, outlineStyle: C, outlineStart: S });
    b !== A && a(b, l), r();
  };
  return o.jsx(Kt, { isOpen: e, onClose: r, onConfirm: q, contentClassName: "max-w-3xl", children: o.jsx(hs, { delayDuration: 250, skipDelayDuration: 0, children: o.jsxs("div", { className: "flex min-h-0 flex-1 flex-col p-6", children: [o.jsx("h2", { className: "text-lg font-bold text-gray-800 dark:text-odp-fgStrong", children: "\uCD5C\uB300 heading \uBCC0\uACBD" }), o.jsxs("p", { className: "mt-1 text-sm text-gray-500 dark:text-odp-muted", children: ["\uAC10\uC9C0\uB41C \uCD5C\uB300 heading\uC744 \uC120\uD0DD\uD55C \uB2E8\uACC4\uB85C \uBC14\uAFB8\uACE0, \uD558\uC704 heading\uB3C4 \uAC19\uC740 \uAC04\uACA9\uC73C\uB85C \uC774\uB3D9\uD569\uB2C8\uB2E4.", " ", "\uC22B\uC790 \uD0A4 1\u20139\uB85C \uCD5C\uB300 heading\uC744 \uBC14\uAFC0 \uC218 \uC788\uC2B5\uB2C8\uB2E4."] }), o.jsxs("div", { className: "mt-4", children: [o.jsx("div", { className: "mb-2 text-xs font-medium text-gray-500 dark:text-odp-muted", children: "\uC801\uC6A9 \uBC94\uC704" }), o.jsx(Vn, { className: "flex items-center gap-2", value: l, onValueChange: O, "aria-label": "\uCD5C\uB300 heading \uC801\uC6A9 \uBC94\uC704", children: Tu.map((b) => {
    const R = l === b.value, X = b.value === "selection" && !s;
    return o.jsx(Wn, { value: b.value, disabled: X, className: ["flex-1 rounded-lg border-2 px-3 py-2.5 text-left outline-none transition-all duration-200", "focus-visible:ring-2 focus-visible:ring-blue-500/40", "disabled:cursor-not-allowed disabled:opacity-40", R ? "scale-100 border-blue-600 bg-blue-50 shadow-sm dark:border-blue-400 dark:bg-blue-950/30" : "scale-[0.92] border-gray-400 hover:border-gray-500 dark:border-odp-borderStrong dark:hover:border-gray-400"].join(" "), children: o.jsxs("div", { className: R ? "" : "opacity-50", children: [o.jsx("div", { className: "font-medium text-sm text-gray-800 dark:text-odp-fgStrong", children: b.title }), o.jsx("div", { className: "mt-0.5 text-[11px] leading-snug text-gray-500 dark:text-odp-muted", children: b.value === "selection" && !s ? "\uC120\uD0DD\uB41C \uD14D\uC2A4\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4" : b.description })] }) }, b.value);
    ...
    const R = Number(b);
    zr(R) && m(R);
  }, children: [o.jsxs(Vl, { id: "editor-heading-max", "aria-label": "\uCD5C\uB300 heading", className: "inline-flex w-full items-center justify-between gap-2 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-800 outline-none focus-visible:ring-2 focus-visible:ring-blue-400 dark:border-odp-borderStrong dark:bg-odp-surface dark:text-odp-fgStrong", children: [o.jsx(Wl, {}), o.jsx(Ul, { className: "text-gray-500", children: o.jsx(ms, { size: 14 }) })] }), o.jsx(ql, { children: o.jsx(Xl, { className: "z-100010 max-h-60 min-w-(--radix-select-trigger-width) overflow-hidden rounded-md border border-gray-200 bg-white shadow-lg dark:border-odp-borderStrong dark:bg-odp-bgSoft", position: "popper", sideOffset: 4, children: o.jsx(Yl, { className: "p-1", children: Qa.map((b) => o.jsxs(Gl, { value: String(b), className: "relative flex cursor-pointer select-none items-center rounded-sm py-1.5 pl-7 pr-3 text-sm text-gray-800 outline-none data-highlighted:bg-gray-100 dark:text-odp-fg dark:data-highlighted:bg-odp-focusBg", children: [o.jsx(Zl, { className: "absolute left-1.5 inline-flex items-center", children: o.jsx(vn, { size: 12 }) }), o.jsx(Jl, { children: `h${b}` })] }, b)) }) }) })] })] }), o.jsxs("div", { className: "mt-4 rounded-lg border border-gray-200 p-3 dark:border-odp-borderSoft", children: [o.jsxs("div", { className: "flex items-center justify-between gap-3", children: [o.jsxs("div", { className: "min-w-0", children: [o.jsx("div", { className: "text-sm font-medium text-gray-800 dark:text-odp-fgStrong", children: "outline \uBC88\uD638 \uB9DE\uCD94\uAE30" }), o.jsx("p", { className: "mt-0.5 text-[11px] leading-snug text-gray-500 dark:text-odp-muted", children: "\uC81C\uBAA9 \uC55E\uC758 1. / 2.1. \uAC19\uC740 \uBC88\uD638\uB97C \uD604\uC7AC heading \uC218\uC900\uC5D0 \uB9DE\uAC8C \uB2E4\uC2DC \uBD99\uC785\uB2C8\uB2E4." })] }), o.jsx(Sr, { className: Du(h), checked: h, onCheckedChange: T, "aria-label": "outline \uBC88\uD638 \uB9DE\uCD94\uAE30", children: o.jsx(Cr, { className: Iu }) })] }), h ? o.jsxs("div", { className: "mt-3 space-y-3 border-t border-gray-100 pt-3 dark:border-odp-borderSoft/60", children: [o.jsxs("div", { children: [o.jsx("div", { className: "mb-2 text-xs font-medium text-gray-500 dark:text-odp-muted", children: "\uCD5C\uB300 heading \uBC88\uD638 \uD615\uC2DD" }), o.jsx(Vn, { className: "flex items-center gap-2", value: C, onValueChange: (b) => {
    (b === "flat" || b === "nested") && P(b);
  }, "aria-label": "\uCD5C\uB300 heading \uBC88\uD638 \uD615\uC2DD", children: Pu.map((b) => {
    const R = C === b.value;
    return o.jsx(Wn, { value: b.value, className: ["flex-1 rounded-lg border-2 px-3 py-2 text-left outline-none transition-all duration-200", "focus-visible:ring-2 focus-visible:ring-blue-500/40", R ? "scale-100 border-blue-600 bg-blue-50 shadow-sm dark:border-blue-400 dark:bg-blue-950/30" : "scale-[0.92] border-gray-400 hover:border-gray-500 dark:border-odp-borderStrong dark:hover:border-gray-400"].join(" "), children: o.jsxs("div", { className: R ? "" : "opacity-50", children: [o.jsx("div", { className: "font-medium text-sm text-gray-800 dark:text-odp-fgStrong", children: b.title }), o.jsx("div", { className: "mt-0.5 text-[11px] leading-snug text-gray-500 dark:text-odp-muted", children: b.description })] }) }, b.value);
...
function Ou({ checked: e = false, onChange: t, theme: n = "light" }) {
  return o.jsx(Cn, { checked: e, onChange: t, theme: n, icon: Rl, title: e ? "Mirror Edit on \u2014 dual caret + instant preview sync" : "Mirror Edit off", ariaLabel: "Mirror Edit" });
}
function Bu({ onRequestLink: e, onRequestUpload: t, onRequestClip: n, disabled: r = false }) {
  const [a, s] = i.useState(false), l = i.useRef(null), u = i.useRef(null), p = i.useCallback(() => s(false), []);
  return o.jsxs(o.Fragment, { children: [o.jsx(Qs, { title: "\uC774\uBBF8\uC9C0", visible: a, onChange: s, disabled: r, overlay: o.jsxs("ul", { className: "md-editor-menu", role: "menu", onClick: p, children: [o.jsx("li", { className: "md-editor-menu-item md-editor-menu-item-image", role: "menuitem", tabIndex: 0, onClick: () => e(), onKeyDown: (m) => {
  ...
  }, children: "\uC798\uB77C\uC11C \uC5C5\uB85C\uB4DC" })] }), children: o.jsx(Tl, { className: "md-editor-icon", size: 16, "aria-hidden": true }) }), o.jsx("input", { ref: l, type: "file", accept: "image/*", multiple: true, className: "hidden", tabIndex: -1, "aria-hidden": true, onChange: (m) => {
...
function zu({ isOpen: e, onClose: t, onConfirm: n }) {
  const [r, a] = i.useState(""), [s, l] = i.useState(""), [u, p] = i.useState("");
  i.useEffect(() => {
    e && (a(""), l(""), p(""));
  }, [e]);
  const m = () => {
...
function Vu({ isOpen: e, file: t, onClose: n, onConfirm: r }) {
  ...
  }, [e, t]), o.jsx(Kt, { isOpen: e && !!t, onClose: n, contentClassName: "max-w-2xl w-[min(96vw,42rem)] max-h-[90vh] h-[min(90vh,720px)]", resizeHeight: true, children: a ? o.jsx(cc, { imageSrc: a, ...(t == null ? void 0 : t.name) ? { fileName: t.name } : {}, onCancel: n, onConfirm: r }) : null });
}
...
function Uu() {
  const [e, t] = i.useState(gr), n = i.useCallback((r) => {
    t((a) => {
...
function Gu(e) {
  ...
  for (; (n = fo.exec(e)) !== null; ) {
    ...
    if (a.length < Yu) continue;
    const s = n[0], l = s.length - a.length, u = n.index + l;
...
function mo(e, t) {
  ...
  for (let a = 1; a <= e.doc.lines; a += 1) {
    ...
    for (const l of Gu(s.text)) {
      ...
      n.push(Rr.replace({ widget: new Ju(Zu(l.mime, p - u), u, p) }).range(u, p));
    }
  }
  return { deco: Rr.set(n, true), expanded: r };
}
const Cs = Yo.define({ create(e) {
  ...
  let r = n !== e.expanded;
  for (const a of t.effects) a.is(ks) ? (n = [{ from: a.value.from, to: a.value.to }], r = true) : a.is(Es) && n.length > 0 && (n = [], r = true);
  ...
  return a !== -1 && n.expanded.some(({ from: s, to: l }) => a >= s && a <= l) || t.dispatch({ effects: Es.of(null) }), false;
} });
function Ns() {
  return [Cs, ed];
}
...
const Ls = Yo.define({ create() {
  ...
  t.docChanged && n.length && (n = n.map(({ from: a, to: s }) => ({ from: t.changes.mapPos(a, 1), to: t.changes.mapPos(s, -1) })).filter(({ from: a, to: s }) => a < s));
  let r = n !== e;
  for (const a of t.effects) if (a.is(zt)) js(n, a.value.from, a.value.to) || (n = [...n, a.value], r = true);
  else if (a.is(mt)) {
    const s = n.filter((l) => l.from !== a.value.from || l.to !== a.value.to);
...
function ld(e, t) {
  if (e) try {
    e.dispatch({ effects: Ms.reconfigure(t ? Rs() : []) });
  } catch {
  }
}
...
`;
function fd(e) {
  if (!Ia() || !(e == null ? void 0 : e.state)) return false;
...
function gd({ enabled: e, historyKey: t, meta: n, grid: r, applySnapshot: a }) {
  const s = i.useRef([]), l = i.useRef(0), u = i.useRef(false), p = i.useRef(false), m = i.useRef(null), h = i.useRef(null), T = i.useRef(a);
  T.current = a;
  const [C, P] = i.useState(0), S = i.useCallback(() => P((E) => E + 1), []), M = i.useCallback(() => {
    m.current && (clearTimeout(m.current), m.current = null);
  }, []), A = i.useCallback(() => go({ meta: n, grid: r }), [r, n]), I = i.useCallback(() => {
    M();
    const E = h.current;
    if (E == null) return;
    h.current = null;
  ...
  }, [A, e, I]), q = i.useCallback(() => {
    if (I(), l.current <= 0) return false;
    l.current -= 1;
    const E = s.current[l.current], D = E ? xo(E) : null;
    return D ? (u.current = true, T.current(D), S(), requestAnimationFrame(() => {
      u.current = false;
    }), true) : false;
  }, [S, I]), b = i.useCallback(() => {
  ...
  }, [S, I]), R = e && p.current && l.current > 0, X = e && p.current && l.current < s.current.length - 1;
  return { undo: q, redo: b, canUndo: R, canRedo: X, recordNow: O, flushPendingRecord: I };
}
const xd = ["thead", "tbody", "tfoot"], Jn = 10, bo = 36, wo = 44, Et = 4, sn = 14, bd = "h-3.5 w-3.5 shrink-0", ce = "h-3 w-3 shrink-0", Qn = "__none__", wd = (e) => ["relative inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border outline-none transition-all duration-200 focus-visible:ring-2 focus-visible:ring-blue-400", e ? "border-blue-500 bg-blue-500 shadow-sm dark:border-blue-500 dark:bg-blue-500" : "border-transparent bg-gray-300 dark:border-odp-borderStrong dark:bg-odp-borderStrong"].join(" "), yd = "block h-4 w-4 translate-x-0.5 rounded-full bg-white shadow transition-transform will-change-transform data-[state=checked]:translate-x-[1.125rem]", yo = 288, Ts = 200, vd = 480, kd = 380, Ed = 560, vo = 16, Pt = 6, Sd = [{ value: "full", label: "\uD398\uC774\uC9C0 \uC804\uCCB4 (full)" }, { value: "fit", label: "\uB0B4\uC6A9\uB9CC\uD07C (fit)" }], Cd = [{ value: "left", label: "\uC67C\uCABD" }, { value: "right", label: "\uC624\uB978\uCABD" }], Nd = "pointer-events-none z-100050 max-w-[240px] rounded-md border border-gray-200 bg-white px-2 py-1 text-[11px] leading-snug text-gray-800 shadow-md dark:border-odp-borderStrong dark:bg-odp-surface dark:text-odp-fgStrong", Md = "z-100050 min-w-[168px] overflow-hidden rounded-lg border border-gray-200 bg-white p-1 shadow-lg dark:border-odp-borderStrong dark:bg-odp-bgSoft", ko = "flex cursor-pointer select-none items-center gap-2 rounded-md px-3 py-2 text-sm text-red-600 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-40 data-[highlighted]:bg-red-50 dark:text-red-400 dark:data-[highlighted]:bg-red-950/40", Ps = typeof navigator < "u" && (/Mac|iPhone|iPad|iPod/i.test(navigator.platform) || /Mac|iPhone|iPad|iPod/i.test(navigator.userAgent ?? "")), pt = Ps ? "\u2318" : "Ctrl", jd = `${pt}+E`, Ld = `${pt}+Shift+E`, Rd = `${pt}+Shift+>`, Td = `${pt}+Shift+<`, er = `${pt}+Z`, tr = Ps ? `${pt}+Shift+Z` : `${pt}+Y`, Pd = 14;
function Ad(e, t, n = Pd) {
  const r = (e || "").trim(), a = /^(\d+(?:\.\d+)?)(px|%|em|rem|pt)?$/i.exec(r), s = ((a == null ? void 0 : a[2]) || "px").toLowerCase(), l = a ? Number(a[1]) : n, u = s === "em" || s === "rem" ? 0.1 : 1, p = s === "em" || s === "rem" ? 0.5 : s === "%" ? 50 : 8;
...
function wt(e) {
  return Math.min(vd, Math.max(Ts, Math.round(e)));
}
...
function Co(e, t, n, r, a, s) {
  const l = r.left - a.left, u = t - a.top, p = r.width, m = Math.min(Math.max(n - a.left, l), l + p);
...
function No(e, t, n, r, a, s) {
  const l = r.top - a.top, u = t - a.left, p = r.height, m = Math.min(Math.max(n - a.top, l), l + p);
...
function $d({ insert: e, tip: t, allowResize: n, onDoubleClickInsert: r, onResizePointerDown: a }) {
  ...
  return o.jsx("div", { role: "presentation", title: t, "data-haim-edge-hit": "", className: `pointer-events-auto absolute z-[25] ${n ? s ? "cursor-row-resize" : "cursor-col-resize" : "cursor-pointer"}`, style: { left: l.left, top: l.top, width: l.width, height: l.height }, onMouseDown: (u) => {
    ...
    let T = false;
    const C = () => {
      document.removeEventListener("pointermove", P, true), document.removeEventListener("pointerup", S, true), document.removeEventListener("pointercancel", S, true);
    }, P = (M) => {
      T || Math.abs(M.clientX - p) < 3 && Math.abs(M.clientY - m) < 3 || (T = true, C(), a(h));
    }, S = () => {
      C();
    };
    document.addEventListener("pointermove", P, true), document.addEventListener("pointerup", S, true), document.addEventListener("pointercancel", S, true);
  }, onDoubleClick: (u) => {
...
function Hd({ kind: e, indices: t, table: n, wrap: r, colCount: a }) {
  ...
  return i.useEffect(() => {
    ...
    const u = () => {
      ...
      if (e === "row") for (const T of t) {
        ...
        h.push({ left: m.left - p.left, top: P.top - p.top, width: m.width, height: Math.max(1, P.height) });
      }
      else {
        const T = As(n, a);
        for (const C of t) {
          const P = T[C], S = T[C + 1];
          P == null || S == null || h.push({ left: P - p.left, top: m.top - p.top, width: Math.max(1, S - P), height: m.height });
        }
      }
      l(h);
    };
...
function Bd(e, t, n) {
  ...
  if (!a) return null;
  const s = Number(a.getAttribute("data-edit-r")), l = Number(a.getAttribute("data-edit-c"));
  return !Number.isInteger(s) || !Number.isInteger(l) ? null : yi(n, s, l);
}
function Mo(e, t, n) {
  return e === "col" ? n.colspan > 1 && n.c < t && t < n.c + n.colspan : n.rowspan > 1 && n.r < t && t < n.r + n.rowspan;
}
function At(e, t, n, r, a, s, l) {
  ...
  const h = Od(e), T = As(e, s), C = Bd(n, r, l);
  let P = null;
  for (let M = 0; M < h.length; M += 1) {
    if (C && Mo("row", M, C)) continue;
    const A = h[M], I = Math.abs(r - A);
    I <= Jn && n >= u.left - m && n <= u.right + m && (!P || I < P.dist) && (P = { index: M, dist: I, y: A });
  }
  let S = null;
  for (let M = 0; M < T.length; M += 1) {
    if (C && Mo("col", M, C)) continue;
    const A = T[M], I = Math.abs(n - A);
    I <= Jn && r >= u.top - m && r <= u.bottom + m && (!S || I < S.dist) && (S = { index: M, dist: I, x: A });
  }
  return P && S ? P.dist <= S.dist ? Co(P.index, P.y, n, u, p, a) : No(S.index, S.x, r, u, p, s) : P ? Co(P.index, P.y, n, u, p, a) : S ? No(S.index, S.x, r, u, p, s) : null;
}
function zd({ isOpen: e, initialMeta: t, initialGrid: n, onClose: r, onSave: a }) {
  var _a2, _b, _c2, _d2, _e2, _f2;
  const [s, l] = i.useState(pn()), [u, p] = i.useState(n), [m, h] = i.useState(null), [T, C] = i.useState(false), [P, S] = i.useState("thead"), [M, A] = i.useState([]), [I, O] = i.useState(false), [q, b] = i.useState(null), [R, X] = i.useState(null), [E, D] = i.useState(false), [K, J] = i.useState(0), [Q, re] = i.useState(null), [ie, le] = i.useState(null), we = i.useRef(null), [te, W] = i.useState(null), ee = te !== null, pe = ls(), [Se, We] = i.useState(yo), [$e, ae] = i.useState(yo), [ue, Ce] = i.useState(false), [de, Fe] = i.useState(false), [z, B] = i.useState(() => typeof window < "u" ? window.innerWidth : 1280), [ne, Z] = i.useState(() => typeof window < "u" ? window.matchMedia("(orientation: landscape)").matches : true), Ee = i.useRef(null), he = i.useRef(null), ye = i.useRef(null), Ae = i.useRef(null), fe = i.useRef(false), ge = i.useRef(null), me = i.useRef(null), De = i.useRef(false), je = i.useRef(false), He = i.useRef({ x: 0, y: 0 });
  Ae.current = R, fe.current = T, me.current = m, De.current = ue, je.current = ee, we.current = ie;
  const Oe = i.useRef(t), xe = i.useRef(n);
  Oe.current = t, xe.current = n, i.useEffect(() => {
    if (!e) return;
    const c = Oe.current, d = xe.current;
    l(c ? { ...c } : pn()), p({ rows: d.rows.map((w) => [...w]), aligns: [...d.aligns] }), h(null), C(false), ge.current = null, X(null), Ce(false), Fe(false), W(null), le(null), J((w) => w + 1), li().then((w) => A(w.templates)), ci().then((w) => ui(w));
  }, [e]);
  const Be = i.useCallback((c) => {
    l(c.meta), p({ rows: c.grid.rows.map((d) => [...d]), aligns: [...c.grid.aligns ?? []] }), h(null), C(false), ge.current = null, X(null);
  }, []), { undo: Ge, redo: Le, canUndo: Ue, canRedo: st, recordNow: Je } = gd({ enabled: e, historyKey: K, meta: s, grid: u, applySnapshot: Be }), Qe = i.useRef(false);
  i.useEffect(() => {
  ...
  const Me = i.useMemo(() => di(s.merges), [s.merges]), Ne = u.rows.length, j = Math.max(1, ...u.rows.map((c) => c.length), u.aligns.length), $ = i.useMemo(() => {
    if (!m) return [];
    ...
    return c;
  }, [m, Me]), Y = $[0] ?? null, et = !!Y, at = i.useRef(Se), tt = i.useRef($e);
  at.current = Se, tt.current = $e;
  const gt = i.useMemo(() => {
    const c = z * 0.95;
    return Math.max(Ts, c - vo - Pt - kd);
  }, [z]), Ut = i.useCallback((c) => {
    const d = at.current, w = tt.current, N = d + w;
    let k = wt(d + c), F = wt(N - k);
    k = wt(N - F), F = wt(N - k), We(k), ae(F);
  }, []), qt = i.useCallback((c) => {
    ae((d) => {
      const w = wt(d + c);
      if (Se + Pt + w <= gt) return w;
      const k = gt - Se - Pt;
      return wt(k);
    });
  }, [gt, Se]), Mn = i.useMemo(() => {
    ...
    const d = Se + Pt + $e;
    return { width: Math.min(c, vo + d + Pt + Ed), maxWidth: "95dvw", height: "95dvh", maxHeight: "95dvh" };
  }, [$e, ne, Se, z]), xt = i.useMemo(() => Y ? s.cells[Ve(Y.r, Y.c)] ?? {} : {}, [s.cells, Y]), Ie = i.useCallback((c) => {
    $.length && l((d) => {
      const w = { ...d.cells };
  ...
  }, []), Re = i.useRef(u), qe = i.useRef(s);
  Re.current = u, qe.current = s;
  const Xt = i.useCallback((c) => {
    ve(Nc(Re.current, qe.current, c));
  }, [ve]), Yt = i.useCallback((c) => {
    ve(Mc(Re.current, qe.current, c));
  }, [ve]), it = i.useCallback((c) => {
    const d = me.current;
    let w, N;
    ...
    const F = Re.current.rows.length;
    ...
    const k = [];
    for (let G = w; G <= N; G += 1) k.push(G);
    const F = Math.max(1, ...Re.current.rows.map((G) => G.length), Re.current.aligns.length, 1);
    ...
    Q && (Q.kind === "row" ? ve(Rc(Re.current, qe.current, Q.indices)) : ve(Tc(Re.current, qe.current, Q.indices)), re(null), le(null));
  }, [ve, Q]), Xe = !!(m && !(m.r0 === m.r1 && m.c0 === m.c1)), bt = i.useCallback(() => {
    !m || m.r0 === m.r1 && m.c0 === m.c1 || l((c) => ({ ...c, merges: fi(c.merges, m.r0, m.c0, m.r1, m.c1) }));
  }, [m]), Mt = i.useCallback(() => {
    m && l((c) => ({ ...c, merges: mi(c.merges, m.r0, m.c0, m.r1, m.c1) }));
  }, [m]), Qt = i.useCallback((c) => {
    $.length && l((d) => {
      var _a3;
  ...
  const Ln = i.useCallback((c) => {
  ...
  }, [j, E, s.merges, T, Ne]), lt = i.useCallback((c, d) => {
    var _a3, _b2;
    ...
    const G = (Ze) => {
      let V = 24;
      d.kind === "col" ? V = Ze.clientX - k : V = Ze.clientY - F, V = Math.max(24, Math.round(V)), l((Pe) => d.kind === "col" ? { ...Pe, colWidths: Ur(Pe.colWidths, N, V) } : { ...Pe, rowHeights: Ur(Pe.rowHeights, N, V) });
    }, be = () => {
  ...
  }, [tn, de, ue]), L = i.useCallback((c, d, w, N) => {
    let k = c + w, F = d + N;
  ...
  }, [j, Me, en, Ne]), H = i.useCallback((c, d, w) => {
  ...
  }, [u.rows, Y]), oe = i.useMemo(() => s.templateId ? M.find((c) => c.id === s.templateId) ?? null : null, [s.templateId, M]), ke = i.useCallback((c, d) => {
    const w = pi({ row: c, col: d, rowCount: Ne, colCount: j, meta: s, template: oe }), N = {};
  ...
  }, Te = (c) => c === "thead" ? o.jsx(Kn, { className: ce, "aria-hidden": true }) : c === "tfoot" ? o.jsx(Jr, { className: ce, "aria-hidden": true }) : o.jsx(Qr, { className: ce, "aria-hidden": true });
  return o.jsxs(o.Fragment, { children: [o.jsxs(Kt, { isOpen: e, onClose: () => {
    ...
    return o.jsx("tr", { style: w ? { height: w } : void 0, children: Array.from({ length: j }, (N, k) => {
      ...
      const F = xi(s.merges, d, k), G = se(d, k), be = $n(s.colWidths, k), Ze = o.jsx("td", { "data-edit-r": d, "data-edit-c": k, colSpan: F == null ? void 0 : F.colspan, rowSpan: F == null ? void 0 : F.rowspan, className: `min-h-11 cursor-pointer border-2 border-gray-300 p-0 transition-[box-shadow,outline-color] dark:border-odp-borderStrong ${be ? "" : "min-w-28"} ${G ? "relative z-[1] outline outline-2 outline-offset-[-2px] outline-blue-500 ring-0" : "hover:relative hover:z-[1] hover:outline hover:outline-2 hover:outline-offset-[-2px] hover:outline-blue-400/70"}`, onContextMenu: () => {
        ...
        const Pe = ye.current, ze = he.current;
        if (Pe && ze && At(Pe, ze, V.clientX, V.clientY, Ne, j, s.merges)) {
  ...
  }) })] }), ie ? o.jsx(Hd, { kind: ie.kind, indices: ie.indices, table: ye.current, wrap: he.current, colCount: j }) : null, pe && te ? o.jsxs(cs, { open: ee, onOpenChange: (c) => {
    c || (W(null), nt());
    ...
    Gt(te.c), W(null);
  }, children: [o.jsx(vt, { className: ce, "aria-hidden": true }), "\uC5F4 \uC0AD\uC81C"] })] }) : null, R && !ee ? o.jsxs(o.Fragment, { children: [o.jsx(Fd, { insert: R }, `preview-${R.kind}-${R.index}`), o.jsx($d, { insert: R, allowResize: R.index !== 0, tip: R.index === 0 ? R.label : `${R.label} \xB7 ${So(R.kind)}`, onDoubleClickInsert: () => {
    const { kind: c, index: d } = R;
    c === "row" ? Xt(d) : Yt(d);
  }, onResizePointerDown: (c) => lt(c, R) }, `hit-${R.kind}-${R.index}`), o.jsx(_d, { tip: R.index === 0 ? R.label : `${R.label} \xB7 ${So(R.kind)}`, onDoubleClick: () => {
    const { kind: c, index: d } = R;
    c === "row" ? Xt(d) : Yt(d);
  }, style: { left: R.x, top: R.y } }, `btn-${R.kind}-${R.index}`)] }) : null] }) })] })] })] }), o.jsx(pc, { isOpen: I, template: q, onClose: () => {
    O(false), b(null);
  }, onSave: (c) => {
    const w = [...wi().templates.filter((N) => N.id !== (q == null ? void 0 : q.id) && N.id !== c.id), c];
    bi({ templates: w }).then((N) => {
...
function Vd({ containerRef: e, getMarkdown: t, setMarkdown: n, onEditTable: r, onEditFailed: a }) {
  const s = ls(), [l, u] = i.useState(false), [p, m] = i.useState(null), [h, T] = i.useState(null), C = i.useRef(null);
  C.current = p;
  const P = i.useCallback((b) => {
    m(b), u(true);
  }, []);
  i.useEffect(() => {
    const b = e.current;
    if (!b) return;
    const R = () => b.querySelector(".md-editor-preview"), X = (te) => {
      var _a2, _b, _c2, _d2;
      ...
      const W = R(), ee = (_d2 = (_c2 = te.target) == null ? void 0 : _c2.closest) == null ? void 0 : _d2.call(_c2, "table");
      !(ee instanceof HTMLTableElement) || !(W == null ? void 0 : W.contains(ee)) || (te.preventDefault(), te.stopPropagation(), P({ table: ee, previewRoot: W, x: te.clientX, y: te.clientY }));
    };
    ...
    const Q = () => {
      ...
      !(ee instanceof HTMLTableElement) || !W.contains(ee) || (Q(), K = false, J = ee, D = { x: te.clientX, y: te.clientY }, E = setTimeout(() => {
        K = true, vi();
        const pe = R();
        J && pe && P({ table: J, previewRoot: pe, x: (D == null ? void 0 : D.x) ?? te.clientX, y: (D == null ? void 0 : D.y) ?? te.clientY });
      }, ki));
    }, ie = (te) => {
      if (!D) return;
      ...
      var _a2, _b;
      const W = R(), ee = (_b = (_a2 = te.target) == null ? void 0 : _a2.closest) == null ? void 0 : _b.call(_a2, "table");
      ee && (W == null ? void 0 : W.contains(ee)) && window.matchMedia("(pointer: coarse)").matches && te.preventDefault();
    };
    return b.addEventListener("contextmenu", X, true), b.addEventListener("pointerdown", re), b.addEventListener("pointermove", ie), b.addEventListener("pointerup", le), b.addEventListener("pointercancel", le), b.addEventListener("contextmenu", we, true), () => {
      Q(), b.removeEventListener("contextmenu", X, true), b.removeEventListener("pointerdown", re), b.removeEventListener("pointermove", ie), b.removeEventListener("pointerup", le), b.removeEventListener("pointercancel", le), b.removeEventListener("contextmenu", we, true);
    };
  }, [e, P]);
  const S = () => {
    const b = C.current;
    if (!b) return;
    r(b.table, b.previewRoot) || (a == null ? void 0 : a());
  }, M = () => {
    const b = C.current;
    if (!b) return;
    const R = gs(t(), b.table, b.previewRoot);
    if (!R) {
      a == null ? void 0 : a();
      return;
    }
    ...
    u(false), m(null);
  }, q = o.jsxs(o.Fragment, { children: [o.jsxs("button", { type: "button", className: s ? Ei : jo, onClick: () => {
    S(), O();
...
function Wd(e) {
  ...
  const s = i.useCallback((m, h = m) => {
    const T = r.current(), C = ar(T, m, h);
    return C ? (n({ block: C, meta: C.meta ?? pn(), grid: C.grid }), true) : false;
  }, []), l = i.useCallback((m, h) => {
    const T = r.current(), C = gs(T, m, h);
    return C ? (n({ block: C, meta: C.meta ?? pn(), grid: C.grid }), true) : false;
  }, []), u = i.useCallback(() => n(null), []), p = i.useCallback((m, h) => {
    if (!t) return;
    const T = r.current(), C = ar(T, t.block.start, t.block.start + 1) ?? t.block, P = Ci(T, C, m, h);
    a.current(P), n(null);
  }, [t]);
...
function Zd(e, t) {
  ...
  let r = false;
  return yr(e).iterate({ from: n.from, to: Math.min(n.to, n.from + 1), enter(a) {
    const s = a.type.name;
...
function nr(e, t) {
  ...
  const r = e.doc.lineAt(t), a = oa(e, r.from, r.to);
  return !a || a.from >= a.to ? null : { ...a, kind: "heading" };
}
const Ot = ta.define({ combine: (e) => e[e.length - 1] ?? null }), _s = new wr();
function Jd(e) {
...
function $s(e, t) {
  ...
  if (!n || !r) return null;
  const a = e.contentDOM.getBoundingClientRect(), s = Math.min(n.top, r.top), l = Math.max(n.bottom, r.bottom), u = Math.max(0, l - s);
  if (u < 2) return null;
...
function Po(e) {
  const t = ht(e.state);
  if (!t) return false;
  const r = !Ht(e.state, t), a = e.dom.querySelector('.cm-note-cover-fold-chevron[data-fold-kind="cover"]');
  return Fs(a, !r), (async () => {
...
function of() {
  return Qo.fromClass(class {
    ...
    update(e) {
      const t = e.state.facet(Ot) !== this.lastKey, r = !!St(e.state.doc), a = r && !this.hadCover;
...
function af() {
  ...
  }), na({ class: "cm-note-cover-fold-gutter", lineMarker(e, t) {
    const n = nr(e.state, t.from);
    if (!n) return null;
    const r = !Ht(e.state, n);
    return new Ro(r, n.kind);
  }, lineMarkerChange: (e) => e.docChanged || e.viewportChanged || sf(e), initialSpacer: () => new Ro(true, "heading"), domEventHandlers: { mousedown(e, t, n) {
    if (!(n instanceof MouseEvent) || n.button !== 0) return false;
    const r = nr(e.state, t.from);
    if (!r) return false;
    if (r.kind === "cover") {
      if (!Po(e)) return false;
    } else {
      const a = n.target instanceof Element ? n.target.closest(".cm-note-cover-fold-chevron") : null;
      Fs(a, Ht(e.state, r)), To(e, r);
    }
    return n.preventDefault(), n.stopPropagation(), true;
  } } }), ra({ domEventHandlers: { mousedown(e, t, n) {
    if (!(n instanceof MouseEvent) || n.button !== 0) return false;
    const r = St(e.state.doc);
    if (r && t.from >= r.from && t.from < r.to) return Po(e) ? (n.preventDefault(), true) : false;
    const a = nr(e.state, t.from);
    return !a || a.kind !== "heading" ? false : (To(e, a), n.preventDefault(), true);
...
function df(e, t, n) {
  let r = wn.get(e);
  r || (r = Js.createRoot(e), wn.set(e, r)), r.render(i.createElement(lf, { cover: t, getPresignedUrl: n ?? void 0 }));
}
function ff(e, t, n, r) {
  if (!e || typeof e.querySelectorAll != "function") return 0;
  const { cover: a } = us(t ?? ""), s = Array.from(e.querySelectorAll("[data-note-cover-mount]"));
...
function kf(e, t = {}) {
  ...
  return zs(e).forEach((s, l) => {
    ...
    const h = !n.has(p), T = yf(h);
    s.insertBefore(T, s.firstChild);
    const C = (S) => {
      s.classList.toggle(ln, S), rr(u, S), vf(T, !S);
    };
    ...
    T.addEventListener("click", P), r.push(() => {
      T.removeEventListener("click", P), T.remove(), s.classList.remove(Io, ln), s.removeAttribute(mn), rr(u, false);
    });
  }), () => {
    for (const s of r) s();
  };
...
function jf(e) {
  ...
  function l() {
    for (const P of t) clearTimeout(P);
    t = [];
  }
  function u() {
    if (s) return false;
    const P = e.getPreviewRoot(), S = e.getView();
    return !P || !S || Dt(P) ? false : $a(S, P, { allowCollapsed: true });
  }
  function p() {
  ...
  function m(P) {
    n && r === P || (n == null ? void 0 : n.disconnect(), r = P, n = new MutationObserver((S) => {
      S.some((A) => {
    ...
    }), n.observe(P, { childList: true, subtree: true, characterData: true }));
  }
  function h(P) {
    if (s) return;
    const S = e.getPreviewRoot();
    if (S && m(S), u(), !!(P == null ? void 0 : P.withRetries)) {
      l();
  ...
  function T() {
    s = true, l(), n == null ? void 0 : n.disconnect(), n = null, r = null, a = false;
  }
  const C = e.getPreviewRoot();
  return C && m(C), h({ withRetries: true }), { schedule: h, stop: T };
}
const $o = [0, 16, 48, 120, 280], Lf = 50, Rf = 40, Fo = 32, Tf = 32;
function Ho(e) {
...
function If(e) {
  let t = false, n = [], r = null, a = 0, s = null, l = 0, u = 0, p = null, m = null, h = null, T = null, C = null, P = "none", S = false;
  function M() {
  ...
  function K() {
    ...
    if (!z || !B || P === "preview" || P !== "none" && P !== "follow") return false;
    P = "follow";
    const ne = Fa(B, z);
    return q("follow"), ne;
  }
  ...
  function Q() {
    ...
    const ne = b(B), Z = R(z);
    if (!Z) return;
    const Ee = ne.scrollTop, he = B.lineBlockAtHeight(Ee), ye = B.state.doc.lineAt(he.from).number - 1, Ae = Pf(z, ye);
    if (!Ae) return;
  ...
  function we() {
    S || P === "preview" || P === "follow" || l || (l = requestAnimationFrame(() => {
      l = 0, ie();
    }));
  }
  function te() {
    S || P === "editor" || P === "follow" || u || (u = requestAnimationFrame(() => {
      u = 0, le();
    }));
  }
  function W(z) {
  ...
  function We(z) {
    const B = yt(z);
    return B ? (m === B || (m && m.removeEventListener("scroll", W), m = B, T = B, B.addEventListener("scroll", W, { passive: true })), true) : false;
  }
  function $e(z, B) {
    const ne = Df(z, B);
  ...
  function ue() {
    S || r != null || a >= Rf || (r = setTimeout(() => {
      if (r = null, a += 1, S) return;
      Ce() || ue();
    }, Lf));
  }
  function Ce() {
    ...
    let ne = true;
    return z && Se(z) || (ne = false), B ? (We(B) || (ne = false), ae(B)) : ne = false, $e(z, B) || (ne = false), ne;
  }
  function de(z) {
  ...
  function Fe() {
    S = true, M(), A(), I(), O(), p && (p.removeEventListener("scroll", W), p = null), m && (m.removeEventListener("scroll", W), m = null), h && (h.removeEventListener("scroll", W, true), h.removeEventListener("wheel", ee, true), h.removeEventListener("touchmove", ee, true), h = null), C && (C.removeEventListener("load", pe, true), C.removeEventListener("error", pe, true), C = null), T = null, t = false, P = "none";
  }
...
async function zo({ key: e, stack: t, index: n }) {
  if (!e) return;
  const r = Mr(t), a = Math.max(0, Math.min(n ?? r.length - 1, r.length - 1));
  await Bt.histories.put({ key: e, stack: r, index: a, updatedAt: Date.now() });
}
async function Of() {
  const e = Date.now() - Us;
...
function zf(e, t, n) {
  ...
  if (t.length === 1) return e.state.doc.toString() !== r && e.dispatch({ changes: { from: 0, to: e.state.doc.length, insert: r }, annotations: [Rn.addToHistory.of(false)] }), n == null ? void 0 : n(), true;
  e.dispatch({ changes: { from: 0, to: e.state.doc.length, insert: t[0] ?? "" }, annotations: [Rn.addToHistory.of(false), Tr.of("full")] }), n == null ? void 0 : n();
  for (let s = 1; s < t.length; s += 1) {
    const l = t[s] ?? "";
    e.dispatch({ changes: { from: 0, to: e.state.doc.length, insert: l }, annotations: [Tr.of("full")] });
  }
  return e.state.doc.toString() !== r && e.dispatch({ changes: { from: 0, to: e.state.doc.length, insert: r }, annotations: [Rn.addToHistory.of(false)] }), true;
}
function Ko(e) {
...
function Vf({ currentFile: e, value: t, onChange: n, editorRef: r, enabled: a = true }) {
  const s = a ? Ff(e) : null, l = i.useRef([""]), u = i.useRef(0), p = i.useRef(null), m = i.useRef(false), h = i.useRef(null), T = i.useRef(null), C = i.useRef(t), P = i.useRef(false), S = i.useRef(null), M = i.useRef(0), A = i.useRef(t);
  C.current = t;
  const I = i.useCallback(async (D, K, J) => {
    if (D) try {
      await zo({ key: D, stack: K, index: J });
    } catch (Q) {
      console.warn("[editor-undo-history] save failed:", Q);
    }
  }, []), O = i.useCallback((D, K, J) => {
    D && (T.current && clearTimeout(T.current), T.current = setTimeout(() => {
      T.current = null, I(D, K, J);
    }, 300));
  }, [I]), q = i.useCallback(() => {
    ...
    return true;
  }, [r]), X = i.useCallback((D, K) => {
    var _a2, _b;
    const J = C.current ?? "", Q = ((_a2 = K == null ? void 0 : K.stack) == null ? void 0 : _a2.length) ? K.stack : [J], re = ((_b = K == null ? void 0 : K.stack) == null ? void 0 : _b.length) ? K.index ?? K.stack.length - 1 : 0, ie = cn(Q, re, J);
    l.current = ie.stack, u.current = ie.index, S.current = D, P.current = false, A.current = J;
    const le = ie.stack.slice(0, ie.index + 1), we = (te) => {
      p.current === D && (R(le) || te <= 0 || setTimeout(() => we(te - 1), 50));
    };
    we(40), O(D, ie.stack, ie.index);
  }, [R, O]);
  return i.useEffect(() => {
    a && Of().catch(() => {
    });
    ...
    if (q(), T.current && (clearTimeout(T.current), T.current = null), D && D !== K) {
      const ie = b();
      I(D, ie.stack, ie.index);
    }
    p.current = K, S.current = null, P.current = false;
    const J = Vo(r);
    ...
    return (async () => {
      ...
      re || M.current !== Q || p.current === K && X(K, ie);
    })(), () => {
      re = true;
    };
  }, [a, s, r, q, b, I, X]), i.useEffect(() => {
    if (!a || !s || S.current !== s || P.current || m.current || t === A.current) return;
    const D = t ?? "";
    A.current = D;
    const K = cn(l.current, u.current, D);
    l.current = K.stack, u.current = K.index, R(K.stack.slice(0, K.index + 1)), O(s, K.stack, K.index);
  }, [a, s, t, R, O]), i.useEffect(() => {
    if (a) return () => {
  ...
  }, [a, q]), { onChange: i.useCallback((D) => {
    m.current || (A.current = D, P.current = true, n == null ? void 0 : n(D), !(!a || !p.current) && (q(), h.current = setTimeout(() => {
...
function Xs(e, t, n, r, a) {
  const s = t - r.length, l = n + a.length;
  if (s < 0 || l > e.length || e.sliceString(s, t) !== r || e.sliceString(n, l) !== a) return false;
  if (r === a && Uf(r)) {
    const u = r[0] ?? "";
...
function qf(e, t, n, r) {
  const { from: a, to: s, empty: l } = t;
  if (l) {
    const m = `${n}${r}`;
    return { change: { from: a, to: s, insert: m }, next: Ke.cursor(a + n.length) };
  }
  ...
  if (u.length >= n.length + r.length && u.startsWith(n) && u.endsWith(r)) {
    ...
    return { change: { from: a, to: s, insert: m }, next: Ke.range(a, a + m.length) };
  }
  if (Xs(e, a, s, n, r)) {
    const m = a - n.length, h = s + r.length;
    return { change: { from: m, to: h, insert: u }, next: Ke.range(m, m + u.length) };
  }
  const p = `${n}${u}${r}`;
  return { change: { from: a, to: s, insert: p }, next: Ke.range(a + n.length, a + n.length + u.length) };
}
function Xf(e, t) {
...
function Nt(e, t, n = t) {
  ...
  const r = e.state.selection.ranges.map((a) => qf(e.state.doc, a, t, n));
  return Ys(e, r);
}
function Yf(e) {
  return Nt(e, "**");
...
function am(e) {
  return Wt(e, (t) => {
    ...
    if (n) {
      const a = n[1] ?? "", s = n[4] ?? "";
      return qs.test(t) ? `${a}- ${s.replace(/^\[[ xX]\]\s?/, "")}` : `${a}${s}`;
    }
    const r = t.match(Lr);
    return r ? `${r[1] ?? ""}- ${r[5] ?? ""}` : `- ${t}`;
  });
...
function Nn(e, t, n = t) {
  ...
  const r = e.state.changeByRange((a) => {
    ...
    const s = e.state.doc.sliceString(a.from, a.to), l = `${t}${s}${n}`;
    return { changes: { from: a.from, to: a.to, insert: l }, range: Ke.range(a.from + t.length, a.from + t.length + s.length) };
  });
...
const pm = fa({ nonTightLists: false });
function hm(e) {
  var _a2, _b;
  ...
  e.dispatch({ changes: { from: a.from, to: r.from, insert: "" }, selection: Ke.cursor(n - s) });
}
function gm(e) {
  return pm(e) ? (hm(e), true) : fd(e) ? true : da(e);
}
const xm = ca.highest(ts.of([{ key: "Enter", run: gm }]));
function bm(e) {
  var _a2, _b;
  if (!(e == null ? void 0 : e.state)) return;
...
const ym = [{ key: "Alt-h", preventDefault: true, run: (e) => dn(e, Ra) }, { key: "Alt-j", preventDefault: true, run: (e) => dn(e, Ta) }, { key: "Alt-k", preventDefault: true, run: (e) => dn(e, Pa) }, { key: "Alt-l", preventDefault: true, run: (e) => dn(e, Aa) }];
ua({ editorConfig: { languageUserDefined: { "ko-KR": ma }, renderDelay: ds() ? 500 : 0 }, codeMirrorExtensions(e, { keyBindings: t }) {
  ...
  }), a = [{ key: "ArrowLeft", run: (s) => Ir(s, -1) }, { key: "ArrowRight", run: (s) => Ir(s, 1) }, { key: "Ctrl-ArrowLeft", mac: "Alt-ArrowLeft", run: (s) => rt(s, -1, Ea), shift: (s) => rt(s, -1, ka) }, { key: "Ctrl-ArrowRight", mac: "Alt-ArrowRight", run: (s) => rt(s, 1, Ca), shift: (s) => rt(s, 1, Sa) }, { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: (s) => rt(s, -1, Ma), shift: (s) => rt(s, -1, Na) }, { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: (s) => rt(s, 1, La), shift: (s) => rt(s, 1, ja) }, ...ym, { key: "Alt--", preventDefault: true, run: om }, { key: "Ctrl-Tab", run: sm }, { key: "Ctrl-d", mac: "Cmd-d", preventDefault: true, run: (s) => (ga(s), true) }, { key: "Ctrl-b", mac: "Cmd-b", preventDefault: true, run: Yf }, { key: "Ctrl-i", mac: "Cmd-i", preventDefault: true, run: Gf }, { key: "Ctrl-u", mac: "Cmd-u", preventDefault: true, run: Jf, shift: am }, { key: "Ctrl-o", mac: "Cmd-o", preventDefault: true, run: im }, { key: "Shift-Ctrl-s", mac: "Shift-Cmd-s", preventDefault: true, run: Zf }, { key: "Ctrl-ArrowUp", mac: "Cmd-ArrowUp", preventDefault: true, run: Qf }, { key: "Ctrl-ArrowDown", mac: "Cmd-ArrowDown", preventDefault: true, run: em }, ...[1, 2, 3, 4, 5, 6, 7, 8, 9].map((s) => ({ key: `Ctrl-${s}`, mac: `Cmd-${s}`, preventDefault: true, run: (l) => Wo(l, s) })), { key: "Ctrl-0", mac: "Cmd-0", preventDefault: true, run: (s) => Wo(s, 10) }, { any: (s, l) => (l.ctrlKey || l.metaKey) && l.altKey && l.code === "KeyC" ? Gs(s) : Zs(s, l) }, { key: "Mod-Alt-ArrowUp", run: pa }, { key: "Mod-Alt-ArrowDown", run: ha }, ...r];
  return n.some((s) => s.type === "drawSelection") || n.push({ type: "drawSelection", extension: xa() }), n.push({ type: "markdownSingleNewlineEnter", extension: xm }, { type: "lineNumbers", extension: af() }, { type: "allowMultipleSelections", extension: ba.allowMultipleSelections.of(true) }, { type: "clickAddsSelectionRange", extension: _t.clickAddsSelectionRange.of((s) => {
    const l = /Mac|iPod|iPhone|iPad/.test(navigator.platform);
    return s.altKey || (l ? s.metaKey : s.ctrlKey);
  }) }, { type: "multiCursorPreview", extension: wa({ minSelectionLength: 2, maxMatches: 200 }) }, { type: "keymap", extension: ts.of(a) }, { type: "base64ImageFold", extension: td(gr()) }, { type: "mermaidBase64Fold", extension: id(gr()) }, { type: "autocompleteGate", extension: _t.updateListener.of((s) => {
    ud(s), !as() && ya(s.state) === "active" && va(s.view);
  }) }), n;
}, markdownItPlugins(e) {
  return nl(e);
} });
function Wm({ value: e, onChange: t, onSave: n, theme: r = "light", currentFile: a = null, previewOnly: s = false, isMobileLayout: l = false, onUploadImage: u, isUploadingEditorImage: p = false, uploadImagePercent: m = 0, onCancelUploadImage: h, onResolveWikiImageUrl: T, snippetConfig: C = { snippets: [] }, llmProviderProfiles: P = [], getImgbbApiKey: S, onOpenViewPath: M, onRequestConvertAllImagesToWiki: A, onRegisterConvertAllImagesToWiki: I }) {
  var _a2, _b;
  const O = qo(), { showAlert: q } = Pi(), b = i.useId(), R = i.useMemo(() => Ac(b), [b]), X = i.useMemo(() => Dc(R), [R]), E = i.useRef(null), D = i.useRef(null), K = i.useRef(null), J = i.useRef(null), Q = i.useRef(C), re = i.useRef(e), ie = i.useRef(a), le = i.useRef(r), we = i.useRef("");
  i.useEffect(() => {
    re.current = e, ie.current = a, le.current = r;
  }, [e, a, r]), i.useEffect(() => {
    const { issues: f } = us(e ?? "");
    if (!f.length) {
      we.current = "";
...
${g}` }));
  ...
  const te = i.useCallback((f = {}) => {
    const g = re.current ?? "", x = ie.current;
  ...
  }, [O]), { onChange: W } = Vf({ currentFile: a, value: e, onChange: t, editorRef: E, enabled: !s }), ee = Wd({ getMarkdown: () => re.current ?? "", setMarkdown: (f) => {
    typeof t == "function" && t(f);
  } }), pe = i.useRef(ee.openAtOffset), Se = i.useRef(ee.openPreviewTable);
  i.useEffect(() => {
    pe.current = ee.openAtOffset, Se.current = ee.openPreviewTable;
  }, [ee.openAtOffset, ee.openPreviewTable]);
  const We = i.useRef(null), [$e, ae] = i.useState(false), [ue, Ce] = i.useState(false), [de, Fe] = i.useState(null), z = i.useRef(() => {
  }), [B, ne] = i.useState(false), [Z, Ee] = i.useState(null), [he, ye] = i.useState(0), [Ae, fe] = i.useState(false), [ge, me] = i.useState(false), De = i.useRef({ from: 0, to: 0 }), je = i.useRef(W);
  i.useEffect(() => {
    je.current = W;
  }, [W]);
  const [He, Oe] = i.useState(null), [xe, Be] = i.useState(null), [Ge, Le] = i.useState(false), [Ue, st] = i.useState(null), [Je, Qe] = i.useState(false), [Me, Ne] = i.useState(null), [j, $] = i.useState(null), Y = i.useRef(null), [et, at] = uc(), [tt, gt] = Uu(), [Ut, qt] = qu(), [Mn, xt] = Xu(), Ie = i.useMemo(() => ds(), []), ve = Ie ? false : Mn, Re = i.useRef(null);
  i.useEffect(() => {
    if (s) return;
    const f = () => {
      var _a3, _b2, _c2;
      const v = (_c2 = (_b2 = ((_a3 = E.current) == null ? void 0 : _a3.value) ?? E.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2);
      v && (Re.current = v.state.selection);
    }, g = (y) => {
    ...
    const f = () => {
      ...
      var _a3, _b2;
      const H = (_b2 = (_a3 = f()) == null ? void 0 : _a3.getEditorView) == null ? void 0 : _b2.call(_a3), U = Re.current;
...
`;
    ...
    for (const L of Ii) L.directive && (_[L.id] = () => x(L.directive));
    return _["editor-revoke"] = () => {
      ...
      const L = (_b2 = (_a3 = f()) == null ? void 0 : _a3.getEditorView) == null ? void 0 : _b2.call(_a3);
      L && (L.focus(), ia(L));
    }, _["editor-llm-assist"] = () => ae(true), _["editor-export-pdf"] = v, _["editor-pgbr"] = () => {
      g(), y();
  ...
  const { width: qe, isResizing: Xt, handleProps: Yt } = Fi({ storageKey: fm, defaultWidth: mm, minWidth: 160, collapseBelowWidth: 80, maxWidth: 640, edge: "right", onCollapseBelowMin: () => {
    var _a3, _b2, _c2;
    ...
    const f = it == null ? void 0 : it.fonts;
  ...
  i.useEffect(() => {
  ...
  }, [Me, X]), hc(D, e, T, (a == null ? void 0 : a.id) ?? null), fc(D, { layoutKey: `${r}|${e}` }), i.useEffect(() => {
    const f = D.current;
    if (!f || !e) return;
    let g = 0;
    const x = () => {
    ...
    const f = D.current;
    if (!f) return;
    const g = Sf(a), x = { current: [] };
    let y = false, v = null, _ = null, L = [];
    const H = () => f.querySelector(".md-editor-preview"), U = () => {
      if (y) return;
      const se = H();
      if (!se || !wf(se)) return;
      const Te = kf(se, { collapsedIds: x.current, onCollapsedChange: (d) => {
    ...
    if (!l || s || !(a == null ? void 0 : a.id)) return;
    xt(false);
    const f = () => {
      var _a3, _b2, _c2;
      (_c2 = (_b2 = ((_a3 = E.current) == null ? void 0 : _a3.value) ?? E.current) == null ? void 0 : _b2.togglePreviewOnly) == null ? void 0 : _c2.call(_b2, true);
  ...
  }, [l, s, a == null ? void 0 : a.id, xt]), i.useEffect(() => {
    if (s || Ie) return;
    const f = D.current;
    if (!f) return;
    ...
    const v = (c) => c instanceof Element ? Gn(c) ? true : !!c.closest("a, button, input, textarea, select, .md-editor-code-action, [data-transform-handle]") : false, _ = (c) => {
      ...
      if (!x()) {
        ...
        (F == null ? void 0 : F.rangeCount) && d.contains(F.getRangeAt(0).commonAncestorContainer) && !F.getRangeAt(0).collapsed ? Tn(d, { allowCollapsed: false }) : Rt(d);
        return;
      }
      ...
      k && ((w == null ? void 0 : w.rangeCount) && d.contains(w.getRangeAt(0).commonAncestorContainer) && Tn(d, { allowCollapsed: true }), Pr(k, d, { focus: true, target: c }), Pn(), (_f2 = J.current) == null ? void 0 : _f2.schedule({ withRetries: true }));
    }, L = (c) => c.button === 2 || c.button === 0 && c.ctrlKey, H = (c, d) => Ar(d, c.clientX, c.clientY) ? true : Dr(c.clientX, c.clientY) ? za(d) : false, U = (c) => {
      var _a3, _b2, _c2, _d2;
      const d = g();
      if (!d) return;
      const w = c.target;
      ...
      if (d.contains(w)) {
        y = { x: c.clientX, y: c.clientY }, !Gn(w) && !x() && Rt(d);
        return;
      }
      ...
      if (!(!d || !(c.target instanceof Node) || !d.contains(c.target)) && !v(c.target)) {
        if (fn(f)) {
          ...
          k && F && (Pn(), lo(F, k, d, c.clientX, c.clientY));
          return;
        }
      ...
      if (!(!d || !(c.target instanceof Node) || !d.contains(c.target)) && !v(c.target)) {
        if (fn(f)) {
          ...
          N && F && k && (Pn(), lo(F, N, d, k.clientX, k.clientY));
          return;
        }
      ...
      be && (be.hasFocus || (F ? (Tn(d, { allowCollapsed: true }), Pr(be, d, { focus: true }), (_e2 = J.current) == null ? void 0 : _e2.schedule({ withRetries: true })) : be.focus()));
    };
    return f.addEventListener("mousedown", U, true), f.addEventListener("contextmenu", oe, true), f.addEventListener("mouseup", ke), f.addEventListener("touchend", se, { passive: true }), f.addEventListener("keydown", Te, true), () => {
      Rt(g()), f.removeEventListener("mousedown", U, true), f.removeEventListener("contextmenu", oe, true), f.removeEventListener("mouseup", ke), f.removeEventListener("touchend", se), f.removeEventListener("keydown", Te, true);
    };
  }, [s, ve, Ie]), i.useEffect(() => {
    var _a3, _b2, _c2, _d2;
    if (s) {
    ...
    const f = D.current;
    if (f) return au(f, { getPreviewRoot: () => f.querySelector(".md-editor-preview"), getView: () => {
      var _a3, _b2, _c2;
  ...
  }, [e, a == null ? void 0 : a.id, ve, Ie]), i.useEffect(() => {
    if (s) return;
    const f = () => {
      var _a3;
...
`), se = ((_c2 = (_b2 = ((_a4 = E.current) == null ? void 0 : _a4.value) ?? E.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2)) ?? H;
    ...
    const g = (x) => {
      ...
      if (_ && f.contains(_)) {
        ...
        if (ke) {
          const { from: se, to: Te } = ke.state.selection.main, c = re.current ?? "";
          if (ar(c, se, Te)) {
            x.preventDefault(), pe.current(se, Te);
            return;
          }
        }
      }
      ...
      x.preventDefault();
      const U = H.kind === "wiki" ? Ji(f, L, H.key) : Qi(f, L, H.key);
    ...
    const g = (v) => {
      ...
      const U = H.getAttribute("href") || "", oe = tl(U, { currentViewPath: (a == null ? void 0 : a.type) ? a.id : null });
  ...
  }, [O, a == null ? void 0 : a.id, a == null ? void 0 : a.type, M]);
  const Zt = i.useCallback(({ width: f, height: g }) => {
    const x = Z;
  ...
  }, [Z, W, e]), Jt = i.useCallback(async ({ file: f }) => {
    var _a3;
    const g = Z;
    ...
    const v = g.kind === "wiki" ? Oi(e, { path: g.key, occurrence: g.occurrence ?? 0, nextPath: y }) : Yr(e, { src: g.key, occurrence: g.occurrence ?? 0, nextPath: y });
    v.updated && v.markdown !== e && W(v.markdown);
  }, [W, u, e, Z]), nt = i.useCallback(async ({ width: f, height: g }) => {
    var _a3;
    const x = Z;
    ...
    const y = await Bi({ markdownSrc: x.key, displaySrc: x.imageSrc, currentNotePath: (a == null ? void 0 : a.id) ?? null });
    let v = "";
  ...
  }, [a == null ? void 0 : a.id, W, u, e, Z]), jn = i.useCallback(async ({ width: f, height: g }) => {
    const x = Z;
    ...
    const v = zi({ path: x.key, imageSrc: x.imageSrc });
    if (!v) throw new Error("Cannot determine image source URL for upload.");
    const L = (await Ki({ apiKey: y, image: v, name: Vi(x.key) ? "image" : void 0 })).url, H = x.occurrence ?? 0;
    let U = e;
    ...
    const ke = await Wi(U, { kind: x.kind === "wiki" ? "wiki" : "markdown", key: x.key, occurrence: H }, L);
  ...
  i.useEffect(() => {
    if (typeof I == "function") return I(async () => {
      ...
      const f = await qi(e, { currentNotePath: (a == null ? void 0 : a.id) ?? null, uploadFiles: async (g) => {
        if (typeof u != "function") throw new Error("Upload handler not available.");
        return u(g);
      } });
      return f.markdown !== e && W(f.markdown), f;
    }), () => I(null);
  }, [a == null ? void 0 : a.id, W, I, u, s, e]);
  const Xe = i.useCallback((f) => {
    const g = D.current;
  ...
  }, []), bt = i.useCallback(({ kind: f, key: g, occurrence: x, widthPx: y, heightPx: v }) => {
  ...
  i.useEffect(() => {
    ...
    const g = (v) => {
      ...
      if (!L) return;
      const H = v.pointerType === "touch", U = Y.current || xe, oe = v.clientX, ke = v.clientY, se = U.heightPx > 0 ? U.widthPx / U.heightPx : 1, Te = (d) => {
        ...
        document.removeEventListener("pointermove", Te, true), document.removeEventListener("pointerup", c, true);
      };
      document.addEventListener("pointermove", Te, true), document.addEventListener("pointerup", c, true);
    }, x = (v) => {
...
`);
  ...
  const en = i.useCallback(async (f) => {
    var _a3;
...
`), Oe(null);
  ...
  const tn = i.useMemo(() => [o.jsx(ju, { value: e, theme: r, currentFile: a, language: "ko-KR" }, "export-pdf"), o.jsx(Lu, { editorRef: E }, "insert-pgbr"), o.jsx(Ru, { onOpen: Ye }, "heading-remap"), o.jsx(xu, { onOpen: () => {
    ae(true);
  } }, "llm-assist"), o.jsx(Mu, { onOpen: () => {
    ne(true);
  } }, "checklist-progress"), o.jsx($u, { checked: et, onChange: at, theme: r }, "toc-title-wrap"), o.jsx(Fu, { checked: tt, onChange: gt, theme: r }, "base64-image-fold"), o.jsx(Hu, { checked: Ut, onChange: qt, theme: r }, "editor-autocomplete"), Ie ? null : o.jsx(Ou, { checked: ve, onChange: xt, theme: r }, "mirror-edit"), o.jsx(Bu, { disabled: typeof u != "function", onRequestLink: () => fe(true), onRequestUpload: (f) => {
    ct(f);
  }, onRequestClip: (f) => Oe(f) }, "image-toolbar")], [e, r, a, et, at, tt, gt, Ut, qt, Ie, ve, xt, u, ct, Ye]), nn = i.useMemo(() => ["bold", "underline", "italic", "-", "strikeThrough", "sub", "sup", "quote", "unorderedList", "orderedList", "task", "-", "codeRow", "code", "link", 9, "table", "mermaid", "katex", 1, 2, 3, 4, "-", "revoke", "next", 0, "=", 6, 7, ...Ie ? [] : [8], "pageFullscreen", "fullscreen", "previewOnly", "preview", "htmlPreview", ...Me ? [5] : [], "catalog"], [Me, Ie]), jt = i.useMemo(() => {
  ...
  return o.jsxs("div", { ref: D, className: `h-full w-full flex flex-col relative${et ? " toc-titles-wrap" : ""}`, style: { "--md-catalog-width": `${qe}px`, ...Gt }, children: [(it == null ? void 0 : it.webfontCss) ? o.jsx("style", { "data-s3haim-document-webfonts": "1", children: it.webfontCss }) : null, j && Xo.createPortal(o.jsx(Xi, { handleProps: Yt, isResizing: Xt, visibleOnHover: true, label: "TOC resize handle", style: { position: "fixed", top: j.top, left: j.left, height: j.height, bottom: "auto", zIndex: 10003 } }), document.body), p && o.jsxs("div", { className: "absolute top-0 left-0 right-0 bottom-0 z-10 flex items-center justify-center gap-2 py-2 text-sm bg-blue-300/40 dark:bg-blue-800/50 text-blue-700 dark:text-blue-300 border-b border-blue-500/20", "aria-live": "polite", children: [o.jsx(zl, { size: 16, className: "animate-spin shrink-0" }), o.jsxs("span", { children: ["Uploading image... ", Math.max(0, Math.min(100, Math.round(m))), "%"] }), typeof h == "function" && o.jsx("button", { type: "button", onClick: h, className: "ml-2 rounded-md border border-blue-600/50 bg-white/80 px-2 py-1 text-xs font-medium text-blue-800 hover:bg-white dark:border-blue-300/40 dark:bg-blue-950/60 dark:text-blue-100 dark:hover:bg-blue-950", children: "Cancel" })] }), o.jsx(la, { ref: E, id: R, modelValue: e, onChange: W, mdHeadingId: X, className: "h-full! max-h-dvh", theme: r, language: "ko-KR", codeTheme: Yi, customIcon: mc, previewOnly: s, noMermaid: true, autoDetectCode: true, scrollAuto: false, footers: ["markdownTotal"], toolbars: nn, defToolbars: tn, onUploadImg: jt }, `footnotes-${he}`), o.jsx(lc, { containerRef: D }), o.jsx(Oa, { containerRef: D }), o.jsx(dc, { isOpen: !!Z, onClose: () => Ee(null), path: (Z == null ? void 0 : Z.key) ?? "", kind: (Z == null ? void 0 : Z.kind) ?? "wiki", initialWidth: (Z == null ? void 0 : Z.width) ?? "", initialHeight: (Z == null ? void 0 : Z.height) ?? "", imageSrc: (Z == null ? void 0 : Z.imageSrc) ?? "", onApply: Zt, onStartFreeTransform: Mt, onCrop: Jt, onConvertToWiki: nt, onConvertToImgbb: jn }, Z ? `${Z.kind}|${Z.key}|${Z.width ?? ""}|${Z.height ?? ""}|${Z.occurrence ?? 0}` : "wiki-image-size-modal"), o.jsx(zu, { isOpen: Ae, onClose: () => fe(false), onConfirm: ({ desc: f, url: g }) => {
    lt(`![${f || ""}](${g})
`);
  } }), o.jsx(Ku, { isOpen: ge, onClose: () => me(false), onConfirm: ({ line1: f, line2: g }) => {
    var _a3, _b2, _c2, _d2, _e2;
    const y = (_c2 = (_b2 = ((_a3 = E.current) == null ? void 0 : _a3.value) ?? E.current) == null ? void 0 : _b2.getEditorView) == null ? void 0 : _c2.call(_b2), v = (y == null ? void 0 : y.state.doc.toString()) ?? re.current ?? "", { from: _, to: L } = De.current, H = Gi(v, _, L, f, g);
    ...
    q({ title: "? ??", message: "? ?? ???? ?? ?? ?????. ??? ??? ??? ??? ???." });
  } }), o.jsx(Ba, { containerRef: D, getMarkdown: () => re.current ?? "", setMarkdown: (f) => {
  ...
  }, llmProviderProfiles: P, open: $e, onOpenChange: ae, theme: r }), o.jsx(Su, { editorRef: E, onChange: W, open: B, onOpenChange: ne })] });
}
export {
  Wm as default
};
