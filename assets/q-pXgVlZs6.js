...
function r(n, e) {
  ...
  if (c = null, o) {
    ...
    if (i == "\\") return n.eol() || /\s/.test(n.peek()) ? (n.skipToEnd(), /^\\\s*$/.test(n.current()) ? (e.tokenize = v)(n) : e.tokenize = r, "comment") : (e.tokenize = r, "builtin");
  }
...
const a = { name: "q", startState: function() {
