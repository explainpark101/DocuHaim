    ...
    return ce() ? je || ve || (ve = (async () => {
      try {
        const { invoke: t } = await Er(async () => {
          const { invoke: s } = await import("./index-DSUCaAxT.js").then(async (m) => {
            await m.__tla;
            return m;
          }).then((d) => d.j7);
          return {
                                      ...
                                      onClick: async () => {
                                        try {
                                          const { createWebdavBackend: n } = await Er(async () => {
                                            const { createWebdavBackend: V } = await import("./index-DSUCaAxT.js").then(async (m2) => {
                                              await m2.__tla;
                                              return m2;
                                            }).then((ke) => ke.j6);
                                            return {
