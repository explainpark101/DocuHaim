...
import { o as ja } from "./vendor-md-editor-D4hOzNKK.js";
import { bz as Fe, bA as Ve, bB as Ce, bC as _e, bD as Nt, bE as vn, bF as Oi, bG as _i, bH as Sa, bI as ks, bJ as Fi, bK as js, bL as Na, bM as Ca, bN as is, bO as pn, bP as Ss, M as Bi, bQ as wr, bR as Ea, bS as qr, bT as Pa, bU as os, bV as Ta, bW as Xs, bX as Hi, ab as Ae, bY as kr, bZ as sn, b_ as as, b$ as ls, c0 as cs, c1 as Ra, c2 as Ma, c3 as La, c4 as za, c5 as Aa, c6 as Wi, c7 as Ki, c8 as Ia, c9 as Da, _ as Gi, ca as Xi, cb as Ui, cc as Bn, cd as Lr, ce as $a, cf as Oa, r as _a, T as Vi, cg as Br, as as vr, ch as Us, ci as Zr, cj as Jr, ck as Vs, cl as Fa, af as Ba, ag as Ha, cm as Wa, am as Ka, cn as Ga, co as Xa, aq as Ua, cp as Va, cq as Ya, cr as qa, cs as Za, ct as Ja, cu as Ys, cv as Qa, aa as el, av as Yi, cw as tl, cx as on, cy as rl, cz as Hn, cA as nl, cB as sl, cC as ds, cD as us, cE as il, X as ol, U as al, u as ll, cF as cl, cG as dl, cH as ul, cI as fl, cJ as pl, cK as ml, cL as hl, cM as xl, cN as gl, cO as bl, au as Wn, cP as Kn, cQ as qs, cR as wl, cS as yl, cT as vl, cU as kl, cV as jl, cW as ot, cX as Sl, cY as Gn, cZ as Qr, c_ as Nl, c$ as Cl, d0 as El, d1 as Zs, d2 as Js, d3 as Pl, d4 as Xn, d5 as Un, d6 as Tl, d7 as Qs, d8 as Rl, d9 as Ml, da as Ll, db as zl, dc as Al, dd as Il, de as Dl, df as $l, dg as Ol, dh as en, di as _l, dj as Fl, Q as Bl, dk as Hl, dl as Wl, dm as Kl, dn as Gl } from "./index-BkbuIX_p.js";
import { u as Xl, M as Ul } from "./useLazyMermaidRender-BZ27Rhco.js";
import { a as mt, C as St, aA as Vl, aB as Yl, a1 as ql, aC as Zl, av as Jl, b as qi, aD as Zi, W as Ji, aE as Ns, L as Cs, aF as Es, aG as Ps, aH as Ql, ax as ec, aI as tc, aJ as rc, aK as nc, aL as Ts, aM as Rs, T as kn, aN as jn, aO as Sn, aP as Nn, aQ as Qi, aR as Cn, aS as En, aT as Pn, aU as eo, aV as to, aW as ro, aX as no, O as sc, Q as an, e as ln, g as so, x as ic, F as io, _ as Vn, aY as oc, aZ as ac, a_ as Yn, U as lc, a$ as cc, b0 as dc, b1 as uc, b2 as fc, b3 as pc, b4 as mc, b5 as hc, b6 as ei, S as xc, q as gc, J as bc, b7 as wc, $ as yc } from "./vendor-lucide-DyPOSMSJ.js";
import { p as Ft, q as Bt, r as Ht, s as Wt, t as Kt, v as Gt, w as Xt, x as Ut, y as Vt, z as Yt, K as tr, M as rr, o as vc, l as kc, m as jc, n as Sc, b as Nc, d as zt, T as At, e as It, f as Dt, A as $t, a5 as Cc, a6 as Ec } from "./vendor-radix-BgY9OwZN.js";
import { C as Ir, g as fs, a as cn, c as oo, n as ti, b as Pc, d as Tc, e as Rc, f as Mc, u as Lc, w as zc, r as Ac, h as Ic, H as Dc, P as $c } from "./previewFootnoteScroll-DubBRJpK.js";
import { h as Oc, d as ri, i as ft, j as _c, C as jt } from "./ChatImageBackgroundPicker-Cq4DRx29.js";
import { S as kt, g as Fc } from "./SliderWithScrubInput-B28d-DVd.js";
import { N as Bc, u as Hc, t as Wc, W as Kc } from "./useTocTitleWrap-Dj7s-JTG.js";
    ...
    const _ = (G, U) => {
      const R = (I) => {
        ...
        if (H !== null) {
          ...
          c(H), p(false), H !== ie && ke({ maxWidth: Y, maxHeight: H });
        }
      };
...
function Xd({ navigation: e, pages: r, firstPageSingle: n, zoomPercent: s, onZoomChange: i, pageSizeId: o, bodyPageCount: a, pagesHostRef: u, packLayoutKey: c, hasCover: f, coverNode: b, flipIndex: x, onFlipIndexChange: p, onVisibleLogicalPagesChange: w }) {
  ...
  }, [p, O.length, z]), se = z > 0, Y = z < O.length - 1;
  d.useEffect(() => {
    if (e !== "flip") return;
    const $ = (q) => {
      const T = q.target;
...
function Ro({ cover: e, targetId: r, selectedIds: n, onChange: s, onSelectIds: i, onRequestDelete: o, onImageCrop: a, onRestoreImageAspect: u, onToggleImageLockAspect: c }) {
  const f = n.includes(r) ? n : [r], b = Ve(e, f), x = b.length === 1 && _e(e, b[0]) ? b[0] : null, p = f.length > 1 && !x, w = !!x, y = f.length === 1 ? e.elements.find((_) => _.id === f[0]) ?? null : null, g = f.length > 0 && f.every((_) => {
...
function lu(e) {
  return t.jsx(vc, { className: eu, onCloseAutoFocus: (r) => r.preventDefault(), onPointerDownOutside: (r) => {
    const n = r.target;
    n instanceof Element && n.closest(`[${ri}]`) && r.preventDefault();
  }, onInteractOutside: (r) => {
    const n = r.target;
    n instanceof Element && n.closest(`[${ri}]`) && r.preventDefault();
...
function bu({ cover: e, selectedIds: r, onSelectIds: n, onChange: s, getPresignedUrl: i, currentFile: o = null, centerSnapEnabled: a = true, centerSnapTolerance: u = Xi, objectSnapEnabled: c = false, onObjectSnapEnabledChange: f, objectSnapTolerance: b = Ui, textContainerOutlineEnabled: x = false, placePreviewEnabled: p = true, placeMode: w = null, onPlaceModeChange: y, onUndo: g, onRedo: k, className: N = "" }) {
  ...
  const lr = (l) => {
    ...
    const F = m.metaKey || m.ctrlKey, D = m.altKey, ae = m.shiftKey, fe = ae && !F && !D, ne = (F || ae) && !D, S = ne ? Zc(Z.current, l, xe.current) : Yc(Z.current, l, xe.current), W = xe.current, J = S.length > 0 && S.every((Oe) => W.includes(Oe)), ge = J && W.length === S.length && S.every((Oe) => W.includes(Oe));
    let te = W, pe;
  ...
  d.useEffect(() => {
    ...
    const l = (m) => {
      ...
      const v = ni(m.clipboardData), P = Us(m.clipboardData);
    ...
    const l = { current: false }, m = (D) => {
      ...
      const ae = ni(D.dataTransfer), fe = Us(D.dataTransfer);
      (async () => {
        l.current = true;
        try {
  ...
  const Er = new Set(r), Xe = r.length === 1 ? Et(r[0]) : null, bt = d.useMemo(() => {
    const l = Ve(e, r), m = [], v = /* @__PURE__ */ new Set();
    for (const P of l) {
      if (!_e(e, P)) continue;
      const M = Ce(e, P);
...
function Cu({ id: e, kind: r, depth: n, cover: s, selectedIds: i, selectedSet: o, collapsed: a, dropHint: u, isRenaming: c, onStartRename: f, onFinishRename: b, onToggleCollapse: x, onSelectElement: p, onSelectGroup: w, onChange: y, onSelectIds: g, onRequestDeleteLayers: k }) {
  ...
  const R = r === "group" ? Nt(G, e) : null, I = r === "element" ? G.elements.find((V) => V.id === e) : null, se = r === "group" ? Ce(G, e) : [], Y = r === "group" && se.length > 0 && se.every((V) => o.has(V)), ie = r === "group" && !Y && se.some((V) => o.has(V)), ke = r === "element" && o.has(e), de = Hr(s, e), $ = `${Lo} relative ${r === "group" ? Y ? ws : ie ? "bg-blue-50/50 dark:bg-blue-950/20" : "" : ke ? ws : ""} ${de ? "ring-1 ring-inset ring-yellow-400/80" : ""}`, q = c ? {} : { ...N, ...L }, T = (V) => {
    ...
    c || V.target instanceof Element && V.target.closest("[data-no-dnd]") || (r === "group" ? w(e, V) : p(e, V));
...
function _u({ cover: e, selectedIds: r, onSelectIds: n, onChange: s, currentFile: i = null, topPx: o = 0, width: a, isResizing: u = false, resizeHandleProps: c = {}, layersDetached: f, onLayersDetachedChange: b, layersWidth: x, layersIsResizing: p = false, layersResizeHandleProps: w = {}, centerSnapEnabled: y = true, onCenterSnapEnabledChange: g, centerSnapTolerance: k = Xi, onCenterSnapToleranceChange: N, objectSnapEnabled: L = false, onObjectSnapEnabledChange: C, objectSnapTolerance: E = Ui, onObjectSnapToleranceChange: _, textContainerOutlineEnabled: O = false, onTextContainerOutlineEnabledChange: z, placePreviewEnabled: G = true, onPlacePreviewEnabledChange: U, canUndo: R = false, canRedo: I = false, onUndo: se, onRedo: Y, placeMode: ie = null, onPlaceModeChange: ke, className: de = "" }) {
  ...
  }, children: [t.jsx(Vn, { size: 14 }), "\uC774\uBBF8\uC9C0"] })] }), t.jsx("div", { className: "grid grid-cols-3 gap-1.5", children: [{ type: "rect", tip: "\uC0AC\uAC01\uD615", shortcut: "M", Icon: ln }, { type: "ellipse", tip: "\uD0C0\uC6D0", shortcut: "O", Icon: oc }, { type: "roundRect", tip: "\uB465\uADFC \uC0AC\uAC01\uD615", shortcut: null, Icon: ac }].map(({ type: l, tip: m, shortcut: v, Icon: P }) => {
  ...
  d.useLayoutEffect(() => {
    ...
    const a = () => {
      ...
      for (const k of g) {
        ...
        if (!N || !L) continue;
        const C = Vu(k, N, L, y), E = Math.min(p / C.width, w / C.height, 1), _ = Math.max(1, Math.round(C.width * E)), O = Math.max(1, Math.round(C.height * E)), z = `${_}px`, G = `${O}px`;
...
`;
function Jf({ documentValue: e = "", documentFile: r = null, openCoverEdit: n = false, isDocumentLoading: s = false, hasNavigationSession: i = false }) {
  var _a2, _b, _c2, _d2;
  ...
  const fr = d.useMemo(() => {
    const { meta: h } = yl(g);
    return h ?? vl;
  }, [g]), Wr = d.useMemo(() => kl(g), [g]), An = d.useMemo(() => ds(g), [g]), Kr = An.cover, oe = Kr, Fs = !!(oe == null ? void 0 : oe.enabled), In = we ? "scroll" : Ge.navigation, pr = we ? 1 : Ge.pages, ct = In === "scroll" && pr === 1, Dn = !!we, Je = d.useCallback((h) => {
    at((j) => {
      const A = { ...j, ...h };
...
${j}` }));
  ...
  const $n = d.useCallback((h) => {
    ...
    Ct((h) => {
      ...
      const j = Sl({ pageSizeId: Y.pageSizeId }), A = us(h, j);
      return ot({ currentFile: E, editorContent: A }), A;
    });
  }, [we, E, Y.pageSizeId]);
  d.useEffect(() => {
    !we || !(oe == null ? void 0 : oe.pageSizeId) || oe.pageSizeId !== Y.pageSizeId && ie((h) => {
  ...
  Xc(Be, Wr, Tr ?? void 0, E == null ? void 0 : E.id), d.useEffect(() => {
    ...
    return window.addEventListener(Zs, h), () => window.removeEventListener(Zs, h);
  }, []), d.useEffect(() => {
    ...
    return window.addEventListener(Js, h), () => {
      window.removeEventListener(Js, h);
    };
  }, []), d.useEffect(() => {
    const h = Be.current;
    if (!h) return;
  ...
  Fn.current = _n;
  const sa = d.useCallback(() => Fn.current, []), { isBlocked: ia, proceed: Xr, reset: oa } = Pl({ isDirty: sa }), Ws = d.useCallback(() => {
    var _a3;
  ...
  d.useEffect(() => {
    ...
    const j = '.export-pdf-cover, [data-note-cover="1"]', A = (K) => {
      ...
      if (Se && ce.contains(Se)) {
        ...
        K.preventDefault();
        const be = je.kind === "wiki" ? Wl(ce, Se, je.key) : Kl(ce, Se, je.key);
  ...
  const da = d.useCallback(({ width: h, height: j }) => {
    ...
    const A = await jr(h, E), Q = j.kind === "wiki" ? Tl(g, { path: j.key, occurrence: j.occurrence ?? 0, nextPath: A }) : Qs(g, { src: j.key, occurrence: j.occurrence ?? 0, nextPath: A });
    !Q.updated || Q.markdown === g || (k(Q.markdown), ot({ currentFile: E, editorContent: Q.markdown }));
  }, [E, g, ee]), fa = d.useCallback(async ({ width: h, height: j }) => {
    const A = ee;
    if (!(A == null ? void 0 : A.key) || A.kind !== "markdown") throw new Error("\uBCC0\uD658\uD560 \uC774\uBBF8\uC9C0\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.");
    const Q = await Rl({ markdownSrc: A.key, displaySrc: A.imageSrc, currentNotePath: (E == null ? void 0 : E.id) ?? null });
    let K = "";
    if (Q.mode === "path") K = Q.path;
    else if (K = await jr(Q.file, E), !K) throw new Error("\uC774\uBBF8\uC9C0 \uC5C5\uB85C\uB4DC\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.");
    const ce = Qs(g, { src: A.key, occurrence: A.occurrence ?? 0, nextPath: K, width: h, height: j });
    ...
    const K = Ml({ path: A.key, imageSrc: A.imageSrc });
    if (!K) throw new Error("\uC5C5\uB85C\uB4DC\uD560 \uC774\uBBF8\uC9C0 \uC18C\uC2A4\uB97C \uCC3E\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.");
    const Se = (await Ll({ apiKey: Q, image: K, name: zl(A.key) ? "image" : void 0 })).url, je = A.occurrence ?? 0;
    let be = g;
    ...
    const ut = await Al(be, { kind: A.kind === "wiki" ? "wiki" : "markdown", key: A.key, occurrence: je }, Se);
  ...
  d.useEffect(() => {
    ...
    for (const j of os) h[Il(j.id)] = () => {
      Ur({ pageSizeId: j.id });
    };
    return Dl(h);
  }, [Zt, On, Ur, Je, we, Rr, oe, ze, Tt]), d.useEffect(() => $l(({ headingId: h }) => {
    Gr(h);
  }), [Gr]), d.useEffect(() => Ol(() => B.map((h) => ({ id: h.id, text: h.text, level: h.level }))), [B]), d.useEffect(() => {
    const h = Be.current;
    if (!h) return;
    const j = (A) => {
