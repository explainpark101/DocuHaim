const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C76l_n0j.js","assets/vendor-react-SY5QCjFA.js","assets/vendor-md-editor-CyUZNHY0.js","assets/vendor-aws-BNw5jQBi.js","assets/vendor-lucide-BWX_GyjE.js","assets/vendor-motion-YU7ZxHqi.js","assets/vendor-radix-Do7C1uSR.js","assets/vendor-zip-Bez6qchM.js","assets/index-CqNGOs1m.css"])))=>i.map(i=>d[i]);
import { _ as hr, __tla as __tla_0 } from "./vendor-md-editor-CyUZNHY0.js";
import { r, j as e, f as fr, __tla as __tla_1 } from "./vendor-react-SY5QCjFA.js";
import { dG as et, dH as yr, dI as kr, dJ as jr, dK as vr, as as ie, dL as Nr, dM as Sr, dN as wr, dO as Cr, dP as Er, dn as Nt, d1 as St, cZ as H, dQ as wt, dR as Ct, c_ as Ir, c$ as Or, dS as Ar, dT as Lr, dU as Et, dV as It, dW as Fe, dX as Pr, dY as Dr, dZ as _r, d_ as Ot, d$ as Tr, e0 as At, e1 as Lt, e2 as ae, e3 as xe, e4 as Pt, e5 as zr, e6 as Rr, a0 as $r, e7 as F, e8 as ne, e9 as be, ea as je, eb as Fr, ec as Vt, ac as ye, ed as Dt, ee as Mr, ef as Br, eg as Kr, eh as Wr, ei as Ur, cF as Gr, c9 as Vr, ej as Hr, ek as ot, el as Yr, em as Xr, a1 as lt, en as Jr, eo as qr, ep as Zr, eq as _t, er as Qr, es as ea, et as tt, eu as ta, ev as ra, ew as aa, ex as sa, ey as da, ez as Tt, z as na, eA as oa, eB as zt, eC as la, d2 as Rt, eD as $t, eE as rt, eF as ia, eG as ca, eH as xa, eI as ba, eJ as ua, eK as pa, eL as fe, eM as ga, eN as ma, eO as ha, eP as fa, eQ as Me, eR as Ft, eS as ya, eT as ka, eU as ja, eV as va, eW as Na, eX as Sa, eY as Be, eZ as Mt, e_ as Ke, e$ as wa, f0 as Ca, __tla as __tla_2 } from "./index-C76l_n0j.js";
import { W as Ht, aq as Yt, x as Xt, T as Ue, a as oe, b as le, X as Jt, a2 as Ea, v as Ge, t as qt, f as Ia, G as Oa } from "./vendor-lucide-BWX_GyjE.js";
import { T as Aa } from "./TableStyleTemplateEditor-Dd-sSAFY.js";
import { S as Bt } from "./SliderWithScrubInput-B28d-DVd.js";
import { K as Zt, M as Qt, G as ue, H as se, J as ve, D as La, g as Pa, h as Da, i as _a, j as Ta, k as za } from "./vendor-radix-Do7C1uSR.js";
import { G as Ra, O as $a, __tla as __tla_3 } from "./OpenAiCompatibleModelSelect-DzGKLezo.js";
...
\uC774\uC5B4\uC11C \uC9C4\uD589\uD560\uAE4C\uC694, \uC544\uB2C8\uBA74 \uCC98\uC74C\uBD80\uD130 \uB2E4\uC2DC \uB9CC\uB4E4\uAE4C\uC694?`,
  ...
  function us({ storageMode: t = ne, onScanTree: s, canScan: a = true, onOpenFile: u }) {
    ...
    const T = (k) => {
      ...
      },
      {
        ...
        value: `${Q(z.indexSize)} \xB7 ${z.indexFileCount.toLocaleString()}\uAC1C \uD30C\uC77C${z.totalSize > 0 ? ` \xB7 ${de.toFixed(1)}%` : ""}`
      },
      {
        label: "\uC0C9\uC778 \uC81C\uC678 \uC6A9\uB7C9",
        value: Q(Math.max(0, z.totalSize - z.indexSize))
      },
      {
        label: "\uD30C\uC77C \uC218",
  ...
  _s = function({ s3Creds: t, masterPassword: s, onSaveS3Creds: a, onExportCreds: u, onImportClick: n, showHiddenFolders: l, onToggleHiddenFolders: p, showTrashFolder: f = false, onToggleTrashFolder: N, hideRecordingCompanions: v = false, onToggleHideRecordingCompanions: E, treeStickyFolderPathEnabled: w = true, onToggleTreeStickyFolderPath: A, showTreeModifiedDate: m = false, onToggleShowTreeModifiedDate: x, treeHoverExpandSettings: g = va, onTreeHoverExpandSettingsChange: S, onRequestClose: L, webauthnSupported: o = false, webauthnEnabled: P = false, webauthnStorageOnly: h = false, onEnableWebAuthn: i, onDisableWebAuthn: b, snippetConfig: I, onChangeSnippetConfig: D, onSaveSnippetConfig: _, isSavingSnippets: T = false, snippetConfigLoaded: ee = false, editorType: Y, onEditorTypeChange: U, storageMode: G = ne, onStorageModeChange: te, localFolderName: z = "", localVaultFsPath: de = "", onOpenLocalFolder: X, webdavConfig: J, onSaveWebdavConfig: k, isMobileLayout: K = false, sidebarOpen: W = true, sidebarCollapsed: re = false, onOpenSidebar: Ne, onCheckAppUpdate: Se, isCheckingAppUpdate: we = false, latestAppBuildId: Ce = "", onScanStorageUsage: Ee, canScanStorageUsage: ce = false, onOpenStorageUsageFile: Ve, onReadUnusedImageText: Ie, onReadUnusedImageBytes: Oe, onDeleteUnusedImagePaths: pe }) {
    const [c, y] = r.useState(t), [O, R] = r.useState(""), [$, M] = r.useState(J ?? {
      ...
      password: "",
      basePath: ""
    }), [B, V] = r.useState(false), [He, sr] = r.useState(o), [it, ct] = r.useState(() => ra()), [dr, xt] = r.useState(() => Y ?? aa()), [Ae, nr] = r.useState(() => sa()), [ge, or] = r.useState(() => da()), [bt, ut] = r.useState(() => Tt()), [Le, lr] = r.useState(() => na()), [C, pt] = r.useState(() => F.getStatus()), [Pe, ir] = r.useState(() => oa()), [cr, gt] = r.useState(() => zt()), [mt, q] = r.useState(false), [xr, De] = r.useState(false), [br, _e] = r.useState(null), [ur, Ye] = r.useState(false), [Xe, ht] = r.useState(true), [Te, ft] = r.useState(() => G === be), [ze, yt] = r.useState(false), [Je, kt] = r.useState(true), qe = fr(), Re = ot(), jt = String(de || "").trim(), pr = String(z || "").trim() || la() || "", Ze = Re && jt ? jt : pr, vt = Re || typeof window < "u" && "showDirectoryPicker" in window;
    r.useEffect(() => Vt((d, j) => {
      ...
      const d = (j) => {
        var _a2;
        const Z = ((_a2 = j == null ? void 0 : j.detail) == null ? void 0 : _a2.mode) ?? zt();
        gt(Z);
      };
      ...
      const d = (j) => {
        var _a2;
        const Z = ((_a2 = j == null ? void 0 : j.detail) == null ? void 0 : _a2.mode) ?? Tt();
        ut(Z);
      };
      ...
      const Z = (/* @__PURE__ */ new Set([
        ...
        var _a2;
        const he = document.getElementById(Z);
        if (he) {
          he.scrollIntoView({
            behavior: "smooth",
            block: "start"
    ...
    const Qe = !!((t == null ? void 0 : t.imgbbApiKey) || "").trim(), me = (d) => {
      const j = d !== void 0 ? d : rt(c), Z = Ca(j), he = O.trim() || (Qe ? t.imgbbApiKey : "");
      return {
        ...c,
                          ...
                          onClick: async () => {
                            try {
                              const { createWebdavBackend: d } = await hr(async () => {
                                const { createWebdavBackend: Z } = await import("./index-C76l_n0j.js").then(async (m2) => {
                                  await m2.__tla;
                                  return m2;
                                }).then(($e) => $e.gs);
                                return {
                                  createWebdavBackend: Z
                                };
