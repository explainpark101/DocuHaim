import { l as d, m as g, a as v, n as m, p as u, j as x, L as G, s as b, t as a, i as Z, o as R, f as h, h as k, E as f, q as w } from "./vendor-md-editor-DUPlaNge.js";
...
function c(O) {
  return B.configure({ wrap: u((i) => i.type.isTop ? { parser: O.parser, overlay: (t) => t.name == "Text" || t.name == "RawText" } : null) }, "jinja");
}
const J = c(s.language);
function OO(O = {}) {
  let i = O.base || s, t = i.language == s.language ? J : c(i.language);
  return new v(t, [i.support, t.data.of({ autocomplete: I(O) }), i.language.data.of({ closeBrackets: { brackets: ["{"] } }), H]);
}
export {
