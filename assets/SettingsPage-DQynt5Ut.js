...
import { T as xa } from "./TableStyleTemplateEditor-Bnq5Know.js";
...
import { G as fa, O as ya } from "./OpenAiCompatibleModelSelect-DAH6a3pb.js";
                          ...
                          onClick: async () => {
                            try {
                              const { createWebdavBackend: r } = await or(async () => {
                                const { createWebdavBackend: Q } = await import("./index-C8citHM6.js").then(async (m2) => {
                                  await m2.__tla;
                                  return m2;
                                }).then((Te) => Te.gi);
                                return {
