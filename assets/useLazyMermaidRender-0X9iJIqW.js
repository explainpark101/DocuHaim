import { r as m } from "./vendor-react-kfkzeLNk.js";
import { q as w, v as y, w as g } from "./index-siMg0SyX.js";
...
function I(i, f = {}) {
  ...
  m.useEffect(() => {
    ...
    const c = /* @__PURE__ */ new WeakSet(), a = () => {
      if (n || t) return;
      const h = [...o.querySelectorAll(".md-editor-mermaid")].filter((e) => y(e));
      r || (r = new IntersectionObserver((e) => {
        for (const u of e) {
          if (!u.isIntersecting) continue;
          const s = u.target;
          s instanceof HTMLElement && (r == null ? void 0 : r.unobserve(s), g(s));
        }
