...
import { A as ja } from "./vendor-md-editor-BebLMpT_.js";
import { cN as Fe, cO as Ve, cP as Ce, cQ as _e, cR as Nt, cS as vn, cT as Oi, cU as _i, cV as Sa, cW as ks, cX as Fi, cY as js, cZ as Na, c_ as Ca, c$ as is, d0 as pn, d1 as Ss, U as Bi, K as wr, d2 as Ea, d3 as qr, d4 as Pa, d5 as os, d6 as Ta, d7 as Xs, d8 as Hi, d9 as Ae, a8 as kr, da as sn, Q as as, db as ls, dc as cs, dd as Ra, de as Ma, df as La, dg as za, dh as Aa, di as Wi, dj as Ki, dk as Ia, bj as Da, dl as Gi, dm as Xi, dn as Ui, dp as Bn, dq as Lr, dr as $a, ds as Oa, $ as _a, dt as Vi, du as Br, ay as vr, dv as Us, dw as Vs, dx as Zr, dy as Jr, dz as Ys, dA as Fa, dB as Ba, dC as Ha, dD as Wa, dE as Ka, dF as Ga, dG as Xa, dH as Ua, dI as Va, dJ as Ya, dK as qa, dL as Za, dM as Ja, dN as qs, dO as Qa, dP as el, T as Yi, a0 as tl, dQ as on, dR as rl, dS as Hn, dT as nl, dU as sl, dV as ds, dW as us, dX as il, dY as ol, dZ as al, d_ as ll, bi as cl, d$ as dl, e0 as ul, e1 as fl, e2 as pl, e3 as ml, e4 as hl, e5 as xl, e6 as gl, e7 as bl, e8 as wl, E as Wn, e9 as Kn, P as Zs, ea as yl, eb as vl, ec as kl, ed as jl, ee as Sl, ah as ot, ef as Nl, eg as Gn, aG as Qr, aJ as Cl, aK as El, eh as Pl, aF as Js, cm as Qs, ei as Tl, al as Xn, ej as Un, am as Rl, ek as ei, el as Ml, an as Ll, ao as zl, a2 as Al, ap as Il, em as Dl, en as $l, eo as Ol, ep as _l, eq as en, er as Fl, es as Bl, M as Hl, et as Wl, eu as Kl, ar as Gl, ev as Xl, aE as Ul } from "./index-RydzSnnb.js";
import { J as mt, i as St, k as Vl, a1 as Yl, Q as ql, C as Zl, a2 as Jl, K as qi, M as Zi, z as Ji, a3 as Ns, a4 as Cs, a5 as Es, a6 as Ps, a as Ql, a7 as ec, a8 as tc, a9 as rc, aa as nc, ab as Ts, ac as Rs, G as kn, ad as jn, ae as Sn, af as Nn, ag as Qi, ah as Cn, ai as En, aj as Pn, ak as eo, j as to, al as ro, am as no, an as sc, T as an, V as ln, x as so, D as ic, ao as io, I as Vn, ap as oc, aq as ac, ar as Yn, as as lc, at as cc, au as dc, av as uc, aw as fc, ax as pc, ay as mc, az as hc, A as ti, aA as xc, w as gc, v as bc, aB as wc, N as yc } from "./vendor-lucide-DsWVGDs1.js";
import { G as Ft, H as Bt, I as Ht, J as Wt, K as Kt, M as Gt, N as Xt, Q as Ut, U as Vt, V as Yt, S as tr, b as rr, W as vc, X as kc, Y as jc, Z as Sc, d as Nc, e as zt, T as At, f as It, g as Dt, A as $t, _ as Cc, $ as Ec } from "./vendor-radix-BWhlk-Y9.js";
import { C as Ir, g as fs, a as cn, c as oo, n as ri, b as Pc, d as Tc, e as Rc, f as Mc, u as Lc, w as zc, r as Ac, h as Ic, H as Dc, P as $c } from "./previewFootnoteScroll-De8C5JUp.js";
import { c as Oc, C as ni, a as ft, b as _c, d as jt } from "./ChatImageBackgroundPicker-BDUkdZR0.js";
import { S as kt, g as Fc } from "./SliderWithScrubInput-B2qoXP-p.js";
import { N as Bc, u as Hc, t as Wc, W as Kc } from "./useTocTitleWrap-4a3XmQ7p.js";
import { m as ao } from "./vendor-motion-9P87yVtW.js";
import { T as Gc } from "./TocTitleWrapToggle-BNLFhwUn.js";
import { u as Xc } from "./useWikiImageHydration-C94v8Uag.js";
...
import "./storageImageHydration-CflsDWpI.js";
function si(e, r, n) {
...
function bu({ cover: e, selectedIds: r, onSelectIds: n, onChange: s, getPresignedUrl: i, currentFile: o = null, centerSnapEnabled: a = true, centerSnapTolerance: u = Xi, objectSnapEnabled: c = false, onObjectSnapEnabledChange: f, objectSnapTolerance: b = Ui, textContainerOutlineEnabled: x = false, placePreviewEnabled: p = true, placeMode: w = null, onPlaceModeChange: y, onUndo: g, onRedo: k, className: N = "" }) {
  ...
  d.useEffect(() => {
    ...
    const l = (m) => {
      ...
      const v = Us(m.clipboardData), P = Vs(m.clipboardData);
...
${j}` }));
  ...
  const $n = d.useCallback((h) => {
    ...
    Ct((h) => {
      ...
      const j = Nl({ pageSizeId: Y.pageSizeId }), A = us(h, j);
      return ot({ currentFile: E, editorContent: A }), A;
    });
  }, [we, E, Y.pageSizeId]);
  d.useEffect(() => {
  ...
  const ba = { ...Fl(Y), "--print-font-body": en(((_a2 = fr.fonts) == null ? void 0 : _a2.body) || I.body), "--print-font-heading": en(((_b = fr.fonts) == null ? void 0 : _b.heading) || I.heading), "--print-font-bold": en(((_c2 = fr.fonts) == null ? void 0 : _c2.bold) || I.bold), "--print-font-code": en(((_d2 = fr.fonts) == null ? void 0 : _d2.code) || I.code, "mono") };
