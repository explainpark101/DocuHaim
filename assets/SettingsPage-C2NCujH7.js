    ...
    return ce() ? je || ve || (ve = (async () => {
      try {
        const { invoke: t } = await Er(async () => {
          const { invoke: s } = await import("./index--RQb7Uss.js").then(async (m) => {
            await m.__tla;
            return m;
          }).then((d) => d.j6);
          return {
                                      ...
                                      onClick: async () => {
                                        try {
                                          const { createWebdavBackend: n } = await Er(async () => {
                                            const { createWebdavBackend: V } = await import("./index--RQb7Uss.js").then(async (m2) => {
                                              await m2.__tla;
                                              return m2;
                                            }).then((ke) => ke.j5);
                                            return {
