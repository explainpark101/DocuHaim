...
import { ek as N, gb as Z, gc as Y, gd as ee, e4 as te, fe as re, ge as v, fc as ne, fd as se, __tla as __tla_1 } from "./index-B7Eblbsj.js";
  ...
  async function Se(e, t) {
    ...
    if (N()) {
      const { invoke: s } = await oe(async () => {
        const { invoke: i } = await import("./index-B7Eblbsj.js").then(async (m) => {
          await m.__tla;
          return m;
        }).then((c) => c.gu);
        return {
